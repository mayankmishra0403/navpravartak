...
// ─── SAMAN BIRD SANCTUARY DATA ───────────────────────────────────────────────

export const saman: Destination = {
  id: "saman",
  slug: "saman-bird-sanctuary",
  name: "Saman Bird Sanctuary",
  localName: "समान पक्षी अभयारण्य",
  destinationType: "Ramsar Wetland & Seasonal Oxbow Lake",
  country: "India",
  state: "Uttar Pradesh",
  district: "Mainpuri",
  shortDescription: "A Ramsar-recognized floodplain oasis protecting Uttar Pradesh's vulnerable Sarus Crane population.",
  tags: ["RAMSAR SITE #2413", "SARUS CRANE HAVEN", "OXBOW WETLAND", "CENTRAL ASIAN FLYWAY"],
  hero: {
    image: "/images/saman_hero_fullhd.jpg",
    poster: "/images/black_necked_stork.jpg"
  },
  quickFacts: {
    bestTime: "Nov – Feb",
    duration: "3–5 Hours",
    budget: "₹",
    destinationType: "Rainfed Oxbow Wetland",
    difficulty: "Easy",
    distance: "~32 km from Mainpuri"
  },
  discoveryScore: {
    overall: 8.7,
    categories: [
      { name: "Sarus Conservation", score: 9.9 },
      { name: "Wetland Ecology", score: 9.3 },
      { name: "Ramsar Value", score: 9.5 },
      { name: "Agrarian Coexistence", score: 8.8 },
      { name: "Crowd Level", score: 2.0 }
    ]
  },
  editorial: {
    why: "Designated as a Ramsar Site of International Importance (Site No. 2413), Saman is an essential sanctuary for Sarus Crane breeding and over 50,000 wintering Central Asian migratory waterfowl, offering an uncrowded, raw Gangetic ecosystem experience anchored in rural Western Uttar Pradesh.",
    story: "Saman Bird Sanctuary is a critical seasonal freshwater wetland located in Karhal Tehsil of Mainpuri District. Spanning over 526 hectares (5.25 sq km), this sanctuary comprises a natural oxbow lake depression formed amidst the intensively cultivated agricultural plains. Relying on monsoon runoff and seasonal channel flows, it preserves shallow open water, emergent vegetation, and surrounding marshy mudflats.",
    storyFull: "As a premier wintering node along the Central Asian Flyway, Saman provides shelter to massive congregations of Greylag Geese, Northern Pintails, Common Teal, and Black-necked Storks. Crucially, the wetland and its surrounding farmland serve as a core breeding territory for the Sarus Crane (Antigone antigone)—the world's tallest flying bird and Uttar Pradesh's official state bird. Local farming communities celebrate the crane's arrival as an omen of auspicious rainfall and bountiful harvests."
  },
  history: {
    shortIntro: "Natural oxbow flood basin elevated to a Ramsar Wetland of International Importance.",
    timeline: [
      { year: "Pre-20th C.", event: "Formed as a natural oxbow lake depression along historic Yamuna and Gangetic drainage tributaries", era: "Geological Origin" },
      { year: "Feudal Era", event: "Flourished in the historic domain of the Chauhan Rajputs and agrarian chieftains of Mainpuri", era: "Regional Heritage" },
      { year: "1990", event: "Officially notified as a Wildlife Sanctuary by the Government of Uttar Pradesh under the Wildlife Protection Act, 1972", era: "Sanctuary Notification" },
      { year: "2019", event: "Designated as a Ramsar Wetland of International Importance (Ramsar Site No. 2413)", era: "Global Recognition" },
      { year: "Present", event: "Targeted habitat management, water hyacinth clearance, and anti-poaching patrols by UP Forest Department", era: "Conservation Era" }
    ]
  },
  culture: [
    {
      title: "The Sarus Sanctuary Ethos",
      description: "Local farmers in Karhal and Saman practice wildlife-friendly agrarian habits, actively protecting nesting pairs of the venerated Sarus Crane.",
      image: '/images/saman_hero_fullhd.jpg'
    },
    {
      title: "Mainpuri Tarkashi Craft (ODOP)",
      description: "Close cultural proximity to Mainpuri links the region to Tarkashi—the legendary craft of hammering fine brass and copper wire into seasoned rosewood.",
      image: '/images/mainpuri_tarkashi.jpg'
    },
    {
      title: "Makar Sankranti & Melon Fairs",
      description: "Winter harvest celebrations with traditional kite-flying and rural grain exchanges that coincide with the peak migratory birding window.",
      image: 'https://images.unsplash.com/photo-1524613032530-449a5d94c285?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Kartik Purnima Snan",
      description: "Sacred seasonal holy dip rituals and community gatherings along rural canals, oxbow lakes, and historic village temples.",
      image: '/images/black_necked_stork.jpg'
    }
  ],
  food: [
    {
      name: "Mainpuri Bedai & Aloo Sabzi",
      description: "Signature western UP breakfast of crispy, deep-fried puffed bread stuffed with spiced urad dal, served with slow-cooked tangy potato curry.",
      category: "Breakfast",
      price: "₹30–₹50/plate",
      image: '/images/kachori.jpg'
    },
    {
      name: "Samosa & Khasta with Matar",
      description: "Flaky golden kachoris and crisp samosas smothered with spicy yellow pea curry, ginger juliennes, and sweet-sour tamarind saunth.",
      category: "Snack",
      price: "₹25–₹45/plate",
      image: '/images/samosa_chaat.jpg'
    },
    {
      name: "Karhal Dehati Peda & Rabri",
      description: "Rich, caramel-hued traditional milk solids (khoya) confection prepared from pure buffalo milk in local Karhal dairy sweet shops.",
      category: "Dessert",
      price: "₹250–₹450/kg",
      image: '/images/kheer.jpg'
    },
    {
      name: "Fresh Sugarcane Nectar & Chaach",
      description: "Chilled roadside-pressed sugarcane juice infused with mint and lemon, alongside cooling spiced buttermilk dusted with roasted cumin.",
      category: "Beverage",
      price: "₹15–₹30/glass",
      image: '/images/sattu_drink.jpg'
    },
    {
      name: "Desi Ghee Subzi Puri",
      description: "Highway dhaba delicacy of piping-hot pooris fried in pure ghee, accompanied by dry pumpkin curry and homemade spicy pickle.",
  ...
  attractions: [
    {
      id: "saman-main-watchtower",
      name: "Saman Main Watchtower",
      category: "Observation Deck",
      description: "Central elevated vantage platform providing panoramic vistas across the circular open-water body of Saman Tal.",
      duration: "45 mins",
      distance: "At Saman Tal",
      score: 9.5,
      image: '/images/saman_hero_fullhd.jpg'
    },
    {
      id: "saman-open-water",
      name: "Saman Lake Open Water & Marsh",
      category: "Core Wetland",
      description: "The primary 526-hectare oxbow water body where over 50,000 wintering ducks, geese, and storks congregate.",
      duration: "1.5–2 hrs",
      distance: "Sanctuary Core",
      score: 9.6,
      image: '/images/common_teal.jpg'
    },
    {
      id: "range-office-campus",
      name: "Forest Range Office Campus",
      category: "Conservation Hub",
      description: "Administrative entry node equipped with regional avifauna educational panels and peaceful shaded approach paths.",
      duration: "30 mins",
    ...
    {
      id: "agricultural-perimeter-trail",
      name: "Saman Agricultural Perimeter Trail",
      category: "Nature Bund Trail",
      description: "Grassy earthen bund trails weaving between rural wheat and mustard fields where Sarus Cranes actively forage.",
      duration: "1 hr",
      distance: "Lake Perimeter",
      score: 9.1,
      image: '/images/saman_hero_fullhd.jpg'
    },
    {
      id: "karhal-town-temples",
      name: "Karhal Town Heritage Temples",
      category: "Historic Shrines",
      description: "Ancient community temples located in Karhal town center reflecting the rustic spiritual life of rural Mainpuri.",
      duration: "45 mins",
      distance: "12 km from sanctuary",
      score: 8.5,
  ...
  hiddenGems: [
    {
      name: "Wetland Embankment Jetty",
      why: "A secluded water-level perspective surrounded by floating lotus pads and reeds, perfect for ground-level photography of feeding Black-necked Storks.",
      distance: "Saman Tal",
      duration: "1 hr",
      image: '/images/black_necked_stork.jpg'
    },
    {
      name: "Mainpuri Tarkashi Artisan Karkhanas",
      why: "Traditional hidden craft workshops in Mainpuri where master artisans painstakingly inlay fine brass wires into seasoned shisham wood.",
      distance: "32 km in Mainpuri",
      duration: "2 hrs",
      image: '/images/mainpuri_tarkashi.jpg'
    }
  ],
  thingsToDo: [
    { activity: "Dawn Sarus Crane Courtship Watch", duration: "2.5 hrs", cost: "₹30–₹50 (Entry)", difficulty: "Easy", bestTime: "06:30 AM – 09:30 AM, Nov–Feb", image: "/images/saman_hero_fullhd.jpg" },
    { activity: "Waterfowl Flocks & Telephoto Birding", duration: "2 hrs", cost: "Camera fees apply", difficulty: "Easy", bestTime: "Morning mist clearance", image: "/images/common_teal.jpg" },
    { activity: "Farmland Bunds Ecology Walk", duration: "1.5 hrs", cost: "Free", difficulty: "Easy", bestTime: "08:30 AM – 11:30 AM", image: "/images/black_necked_stork.jpg" },
    { activity: "Mainpuri Tarkashi Handicraft Tour", duration: "2 hrs", cost: "Free to visit", difficulty: "Easy", bestTime: "Afternoon 02:00 PM – 05:00 PM", image: "/images/mainpuri_tarkashi.jpg" }
  ],
  nearbyPlaces: [
    { name: "Karhal Town", distance: "15 km", type: "Rural Markets & Sweets", travelTime: "20 min", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=500&h=340&fit=crop&auto=format" },
    { name: "Mainpuri City", distance: "32 km", type: "Historic Fort & Tarkashi", travelTime: "40 min", image: "/images/mainpuri_tarkashi.jpg" },
    { name: "Etawah Safari Park", distance: "45 km", type: "Lion Safari & Wildlife Hub", travelTime: "50 min", image: "https://images.unsplash.com/photo-1516426122078-c23e76319801?w=500&h=340&fit=crop&auto=format" },
    { name: "Agra City & Taj Mahal", distance: "115 km", type: "Mughal Heritage Wonder", travelTime: "1.5 hrs via Expressway", image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=500&h=340&fit=crop&auto=format" }
  ],
  travel: {
    air: { airport: "Agra Airport (AGR) / Lucknow Airport (LKO)", distance: "115 km / 210 km", time: "~1.5 to 2.5 hrs via Agra-Lucknow Expressway" },
    rail: { station: "Mainpuri Railway Station (MNQ) / Etawah Junction (ETW)", distance: "32 km / 45 km", time: "Etawah is a major trunk junction on the Delhi-Howrah mainline" },
    road: { highway: "Agra-Lucknow Expressway (Karhal Interchange) & SH-84", distance: "Short drive from Karhal exit", time: "Seamless 6-lane expressway transit" }
  },
  stay: {
    categories: [
      { type: "Sanctuary Rest House", range: "₹500–₹1,000/night", options: ["Forest Rest House Saman (UP Forest Dept Mainpuri booking)"] },
      { type: "Transit & Business Hotels", range: "₹1,200–₹2,800/night", options: ["Etawah Junction Business Hotels", "Mainpuri City Lodges"] },
      { type: "Luxury / Heritage", range: "₹4,000–₹9,000/night", options: ["Expressway luxury heritage resorts in Agra"] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: "Budget Birder", perDay: "₹700–₹1,100", breakdown: [{ category: "Public Transit & Auto", amount: "₹300–₹450" }, { category: "Local Food & Chaach", amount: "₹150–₹350" }, { category: "Entry Fee", amount: "₹50" }] },
      { tier: "Comfort Explorer", perDay: "₹2,000–₹3,200", breakdown: [{ category: "Private Car from Etawah", amount: "₹1,400–₹2,000" }, { category: "Meals & Sweets", amount: "₹400–₹700" }, { category: "Camera & Guide", amount: "₹200–₹500" }] }
    ]
  },
  itineraries: {
    'Half Day': [
      {
        day: 1,
        schedule: [
          { time: "06:30 AM", place: "Early sunrise arrival at Saman Watchtower", duration: "1.5 hrs", distance: "Main entrance" },
          { time: "08:00 AM", place: "Walking the grassy bund trails for foraging Sarus Cranes", duration: "1.5 hrs", distance: "Perimeter" },
          { time: "09:30 AM", place: "Forest Range Office briefing & avifauna panel tour", duration: "45 min", distance: "Campus" },
          { time: "10:30 AM", place: "Karhal town breakfast: Bedai Aloo & Dehati Peda", duration: "1 hr", distance: "Karhal" }
        ]
      }
    ],
    '1 Full Day': [
      {
        day: 1,
        schedule: [
          { time: "06:30 AM", place: "Sunrise birdwatching & telephoto shooting at Saman Lake", duration: "3 hrs", distance: "Saman Tal" },
          { time: "09:30 AM", place: "Track waterfowl flocks along the marshy mudflats", duration: "1.5 hrs", distance: "Marshland" },
          { time: "11:30 AM", place: "Rural lunch and refreshments in Karhal town", duration: "1.5 hrs", distance: "Karhal" },
          { time: "01:30 PM", place: "Drive to Mainpuri for Maharaja Tej Singh Fort & Tarkashi craft walk", duration: "2.5 hrs", distance: "32 km" },
          { time: "04:30 PM", place: "Optional sunset excursion to nearby Etawah Safari Park", duration: "2 hrs", distance: "45 km" }
        ]
      }
    ]
  },
  experiences: [
    { title: "Sarus Crane Breeding Haven Walk", duration: "2.5 hrs", price: "₹250–₹500", category: "Conservation", image: "/images/saman_hero_fullhd.jpg" },
    { title: "Ramsar Wetland Waterfowl Safari", duration: "3 hrs", price: "₹300–₹600", category: "Birding", image: "/images/common_teal.jpg" },
    { title: "Mainpuri Tarkashi Brass-Wire Inlay Workshop", duration: "2 hrs", price: "₹350", category: "Artisan Craft", image: "/images/mainpuri_tarkashi.jpg" }
  ],
  aiPrompts: [
    "What migratory bird species can I see at Saman Bird Sanctuary in December?",
    "How do I drive to Saman Sanctuary using the Agra-Lucknow Expressway?",
    "Where can I see Sarus Cranes nesting around Saman Wetland?",
    "Can I combine a visit to Saman Sanctuary with Etawah Safari Park in one day?"
  ],
  reviews: [
    { name: "Suresh Chandra Yadav", location: "Mainpuri", text: "Saman Tal is the pride of Mainpuri. Watching dozens of magnificent Sarus Crane pairs calling across the misty wheat fields at dawn is an unforgettable sight.", rating: 5, image: "/images/saman_hero_fullhd.jpg", date: "January 2026" },
    { name: "Nisha Kulshrestha", location: "Agra", text: "A truly untouched Ramsar sanctuary just minutes off the Agra-Lucknow Expressway! Pure peace, zero commercial noise, and incredible waterfowl diversity.", rating: 5, image: "/images/common_teal.jpg", date: "December 2025" }
  ],
  sources: {
    official: ["Uttar Pradesh Forest & Wildlife Department", "Ramsar Sites Information Service (RSIS ID: 2413)", "District Administration Mainpuri (mainpuri.nic.in)"],
    historical: ["Saman Bird Sanctuary Eco-Tourism & Wildlife Survey (UP Forest Dept)", "District Gazetteer of Mainpuri — Cultural & Archaeological Records"],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              <p className="font-mono text-xs text-white/50 mb-1">{destination.id === 'saman' ? 'RAMSAR DESIGNATED' : destination.id === 'lakh-bahosi' ? 'SANCTUARY NOTIFIED' : destination.id === 'chandauli' ? 'DISTRICT ESTABLISHED' : destination.id === 'ballia' ? 'DISTRICT ESTABLISHED' : destination.id === 'deoria' ? 'DISTRICT ESTABLISHED' : destination.id === 'ghazipur' ? 'CITY FOUNDED' : 'HISTORIC ERA'}</p>
              <p className="font-display text-xl font-medium">{destination.id === 'saman' ? 'Site No. 2413' : destination.id === 'lakh-bahosi' ? '1988 AD' : destination.id === 'chandauli' ? '1997 AD' : destination.id === 'ballia' ? '1879 AD' : destination.id === 'deoria' ? '1946 AD' : destination.id === 'ghazipur' ? '1330 AD' : '11th Century'}</p>
              <p className="text-xs text-white/60 mt-1">{destination.id === 'saman' ? 'Sarus Crane Haven & Mainpuri Tarkashi' : destination.id === 'lakh-bahosi' ? '80 sq km Wetland & Kannauj Attar' : destination.id === 'chandauli' ? 'Rice Bowl of UP & Lal Bahadur Shastri' : destination.id === 'ballia' ? 'Sage Bhrigu & 1942 Baghi Ballia' : destination.id === 'deoria' ? 'Devraha Baba Hermitage' : destination.id === 'ghazipur' ? 'Sayyid Masud / Gulab Nagri' : 'Mahayogi Gorakhnath Seat'}</p>
            </div>
          </div>
        </div>
      </div>
...
export default function App() {
  const destination: Destination = saman
