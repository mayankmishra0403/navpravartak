...
// ─── Patna Bird Sanctuary Data ────────────────────────────────────────────────

const patnaSanctuary: Destination = {
  id: 'patna-bird-sanctuary',
  slug: 'patna-bird-sanctuary-etah',
  name: 'Patna Bird Sanctuary',
  localName: 'पटना पक्षी विहार (एटा)',
  destinationType: 'Protected Ramsar Wetland & Bird Sanctuary',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Etah',
  shortDescription: "The smallest bird sanctuary in Uttar Pradesh is a 1-square-kilometer miracle, hosting over 200,000 migratory birds each winter.",
  tags: ['RAMSAR WETLAND', 'BIRD SANCTUARY', 'GHUNGROO NAGARI'],
  hero: {
    image: '/images/patna_hero_fullhd.jpg',
    poster: '/images/patna_sarus_crane.jpg'
  },
  quickFacts: {
    bestTime: 'Nov – Feb',
    duration: '2–3 Hours',
    budget: '₹',
    destinationType: 'Ramsar Wetland & Sanctuary',
    difficulty: 'Easy',
    distance: '~6 km from Jalesar'
  },
  discoveryScore: {
    overall: 9.2,
    categories: [
      { name: 'Micro-Ecosystem Value', score: 9.8 },
      { name: 'Bird Congregation', score: 9.6 },
      { name: 'Cultural Craft Heritage', score: 9.0 },
      { name: 'Crowd Level', score: 9.7 },
      { name: 'Local Experience', score: 8.9 }
    ]
  },
  editorial: {
    why: "Located just 6 kilometers from the world-famous brass town of Jalesar in Etah district, Patna Bird Sanctuary is a textbook example of micro-conservation success. Spanning a mere 1.09 square kilometers, it holds the title of the smallest bird sanctuary in Uttar Pradesh.",
    story: "Covering 108 hectares of shallow rain-fed Gangetic depression, Patna Jheel transforms every winter into a bustling haven for over 200,000 migratory waterfowl from Siberia and Central Asia, sheltered under a canopy of wild date palms.",
    storyFull: "What truly sets Patna Jheel apart is the extraordinary tameness of its birds. An ancient lakeside Hindu temple has maintained a strict, community-enforced ban on hunting and poaching for generations. As a result, rosy pelicans, greater flamingos, northern pintails, and endangered Sarus cranes forage in close proximity to human observers without fear, creating one of India most intimate wildlife viewing experiences."
  },
  history: {
    shortIntro: "From a tranquil village pond and singhara cultivation jheel to a world-class Ramsar wetland.",
    timeline: [
      { year: 'Pre-1991', event: 'Patna Jheel was a natural agrarian depression utilized for water chestnut (singhara) cultivation with strict religious protection against hunting.', era: 'Community Era' },
      { year: '1991', event: 'Recognizing the phenomenal congregation of winter waterfowl, the UP Forest Department declared the 108-hectare wetland a Wildlife Sanctuary.', era: 'Sanctuary Notification' },
      { year: '2010s', event: 'Construction of dedicated watchtowers and ecological desiltation channels to preserve the central date palm island ecosystem.', era: 'Habitat Protection' },
      { year: '2020s', event: 'Elevated and formally accepted as a globally designated Ramsar Wetland site for critical bird flyway conservation.', era: 'Ramsar Recognition' },
      { year: 'Present', event: 'Thriving bird sanctuary paired with Jalesar GI-tagged brass craft heritage, attracting ornithologists and culture travelers.', era: 'Modern Ecotourism' }
    ]
  },
  culture: [
    { title: 'Jalesar Ghungroo & Brass Craft', description: "Just 6 km away, Jalesar is globally renowned as 'Ghungroo Nagari', casting resonant brass temple bells and delicate dancing bells exported worldwide under ODOP.", image: '/images/jalesar_brass.jpg' },
    { title: 'Sacred Temple Conservation Decree', description: 'The ancient lakeside temple enforces a sacred ethos of Ahimsa, where local villagers consider harming any bird a religious transgression, ensuring zero poaching.', image: '/images/patna_hero_fullhd.jpg' },
    { title: 'Wild Date Palm Islands', description: 'The unique landscape is characterized by dense groves of wild date palms (Phoenix sylvestris) rising from the shallow lake, creating natural nesting perches.', image: '/images/wetland_trail.jpg' },
    { title: 'Awagarh Rajput Heritage', description: 'Nearby Awagarh fort stands as an imposing 108-acre fortress of the Jadon Rajput dynasty, blending grand feudal architectural history with the rural countryside.', image: '/images/watchtower.jpg' }
  ],
  food: [
    { name: 'Western UP Bedmi Puri & Aloo', description: 'Crisp urad dal-infused whole wheat puris served with spicy, tangy fenugreek-infused potato curry and pickled green chilies.', category: 'Signature Breakfast', price: '₹40–₹60/plate', image: '/images/kachori.jpg' },
    { name: 'Hot Desi Ghee Jalebi', description: 'Golden spirals of fermented batter deep-fried in pure cow ghee and dipped in fragrant saffron-cardamom sugar syrup.', category: 'Sweet', price: '₹30–₹50/100g', image: '/images/kheer.jpg' },
    { name: 'Jalesar Khasta Kachori & Chutney', description: 'Extra-crispy flaky pastries filled with spiced moong and urad dal, topped with sweet saunth and fiery coriander chutney.', category: 'Snack', price: '₹20–₹40', image: '/images/kachori.jpg' },
    { name: 'Highway Dhaba Dal Tadka & Roti', description: 'Smoky yellow dal tempered with cumin, garlic, and dried red chilies, served with tandoori rotis on the Jalesar-Sikandra highway.', category: 'Main Course', price: '₹80–₹140', image: '/images/litti_chokha.jpg' },
    { name: 'Spiced Mattha & Samosa Chaat', description: 'Fresh churned country buttermilk with roasted cumin alongside crushed samosas laden with sweet yogurt and mint drizzle.', category: 'Street Food', price: '₹30–₹50', image: '/images/samosa_chaat.jpg' }
  ],
  attractions: [
    { id: 'patna-core-wetland', name: 'Patna Jheel Core Wetland', category: 'Nature', description: 'The shallow 108-hectare freshwater lake hosting over 200,000 birds including Rosy Pelicans, Bar-headed Geese, and Flamingos.', duration: '2–3 hrs', distance: 'Core Sanctuary', score: 9.9, image: '/images/patna_hero_fullhd.jpg' },
    { id: 'jalesar-brass-foundries', name: 'Jalesar Brass Bell Foundries', category: 'Culture', description: 'Centuries-old metal casting workshops handcrafting temple bells and musical dancing ghungroos with rhythmic acoustic tuning.', duration: '2 hrs', distance: '6 km in Jalesar', score: 9.5, image: '/images/jalesar_brass.jpg' },
    { id: 'patna-watchtower', name: 'Forest Department Watchtower', category: 'Nature', description: 'Elevated viewing platform offering sweeping panoramic vistas over the date palm groves and shallow bird feeding channels.', duration: '1 hr', distance: 'Lake Perimeter', score: 9.2, image: '/images/watchtower.jpg' },
    { id: 'sacred-lakeside-temple', name: 'Sacred Lakeside Temple', category: 'Spiritual', description: 'Revered local temple that acts as the spiritual guardian of the sanctuary, where migratory birds roam freely around the courtyard.', duration: '30 min', distance: 'Waterfront', score: 9.0, image: '/images/patna_sarus_crane.jpg' },
    { id: 'awagarh-fort', name: 'Awagarh Heritage Fort', category: 'Heritage', description: 'An imposing 108-acre historical fort built by Jadon Rajput rulers, standing as the grandest medieval fortress in Etah district.', duration: '2 hrs', distance: '18 km from sanctuary', score: 9.3, image: '/images/wetland_trail.jpg' },
    { id: 'date-palm-trail', name: 'Phoenix Sylvestris Nature Walk', category: 'Nature', description: 'Secluded earthen walking trail weaving through wild date palms where Sarus cranes nest and spotted owlets perch.', duration: '1.5 hrs', distance: 'Sanctuary Fringes', score: 9.1, image: '/images/cormorant_bird.jpg' }
  ],
  hiddenGems: [
    { name: 'Jalesar Ghungroo Master Foundry', why: 'A hidden artisanal workshop where master craftsmen pour molten bell metal into clay molds to tune pure musical notes for classical dancers.', distance: '6 km in Jalesar', duration: '1.5 hrs', image: '/images/jalesar_brass.jpg' },
    { name: 'Sikandra Rao Colonial Canal Aqueduct', why: 'A historic British-era irrigation aqueduct bridging the canal across natural flood depressions, surrounded by tranquil birding spots.', distance: '14 km from sanctuary', duration: '1 hr', image: '/images/wetland_trail.jpg' },
    { name: 'Nuh Khera Ancient Mound', why: 'An archaeological mound yielding ancient terracotta artifacts, punch-marked coins, and medieval pottery from the Gangetic civilization.', distance: '12 km from lake', duration: '1.5 hrs', image: '/images/watchtower.jpg' }
  ],
  thingsToDo: [
    { activity: 'Dawn Birdwatching & Telephoto Photography', duration: '2.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '06:30 AM, Nov–Feb', image: '/images/patna_hero_fullhd.jpg' },
    { activity: 'Jalesar Brass Bell & Ghungroo Workshop Tour', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '10:30 AM – 02:00 PM', image: '/images/jalesar_brass.jpg' },
    { activity: 'Awagarh Fort Rajput Heritage Exploration', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '03:00 PM – 05:00 PM', image: '/images/wetland_trail.jpg' },
    { activity: 'Date Palm Island Perimeter Trail Walk', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Golden Hour 04:30 PM', image: '/images/cormorant_bird.jpg' },
    { activity: 'Traditional Bedmi Puri & Jalebi Breakfast', duration: '45 min', cost: '₹50–₹100', difficulty: 'Easy', bestTime: '08:30 AM in Jalesar', image: '/images/kachori.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Jalesar Ghungroo Town', distance: '6 km', type: 'Handicraft & Bell City', travelTime: '10 min', image: '/images/jalesar_brass.jpg' },
    { name: 'Awagarh Fort', distance: '18 km', type: 'Historic Rajput Fort', travelTime: '25 min', image: '/images/wetland_trail.jpg' },
    { name: 'Sur Sarovar (Keetham Lake), Agra', distance: '45 km', type: 'Ramsar Bird Sanctuary', travelTime: '1 hr', image: '/images/cormorant_bird.jpg' },
    { name: 'Agra Heritage City (Taj Mahal)', distance: '50 km', type: 'World Heritage Center', travelTime: '1.2 hrs', image: 'https://images.unsplash.com/photo-1564507592333-c60657eea523?w=500&h=340&fit=crop&auto=format' }
  ],
  travel: {
    air: { airport: 'Kheria Airport Agra (AGR) / Delhi IGI (DEL)', distance: '65 km / 200 km', time: 'Agra ~1.5 hrs drive; Delhi ~3.5 hrs via Yamuna Expressway' },
    rail: { station: 'Jalesar Road Station / Tundla Junction / Agra Cantt', distance: '15 km / 38 km / 55 km', time: 'Tundla Junction is a major mainline halt with Shatabdi & Rajdhani connections' },
    road: { highway: 'Jalesar-Sikandra Rao Road (State Highway)', distance: 'Directly on paved state highway', time: 'Auto-rickshaws and e-rickshaws available from Jalesar bus stand (~10 mins)' }
  },
  stay: {
    categories: [
      { type: 'Agra Luxury & Heritage Hotels', range: '₹3,000–₹8,000/night', options: ['ITC Mughal Agra', 'Tajview Agra', 'Hotel Clarks Shiraz (Agra base)'] },
      { type: 'Etah & Jalesar Guesthouses', range: '₹800–₹1,500/night', options: ['Hotel Shanti Palace Etah', 'Jalesar Highway Tourist Lodge'] },
      { type: 'Budget Homestays', range: '₹600–₹1,000/night', options: ['Rural Farmstays near Awagarh', 'Station Road Yatri Niwas'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Birdwatcher', perDay: '₹500–₹1,000', breakdown: [{ category: 'Local Bus / Auto', amount: '₹150–₹250' }, { category: 'Street Food & Breakfast', amount: '₹150–₹250' }, { category: 'Entry Fee', amount: 'Free' }, { category: 'Ghungroo Souvenir', amount: '₹200–₹400' }] },
      { tier: 'Day Trip from Agra', perDay: '₹2,000–₹3,500', breakdown: [{ category: 'Private Cab from Agra', amount: '₹1,500–₹2,200' }, { category: 'Dhaba Lunch & Snacks', amount: '₹300–₹500' }, { category: 'Artisan Workshop Tour', amount: 'Free' }, { category: 'Brass Souvenirs', amount: '₹500+' }] },
      { tier: 'Heritage & Wildlife Explorer', perDay: '₹4,500+', breakdown: [{ category: 'Agra Hotel Base', amount: '₹2,500–₹4,000' }, { category: 'Full Day Chauffeur Car', amount: '₹2,000–₹2,800' }, { category: 'Fine Dining & Craft Purchases', amount: '₹1,000+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '06:00 AM', place: 'Sunrise arrival at Patna Bird Sanctuary & walking the date palm perimeter trail', duration: '2.5 hrs', distance: 'Core Wetland' }, { time: '08:45 AM', place: 'Traditional Bedmi Puri & piping hot Jalebi breakfast in Jalesar town', duration: '45 min', distance: '6 km' }, { time: '09:45 AM', place: 'Walking tour of Jalesar brass bell foundries & Ghungroo workshops', duration: '2 hrs', distance: 'Jalesar Market' }, { time: '12:30 PM', place: 'Drive to Awagarh Fort for exploring Rajput fort architecture', duration: '2 hrs', distance: '18 km' }, { time: '03:30 PM', place: 'Return drive toward Agra or Tundla Junction', duration: '1.5 hrs', distance: 'Transit' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '06:30 AM', place: 'Early morning bird photography at Patna Sanctuary watchtower', duration: '3 hrs', distance: 'Sanctuary' }, { time: '10:30 AM', place: 'Visit to lakeside temple and interaction with local conservationists', duration: '1.5 hrs', distance: 'Waterfront' }, { time: '01:00 PM', place: 'Lunch in Jalesar followed by in-depth brass casting artisan workshop visit', duration: '3 hrs', distance: 'Jalesar' }, { time: '05:00 PM', place: 'Sunset view of the date palm canopy and check-in to hotel', duration: '2 hrs', distance: 'Etah / Agra' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Excursion to Awagarh Fort and Jadon Rajput royal estate grounds', duration: '3 hrs', distance: 'Awagarh' }, { time: '12:30 PM', place: 'Visit to Sur Sarovar (Keetham Lake) Ramsar bird sanctuary near Agra', duration: '3 hrs', distance: 'Keetham Lake' }, { time: '04:30 PM', place: 'Evening Taj Mahal sunset viewpoint from Mehtab Bagh Agra', duration: '2 hrs', distance: 'Agra' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '07:00 AM', place: 'Arrival from Agra & morning orientation at Patna Bird Sanctuary', duration: '3 hrs', distance: 'Patna Jheel' }, { time: '11:00 AM', place: 'Deep birding trail for pelicans, pintails, and flamingos', duration: '2.5 hrs', distance: 'Lake Trails' }, { time: '03:30 PM', place: 'Jalesar bell-making foundry demonstration and ODOP shopping', duration: '3 hrs', distance: 'Jalesar' }] },
      { day: 2, schedule: [{ time: '06:30 AM', place: 'Golden hour Sarus crane photography at Patna marshland edges', duration: '3 hrs', distance: 'East Fringe' }, { time: '11:00 AM', place: 'Historical exploration of Awagarh Fort and Nuh Khera archaeological site', duration: '4 hrs', distance: 'Awagarh' }, { time: '04:30 PM', place: 'Rural walk through mustard fields and traditional village pottery stalls', duration: '2 hrs', distance: 'Etah Countryside' }] },
      { day: 3, schedule: [{ time: '08:00 AM', place: 'Combined Agra Golden Triangle heritage circuit (Taj Mahal & Agra Fort)', duration: '5 hrs', distance: 'Agra' }, { time: '03:00 PM', place: 'Departure via Yamuna Expressway or Agra Cantt railway station', duration: '2 hrs', distance: 'Highway' }] }
    ]
  },
  experiences: [
    { title: 'Intimate Avian Photography Walk', duration: '2.5 hrs', price: 'Free', category: 'Wildlife', image: '/images/patna_hero_fullhd.jpg' },
    { title: 'Jalesar Ghungroo Master Craft Trail', duration: '2 hrs', price: 'Free', category: 'Handicraft', image: '/images/jalesar_brass.jpg' },
    { title: 'Awagarh Rajput Fortress Exploration', duration: '2 hrs', price: 'Free', category: 'Heritage', image: '/images/wetland_trail.jpg' },
    { title: 'Lakeside Temple & Date Palm Trail', duration: '1.5 hrs', price: 'Free', category: 'Spiritual', image: '/images/patna_sarus_crane.jpg' }
  ],
  aiPrompts: [
    "What migratory bird species can I spot at Patna Bird Sanctuary in December?",
    "How can I visit the brass bell and ghungroo factories in nearby Jalesar?",
    "Why is the local temple so important to the protection of birds at Patna Jheel?",
    "How does Patna Bird Sanctuary compare to Sur Sarovar (Keetham Lake) in Agra?",
    "Can you plan a half-day trip from Agra to Patna Bird Sanctuary and Jalesar?",
    "Patna Bird Sanctuary Etah kaise pahuchein aur entry fees kya hai?"
  ],
  reviews: [
    { name: 'Siddharth Saxena', location: 'Agra', text: 'Just 50 km from Agra, Patna Bird Sanctuary is an astonishing hidden treasure! Because of the sacred temple, birds have zero fear of humans. You can photograph Sarus cranes and pelicans up close without disturbing them.', rating: 5, image: '/images/patna_hero_fullhd.jpg', date: 'February 2026' },
    { name: 'Meenakshi Iyer', location: 'New Delhi', text: 'Combining the morning bird walk at Patna Jheel with the brass bell foundries of Jalesar makes this one of the most culturally rich day trips in western Uttar Pradesh.', rating: 5, image: '/images/jalesar_brass.jpg', date: 'January 2026' },
    { name: 'Dr. Harshvardhan Shukla', location: 'Aligarh', text: 'A textbook example of how faith and community culture protect wildlife. The 1-sq-km lake is buzzing with thousands of pintails and bar-headed geese in winter. Truly remarkable.', rating: 5, image: '/images/patna_sarus_crane.jpg', date: 'December 2025' }
  ],
  sources: {
    official: ['Uttar Pradesh State Forest Department (forest.up.gov.in)', 'Ramsar Sites Information Service (rsis.ramsar.org)', 'Etah District Official Portal (etah.nic.in)'],
    historical: ['Zoological Survey of India Faunal Records (Patna Sanctuary)', 'International Key Biodiversity Areas (KBA) Database — Patna Wetland'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="text-xs text-white/60 mt-1">Ramsar Wetland</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Patna Jheel' }, { top: '42%', left: '38%', label: 'Jalesar Brass Hub' }, { top: '28%', left: '52%', label: 'Awagarh Fort' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('species') && `At Patna Bird Sanctuary in peak winter, you can spot Rosy Pelicans, Greater Flamingos, Bar-headed Geese, Northern Pintails, Comb Ducks, Gadwalls, and resident Sarus Cranes.`}
                  {selected?.includes('factories') && `Jalesar town (6 km away) is globally famous as 'Ghungroo Nagari'. You can walk into traditional family-run foundries in the old market where master artisans cast brass temple bells and musical anklet bells.`}
                  {selected?.includes('temple') && `The lakeside temple has enforced an ancient religious decree against hunting for generations. Because the birds are never harmed, they have lost fear of humans, offering remarkably close views.`}
                  {selected?.includes('compare') && `While Sur Sarovar (Keetham) is a larger reservoir, Patna Bird Sanctuary is a compact 1-sq-km micro-wetland with far higher bird density per acre and significantly less tourist footfall.`}
                  {selected?.includes('itinerary') && `From Agra (50 km): Depart at 05:30 AM, reach Patna Sanctuary by 07:00 AM for sunrise birding, have Bedmi Puri breakfast in Jalesar, tour the Ghungroo brass foundries, and return by afternoon.`}
                  {selected?.includes('pahuchein') && `पटना पक्षी विहार एटा जिले में जलेसर से 6 किमी दूरी पर है। आगरा से सड़क मार्ग से लगभग 1.5 घंटे लगते हैं। प्रवेश पूरी तरह निःशुल्क है और सुबह 6 बजे से शाम 5:30 तक खुला रहता है।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Entry & Timings', content: 'Entry is open daily from sunrise to sunset (06:00 AM to 05:30 PM). There is no official entry fee for general visitors. Best observation light is during early morning sunrise hours.' },
    { title: 'Birdwatching & Quietness', content: 'Maintain absolute silence near the lake edge. The birds are unusually calm and tame because of the lakeside temple tradition; do not make sudden loud movements or throw food into the water.' },
    { title: 'Photography Guidelines', content: 'Telephoto lenses (300mm–600mm) work exceptionally well. Photography is permitted throughout the sanctuary. Drone videography is strictly prohibited to prevent disturbing migratory flocks.' },
    { title: 'Dress & Temple Etiquette', content: 'Modest rural attire is advised. Remove shoes when approaching the lakeside temple courtyard. Wear mud-friendly walking shoes as trails can be soft in winter mornings.' },
    { title: 'Emergency Contacts', content: 'Etah Police Control Room: 112 / +91-5742-234200 · Jalesar Police Station: +91-5742-222100 · District Hospital Etah: +91-5742-233102 · Forest Range Office Jalesar: +91-5742-222300.' },
    { title: 'Transport Tips', content: 'Hire auto-rickshaws for a round trip from Jalesar bus stand, as finding return transit directly at the sanctuary gate can take time. Carry mosquito repellent and a water bottle.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={patnaSanctuary} />
      <QuickFacts facts={patnaSanctuary.quickFacts} />
      <WhyVisit destination={patnaSanctuary} />
      <DestinationStory destination={patnaSanctuary} />
      <HistoryTimeline destination={patnaSanctuary} />
      <CultureGrid destination={patnaSanctuary} />
      <FoodSection destination={patnaSanctuary} />
      <AttractionsGrid destination={patnaSanctuary} />
      <HiddenGems destination={patnaSanctuary} />
      <ThingsToDo destination={patnaSanctuary} />
      <NearbyPlaces destination={patnaSanctuary} />
      <HowToReach destination={patnaSanctuary} />
      <WhereToStay destination={patnaSanctuary} />
      <BestTime destination={patnaSanctuary} />
      <BudgetGuide destination={patnaSanctuary} />
      <Itineraries destination={patnaSanctuary} />
      <LocalExperiences destination={patnaSanctuary} />
      <MapSection destination={patnaSanctuary} />
      <AskD360 destination={patnaSanctuary} />
      <CommunityStories destination={patnaSanctuary} />
      <PracticalInfo />
      <SourcesTrust destination={patnaSanctuary} />
      <Footer />
    </div>
  )
}
