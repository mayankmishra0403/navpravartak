...
const suraha: Destination = {
  id: 'suraha-tal',
  slug: 'suraha-tal-ballia',
  name: 'Suraha Tal',
  localName: 'सुरहा ताल (लोकनायक जयप्रकाश पक्षी विहार)',
  destinationType: 'Protected Oxbow Lake & Bird Sanctuary',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Ballia',
  shortDescription: "A magnificent horseshoe wetland in India's eastern frontier where thousands of migratory birds transform the Gangetic horizon into a living avian canvas.",
  tags: ['OXBOW LAKE', 'BIRD SANCTUARY', 'GANGETIC WETLAND'],
  hero: {
    image: '/images/suraha_hero_fullhd.jpg',
    poster: '/images/suraha_lake_boats.jpg'
  },
  quickFacts: {
    bestTime: 'Nov – Feb',
    duration: '1–2 Days',
    budget: '₹',
    destinationType: 'Oxbow Lake & Bird Sanctuary',
    difficulty: 'Easy',
    distance: '~11 km from Ballia'
  },
  discoveryScore: {
    overall: 9.1,
    categories: [
      { name: 'Uniqueness', score: 9.5 },
      { name: 'Ecological Weight', score: 9.3 },
      { name: 'Cultural Legacy', score: 8.8 },
      { name: 'Crowd Level', score: 9.6 },
      { name: 'Local Experience', score: 8.7 }
    ]
  },
  editorial: {
    why: "Suraha Tal is a sprawling, saucer-shaped oxbow lake formed by the ancient meandering shifts of the mighty Ganga and Ghaghara rivers. Acting as a critical hydrological sponge and winter haven, it offers an untouched wilderness free of tourist crowds.",
    story: "Officially declared as the Loknayak Jayaprakash Bird Sanctuary in 1991, Suraha Tal honors the legendary freedom fighter Jayaprakash Narayan, whose birthplace Sitab Dihara lies nearby in Ballia.",
    storyFull: "The landscape shifts dramatically across seasons—from a shimmering, expansive water mirror during the post-monsoon and winter months to a mosaic of marshy grasslands, floating reeds, and fertile agricultural fringes. As morning mist lifts off the lake, hundreds of migratory bird species—including bar-headed geese, red-crested pochards, pintails, and painted storks—create a mesmerizing natural symphony across the water."
  },
  history: {
    shortIntro: "From an ancient oxbow lake formed by Ganga-Ghaghara shifts to a protected sanctuary honoring Loknayak JP.",
    timeline: [
      { year: 'Ancient Era', event: 'Natural formation as a massive horseshoe oxbow lake (chaur) through millennia of Ganga and Ghaghara riverbed shifts.', era: 'Geological Origin' },
      { year: '1942', event: 'Ballia declares independence during Quit India Movement (Ballia ke Baagi); Suraha Tal serves as a cultural symbol of local resilience.', era: 'Freedom Movement' },
      { year: '1991', event: 'Formally notified as Loknayak Jayaprakash Bird Sanctuary by UP Government to protect migratory bird flyway habitats.', era: 'Sanctuary Notification' },
      { year: '2000s', event: 'Integrated wetland conservation programs initiated by UP Forest Department to protect indigenous fishery and weed clearance.', era: 'Wetland Conservation' },
      { year: 'Present', event: 'Recognized as one of eastern UP premier birdwatching wetlands with community-guided flatboat excursions.', era: 'Ecotourism & Birding' }
    ]
  },
  culture: [
    { title: 'Baagi Ballia Freedom Spirit', description: "Ballia is globally celebrated for its fierce patriotic spirit, being the first Indian district to overthrow British rule for two weeks during the 1942 Quit India Movement.", image: '/images/suraha_hero_fullhd.jpg' },
    { title: 'Dadri Mela Tradition', description: 'Every Kartik Purnima (November), Ballia hosts the legendary Dadri Mela, one of Northern India largest historic cattle and cultural fairs featuring Dangal wrestling.', image: '/images/bhrigu_temple.jpg' },
    { title: 'Bhojpuri Folk Music & Birha', description: 'Surrounding villages echo with traditional Bhojpuri folk melodies including Birha, Sohar, and Chaiti, sung by local boatmen and farmers along the water.', image: '/images/suraha_lake_boats.jpg' },
    { title: 'Mallah & Nishad Boatmanship', description: 'Traditional fishing communities navigate non-motorized flat-bottom wooden boats (nauka) with ancestral knowledge of deep trenches and seasonal bird roosts.', image: '/images/lake_channel.jpg' }
  ],
  food: [
    { name: 'Ballia Authentic Litti Chokha', description: 'Fire-roasted whole wheat balls stuffed with spiced sattu, served with smoky roasted eggplant-tomato chokha and melted desi ghee.', category: 'Signature', price: '₹60–₹100/plate', image: '/images/litti_chokha.jpg' },
    { name: 'Traditional Dal Pitha', description: 'Steamed rice flour dumplings filled with spiced Bengal gram lentils, lightly pan-tempered with mustard seeds and curry leaves.', category: 'Specialty', price: '₹40–₹70', image: '/images/litti_chokha.jpg' },
    { name: 'Crisp Urad Dal Khasta Kachori', description: 'Flaky deep-fried pastry stuffed with spiced urad dal, served with zesty potato-fenugreek curry and sweet tamarind chutney.', category: 'Breakfast', price: '₹30–₹50', image: '/images/kachori.jpg' },
    { name: 'Roasted Sattu Sharbat & Mattha', description: 'Nutritious roasted gram flour drink with black salt, cumin, and lemon juice, alongside fresh rural spiced buttermilk.', category: 'Beverage', price: '₹20–₹40', image: '/images/sattu_drink.jpg' },
    { name: 'Desi Samosa Chaat & Thekua', description: 'Highway stall crushed samosas with tangy chutneys, accompanied by crisp deep-fried wheat and jaggery Thekua cookies.', category: 'Street Food & Sweet', price: '₹30–₹60', image: '/images/samosa_chaat.jpg' }
  ],
  attractions: [
    { id: 'suraha-lake-basin', name: 'Suraha Tal Central Water Basin', category: 'Nature', description: 'The vast horseshoe oxbow lake expanse hosting thousands of winter migratory birds, explored via quiet wooden flatboats.', duration: '3–4 hrs', distance: 'Central Lake', score: 9.8, image: '/images/suraha_hero_fullhd.jpg' },
    { id: 'bhrigu-temple', name: 'Bhrigu Muni Temple (Ballia)', category: 'Culture', description: 'Ancient sacred temple dedicated to Sage Bhrigu, from whose disciples and spiritual hermitage the city of Ballia derives its name.', duration: '1–2 hrs', distance: '11 km in Ballia', score: 9.3, image: '/images/bhrigu_temple.jpg' },
    { id: 'jp-memorial', name: 'Loknayak JP Memorial (Sitab Dihara)', category: 'Heritage', description: 'The ancestral home, museum, and memorial commemorating Bharat Ratna Jayaprakash Narayan, architect of the Total Revolution.', duration: '2–3 hrs', distance: '35 km from lake', score: 9.5, image: '/images/suraha_lake_boats.jpg' },
    { id: 'sarus-crane-roost', name: 'Sarus Crane & Waterfowl Roost', category: 'Nature', description: 'Protected marshy fringes where towering pairs of resident Sarus cranes forage alongside Siberian pintails and greylag geese.', duration: '2 hrs', distance: 'Northern Embankment', score: 9.6, image: '/images/sarus_crane_pair.jpg' },
    { id: 'lake-watchtower', name: 'Wetland Watchtower & Bund View', category: 'Nature', description: 'Elevated vantage point on the embankment offering panoramic views over the horseshoe wetland and lush green paddy fringes.', duration: '1 hr', distance: 'Sanctuary Entry', score: 9.1, image: '/images/watchtower.jpg' },
    { id: 'dadri-mela-ground', name: 'Dadri Mela Heritage Grounds', category: 'Culture', description: 'Historic grounds on the banks of Ganga hosting the annual month-long Kartik Purnima fair, cattle market, and cultural festivals.', duration: '2 hrs', distance: '12 km in Ballia', score: 8.9, image: '/images/lake_channel.jpg' }
  ],
  hiddenGems: [
    { name: 'Rewati Ganga-Ghaghara Confluence', why: 'A majestic geographic point where the Ganga and Ghaghara rivers converge, creating pristine sandy shoals and wild river dolphins.', distance: '28 km from lake', duration: '2.5 hrs', image: '/images/lake_channel.jpg' },
    { name: 'Karon Rural Pottery & Terracotta Hamlets', why: 'Centuries-old village artisans crafting traditional clay pots, water vessels, and handmade terracotta stoves using alluvial lake clay.', distance: '8 km from sanctuary', duration: '1.5 hrs', image: '/images/suraha_lake_boats.jpg' },
    { name: 'Kathaura Reed & Bamboo Marsh Trails', why: 'Secluded narrow channels bordered by tall elephant grass where kingfishers, purple swamphens, and bronze-winged jacanas nest.', distance: 'East Basin', duration: '2 hrs', image: '/images/painted_stork.jpg' }
  ],
  thingsToDo: [
    { activity: 'Sunrise Wooden Nauka Boat Cruise', duration: '2.5 hrs', cost: '₹200–₹400', difficulty: 'Easy', bestTime: '06:00 AM, Nov–Feb', image: '/images/suraha_lake_boats.jpg' },
    { activity: 'Migratory Avian Photography Stakeout', duration: '3 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning / Golden Hour', image: '/images/sarus_crane_pair.jpg' },
    { activity: 'Bhrigu Temple Heritage & Riverbank Darshan', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '09:00 AM – 12:00 PM', image: '/images/bhrigu_temple.jpg' },
    { activity: 'Loknayak JP Memorial Pilgrimage', duration: '2.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Afternoon', image: '/images/suraha_hero_fullhd.jpg' },
    { activity: 'Authentic Litti Chokha & Sattu Tasting', duration: '1 hr', cost: '₹100–₹200', difficulty: 'Easy', bestTime: 'Lunch / Evening', image: '/images/litti_chokha.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Ballia City Center & Bhrigu Temple', distance: '11 km', type: 'District HQ & Heritage', travelTime: '20 min', image: '/images/bhrigu_temple.jpg' },
    { name: 'Sitab Dihara (JP Memorial)', distance: '35 km', type: 'Freedom Movement Site', travelTime: '50 min', image: '/images/suraha_lake_boats.jpg' },
    { name: 'Buxar Historic Battlefield (Bihar)', distance: '40 km', type: 'Historical Landmark', travelTime: '1 hr', image: '/images/lake_channel.jpg' },
    { name: 'Varanasi Heritage City & Ghats', distance: '145 km', type: 'Spiritual Capital', travelTime: '3.5 hrs', image: 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=500&h=340&fit=crop&auto=format' }
  ],
  travel: {
    air: { airport: 'Patna Airport (PAT) / Varanasi Airport (VNS)', distance: '120 km / 145 km', time: 'Patna ~3 hrs drive; Varanasi ~3.5 hrs via NH-31' },
    rail: { station: 'Ballia Railway Station (BUI)', distance: '11 km from lake', time: 'Well connected with direct trains from Delhi, Lucknow, Varanasi, and Kolkata' },
    road: { highway: 'State Highway via Bairia / Sadar Road', distance: 'Smooth paved road to sanctuary approach', time: 'Auto-rickshaws and taxis readily available from Ballia station (~25 mins)' }
  },
  stay: {
    categories: [
      { type: 'City Hotels', range: '₹1,200–₹2,800/night', options: ['Hotel Krishna Ballia', 'Hotel Surya Executive', 'Ganga Heritage Inn'] },
      { type: 'Government Guest Houses', range: '₹800–₹1,500/night', options: ['UP Tourism Rahi Tourist Bungalow Ballia', 'Forest Department Rest House'] },
      { type: 'Budget Lodges', range: '₹500–₹1,000/night', options: ['Station Road Yatri Niwas', 'Chowk Guest Houses'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Explorer', perDay: '₹1,000–₹1,800', breakdown: [{ category: 'Stay', amount: '₹600–₹1,000' }, { category: 'Food', amount: '₹250–₹400' }, { category: 'Auto Transit', amount: '₹150–₹300' }, { category: 'Boat Ride', amount: '₹150–₹250' }] },
      { tier: 'Comfort Eco-Traveler', perDay: '₹2,500–₹4,000', breakdown: [{ category: 'Hotel Stay', amount: '₹1,500–₹2,200' }, { category: 'Food', amount: '₹500–₹800' }, { category: 'Private Cab', amount: '₹800–₹1,200' }, { category: 'Guide & Boat', amount: '₹400–₹600' }] },
      { tier: 'Heritage & Wildlife Deep-Dive', perDay: '₹5,000+', breakdown: [{ category: 'Executive Hotel', amount: '₹2,800+' }, { category: 'Private Car & Chauffeur', amount: '₹2,000–₹3,000' }, { category: 'Local Food & Sweets', amount: '₹800+' }, { category: 'Custom Guided Excursions', amount: '₹1,000+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '06:30 AM', place: 'Arrive at Suraha Tal embankment & sunrise boat ride for bird watching', duration: '3 hrs', distance: 'Lake Basin' }, { time: '10:30 AM', place: 'Local breakfast of Dal Pitha & hot ginger tea at lakeside stall', duration: '45 min', distance: 'Fringe Village' }, { time: '12:00 PM', place: 'Drive into Ballia city & visit historic Bhrigu Muni Temple', duration: '1.5 hrs', distance: '11 km' }, { time: '01:30 PM', place: 'Authentic Bhojpuri Litti Chokha lunch at City Chowk', duration: '1 hr', distance: 'Ballia Market' }, { time: '03:30 PM', place: 'Afternoon excursion to Loknayak JP Memorial at Sitab Dihara', duration: '2 hrs', distance: '35 km' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '06:00 AM', place: 'Early morning bird photography at Suraha Tal northern marsh channels', duration: '3.5 hrs', distance: 'Sanctuary' }, { time: '10:30 AM', place: 'Interaction with local Mallah fishermen and lakeside biodiversity walk', duration: '2 hrs', distance: 'Wetland Bund' }, { time: '02:00 PM', place: 'Check-in to Ballia hotel & relaxed Bhojpuri lunch', duration: '2 hrs', distance: 'Ballia' }, { time: '04:30 PM', place: 'Sunset walk at the Dadri Mela grounds along the Ganga riverbank', duration: '2 hrs', distance: 'Ganga Bank' }] },
      { day: 2, schedule: [{ time: '07:30 AM', place: 'Morning darshan at Bhrigu Temple and Ballia freedom history tour', duration: '2.5 hrs', distance: 'Ballia Town' }, { time: '11:00 AM', place: 'Heritage drive to Sitab Dihara (Jayaprakash Narayan Memorial)', duration: '3 hrs', distance: 'Sitab Dihara' }, { time: '03:30 PM', place: 'Scenic confluence tour of Ganga and Ghaghara rivers at Rewati', duration: '2.5 hrs', distance: 'Rewati' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '07:00 AM', place: 'Arrival in Ballia & morning orientation at Suraha Tal wetland basin', duration: '3 hrs', distance: 'Lake Basin' }, { time: '12:00 PM', place: 'Traditional flatboat cruise spotting migratory geese and pochards', duration: '2.5 hrs', distance: 'Open Water' }, { time: '05:00 PM', place: 'Sunset photography from the wetland watchtower', duration: '1.5 hrs', distance: 'Watchtower' }] },
      { day: 2, schedule: [{ time: '06:30 AM', place: 'Deep marsh bird stakeout with local naturalist guide', duration: '4 hrs', distance: 'North Marsh' }, { time: '12:00 PM', place: 'Cultural tour of Karon terracotta and pottery village hamlets', duration: '2.5 hrs', distance: 'Karon' }, { time: '04:00 PM', place: 'Bhrigu Temple visit and evening shopping in Ballia Handloom Bazaar', duration: '3 hrs', distance: 'Ballia Chowk' }] },
      { day: 3, schedule: [{ time: '08:00 AM', place: 'Full-day freedom trail excursion to Sitab Dihara and Buxar battlefield', duration: '5 hrs', distance: 'Sitab Dihara / Buxar' }, { time: '03:00 PM', place: 'Departure toward Varanasi / Patna', duration: '2 hrs', distance: 'Transit' }] }
    ]
  },
  experiences: [
    { title: 'Sunrise Flatboat Birdwatching', duration: '2.5 hrs', price: '₹200–₹400', category: 'Wildlife', image: '/images/suraha_lake_boats.jpg' },
    { title: 'Sarus Crane & Wetland Photography', duration: '3 hrs', price: 'Free', category: 'Photography', image: '/images/sarus_crane_pair.jpg' },
    { title: 'Bhrigu Muni Spiritual Heritage Walk', duration: '1.5 hrs', price: 'Free', category: 'Spiritual', image: '/images/bhrigu_temple.jpg' },
    { title: 'Sitab Dihara Freedom Heritage Tour', duration: '3 hrs', price: 'Free', category: 'Heritage', image: '/images/suraha_hero_fullhd.jpg' }
  ],
  aiPrompts: [
    "What migratory bird species can I spot at Suraha Tal during December?",
    "How can I hire a traditional wooden boat for birdwatching at Suraha Tal?",
    "What is the best way to travel from Varanasi to Suraha Tal Ballia?",
    "Can you plan a 2-day birdwatching and heritage itinerary for Ballia?",
    "What is the historical connection between Loknayak JP and Suraha Tal?",
    "Suraha Tal mein bird watching ke liye best time aur boat kaise book karein?"
  ],
  reviews: [
    { name: 'Dr. Anand Prakash Tripathi', location: 'Varanasi', text: 'Suraha Tal is an ornithologist dream! We saw hundreds of bar-headed geese and red-crested pochards in the morning mist. Zero commercial disturbance and incredibly pure village warmth.', rating: 5, image: '/images/suraha_hero_fullhd.jpg', date: 'January 2026' },
    { name: 'Pooja Srivastava', location: 'Patna', text: 'Taking a flatboat with local Nishad boatmen as dawn broke over the horseshoe lake was an unforgettable experience. The authentic Litti Chokha in Ballia is the best in UP.', rating: 5, image: '/images/suraha_lake_boats.jpg', date: 'December 2025' },
    { name: 'Manish Kumar Yadav', location: 'Lucknow', text: 'A deeply rewarding offbeat trip. The combination of Suraha Tal bird sanctuary, Bhrigu Muni Temple, and JP Memorial at Sitab Dihara makes it a rich nature-meets-history circuit.', rating: 5, image: '/images/bhrigu_temple.jpg', date: 'November 2025' }
  ],
  sources: {
    official: ['Uttar Pradesh Forest Department (forest.up.gov.in)', 'Ballia District Official Administration Portal (ballia.nic.in)', 'Wildlife Institute of India Wetland Database'],
    historical: ['Gazetteer of Ballia District — Historical and Cultural Survey', 'Records of 1942 Ballia Freedom Struggle and Loknayak JP Archives'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">1991 AD</p>
              <p className="text-xs text-white/60 mt-1">Bird Sanctuary</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Suraha Tal Basin' }, { top: '42%', left: '38%', label: 'Bhrigu Temple' }, { top: '28%', left: '52%', label: 'JP Memorial' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('species') && `At Suraha Tal during peak winter, you can spot Bar-headed Geese, Red-crested Pochards, Northern Pintails, Painted Storks, Gadwalls, and resident breeding pairs of majestic Sarus Cranes.`}
                  {selected?.includes('boat') && `You can hire traditional flat-bottom wooden boats (nauka) directly from local Mallah fishermen at the main sanctuary embankment. Rates range from ₹200 to ₹400 for a 2-hour guided birding round.`}
                  {selected?.includes('Varanasi') && `From Varanasi, take NH-31 via Ghazipur to Ballia (~145 km, 3.5 hrs). From Ballia railway station, auto-rickshaws and taxis take around 25 minutes to reach the Suraha Tal sanctuary approach.`}
                  {selected?.includes('itinerary') && `Day 1: Sunrise boat cruise at Suraha Tal, lakeside bird photography, and Bhrigu Muni Temple visit. Day 2: Heritage drive to Loknayak JP Memorial at Sitab Dihara and confluence view at Rewati.`}
                  {selected?.includes('connection') && `The sanctuary is named 'Loknayak Jayaprakash Bird Sanctuary' in honor of JP Narayan, who was born in nearby Sitab Dihara in Ballia and led the historic freedom movement in eastern UP.`}
                  {selected?.includes('book karein') && `सुरहा ताल में बर्ड वाचिंग के लिए सबसे अच्छा समय नवंबर से फरवरी है। सुबह 6 बजे मुख्य तटबंध (बांध) पर पहुंचकर स्थानीय मल्लाहों से पारंपरिक नाव ₹200–400 में ले सकते हैं।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Boating & Safety', content: 'Hire non-motorized flat-bottom wooden boats (nauka) directly from local boatmen along the embankment. Always ensure basic life jackets or floatation rings are on board before venturing onto open deep water.' },
    { title: 'Birdwatching Guidelines', content: 'Best birding hours are between 06:00 AM and 09:30 AM. Wear muted earth tones (dull green, khaki, brown) and maintain silence to avoid startling roosting flocks of bar-headed geese and cranes.' },
    { title: 'Photography & Drones', content: 'Handheld telephoto bird photography is permitted. Commercial drone filming requires prior permission from the Uttar Pradesh State Forest Department and Ballia District Administration.' },
    { title: 'Dress & Etiquette', content: 'Modest rural-appropriate attire is recommended. Remove shoes before entering local shrines or Bhrigu Muni temple. Always ask respectfully before photographing local fishermen or villagers.' },
    { title: 'Emergency Contacts', content: 'Ballia District Police Control Room: 112 / +91-5498-220202 · District Hospital Ballia (Emergency): +91-5498-220102 · UP Forest Division Ballia: +91-5498-220300.' },
    { title: 'Cash & Connectivity', content: 'Carry sufficient cash as digital UPI payments may fail in rural wetland fringes due to fluctuating mobile network signals. Bring mosquito repellent and sturdy walking shoes for embankment paths.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={suraha} />
      <QuickFacts facts={suraha.quickFacts} />
      <WhyVisit destination={suraha} />
      <DestinationStory destination={suraha} />
      <HistoryTimeline destination={suraha} />
      <CultureGrid destination={suraha} />
      <FoodSection destination={suraha} />
      <AttractionsGrid destination={suraha} />
      <HiddenGems destination={suraha} />
      <ThingsToDo destination={suraha} />
      <NearbyPlaces destination={suraha} />
      <HowToReach destination={suraha} />
      <WhereToStay destination={suraha} />
      <BestTime destination={suraha} />
      <BudgetGuide destination={suraha} />
      <Itineraries destination={suraha} />
      <LocalExperiences destination={suraha} />
      <MapSection destination={suraha} />
      <AskD360 destination={suraha} />
      <CommunityStories destination={suraha} />
      <PracticalInfo />
      <SourcesTrust destination={suraha} />
      <Footer />
    </div>
  )
}
