...
// ─── Khairabad Weaving Data ───────────────────────────────────────────────────

const khairabad: Destination = {
  id: 'khairabad-weaving',
  slug: 'khairabad-weaving-sitapur',
  name: 'Khairabad Weaving',
  localName: 'खैराबाद हथकरघा व दरी उद्योग (सीतापुर)',
  destinationType: 'Living Textile & Handloom Craft Cluster',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Sitapur',
  shortDescription: "Mughal-era flat-weave durrie and carpet workshops in Sitapur, where generational master artisans interlace vibrant cotton, wool, and jute on horizontal pit looms.",
  tags: ['LIVING CRAFT CLUSTER', 'ODOP SITAPUR', 'FLAT-WEAVE DURRIES'],
  hero: {
    image: '/images/khairabad_1.jpg',
    poster: '/images/khairabad_2.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹',
    destinationType: 'Handloom & Rug Weaving Cluster',
    difficulty: 'Easy (Artisan Trail)',
    distance: '~8 km from Sitapur / ~85 km from Lucknow'
  },
  discoveryScore: {
    overall: 9.2,
    categories: [
      { name: 'Craft Authenticity', score: 9.8 },
      { name: 'Hands-on Storytelling', score: 9.4 },
      { name: 'Cultural Value', score: 9.5 },
      { name: 'Product Diversity', score: 9.0 },
      { name: 'Workshop Access', score: 8.3 }
    ]
  },
  editorial: {
    why: "Khairabad represents an authentic living craft ecosystem where the rhythmic clatter of horizontal wooden looms has echoed through historic mohallas for centuries. Documented under UP's One District One Product (ODOP) initiative and national handicrafts records, the town's flat-weave durries and hand-knotted floor coverings showcase unmatched artisanal precision and reversible textile geometry.",
    story: "Originating as a distinguished weaving center during the Mughal era and nurtured across generations, Sitapur's durrie craft distinguishes itself through seamless flat-weave interlacing. Unlike tufted or machine rugs, every thread of warp and weft is manually locked into place using iron beating combs and hardwood shuttles.",
    storyFull: "Walking through the narrow artisan lanes of Khairabad reveals modest family-run karkhanas where yarn spools in vibrant crimson, indigo, ochre, and natural unbleached cotton are spun onto bobbins before being stretched across horizontal pit looms. The master weaver orchestrates complex geometric patterns and traditional floral motifs from memory, moving foot pedals and wooden shuttles in unbroken cadence. These durable, reversible flat-weaves grace homes across India and international markets, standing as a testament to Uttar Pradesh's enduring handloom legacy."
  },
  history: {
    shortIntro: 'From Mughal-era imperial court commissions to a designated modern ODOP textile cluster.',
    timeline: [
      { year: '16th–17th C.', event: 'Khairabad and Sitapur emerge as prominent weaving hubs during the Mughal era, supplying fine flat-weave cotton durries and floor rugs to regional courts.', era: 'Mughal Craft Heritage' },
      { year: '19th C.', event: 'Nawabi Awadh era expands the craft into intricate geometric prayer rugs (Jainamaz), bathmats, and decorative export carpets.', era: 'Nawabi & Colonial Era' },
      { year: '1980s', event: 'Office of the Development Commissioner (Handicrafts), Ministry of Textiles formalizes cluster documentation and weaver census.', era: 'National Recognition' },
      { year: '2018', event: 'Government of Uttar Pradesh designates Durrie & Carpet Weaving as Sitapur’s flagship One District One Product (ODOP) craft.', era: 'ODOP Designation' },
      { year: 'Present', event: 'Artisan clusters across Khairabad, Laharpur, and Biswan integrate contemporary home décor palettes, export-grade wool/jute blends, and buyer direct-access trails.', era: 'Contemporary Revival' }
    ]
  },
  culture: [
    { title: 'Horizontal Loom Mastery', description: 'Artisans work on specialized horizontal pit looms, manually controlling warp tension and packing rows tight with weighted iron panja combs.', image: '/images/khairabad_3.jpg' },
    { title: 'Reversible Flat-Weave Durries', description: 'Unlike tufted rugs, Sitapur durries feature identical patterns and textures on both sides, doubling product longevity and practical durability.', image: '/images/khairabad_4.jpg' },
    { title: 'ODOP Sitapur Craft Identity', description: 'Under UP ODOP, Khairabad forms the craft heartland alongside sister weaving hubs Laharpur, Biswan, and Parsendi, sustaining thousands of rural families.', image: '/images/khairabad_5.jpg' },
    { title: 'Sufi Heritage & Town Ethos', description: 'Khairabad is steeped in historic Sufi tradition, home to famous dargahs like Bade Makhdoom Sahab, creating an atmosphere of deep spiritual and artisanal calm.', image: '/images/khairabad_6.jpg' }
  ],
  food: [
    { name: 'Sitapur Shahi Biryani', description: 'Fragrant long-grain Basmati rice slow-cooked with tender meat and mild Awadhi whole spices in sealed copper degs.', category: 'Specialty', price: '₹120–₹180/plate', image: '/images/khairabad_7.jpg' },
    { name: 'Khairabad Dal Kachori & Chana', description: 'Crisp deep-fried urad dal pastries accompanied by tangy spiced black gram curry and sweet-sour amchur chutney.', category: 'Breakfast', price: '₹30–₹50/plate', image: '/images/khairabad_8.jpg' },
    { name: 'Makhan Malai & Rabri', description: 'Silky, airy seasonal milk foam infused with saffron and cardamom, garnished with slivered pistachios and silver vark.', category: 'Dessert', price: '₹40–₹70', image: '/images/khairabad_9.jpg' },
    { name: 'Spiced Sattu Sherbet & Mattha', description: 'Wholesome roasted gram flour cooler with roasted jeera, rock salt, and green chili, popular among local weavers during hot afternoon shifts.', category: 'Beverage', price: '₹20–₹35', image: '/images/khairabad_10.jpg' },
    { name: 'Sitapur Tikki & Matar Chaat', description: 'Crispy golden potato patties pan-grilled on large iron tawas, ladled with simmering dried white pea gravy and spicy mint water.', category: 'Street Food', price: '₹30–₹60', image: '/images/khairabad_11.jpg' }
  ],
  attractions: [
    { id: 'khairabad-weaver-workshops', name: 'Khairabad Handloom Weaving Mohallas', category: 'Culture', description: 'Explore working family karkhanas in Khairabad where master weavers pass shuttles on horizontal pit looms to craft bespoke cotton and wool durries.', duration: '2–3 hrs', distance: 'Khairabad Center', score: 9.7, image: '/images/khairabad_1.jpg' },
    { id: 'odop-cluster-showrooms', name: 'ODOP Durrie & Carpet Display Centres', category: 'Shopping', description: 'Authorized cooperative retail spaces and wholesale units showcasing reversible geometric durries, runners, prayer mats, and export wool rugs.', duration: '1–2 hrs', distance: 'Main Town Road', score: 9.4, image: '/images/khairabad_2.jpg' },
    { id: 'globe-enterprises-jainpur', name: 'Jainpur & Mela Maidan Handloom Hub', category: 'Heritage', description: 'Documented industrial handloom units and master yarn processing setups where large-scale custom orders and multi-loom production are managed.', duration: '1.5 hrs', distance: '2 km from town', score: 9.2, image: '/images/khairabad_3.jpg' },
    { id: 'bade-makhdoom-dargah', name: 'Dargah Hazrat Bade Makhdoom Sahab', category: 'Heritage', description: 'Historic 15th-century Sufi pilgrimage shrine embodying Khairabad’s tranquil spiritual heritage with intricate medieval arched gateways.', duration: '1 hr', distance: '1.5 km', score: 9.3, image: '/images/khairabad_4.jpg' },
    { id: 'biswan-laharpur-outpost', name: 'Laharpur & Biswan Craft Outposts', category: 'Hidden Gems', description: 'Sister weaving settlements in Sitapur district specializing in fine cotton rugs, dyed yarn processing, and traditional panja weaving.', duration: '3 hrs', distance: '25–35 km', score: 9.1, image: '/images/khairabad_5.jpg' },
    { id: 'sitapur-town-heritage', name: 'Sitapur District Craft Showrooms', category: 'Culture', description: 'District headquarters hub featuring ODOP craft facilitation centres, government emporiums, and convenient rail transit connections.', duration: '1.5 hrs', distance: '8 km', score: 9.0, image: '/images/khairabad_6.jpg' }
  ],
  hiddenGems: [
    { name: 'Panja Loom Yarn Dyeing Vats', why: 'Secluded traditional dyeing workshops on the town outskirts where raw cotton hanks are immersed in simmering natural and vibrant chemical dye kettles.', distance: 'Outer Khairabad', duration: '1 hr', image: '/images/khairabad_7.jpg' },
    { name: 'Historic Imam Bara & Chhoti Dargah', why: 'Secluded 18th-century brick-and-lime architectural gem showcasing fine stucco moldings and quiet reflective courtyards away from city traffic.', distance: 'Old Town', duration: '1 hr', image: '/images/khairabad_8.jpg' },
    { name: 'Artisan Home Loom Demonstrations', why: 'Intimate multi-generational family setups where weavers demonstrate how intricate graph patterns (nakshas) are translated directly into loom warp counts.', distance: 'Artisan Lanes', duration: '1.5 hrs', image: '/images/khairabad_9.jpg' }
  ],
  thingsToDo: [
    { activity: 'Live Handloom Weaving Demonstration', duration: '2 hrs', cost: 'Free / Guide Tip', difficulty: 'Easy', bestTime: '09:00 AM – 12:00 PM', image: '/images/khairabad_1.jpg' },
    { activity: 'Bespoke Durrie & Rug Custom Ordering', duration: '1.5 hrs', cost: '₹800–₹8,000', difficulty: 'Easy', bestTime: '11:00 AM – 04:00 PM', image: '/images/khairabad_2.jpg' },
    { activity: 'Heritage Walk through Khairabad Dargahs', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '04:30 PM (Golden Hour)', image: '/images/khairabad_4.jpg' },
    { activity: 'Yarn Spooling & Panja Beater Workshop', duration: '1 hr', cost: 'Free (With Permission)', difficulty: 'Easy', bestTime: '10:00 AM – 01:00 PM', image: '/images/khairabad_3.jpg' },
    { activity: 'Sitapur Awadhi Food & Chaat Trail', duration: '2 hrs', cost: '₹150–₹300', difficulty: 'Easy', bestTime: '06:00 PM – 08:30 PM', image: '/images/khairabad_8.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Sitapur City Centre & Junction', distance: '8 km', type: 'District HQ & Rail Gateway', travelTime: '15 min', image: '/images/khairabad_6.jpg' },
    { name: 'Biswan Weaving Cluster', distance: '28 km', type: 'Handloom & Durrie Hub', travelTime: '40 min', image: '/images/khairabad_5.jpg' },
    { name: 'Laharpur Carpet Outpost', distance: '35 km', type: 'ODOP Artisan Settlement', travelTime: '50 min', image: '/images/khairabad_3.jpg' },
    { name: 'Lucknow Heritage Capital', distance: '85 km', type: 'State Capital & Airport', travelTime: '1.5–2 hrs', image: '/images/khairabad_7.jpg' }
  ],
  travel: {
    air: { airport: 'Chaudhary Charan Singh Airport (LKO), Lucknow', distance: '95 km', time: 'Approx 2 hours via NH 24 / NH 30 four-lane expressway' },
    rail: { station: 'Sitapur Junction (STP) / Khairabad Avadh (KB)', distance: '8 km / Local', time: 'Direct trains from Lucknow, Delhi, and Bareilly; Khairabad has passenger halts' },
    road: { highway: 'National Highway 30 (Lucknow - Sitapur - Bareilly Corridor)', distance: 'Direct 4-lane highway', time: 'Smooth 85 km drive from Lucknow; well-connected state transport and private cabs' }
  },
  stay: {
    categories: [
      { type: 'Sitapur City Hotels', range: '₹1,500–₹3,200/night', options: ['Hotel Ganga Sagar Sitapur', 'Hotel Balaji Comfort Inn', 'Station Road Executive Hotels'] },
      { type: 'Heritage & Boutique Stays', range: '₹2,500–₹5,000/night', options: ['Boutique homestays on Lucknow-Sitapur Highway corridor', 'Maharaja Guesthouse Sitapur'] },
      { type: 'Budget Guesthouses', range: '₹800–₹1,500/night', options: ['Khairabad Town Lodges', 'Civil Lines Transit Guesthouses'] },
      { type: 'Lucknow Luxury Base', range: '₹4,000–₹9,000/night', options: ['Day trip base in Gomti Nagar / Hazratganj with private cab to Khairabad'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Day Explorer', perDay: '₹1,000–₹2,000', breakdown: [{ category: 'Local Transport', amount: '₹300–₹500' }, { category: 'Food & Chaat', amount: '₹250–₹400' }, { category: 'Artisan Tip/Entry', amount: '₹200–₹300' }, { category: 'Souvenir Durrie', amount: '₹600–₹1,200' }] },
      { tier: 'Textile Buyer & Craft Circuit', perDay: '₹3,500–₹6,500', breakdown: [{ category: 'Sitapur Stay', amount: '₹1,800–₹2,800' }, { category: 'Private Cab', amount: '₹1,500–₹2,200' }, { category: 'Dining', amount: '₹500–₹900' }, { category: 'Custom Weaving Orders', amount: '₹2,000–₹8,000+' }] },
      { tier: 'Curated Heritage Enthusiast', perDay: '₹7,000+', breakdown: [{ category: 'Premium Base Stay', amount: '₹3,500–₹6,000' }, { category: 'Full Day Chauffeur Cab', amount: '₹2,500–₹3,500' }, { category: 'Artisan Guide Fee', amount: '₹1,000–₹1,500' }, { category: 'Fine Wool/Silk Durries', amount: '₹5,000–₹15,000+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '08:30 AM', place: 'Arrival at Sitapur Junction & drive to Khairabad artisan lane', duration: '45 min', distance: '8 km' }, { time: '09:30 AM', place: 'Observe live horizontal loom weaving & warp-weft interlacing in family workshop', duration: '2 hrs', distance: 'Old Khairabad' }, { time: '11:45 AM', place: 'Visit ODOP durrie showrooms & sample geometric reversible patterns', duration: '1.5 hrs', distance: 'Main Bazar' }, { time: '01:30 PM', place: 'Authentic lunch of Sitapur Shahi Biryani / Awadhi thali', duration: '1 hr', distance: 'Sitapur Road' }, { time: '02:45 PM', place: 'Excursion to Jainpur & Mela Maidan handloom production units', duration: '2 hrs', distance: 'Jainpur' }, { time: '05:00 PM', place: 'Sunset visit to historic Hazrat Bade Makhdoom Sahab Dargah before departure', duration: '1 hr', distance: 'Heritage Core' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Check-in to Sitapur hotel & briefing on ODOP craft clusters', duration: '1 hr', distance: 'Civil Lines' }, { time: '10:30 AM', place: 'Deep dive into Khairabad flat-weave workshops & yarn dyeing vats', duration: '3 hrs', distance: 'Khairabad' }, { time: '02:00 PM', place: 'Lunch & tea with master weavers discussing graph designs and panja technique', duration: '1.5 hrs', distance: 'Artisan Lane' }, { time: '04:00 PM', place: 'Visit historic Khairabad Sufi shrines and architectural monuments', duration: '2 hrs', distance: 'Town Core' }, { time: '06:30 PM', place: 'Evening Chaat trail in Sitapur bazaar & dinner', duration: '2 hrs', distance: 'Sitapur Bazaar' }] },
      { day: 2, schedule: [{ time: '08:30 AM', place: 'Morning drive to sister weaving cluster in Biswan or Laharpur', duration: '1 hr', distance: '28 km' }, { time: '09:30 AM', place: 'Explore rural panja durrie workshops and handloom yarn preparation', duration: '3 hrs', distance: 'Biswan' }, { time: '01:00 PM', place: 'Traditional local lunch at Biswan bazaar', duration: '1 hr', distance: 'Biswan' }, { time: '02:30 PM', place: 'Place custom durrie orders directly with artisan co-operatives', duration: '2 hrs', distance: 'Cluster Hub' }, { time: '05:00 PM', place: 'Departure to Lucknow via NH 30 four-lane highway', duration: '1.5 hrs', distance: 'Expressway' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Arrival in Sitapur & check-in to accommodation', duration: '1.5 hrs', distance: 'Sitapur' }, { time: '11:00 AM', place: 'In-depth Khairabad master artisan workshop visits & flat-weave demonstrations', duration: '3 hrs', distance: 'Khairabad' }, { time: '03:30 PM', place: 'Explore ODOP cooperative showrooms, carpet collections & custom orders', duration: '2.5 hrs', distance: 'Showrooms' }] },
      { day: 2, schedule: [{ time: '08:30 AM', place: 'Full-day Sitapur craft circuit: Laharpur, Biswan & Parsendi weaving hamlets', duration: '5 hrs', distance: 'District Circuit' }, { time: '02:30 PM', place: 'Traditional rural lunch and yarn dyeing vat demonstrations', duration: '2 hrs', distance: 'Biswan' }, { time: '05:00 PM', place: 'Sunset photography at historic brick monuments and countryside', duration: '2 hrs', distance: 'Rural Outskirts' }] },
      { day: 3, schedule: [{ time: '08:00 AM', place: 'Excursion to holy Naimisharanya pilgrimage forest & ancient temple complex', duration: '4 hrs', distance: '40 km' }, { time: '01:00 PM', place: 'Final souvenir pickups of reversible durries & prayer mats', duration: '2 hrs', distance: 'Khairabad' }, { time: '04:00 PM', place: 'Direct departure to Lucknow Airport or Sitapur Junction', duration: '2 hrs', distance: 'Expressway' }] }
    ]
  },
  experiences: [
    { title: 'Horizontal Loom Demonstration', duration: '2 hrs', price: 'Free / Tip', category: 'Craft Immersion', image: '/images/khairabad_1.jpg' },
    { title: 'Custom Reversible Durrie Ordering', duration: '1.5 hrs', price: '₹800–₹8,000', category: 'Handmade Shopping', image: '/images/khairabad_2.jpg' },
    { title: 'ODOP Cluster Artisan Trail', duration: '4 hrs', price: '₹500 Guide Fee', category: 'Cultural Tour', image: '/images/khairabad_3.jpg' },
    { title: 'Historic Khairabad Heritage Walk', duration: '2 hrs', price: 'Free', category: 'Heritage', image: '/images/khairabad_4.jpg' }
  ],
  aiPrompts: [
    "How are Sitapur reversible flat-weave durries made on horizontal looms?",
    "How can I visit authentic master weaver workshops in Khairabad?",
    "What is the best route from Lucknow to Khairabad and Sitapur?",
    "Can you recommend a 2-day handloom and heritage itinerary for Sitapur?",
    "What are the key differences between Khairabad durries and tufted carpets?",
    "Khairabad me hathkargha dario ki kharidari aur workshop dekhne ka sahi tarika kya hai?"
  ],
  reviews: [
    { name: 'Ananya Sengupta', location: 'New Delhi (Textile Designer)', text: 'The flat-weave durries of Khairabad are an absolute treasure of Indian craftsmanship! Seeing master weavers work the horizontal pit looms with such mathematical symmetry and rhythm was breathtaking.', rating: 5, image: '/images/khairabad_1.jpg', date: 'August 2026' },
    { name: 'Mohammad Farooq', location: 'Lucknow', text: 'We purchased two stunning pure cotton reversible durries directly from an artisan family in Khairabad. The quality, feel, and vibrant geometric patterns far exceed commercial store rugs.', rating: 5, image: '/images/khairabad_2.jpg', date: 'July 2026' },
    { name: 'David Miller', location: 'London, UK (Heritage Travel Researcher)', text: 'A completely uncommercialized and authentic textile cluster. The weavers were incredibly welcoming, explaining every nuance of the warp tension, wooden shuttle, and iron comb beating.', rating: 5, image: '/images/khairabad_3.jpg', date: 'May 2026' }
  ],
  sources: {
    official: ['Office of Development Commissioner (Handicrafts), Ministry of Textiles (handicrafts.nic.in)', 'Uttar Pradesh One District One Product (ODOP) Sitapur (odopup.in)', 'UP OCMMS Industrial Registry — Handloom & Carpet Establishments'],
    historical: ['District Gazetteer of Sitapur — Industrial & Craft Survey', 'National Council for Applied Economic Research — Indian Handloom Clusters Report'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">16th C.</p>
              <p className="text-xs text-white/60 mt-1">Mughal Handloom Era</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Khairabad Weavers' }, { top: '42%', left: '38%', label: 'Bade Makhdoom Dargah' }, { top: '28%', left: '52%', label: 'ODOP Sitapur Hub' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('horizontal looms') && `Sitapur durries are flat-woven by interlacing warp (taana) and weft (baana) manually without tufting. The weaver compresses each row using a heavy iron panja comb, producing identical reversible geometric patterns on both sides.`}
                  {selected?.includes('visit authentic') && `Arrive at Khairabad via Sitapur city, connect with local ODOP cooperative centers or master artisan karkhanas in old mohallas. Prior coordination or a local guide ensures respectful access to active loom pits.`}
                  {selected?.includes('best route') && `Take NH 30 (Lucknow - Sitapur Highway) for a smooth 85 km 4-lane drive (approx 1.5 to 2 hours). From Sitapur Junction, Khairabad is just 8 km south and easily reachable via auto-rickshaw or taxi.`}
                  {selected?.includes('2-day') && `Day 1: Khairabad pit loom workshops, master weaver interactions, and Hazrat Bade Makhdoom Dargah. Day 2: Sister weaving hubs of Biswan & Laharpur, yarn dyeing vats, and ODOP showroom custom ordering.`}
                  {selected?.includes('differences') && `Unlike tufted or machine rugs, Khairabad durries are 100% reversible flat-weaves made with dense cotton, wool, or jute. They do not shed pile, are washable, highly durable, and showcase double-sided hand artistry.`}
                  {selected?.includes('kharidari') && `खैराबाद में सीधे बुनकरों या ओडीओपी सहकारी केंद्रों से दरी खरीदना सबसे उत्तम है। आप कॉटन, वूल या जूट में मनपसंद रंग और साइज कस्टमाइज करवा सकते हैं।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Workshop Access & Permissions', content: 'Khairabad is a working craft cluster composed of private home-workshops and karkhanas rather than commercial public museums. Always seek permission before entering loom premises, and schedule visits during morning or afternoon production shifts.' },
    { title: 'Photography & Etiquette', content: 'Always request artisan consent before capturing portraits or close-up photographs of proprietary graph designs (nakshas). Never obstruct narrow loom corridors, touch moving shuttles, or disturb yarn tension on active pit looms.' },
    { title: 'Purchasing & Fair Trade', content: 'When purchasing durries, runners, or rugs, buy directly from master weavers or verified ODOP cooperative centers. Ask about fibre composition (pure cotton, wool blend, jute) and reversibility. Custom sizes can be commissioned with agreed dispatch terms.' },
    { title: 'Accessibility & Safety', content: 'Artisan mohallas have narrow paved lanes and working pit looms situated at floor level. Supervise children around heavy wooden beater combs and spinning bobbins. Wear comfortable walking shoes suited for traditional village lanes.' },
    { title: 'Emergency Contacts', content: 'Sitapur District Police Control: 112 / 05862-242222 · Khairabad Police Station: 05862-251230 · District Hospital Sitapur: 05862-242444 · UP Tourism Helpline: 1800-180-5013.' },
    { title: 'Best Visit Timing & Cash', content: 'The ideal visiting season spans October to March when weather is cool and weavers work in bright, open courtyards. Digital payments (UPI) work in town shops, but carrying physical cash is strongly recommended for direct artisan purchases.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={khairabad} />
      <QuickFacts facts={khairabad.quickFacts} />
      <WhyVisit destination={khairabad} />
      <DestinationStory destination={khairabad} />
      <HistoryTimeline destination={khairabad} />
      <CultureGrid destination={khairabad} />
      <FoodSection destination={khairabad} />
      <AttractionsGrid destination={khairabad} />
      <HiddenGems destination={khairabad} />
      <ThingsToDo destination={khairabad} />
      <NearbyPlaces destination={khairabad} />
      <HowToReach destination={khairabad} />
      <WhereToStay destination={khairabad} />
      <BestTime destination={khairabad} />
      <BudgetGuide destination={khairabad} />
      <Itineraries destination={khairabad} />
      <LocalExperiences destination={khairabad} />
      <MapSection destination={khairabad} />
      <AskD360 destination={khairabad} />
      <CommunityStories destination={khairabad} />
      <PracticalInfo />
      <SourcesTrust destination={khairabad} />
      <Footer />
    </div>
  )
}
