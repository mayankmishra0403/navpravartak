...
const kaimganj: Destination = {
  id: 'kaimganj-town',
  slug: 'kaimganj-town-farrukhabad',
  name: 'Kaimganj Town',
  localName: 'कायमगंज टाउन एवं ग्रामीण स्थापत्य (फर्रुखाबाद)',
  destinationType: 'Historic Small-Town & Vintage Rural Architecture',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Farrukhabad',
  shortDescription: "An authentic 18th-century Nawabi market town founded in 1713, where weathered brick havelis, timber-shuttered bazaars, and ancient religious landmarks preserve living North Indian rural-urban architecture.",
  tags: ['VINTAGE RURAL ARCHITECTURE', 'FOUNDED 1713 AD', 'BANGASH NAWABI HERITAGE'],
  hero: {
    image: '/images/kaimganj_1.jpg',
    poster: '/images/kaimganj_4.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹',
    destinationType: 'Historic Streetscape & Heritage Trail',
    difficulty: 'Easy (Walking Town Lanes)',
    distance: '~40 km from Farrukhabad / ~140 km from Agra'
  },
  discoveryScore: {
    overall: 9.0,
    categories: [
      { name: 'Historic Town Value', score: 9.5 },
      { name: 'Architectural Textures', score: 9.1 },
      { name: 'Photographic Character', score: 9.2 },
      { name: 'Cultural Continuity', score: 8.8 },
      { name: 'Tourism Infrastructure', score: 8.4 }
    ]
  },
  editorial: {
    why: "Founded in 1713 by Nawab Muhammad Khan Bangash and named after his son Qaim Khan, Kaimganj offers a rare and authentic glimpse into the historic vernacular architecture of an early 18th-century North Indian market town. Unlike manicured tourist hubs, its charm lies in weathered brickwork, traditional lime-wash facades, intricately carved wooden doorways, and bustling narrow bazaar lanes that have maintained their trading character for over three centuries.",
    story: "Deeply anchored in the history of Farrukhabad's Bangash dynasty, Kaimganj emerged as a vital commercial and cultural center in the Doab region. The town’s architectural fabric reflects a harmonious blend of Mughal-influenced brick masonry, colonial-era civic remnants, and vernacular domestic dwellings constructed with locally fired bricks and heavy wooden lintels.",
    storyFull: "Exploring Kaimganj is a sensory immersion into living heritage. Morning light highlights the patina of historic shopfronts where generational merchants and artisans conduct business under projecting timber chhajjas. In nearby Mau Rashidabad stands the historic tomb of Nawab Rasheed Khan, while ancient Shivalaya and Devi temples stand alongside historic mosques like the Jama Masjid and Qadeemi Masjid. Just 10 km away lies ancient Kampil—the legendary capital of Southern Panchala—making Kaimganj the perfect base for off-the-beaten-path heritage exploration."
  },
  history: {
    shortIntro: 'From 1713 AD Bangash Nawabi foundation to a thriving rural heritage market town.',
    timeline: [
      { year: '1713 AD', event: 'Nawab Muhammad Khan Bangash founds Kaimganj after imperial Mughal service, naming the town in honor of his eldest son, Qaim Khan.', era: 'Nawabi Foundation' },
      { year: '18th C.', event: 'Development of Mau Rashidabad, construction of Nawab Rasheed Khan Tomb, and expansion of traditional trading bazaars.', era: 'Regional Expansion' },
      { year: '19th C.', event: 'Kaimganj becomes a major agricultural and tobacco trading center in the Farrukhabad Doab, documented in the Imperial Gazetteer.', era: 'Commercial Peak' },
      { year: '1900s', event: 'Introduction of the railway line connecting Kaimganj to Kasganj and Kanpur, cementing its status as tehsil headquarters.', era: 'Rail Era' },
      { year: 'Present', event: 'Preserves authentic vernacular streetscapes, heritage havelis, and serves as the gateway to ancient Kampil archaeological circuits.', era: 'Living Heritage' }
    ]
  },
  culture: [
    { title: 'Vernacular Brick & Lime Architecture', description: 'Traditional multi-story houses featuring exposed Lakhori-style brickwork, lime-plaster mouldings, ornate wrought iron balconies, and heavy carved teak doorways.', image: '/images/kaimganj_2.jpg' },
    { title: 'Historic Bazaar Street Morphology', description: 'Three-century-old market layout with narrow intersecting gallis, wooden-shuttered shopfronts, and open verandas supporting traditional trades.', image: '/images/kaimganj_3.jpg' },
    { title: 'Bangash Nawabi Tomb & Shrines', description: 'Historic Islamic funerary architecture in Mau Rashidabad, including the weathered domed tomb of Nawab Rasheed Khan surrounded by quiet groves.', image: '/images/kaimganj_4.jpg' },
    { title: 'Ancient Panchala & Kampil Connection', description: 'Deep cultural proximity to ancient Kampilya (Kampil), birthplace of Draupadi and 13th Jain Tirthankara Vimalanatha, located just 10 km away.', image: '/images/kaimganj_5.jpg' }
  ],
  food: [
    { name: 'Kaimganj Khasta Dal Kachori', description: 'Flaky golden deep-fried pastries filled with spiced urad dal, served with tangy hing-aloo gravy and sweet sonth chutney.', category: 'Breakfast', price: '₹25–₹45/plate', image: '/images/kaimganj_6.jpg' },
    { name: 'Farrukhabad Special Imarti & Rabri', description: 'Intricately swirled urad dal imartis fried in pure desi ghee, soaked in saffron syrup and paired with thick creamy rabri.', category: 'Dessert', price: '₹40–₹75/plate', image: '/images/kaimganj_7.jpg' },
    { name: 'Wood-Fired Tandoori Roti & Dal Tadka', description: 'Rustic clay-oven wheat flatbreads served with smoky yellow lentils tempered with cumin, garlic, and desi ghee.', category: 'Main Course', price: '₹80–₹130/thali', image: '/images/kaimganj_8.jpg' },
    { name: 'Farrukhabad Spicy Dalmoth & Namkeen', description: 'Famous regional crunchy snack made from whole brown lentils, cashews, musk melon seeds, and fiery secret spice blends.', category: 'Snack/Souvenir', price: '₹140–₹280/kg', image: '/images/kaimganj_9.jpg' },
    { name: 'Kulhad Sattu Sherbet & Spiced Chaas', description: 'Wholesome roasted gram flour cooler with mint, rock salt, and roasted cumin, served in traditional earthen kulhads.', category: 'Beverage', price: '₹20–₹35', image: '/images/kaimganj_10.jpg' }
  ],
  attractions: [
    { id: 'kaimganj-old-bazaar', name: 'Kaimganj Historic Bazaar & Old Lanes', category: 'Heritage', description: 'Explore three-century-old market corridors showcasing vernacular facades, weathered brick masonry, vintage wooden shutters, and authentic small-town trading life.', duration: '2–3 hrs', distance: 'Town Center', score: 9.5, image: '/images/kaimganj_1.jpg' },
    { id: 'nawab-rasheed-makbara', name: 'Tomb of Nawab Rasheed Khan (Mau Rashidabad)', category: 'Heritage', description: 'Historic 18th-century Bangash Nawabi funerary complex featuring weathered domes, arched gateways, and serene heritage environs.', duration: '1.5 hrs', distance: '3 km North', score: 9.3, image: '/images/kaimganj_4.jpg' },
    { id: 'jama-masjid-kaimganj', name: 'Jama Masjid & Qadeemi Mosques', category: 'Heritage', description: 'Prominent historic religious landmarks in the heart of the town, featuring traditional minarets, domed sanctuaries, and tranquil courtyards.', duration: '1 hr', distance: 'Old Town', score: 9.0, image: '/images/kaimganj_2.jpg' },
    { id: 'shivalaya-devi-temples', name: 'Historic Shivalaya & Badi Devi Temple', category: 'Culture', description: 'Centuries-old Hindu shrines anchoring the town’s spiritual landscape, showcasing traditional Nagara-influenced spires and community gathering courtyards.', duration: '1 hr', distance: 'Temple Lane', score: 8.9, image: '/images/kaimganj_3.jpg' },
    { id: 'ancient-kampil-excursion', name: 'Ancient Kampil (Kampilya) Archaeological Site', category: 'Hidden Gems', description: 'Legendary capital of Southern Panchala Kingdom from the Mahabharata era, featuring ancient mounds, Kapil Muni Ashram, and historic Jain temples.', duration: '3 hrs', distance: '10 km West', score: 9.6, image: '/images/kaimganj_5.jpg' },
    { id: 'farrukhabad-heritage-hub', name: 'Farrukhabad District Cultural Centre', category: 'Culture', description: 'District headquarters famed for world-renowned wooden block-printing textile crafts, Nawabi havelis, and Fatehgarh Ganga ghats.', duration: '2–3 hrs', distance: '40 km East', score: 9.1, image: '/images/kaimganj_7.jpg' }
  ],
  hiddenGems: [
    { name: 'Dr. Zakir Hussain Ancestral Memorial & Library', why: 'Historic ancestral connections to India’s 3rd President Dr. Zakir Hussain, featuring preserved documents, educational heritage, and quiet reading spaces.', distance: 'Old Town', duration: '1 hr', image: '/images/kaimganj_2.jpg' },
    { name: 'Dargah of Hazrat Shah Fazl Ahmad Khan', why: 'Revered historic Sufi shrine known for tranquil garden courtyards, delicate stucco patterns, and peaceful spiritual ambiance.', distance: 'Outer Kaimganj', duration: '1 hr', image: '/images/kaimganj_1.jpg' },
    { name: 'Vernacular Wooden Havelis of Grain Lane', why: 'Hidden residential gallis featuring 100-year-old carved teakwood lintels, ornamental jharokhas, and hand-forged brass fittings.', distance: 'Old Bazaar Core', duration: '1.5 hrs', image: '/images/kaimganj_3.jpg' }
  ],
  thingsToDo: [
    { activity: 'Old Town Vernacular Architecture Walk', duration: '2.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '07:30 AM – 10:30 AM', image: '/images/kaimganj_1.jpg' },
    { activity: 'Nawabi Tomb & Mau Rashidabad Heritage Tour', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '04:00 PM (Golden Hour)', image: '/images/kaimganj_4.jpg' },
    { activity: 'Excursion to Ancient Kampil & Jain Temples', duration: '3 hrs', cost: '₹200–₹400 (Transport)', difficulty: 'Easy', bestTime: 'Morning / Afternoon', image: '/images/kaimganj_5.jpg' },
    { activity: 'Farrukhabad Block Print Craft & Dalmoth Shopping', duration: '2 hrs', cost: 'Variable', difficulty: 'Easy', bestTime: '11:00 AM – 03:00 PM', image: '/images/kaimganj_7.jpg' },
    { activity: 'Street Food Trail: Khasta Kachori & Desi Ghee Imarti', duration: '1.5 hrs', cost: '₹100–₹250', difficulty: 'Easy', bestTime: '08:00 AM / 06:00 PM', image: '/images/kaimganj_6.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Ancient Kampil (Kampilya)', distance: '10 km', type: 'Mahabharata & Jain Heritage', travelTime: '20 min', image: '/images/kaimganj_5.jpg' },
    { name: 'Farrukhabad City Centre', distance: '40 km', type: 'District HQ & Craft Hub', travelTime: '50 min', image: '/images/kaimganj_7.jpg' },
    { name: 'Sankisa Buddhist Pilgrimage', distance: '48 km', type: 'Ashokan Stupa Site', travelTime: '1 hr', image: '/images/kaimganj_8.jpg' },
    { name: 'Agra Heritage Capital', distance: '140 km', type: 'Major Airport & Taj Mahal', travelTime: '3 hrs', image: '/images/kaimganj_10.jpg' }
  ],
  travel: {
    air: { airport: 'Agra Airport (AGR) / Kanpur Airport (KNU)', distance: '140 km / 165 km', time: 'Approx 3–3.5 hours drive via well-connected state highway corridors' },
    rail: { station: 'Kaimganj Railway Station (KMJ) / Farrukhabad (FBD)', distance: '1.5 km / 40 km', time: 'Direct passenger & express trains connecting to Kasganj, Mathura, and Kanpur' },
    road: { highway: 'State Highway 29 / NH-730C Corridor', distance: 'Paved district highways', time: 'Smooth road connectivity from Farrukhabad (40 km), Aligarh (110 km), and Delhi (240 km)' }
  },
  stay: {
    categories: [
      { type: 'Farrukhabad Executive Hotels', range: '₹1,500–₹3,200/night', options: ['Hotel Rajputana Farrukhabad', 'Hotel Mohan Palace', 'Station Road Commercial Stays'] },
      { type: 'Fatehgarh Riverside Stays', range: '₹1,800–₹3,500/night', options: ['Ganga View Tourist Lodges', 'Cantonment Heritage Guesthouses'] },
      { type: 'Kaimganj Local Guesthouses', range: '₹600–₹1,200/night', options: ['Town Central Yatri Niwas', 'Station Road Transit Lodges'] },
      { type: 'Agra / Kanpur Base', range: '₹3,500–₹7,000/night', options: ['Regional heritage base with private taxi day-trip to Kaimganj & Kampil'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Day Explorer', perDay: '₹600–₹1,200', breakdown: [{ category: 'Local Transport', amount: '₹200–₹350' }, { category: 'Food & Sweets', amount: '₹200–₹350' }, { category: 'Kampil E-Rickshaw', amount: '₹150–₹300' }, { category: 'Dalmoth Souvenir', amount: '₹150–₹300' }] },
      { tier: 'Heritage & Photography Trip', perDay: '₹2,500–₹4,500', breakdown: [{ category: 'Farrukhabad Hotel', amount: '₹1,500–₹2,500' }, { category: 'Meals & Dining', amount: '₹500–₹800' }, { category: 'Cab to Kaimganj', amount: '₹800–₹1,400' }, { category: 'Local Guide/Tips', amount: '₹300–₹500' }] },
      { tier: 'Complete Regional Circuit', perDay: '₹5,000+', breakdown: [{ category: 'Premium Hotel Stay', amount: '₹2,800–₹4,500' }, { category: 'Full Day Chauffeur Cab', amount: '₹2,000–₹2,800' }, { category: 'Craft & Textile Shopping', amount: '₹1,500+' }, { category: 'Specialty Dining', amount: '₹800+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '08:00 AM', place: 'Arrival in Kaimganj & breakfast of Khasta Kachori with Jalebi', duration: '45 min', distance: 'Old Bazaar' }, { time: '09:00 AM', place: 'Guided vernacular architecture walk: Weathered brick havelis & Jama Masjid', duration: '2.5 hrs', distance: 'Town Core' }, { time: '11:45 AM', place: 'Visit historic Tomb of Nawab Rasheed Khan in Mau Rashidabad', duration: '1.5 hrs', distance: '3 km' }, { time: '01:30 PM', place: 'Traditional North Indian lunch at town dhaba', duration: '1 hr', distance: 'Main Road' }, { time: '02:45 PM', place: 'Afternoon excursion to Ancient Kampil: Kapil Muni Ashram & Jain Temples', duration: '3 hrs', distance: '10 km' }, { time: '06:00 PM', place: 'Evening Imarti & Rabri tasting before departure towards Farrukhabad/Agra', duration: '45 min', distance: 'Highway' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Check-in to Farrukhabad accommodation & drive to Kaimganj', duration: '1 hr', distance: '40 km' }, { time: '10:15 AM', place: 'Deep photographic exploration of Kaimganj old-town facades & wooden door carvings', duration: '3 hrs', distance: 'Old Town' }, { time: '01:30 PM', place: 'Local lunch & interaction with generational shopkeepers regarding town history', duration: '1.5 hrs', distance: 'Bazaar' }, { time: '03:30 PM', place: 'Visit Dargah Shah Fazl Ahmad Khan & Dr. Zakir Hussain Memorial', duration: '2 hrs', distance: 'Outer Lanes' }, { time: '06:00 PM', place: 'Sunset photography at Mau Rashidabad Nawab Tomb & return to Farrukhabad', duration: '2 hrs', distance: 'Farrukhabad' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Morning drive to ancient Kampil (Kampilya) archaeological mounds', duration: '45 min', distance: 'Kampil' }, { time: '09:00 AM', place: 'Explore Mahabharata heritage, ancient step structures & Jain temples', duration: '3 hrs', distance: 'Kampil Core' }, { time: '12:30 PM', place: 'Drive to Farrukhabad city: Traditional textile wooden block printing workshops', duration: '2.5 hrs', distance: 'Farrukhabad' }, { time: '03:30 PM', place: 'Fatehgarh Ganga ghats sunset walk and spicy Dalmoth shopping', duration: '2.5 hrs', distance: 'Fatehgarh' }, { time: '06:30 PM', place: 'Departure to Kanpur or Agra via highway network', duration: '2 hrs', distance: 'Expressway' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Arrival in Farrukhabad, check-in & orientation of Bangash dynasty heritage', duration: '2 hrs', distance: 'Farrukhabad' }, { time: '11:30 AM', place: 'Kaimganj historic townscape: Street architecture, brick havelis & ancient gates', duration: '3 hrs', distance: 'Kaimganj' }, { time: '04:00 PM', place: 'Mau Rashidabad tomb complex & sunset across rural mustard fields', duration: '2.5 hrs', distance: 'Rural Outskirts' }] },
      { day: 2, schedule: [{ time: '08:30 AM', place: 'Full day archaeological excursion to ancient Kampilya (Kampil) & riverine sites', duration: '5 hrs', distance: 'Kampil' }, { time: '02:30 PM', place: 'Excursion to Sankisa (Sankassa) Buddhist stupa & Elephant Capital monument', duration: '3 hrs', distance: 'Sankisa' }, { time: '06:00 PM', place: 'Return to Farrukhabad for evening Ganga Aarti at Ghatia Ghat', duration: '2 hrs', distance: 'Fatehgarh' }] },
      { day: 3, schedule: [{ time: '09:00 AM', place: 'Farrukhabad block-print textile master artisan workshops & ODOP centers', duration: '3 hrs', distance: 'Farrukhabad' }, { time: '01:00 PM', place: 'Traditional Farrukhabadi lunch, Dalmoth packaging & souvenir collection', duration: '2 hrs', distance: 'City Market' }, { time: '03:30 PM', place: 'Departure to Agra Airport or Kanpur Junction', duration: '2.5 hrs', distance: 'Highway' }] }
    ]
  },
  experiences: [
    { title: 'Vernacular Architecture Walking Tour', duration: '2.5 hrs', price: 'Free / Tip', category: 'Heritage Walk', image: '/images/kaimganj_1.jpg' },
    { title: 'Nawabi Tomb & Mau Rashidabad Tour', duration: '1.5 hrs', price: 'Free', category: 'Nawabi History', image: '/images/kaimganj_4.jpg' },
    { title: 'Ancient Kampil Archaeological Excursion', duration: '3.5 hrs', price: '₹300 Cab/Auto', category: 'Archaeology', image: '/images/kaimganj_5.jpg' },
    { title: 'Farrukhabad Block Print & Food Trail', duration: '2.5 hrs', price: 'Free', category: 'Craft & Food', image: '/images/kaimganj_7.jpg' }
  ],
  aiPrompts: [
    "What is the history behind the 1713 founding of Kaimganj by Nawab Muhammad Khan Bangash?",
    "What architectural styles and features are visible in Kaimganj's old bazaar havelis?",
    "How do I plan a day trip from Farrukhabad to Kaimganj and ancient Kampil?",
    "What are the best street food specialties and souvenirs in Kaimganj and Farrukhabad?",
    "What is the historical significance of the Tomb of Nawab Rasheed Khan?",
    "Kaimganj me purani haveliyan aur Kampil ghumne ka sabse accha itinerary kya hai?"
  ],
  reviews: [
    { name: 'Dr. Alok Srivastava', location: 'Lucknow (Architectural Historian)', text: 'Kaimganj is an extraordinary surviving example of an 18th-century North Indian market town. The weathered brick facades, delicate lime cornices, and carved wooden shop shutters are an absolute paradise for vernacular architecture enthusiasts.', rating: 5, image: '/images/kaimganj_1.jpg', date: 'August 2026' },
    { name: 'Sameer Farooqui', location: 'Kanpur', text: 'Visiting Mau Rashidabad and seeing the Tomb of Nawab Rasheed Khan was deeply memorable. The town has such a peaceful, unhurried old-world charm. Don’t miss the Imarti and Rabri near the main chowk!', rating: 5, image: '/images/kaimganj_4.jpg', date: 'July 2026' },
    { name: 'Elena Rostova', location: 'Saint Petersburg (Travel Documentarian)', text: 'Zero tourist commercialization, pure authentic Indian townscape. The walk from the old bazaar to the nearby ancient mounds of Kampil felt like stepping straight into history.', rating: 5, image: '/images/kaimganj_5.jpg', date: 'May 2026' }
  ],
  sources: {
    official: ['District Farrukhabad Official Portal (farrukhabad.nic.in)', 'National Mission on Monuments and Antiquities (NMMA Database)', 'Imperial Gazetteer of India — Farrukhabad & Kaimganj Survey (1908)'],
    historical: ['Gazetteer of the Farrukhabad District (North-Western Provinces)', 'History of the Bangash Nawabs of Farrukhabad by William Irvine'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">1713 AD</p>
              <p className="text-xs text-white/60 mt-1">Bangash Nawabi Era</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Kaimganj Old Bazaar' }, { top: '42%', left: '38%', label: 'Tomb Nawab Rasheed' }, { top: '28%', left: '52%', label: 'Ancient Kampil' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('1713 founding') && `Nawab Muhammad Khan Bangash, the first Nawab of Farrukhabad, established Kaimganj in 1713 after returning from imperial Mughal service. He named the settlement after his eldest son, Qaim Khan, developing it into a thriving administrative and trading hub.`}
                  {selected?.includes('architectural styles') && `Kaimganj features traditional vernacular Doab architecture: slim Lakhori brick masonry, lime-mortar plaster with decorative floral relief, wooden bracketed chhajjas (eaves), and intricately carved teakwood doorways reflecting early 18th-century craftsmanship.`}
                  {selected?.includes('plan a day trip') && `Start with an early morning architecture walk through Kaimganj old bazaar and Jama Masjid, visit the Tomb of Nawab Rasheed Khan in Mau Rashidabad, savor Khasta Kachori and Imarti, and spend the afternoon exploring the ancient archaeological mounds of Kampil (10 km away).`}
                  {selected?.includes('food specialties') && `Must-try foods: Kaimganj Khasta Dal Kachori with spicy aloo, pure desi ghee Imarti with thick Rabri, and famous Farrukhabad Dalmoth. Pick up authentic hand-block printed fabrics from nearby Farrukhabad city.`}
                  {selected?.includes('Tomb of Nawab Rasheed Khan') && `Located in Mau Rashidabad near Kaimganj, this 18th-century tomb complex commemorates Nawab Rasheed Khan of the Bangash ruling family, showcasing classical domed Islamic masonry and historic arched gateways.`}
                  {selected?.includes('purani haveliyan') && `कायमगंज के पुराने बाज़ार में सुबह 8 से 11 बजे पैदल घूमना सबसे अच्छा है जब धूप हल्की होती है और पुरानी हवेलियों के नक्काशीदार लकड़ी के दरवाज़े व लखौरी ईंटों की बनावट स्पष्ट दिखती है। दोपहर में 10 किमी दूर प्राचीन कांपिल तीर्थ भी जरूर जाएं।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Street Walking & Traffic Etiquette', content: 'The historic bazaar and central lanes are active trading corridors with cycle rickshaws, e-rickshaws, and motorcycles. Wear comfortable walking footwear suited for uneven brick surfaces and narrow gallis.' },
    { title: 'Private Property & Photography Rules', content: 'Many vintage havelis and ornate facades are privately owned residences. Always request permission before entering inner courtyards, photographing residents, or entering religious sanctums.' },
    { title: 'Building Safety & Preservation', content: 'Some weathered 18th and 19th-century brick structures have fragile plaster or aged cornices. Keep a respectful, safe distance from unmaintained masonry and avoid climbing old parapets or roofs.' },
    { title: 'Local Transport & Connectivity', content: 'E-rickshaws and auto-rickshaws are readily available for travel between Kaimganj station, the old bazaar, Mau Rashidabad, and nearby Kampil. Agree on fares before starting the ride.' },
    { title: 'Emergency Contacts', content: 'Farrukhabad District Police Control: 112 / 05692-234222 · Kaimganj Police Station: 05690-232100 · Community Health Centre (CHC) Kaimganj: 05690-232233 · UP Tourism Helpline: 1800-180-5013.' },
    { title: 'Best Visit Timing & Cash', content: 'The winter season (October to March) provides cool pleasant weather for outdoor architectural walking tours. Digital payments work in main bazaar shops, but carrying physical cash is strongly advised for rural transit and small food stalls.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={kaimganj} />
      <QuickFacts facts={kaimganj.quickFacts} />
      <WhyVisit destination={kaimganj} />
      <DestinationStory destination={kaimganj} />
      <HistoryTimeline destination={kaimganj} />
      <CultureGrid destination={kaimganj} />
      <FoodSection destination={kaimganj} />
      <AttractionsGrid destination={kaimganj} />
      <HiddenGems destination={kaimganj} />
      <ThingsToDo destination={kaimganj} />
      <NearbyPlaces destination={kaimganj} />
      <HowToReach destination={kaimganj} />
      <WhereToStay destination={kaimganj} />
      <BestTime destination={kaimganj} />
      <BudgetGuide destination={kaimganj} />
      <Itineraries destination={kaimganj} />
      <LocalExperiences destination={kaimganj} />
      <MapSection destination={kaimganj} />
      <AskD360 destination={kaimganj} />
      <CommunityStories destination={kaimganj} />
      <PracticalInfo />
      <SourcesTrust destination={kaimganj} />
      <Footer />
    </div>
  )
}
