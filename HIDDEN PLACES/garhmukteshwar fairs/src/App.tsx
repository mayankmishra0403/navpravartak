...
// ─── Garhmukteshwar Fairs Data ───────────────────────────────────────────────

const garhmukteshwar: Destination = {
  id: 'garhmukteshwar-fairs',
  slug: 'garhmukteshwar-fairs-hapur',
  name: 'Garhmukteshwar Fairs',
  localName: 'गढ़मुक्तेश्वर गंगा मेला एवं तीर्थ (हापुड़)',
  destinationType: 'Historic Ganga Riverfront Pilgrimage & Fair',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Hapur',
  shortDescription: "Ancient Ganga pilgrimage hub and site of the monumental Garh Ganga Kartik Purnima Mela, where sacred ghats, evening aartis, and deep spiritual traditions unite millions along the holy river.",
  tags: ['HISTORIC RIVER SITE', 'GARH GANGA MELA', 'BRIJGHAT AARTI'],
  hero: {
    image: '/images/garh_1.jpg',
    poster: '/images/garh_2.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹',
    destinationType: 'Sacred Riverfront & Cultural Mela',
    difficulty: 'Easy (Riverfront & Ghats)',
    distance: '~35 km from Hapur / ~95 km from Delhi'
  },
  discoveryScore: {
    overall: 9.3,
    categories: [
      { name: 'Heritage & Cultural Value', score: 9.8 },
      { name: 'Festival & Ritual Energy', score: 9.7 },
      { name: 'Visual & Dawn Aesthetics', score: 9.4 },
      { name: 'Accessibility & Roads', score: 9.2 },
      { name: 'Riverfront Tranquility', score: 8.5 }
    ]
  },
  editorial: {
    why: "Garhmukteshwar and its twin riverfront at Brijghat form the premier sacred Ganga pilgrimage gateway in Western Uttar Pradesh. Revered since antiquity as Shivvallambibpur, the town hosts the historic Garh Ganga Kartik Purnima Mela—a centuries-old gathering that transforms the broad river sands into a vibrant tent city of faith, floating diyas, sacred baths, and devotional celebration.",
    story: "Deeply intertwined with the legends of Lord Shiva granting liberation (mukti) to his divine attendants and mentioned in ancient regional traditions, Garhmukteshwar has served as a focal point of Ganga devotion for over two millennia. Its white-domed Ganga Mandir, historic stepwells, and sacred ghats continue to draw pilgrims seeking spiritual purification and ancestral rites.",
    storyFull: "At dawn, the sacred riverbank awakens under soft amber light as wooden boats glide past stone steps, temple bells chime in unison, and thousands of devotees offer prayers to Mother Ganga. Five kilometers downstream at Brijghat, the evening unfolds into a breathtaking spectacle of synchronized Ganga Aarti, where colossal brass lamps illuminate the flowing waters amidst Vedic chants. Outside the high-energy festival days of Kartik Purnima, the town offers a tranquil, contemplative riverside escape steeped in timeless North Indian heritage."
  },
  history: {
    shortIntro: 'From ancient Shivvallambibpur to the renowned Garh Ganga Mahotsav fairgrounds.',
    timeline: [
      { year: 'Ancient Era', event: 'Documented in ancient regional records as Shivvallambibpur, an early Vedic pilgrimage seat on the banks of the sacred Ganga.', era: 'Vedic Foundations' },
      { year: 'Medieval Period', event: 'Construction of the landmark Mukteshwar Mahadev Temple and the historic Ganga Mandir with stone bathing stairs to the river.', era: 'Temple Era' },
      { year: '18th–19th C.', event: 'Garh Ganga Mela evolves into one of North India’s largest annual rural trade and religious fairs, drawing pilgrims across Awadh, Delhi, and Haryana.', era: 'Mela Tradition' },
      { year: '1970s–80s', event: 'Development of modern bridge infrastructure connecting NH-24 (NH-9) across the Ganga, creating the thriving riverfront hub at Brijghat.', era: 'Connectivity Boom' },
      { year: 'Present', event: 'Officially organized by UP Tourism as Garhmukteshwar Mahotsav during Kartik Purnima, featuring modernized ghats, evening aarti, and eco-riverfront management.', era: 'State Mahotsav' }
    ]
  },
  culture: [
    { title: 'Garh Ganga Kartik Purnima Mela', description: 'Massive annual gathering where lakhs of devotees camp along the riverbank in traditional tent settlements, taking holy dips at auspicious lunar dawn.', image: '/images/garh_3.jpg' },
    { title: 'Brijghat Grand Ganga Aarti', description: 'Daily twilight devotional ceremony at Brijghat ghats where priests wield multi-tiered brass oil lamps accompanied by conch shells and Vedic hymns.', image: '/images/garh_4.jpg' },
    { title: 'Deep Daan & Floating Diyas', description: 'Devotional ritual where pilgrims release illuminated clay lamps nestled in marigold flower leaf-boats onto the gentle currents of the sacred Ganga.', image: '/images/garh_5.jpg' },
    { title: 'Ancient Shiva & Ganga Lore', description: 'Local traditions celebrate Lord Shiva’s blessing of mukti and the eternal presence of Goddess Ganga, reflected in sacred rituals and temple festivals.', image: '/images/garh_6.jpg' }
  ],
  food: [
    { name: 'Garh Mela Garma-Garam Jalebi & Rabri', description: 'Crispy golden saffron jalebis fried in pure desi ghee, served topped with thick, velvety layered malai rabri.', category: 'Specialty Sweet', price: '₹50–₹90/plate', image: '/images/garh_7.jpg' },
    { name: 'Brijghat Bedmi Poori & Aloo Sabzi', description: 'Flaky urad dal-stuffed whole wheat pooris paired with spicy, tangy hing-infused potato curry and methi chutney.', category: 'Breakfast', price: '₹40–₹70/plate', image: '/images/garh_8.jpg' },
    { name: 'Hapur Special Urad Dal Papad & Mathri', description: 'Famous GI-standard crisp savory lentil papads and spiced flaky mathris, a renowned specialty of Hapur district.', category: 'Snack/Souvenir', price: '₹120–₹250/kg', image: '/images/garh_9.jpg' },
    { name: 'Kadhai Doodh with Saffron & Pista', description: 'Slow-simmered whole milk reduced in massive iron cauldrons, infused with saffron, cardamom, and crunchy slivered nuts.', category: 'Beverage', price: '₹40–₹60', image: '/images/garh_10.jpg' },
    { name: 'Ganga Ghat Matar Chaat & Tikki', description: 'Pan-roasted spiced potato patties topped with zesty dried white pea gravy, grated radish, and sweet-sour tamarind saunth.', category: 'Street Food', price: '₹30–₹50', image: '/images/garh_11.jpg' }
  ],
  attractions: [
    { id: 'garhmukteshwar-ghats', name: 'Garhmukteshwar Ancient Ganga Ghats', category: 'Heritage', description: 'Historic riverfront bathing stairs and pilgrimage ghats where sacred rituals, morning snan, and holy ceremonies have taken place for generations.', duration: '2–3 hrs', distance: 'Town Riverfront', score: 9.7, image: '/images/garh_1.jpg' },
    { id: 'brijghat-riverfront', name: 'Brijghat Ganga Ghats & Aarti Promenade', category: 'Culture', description: 'Bustling riverside promenade famed for the mesmerizing daily evening Ganga Aarti, temple boats, and vibrant pilgrimage bazaars.', duration: '2–3 hrs', distance: '5 km east on NH-9', score: 9.6, image: '/images/garh_2.jpg' },
    { id: 'ganga-mandir', name: 'Ancient Ganga Mandir', category: 'Heritage', description: 'Historic white temple perched on an elevated mound overlooking the river, housing sacred stone shrines and classical Hindu architecture.', duration: '1 hr', distance: 'Old Town', score: 9.3, image: '/images/garh_3.jpg' },
    { id: 'nakka-kuan', name: 'Nakka Kuan (Ancient Sacred Well)', category: 'Heritage', description: 'An ancient historical brick-and-stone stepwell complex deeply associated with local folklore, ritual cleansing, and archaeological interest.', duration: '45 min', distance: '1.2 km from main ghat', score: 9.1, image: '/images/garh_4.jpg' },
    { id: 'meera-bai-ki-reti', name: 'Meera Bai Ki Reti', category: 'Hidden Gems', description: 'Serene riverbank sand expanse traditionally linked with the saint-poetess Meera Bai’s spiritual visits and devotional retreats.', duration: '1.5 hrs', distance: '2 km on riverfront', score: 9.0, image: '/images/garh_5.jpg' },
    { id: 'historic-jama-masjid', name: 'Historic Jama Masjid', category: 'Heritage', description: 'Medieval-era town landmark with classic domed architecture reflecting the diverse historical and cultural heritage of Garhmukteshwar.', duration: '45 min', distance: 'Town Center', score: 8.9, image: '/images/garh_6.jpg' }
  ],
  hiddenGems: [
    { name: 'Kalyanpur Riverine Wetland & Sandspit', why: 'Secluded tranquil sandbars along the Ganga upstream where migratory waterbirds, river terns, and freshwater turtles congregate at sunrise.', distance: '3 km North', duration: '1.5 hrs', image: '/images/garh_7.jpg' },
    { name: 'Brijghat Early Morning Boat Drift', why: 'Tranquil dawn boat excursions across calm river waters offering unhindered photographic perspectives of bathing ghats shrouded in morning mist.', distance: 'Brijghat Pier', duration: '1 hr', image: '/images/garh_8.jpg' },
    { name: 'Ancient Lodi-Era Brick Ruins & Baoli', why: 'Weathered medieval brick gateways and step structures tucked away on the town fringes, largely untouched by commercial tourist routes.', distance: 'Old Garh Outskirts', duration: '1 hr', image: '/images/garh_9.jpg' }
  ],
  thingsToDo: [
    { activity: 'Sacred Ganga Snan & Ritual Bathing', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '06:00 AM (Sunrise)', image: '/images/garh_1.jpg' },
    { activity: 'Brijghat Grand Evening Ganga Aarti', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: '06:30 PM (Twilight)', image: '/images/garh_2.jpg' },
    { activity: 'Traditional River Boat Safari', duration: '1 hr', cost: '₹150–₹300/person', difficulty: 'Easy', bestTime: '07:00 AM / 05:00 PM', image: '/images/garh_8.jpg' },
    { activity: 'Heritage Walk through Old Temples & Nakka Kuan', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '09:00 AM – 11:30 AM', image: '/images/garh_3.jpg' },
    { activity: 'Garh Mela Bazaar & Hapur Papad Shopping', duration: '1.5 hrs', cost: 'Variable', difficulty: 'Easy', bestTime: '04:00 PM – 07:00 PM', image: '/images/garh_9.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Brijghat Pilgrimage Center', distance: '5 km', type: 'Sacred Riverfront', travelTime: '10 min', image: '/images/garh_2.jpg' },
    { name: 'Hapur City & Grain Hub', distance: '35 km', type: 'District HQ & Markets', travelTime: '40 min', image: '/images/garh_9.jpg' },
    { name: 'Meerut Historic City', distance: '45 km', type: 'Heritage & Rail Hub', travelTime: '55 min', image: '/images/garh_4.jpg' },
    { name: 'Delhi NCR (Anand Vihar)', distance: '90 km', type: 'National Capital Gateway', travelTime: '1.5–2 hrs', image: '/images/garh_6.jpg' }
  ],
  travel: {
    air: { airport: 'Indira Gandhi International Airport (DEL), New Delhi', distance: '110 km', time: 'Approx 2–2.5 hours via Delhi-Meerut Expressway / NH-9' },
    rail: { station: 'Garhmukteshwar (GMS) / Brijghat (BBR)', distance: '2 km / Local', time: 'Direct passenger and express trains on Delhi-Moradabad-Lucknow main line' },
    road: { highway: 'National Highway 9 (Old NH-24 Delhi - Lucknow Corridor)', distance: 'Smooth 6-lane highway', time: 'Fast 1.5 to 2-hour drive from Delhi NCR; regular UPSRTC luxury buses' }
  },
  stay: {
    categories: [
      { type: 'Riverside Dharamshalas & Ashrams', range: '₹500–₹1,500/night', options: ['Brijghat Pilgrim Guest Houses', 'Ganga Seva Trust Ashrams', 'Ghat View Yatri Niwas'] },
      { type: 'Highway Hotels & Resorts', range: '₹1,800–₹3,500/night', options: ['Brij Hotel & Resort NH-9', 'Grand Ganga Tourist Motel', 'Highway Inn Garhmukteshwar'] },
      { type: 'Hapur City Hotels', range: '₹1,500–₹3,000/night', options: ['Hotel Ganga Sagar Hapur', 'The City Club Hapur', 'Station Road Commercial Stays'] },
      { type: 'Delhi / Noida Luxury Base', range: '₹4,000–₹8,000/night', options: ['Day-trip base in East Delhi / Noida with private taxi excursion to Garhmukteshwar'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Pilgrim & Day Visitor', perDay: '₹600–₹1,200', breakdown: [{ category: 'Local Transport', amount: '₹200–₹300' }, { category: 'Food & Sweets', amount: '₹200–₹400' }, { category: 'Puja & Offerings', amount: '₹100–₹200' }, { category: 'Boat Ride', amount: '₹100–₹200' }] },
      { tier: 'Family Cultural Trip', perDay: '₹2,500–₹4,500', breakdown: [{ category: 'Overnight Stay', amount: '₹1,500–₹2,500' }, { category: 'Meals & Sweets', amount: '₹500–₹900' }, { category: 'Private Boat', amount: '₹300–₹500' }, { category: 'Shopping & Mela', amount: '₹500–₹1,000' }] },
      { tier: 'Festival Mela Experience', perDay: '₹5,000+', breakdown: [{ category: 'Resort/AC Stay', amount: '₹2,800–₹4,500' }, { category: 'Private Cab Hire', amount: '₹1,800–₹2,500' }, { category: 'Guided Aarti & Boat', amount: '₹600–₹1,000' }, { category: 'Hapur Specialties', amount: '₹1,000+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '06:00 AM', place: 'Arrival at Garhmukteshwar Main Ghat for holy Ganga sunrise bath', duration: '2 hrs', distance: 'Main Ghat' }, { time: '08:30 AM', place: 'Breakfast of hot Bedmi Poori and Jalebi at town bazaar', duration: '45 min', distance: 'Old Bazaar' }, { time: '09:30 AM', place: 'Visit Ancient Ganga Mandir, Nakka Kuan, and Meera Bai Ki Reti', duration: '2.5 hrs', distance: 'Old Town' }, { time: '12:30 PM', place: 'Lunch & rest at riverfront restaurant or highway dhaba', duration: '1.5 hrs', distance: 'NH-9' }, { time: '03:00 PM', place: 'Drive to Brijghat & enjoy peaceful afternoon boat ride on Ganga', duration: '2 hrs', distance: '5 km' }, { time: '06:00 PM', place: 'Witness magnificent Grand Evening Ganga Aarti at Brijghat', duration: '1.5 hrs', distance: 'Brijghat' }, { time: '07:45 PM', place: 'Shopping for Hapur Papad & sweets before return drive', duration: '45 min', distance: 'Highway' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Arrival, check-in to accommodation & orientation walk along ghats', duration: '1.5 hrs', distance: 'Garhmukteshwar' }, { time: '11:00 AM', place: 'Exploration of ancient heritage temples: Mukteshwar Mahadev & Ganga Mandir', duration: '2.5 hrs', distance: 'Heritage Zone' }, { time: '02:00 PM', place: 'Traditional North Indian lunch followed by bazaar craft walk', duration: '2 hrs', distance: 'Town Center' }, { time: '05:00 PM', place: 'Brijghat evening riverside walk & sunset photography', duration: '1.5 hrs', distance: 'Brijghat' }, { time: '06:30 PM', place: 'Grand Brijghat Ganga Aarti ceremony & deep daan floating lamp offering', duration: '1.5 hrs', distance: 'Ghats' }] },
      { day: 2, schedule: [{ time: '06:00 AM', place: 'Sunrise holy dip & peaceful wooden boat excursion on morning waters', duration: '2.5 hrs', distance: 'Riverfront' }, { time: '09:00 AM', place: 'Breakfast of Kadhai Doodh, Jalebi & Khasta Kachori', duration: '1 hr', distance: 'Ghat Market' }, { time: '10:30 AM', place: 'Visit Nakka Kuan historical stepwell & Meera Bai Ki Reti riverbed', duration: '2 hrs', distance: '2 km' }, { time: '01:00 PM', place: 'Excursion to Hapur district hub: Famous grain markets & papad manufacturing', duration: '2.5 hrs', distance: '35 km' }, { time: '04:30 PM', place: 'Departure to Delhi NCR or Lucknow via NH-9 expressway corridor', duration: '1.5 hrs', distance: 'Highway' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Arrival in Garhmukteshwar, check-in & spiritual introduction to sacred river site', duration: '2 hrs', distance: 'Garhmukteshwar' }, { time: '11:30 AM', place: 'Temple trail: Ancient Ganga Mandir, Shiva shrines & Nakka Kuan well', duration: '3 hrs', distance: 'Old Town' }, { time: '04:30 PM', place: 'Meera Bai Ki Reti sunset walk & evening devotional chants along riverbank', duration: '2.5 hrs', distance: 'Riverfront' }] },
      { day: 2, schedule: [{ time: '06:00 AM', place: 'Full festival & pilgrimage immersion: Morning snan, mela stalls, folk activities', duration: '4 hrs', distance: 'Mela Grounds' }, { time: '11:30 AM', place: 'Explore rural fair economy: brass utensils, wooden handicrafts, religious souvenirs', duration: '2.5 hrs', distance: 'Fairgrounds' }, { time: '04:00 PM', place: 'Transfer to Brijghat for illuminated Ganga Aarti, conch ceremony & deep daan', duration: '3.5 hrs', distance: 'Brijghat' }] },
      { day: 3, schedule: [{ time: '07:00 AM', place: 'Sunrise photography cruise & riverine birdwatching on the Upper Ganga', duration: '2.5 hrs', distance: 'River' }, { time: '10:30 AM', place: 'Excursion to nearby historical sites in Hapur and Western UP rural belt', duration: '3 hrs', distance: 'Hapur' }, { time: '03:00 PM', place: 'Farewell lunch and departure towards Delhi NCR or onward destination', duration: '2 hrs', distance: 'Expressway' }] }
    ]
  },
  experiences: [
    { title: 'Brijghat Grand Evening Aarti', duration: '1.5 hrs', price: 'Free', category: 'Spiritual', image: '/images/garh_2.jpg' },
    { title: 'Dawn Ganga Wooden Boat Cruise', duration: '1 hr', price: '₹150–₹300', category: 'River Tour', image: '/images/garh_8.jpg' },
    { title: 'Garh Ganga Mela Fairground Trail', duration: '3 hrs', price: 'Free Entry', category: 'Cultural Fair', image: '/images/garh_3.jpg' },
    { title: 'Ancient Ganga Mandir Heritage Walk', duration: '1.5 hrs', price: 'Free', category: 'Heritage', image: '/images/garh_4.jpg' }
  ],
  aiPrompts: [
    "What is the significance of the Garh Ganga Kartik Purnima Mela?",
    "What are the timings for the Grand Ganga Aarti at Brijghat?",
    "How do I travel from Delhi to Garhmukteshwar and Brijghat by road or train?",
    "Can you suggest a 1-day family trip itinerary for Garhmukteshwar?",
    "What are the famous food and shopping specialties of Hapur and Garh?",
    "Garhmukteshwar me ganga snan aur aarti dekhne ka sahi samay aur tarika kya hai?"
  ],
  reviews: [
    { name: 'Pandit Rameshwar Sharma', location: 'New Delhi', text: 'Garhmukteshwar holds the pristine soul of the holy Ganga in Western UP. The morning sunrise bath and the evening aarti at Brijghat fill the heart with immense peace and devotion.', rating: 5, image: '/images/garh_1.jpg', date: 'September 2026' },
    { name: 'Dr. Sunita Aggarwal', location: 'Noida', text: 'A wonderful weekend getaway from Delhi NCR via NH-9. Just 1.5 hours away! We enjoyed the tranquil boat ride on the Ganga and delicious Jalebi-Rabri at Brijghat.', rating: 5, image: '/images/garh_2.jpg', date: 'August 2026' },
    { name: 'Amitabh Sen', location: 'Ghaziabad', text: 'The scale and cultural vibrancy of the Kartik Purnima Garh Ganga Mela is awe-inspiring. Thousands of floating diyas lighting up the river at night is a sight you will never forget.', rating: 5, image: '/images/garh_3.jpg', date: 'June 2026' }
  ],
  sources: {
    official: ['District Hapur Official Tourism Portal (hapur.nic.in)', 'Uttar Pradesh Tourism & NRI Department — Garh Ganga Mela', 'Invest UP Tourism Sector Booklet — Garhmukteshwar Mahotsav'],
    historical: ['Gazetteer of Meerut & Hapur District — Archaeological & Cultural Survey', 'Imperial Gazetteer of India — Garhmukteshwar Religious Traditions'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">Ancient Era</p>
              <p className="text-xs text-white/60 mt-1">Shivvallambibpur Heritage</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Garhmukteshwar Ghats' }, { top: '42%', left: '38%', label: 'Brijghat Aarti' }, { top: '28%', left: '52%', label: 'Ancient Ganga Mandir' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('Kartik Purnima Mela') && `The Garh Ganga Mela is one of North India’s most historic river festivals, held during the full moon of Kartik (October/November). Millions gather along the vast sandbanks to take auspicious dips at dawn, camp in tents, and offer thousands of floating diyas.`}
                  {selected?.includes('timings for the Grand Ganga Aarti') && `The daily Grand Ganga Aarti at Brijghat takes place every evening at twilight (approx 06:00 PM in winter, 06:45 PM in summer). Arrive 30 minutes early to secure a comfortable view from the steps or a stationary river boat.`}
                  {selected?.includes('travel from Delhi') && `From Delhi NCR, take the Delhi-Meerut Expressway connected to NH-9 (National Highway 9 / old NH-24). It is a smooth 90–95 km drive taking about 1.5 to 2 hours. Regular express trains also halt at Garhmukteshwar (GMS).`}
                  {selected?.includes('family trip itinerary') && `For a 1-day trip: Arrive early morning for holy snan at Garhmukteshwar ghats, visit ancient Ganga Mandir and Nakka Kuan, enjoy Bedmi Poori & Jalebi, take an afternoon boat cruise at Brijghat, and conclude with the grand evening Aarti.`}
                  {selected?.includes('food and shopping') && `Must-try: Garh Mela hot Jalebi with Rabri, Bedmi Poori-Aloo, and slow-boiled Kadhai Doodh. Don't leave without buying Hapur’s world-famous GI Urad Dal Papad and crispy mathris from the local bazaars.`}
                  {selected?.includes('snan aur aarti') && `गढ़मुक्तेश्वर में पवित्र गंगा स्नान के लिए सुबह 5:30 से 8:00 बजे का समय सबसे शांत और पवित्र होता है। शाम की भव्य गंगा आरती देखने के लिए 5:30 बजे तक ब्रजघाट पहुंचना सबसे उत्तम रहता है।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'River & Bathing Safety', content: 'Always bathe strictly within designated safe zones marked with chains and barricades. The Ganga currents can be deceptive; never venture beyond warning ropes or swim into deep mid-river channels. Follow instructions from river police and NDRF/SDRF rescue boats.' },
    { title: 'Festival Crowd Management', content: 'During the peak Kartik Purnima fair, lakhs of devotees congregate. Establish a fixed meeting point with family members, keep mobile emergency numbers handy, and follow one-way pedestrian routes set up by district administration.' },
    { title: 'Photography & Sacred Etiquette', content: 'Maintain reverence at temple sanctums, during the evening Ganga Aarti, and around dedicated bathing ghats. Always ask permission before photographing individual worshippers, sadhus, or private rituals.' },
    { title: 'Boating Guidelines', content: 'Board only authorized river boats equipped with life jackets from designated jetty points at Brijghat or Garh main ghat. Agree on boat fares and tour duration before embarking.' },
    { title: 'Emergency Contacts', content: 'Hapur District Police Control: 112 / 0122-2305000 · Garhmukteshwar Police Station: 0122-276122 · Community Health Centre (CHC) Garh: 0122-276233 · UP Tourism Helpline: 1800-180-5013.' },
    { title: 'Best Visit Timing & Weather', content: 'The winter season (October to March) brings pleasant cool breezes and crisp morning river mist. Late-autumn nights can be cold, so carry light woolens if attending the evening Ganga Aarti or overnight mela.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={garhmukteshwar} />
      <QuickFacts facts={garhmukteshwar.quickFacts} />
      <WhyVisit destination={garhmukteshwar} />
      <DestinationStory destination={garhmukteshwar} />
      <HistoryTimeline destination={garhmukteshwar} />
      <CultureGrid destination={garhmukteshwar} />
      <FoodSection destination={garhmukteshwar} />
      <AttractionsGrid destination={garhmukteshwar} />
      <HiddenGems destination={garhmukteshwar} />
      <ThingsToDo destination={garhmukteshwar} />
      <NearbyPlaces destination={garhmukteshwar} />
      <HowToReach destination={garhmukteshwar} />
      <WhereToStay destination={garhmukteshwar} />
      <BestTime destination={garhmukteshwar} />
      <BudgetGuide destination={garhmukteshwar} />
      <Itineraries destination={garhmukteshwar} />
      <LocalExperiences destination={garhmukteshwar} />
      <MapSection destination={garhmukteshwar} />
      <AskD360 destination={garhmukteshwar} />
      <CommunityStories destination={garhmukteshwar} />
      <PracticalInfo />
      <SourcesTrust destination={garhmukteshwar} />
      <Footer />
    </div>
  )
}
