...
// ─── Salkhan Fossil Park Data ───────────────────────────────────────

const salkhan: Destination = {
  id: 'salkhan-fossil-park-sonbhadra',
  slug: 'salkhan-fossil-park-sonbhadra',
  name: 'Salkhan Fossil Park',
  localName: 'सलखन जीवाश्म पार्क / सोनभद्र फॉसिल्स पार्क',
  destinationType: 'UNESCO Tentative List 1.4-Billion-Year-Old Geoheritage Site',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Sonbhadra',
  shortDescription: "UNESCO Tentative List Geoheritage Site—preserving 1.4-billion-year-old Mesoproterozoic algae and stromatolite fossil rings embedded in the ancient Vindhyan bedrock of the Kaimur Range.",
  tags: ['1.4 BILLION YEARS OLD', 'UNESCO TENTATIVE LIST', 'MESOPROTEROZOIC STROMATOLITES', 'KAIMUR RANGE'],
  hero: {
    image: '/images/salkhan_hero_fullhd.jpg',
    poster: '/images/stromatolite_rings.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: 'Half Day / 3–4 Hrs',
    budget: '₹ (Low Cost)',
    destinationType: 'UNESCO Tentative Geoheritage',
    difficulty: 'Easy Walking',
    distance: '~12 km from Robertsganj / SH-5A'
  },
  discoveryScore: {
    overall: 9.4,
    categories: [
      { name: 'Geoheritage & Deep Time (1.4 Bn Yrs)', score: 9.8 },
      { name: 'Stromatolite Specimen Preservation', score: 9.6 },
      { name: 'UNESCO Scientific Value', score: 9.5 },
      { name: 'Educational & Interpretive Potential', score: 9.2 },
      { name: 'Kaimur Landscape & Forest Setting', score: 8.9 }
    ]
  },
  editorial: {
    why: "Spanning 25 hectares near Salkhan village, this extraordinary geological monument preserves fossilized microbial reefs from 1.4 billion years ago—predating plant and animal life—making it one of Earth's most significant natural archives on the UNESCO World Heritage Tentative List.",
    story: "Inscribed on India's UNESCO Tentative List under Natural Criterion (viii), Salkhan Fossil Park showcases circular, ring-like stromatolites created by ancient photosynthetic cyanobacteria and algae during the Mesoproterozoic Era.",
    storyFull: "First scientifically noted by J.B. Auden in 1933 and comprehensively researched by Prof. S. Kumar and Mukund Sharma, these concentric rings embedded in Vindhyan limestone and dolomite provide tangible evidence of how early microbial life oxygenated Earth's primitive atmosphere and shaped our biosphere."
  },
  history: {
    shortIntro: "From 1.4-billion-year-old Precambrian cyanobacterial colonies to international geological symposiums and UNESCO recognition.",
    timeline: [
      { year: '~1.4 Billion Yrs Ago', event: 'Photosynthetic cyanobacteria and algal mats build layered calcium carbonate reefs in shallow Mesoproterozoic tidal seas of the Vindhyan basin.', era: 'Mesoproterozoic Era' },
      { year: '1933 AD', event: 'Geological Survey of India geologist J.B. Auden documents early records of fossil-bearing structures in the Sonbhadra region.', era: 'Geological Discovery' },
      { year: '1980–1981', event: 'Prof. S. Kumar of Lucknow University publishes definitive stratigraphic research establishing the global importance of Salkhan stromatolites.', era: 'Scientific Validation' },
      { year: 'August 8, 2002', event: 'Formal inauguration of the 25-hectare Salkhan Fossil Park by UP Forest Department, followed by an international geological workshop.', era: 'Park Inauguration' },
      { year: 'June 4, 2025', event: 'Formally inscribed on UNESCO World Heritage Tentative List under Natural Criterion (viii) for outstanding Earth history value.', era: 'UNESCO Inscription' }
    ]
  },
  culture: [
    { title: 'Deep Time & Earth Science Heritage', description: 'A global pilgrimage for geologists, researchers, and students to touch rock structures formed when single-celled life dominated Earth.', image: '/images/stromatolite_rings.jpg' },
    { title: 'Kaimur Forest & Tribal Coexistence', description: 'Nestled on the edge of Kaimur Wildlife Sanctuary, where local communities have coexisted alongside sacred stone outcrops for generations.', image: '/images/kaimur_forest_rocks.jpg' },
    { title: 'Scientific Conservation Ethic', description: 'Strict protection protocol: visitors observe without chipping, scratching, or applying chemicals to delicate billion-year-old fossil surfaces.', image: '/images/fossil_boulders.jpg' },
    { title: 'Sonbhadra Geoheritage Circuit', description: 'Forms the centerpiece of Eastern UP geo-tourism alongside Chopan River Cliffs, Vijaygarh Fort, and prehistoric rock art caves.', image: '/images/sandstone_cliff_strata.jpg' }
  ],
  food: [
    { name: 'Sonbhadra Baati Chokha with Pure Desi Ghee', description: 'Wood-fired wheat dough batis served with smoky roasted brinjal-tomato mash, spiced toor dal, and garlic chutney.', category: 'Signature Meal', price: '₹60–₹110/plate', image: '/images/litti_chokha.jpg' },
    { name: 'Robertsganj Khasta Sattu Paratha', description: 'Crispy pan-fried whole wheat flatbreads stuffed with spicy roasted gram flour, paired with tangy pickle and curd.', category: 'Breakfast', price: '₹35–₹60', image: '/images/kachori.jpg' },
    { name: 'Dehati Samosa & Matar Chaat', description: 'Crisp golden samosas crushed over warm spiced white peas curry, sweet tamarind chutney, and freshly grated ginger.', category: 'Snack', price: '₹25–₹45', image: '/images/samosa_chaat.jpg' },
    { name: 'Refreshing Spiced Sattu Sharbat', description: 'Chilled roasted gram drink flavored with roasted cumin, rock salt, mint, and fresh lemon—essential for sunny field walks.', category: 'Beverage', price: '₹20–₹35', image: '/images/sattu_drink.jpg' },
    { name: 'Traditional Til-Gur Laddu & Rice Kheer', description: 'Sweet treats crafted from roasted sesame seeds, country jaggery, and slow-simmered cardamom-scented rice kheer.', category: 'Dessert', price: '₹35–₹65', image: '/images/kheer.jpg' }
  ],
  attractions: [
    { id: 'salkhan-stromatolite-core', name: 'Salkhan Stromatolite Core Outcrops', category: 'Geoheritage', description: 'The main 25-hectare geological zone displaying concentric ring formations, conical columns, and laminated algal mats in situ.', duration: '2 hrs', distance: 'Park Center', score: 9.9, image: '/images/salkhan_hero_fullhd.jpg' },
    { id: 'concentric-fossil-rings', name: 'Concentric Ring & Algal Mat Beds', category: 'Paleontology', description: 'Weathered limestone slabs clearly exhibiting circular bio-sedimentary rings formed by Precambrian cyanobacteria colonies.', duration: '1.5 hrs', distance: 'Central Ridge', score: 9.7, image: '/images/stromatolite_rings.jpg' },
    { id: 'geological-interpretation-trail', name: 'Visitor Interpretation Boardwalk', category: 'Education', description: 'Elevated walkways and descriptive signage installed by the Forest Department explaining 1.4 billion years of Earth history.', duration: '1 hr', distance: 'Entrance Zone', score: 9.3, image: '/images/fossil_boulders.jpg' },
    { id: 'kaimur-wildlife-boundary', name: 'Kaimur Range Forest Perimeter', category: 'Nature / Eco', description: 'Forested hill backdrop adjacent to Kaimur Wildlife Sanctuary, sheltering dry deciduous flora, birds, and natural boulders.', duration: '1 hr', distance: 'Park Boundary', score: 9.1, image: '/images/kaimur_forest_rocks.jpg' },
    { id: 'sedimentary-strata-view', name: 'Mesoproterozoic Bedrock Strata', category: 'Stratigraphy', description: 'Exposed layers of the Semri Group in the Vindhyan Supergroup illustrating ancient tidal deposition and sedimentary structures.', duration: '45 min', distance: 'West Outcrop', score: 9.4, image: '/images/sandstone_cliff_strata.jpg' },
    { id: 'robertsganj-chopan-circuit', name: 'Robertsganj & Chopan Geo Circuit', category: 'Regional Circuit', description: 'Combine Salkhan with the nearby Son River cliffs, Gotthani sangam temple, and historic Vijaygarh hilltop fort.', duration: '3 hrs', distance: '12–18 km', score: 9.2, image: '/images/devdari_gorge.jpg' }
  ],
  hiddenGems: [
    { name: 'Micro-Stromatolitic Ridge Formations', why: 'Secluded rocky ledge showing tightly packed miniature stromatolite columns with razor-sharp concentric ring definition.', distance: 'North-West Corner', duration: '45 min', image: '/images/stromatolite_rings.jpg' },
    { name: 'Badagaon Secondary Fossil Outcrops', why: 'Secondary fossil-bearing stone exposures in nearby Badagaon village preserving similar Precambrian algal structures.', distance: '7 km from Salkhan', duration: '1 hr', image: '/images/fossil_boulders.jpg' },
    { name: 'Kaimur Sunset Rock Lookout', why: 'Elevated sandstone boulder on the sanctuary edge offering golden hour views across the forested Sonbhadra plateau.', distance: 'Park Ridge', duration: '30 min', image: '/images/salkhan_hero_fullhd.jpg' }
  ],
  thingsToDo: [
    { activity: 'Stromatolite Ring Macro Photography', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '08:00 AM – 11:00 AM (Raking Light)', image: '/images/stromatolite_rings.jpg' },
    { activity: 'Guided Earth History & Geology Walk', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning / Late Afternoon', image: '/images/salkhan_hero_fullhd.jpg' },
    { activity: 'Kaimur Eco-Trail & Forest Exploration', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: '07:30 AM – 09:30 AM', image: '/images/kaimur_forest_rocks.jpg' },
    { activity: 'Sonbhadra Baati Chokha Culinary Stop', duration: '1 hr', cost: '₹70–₹130', difficulty: 'Easy', bestTime: '12:30 PM – 02:00 PM', image: '/images/litti_chokha.jpg' },
    { activity: 'Combined Chopan & Son River Excursion', duration: '3 hrs', cost: '₹200–₹500', difficulty: 'Easy', bestTime: 'Afternoon / Golden Hour', image: '/images/sandstone_cliff_strata.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Robertsganj (Sonbhadra HQ)', distance: '12 km', type: 'District Headquarters', travelTime: '18 min', image: '/images/devdari_gorge.jpg' },
    { name: 'Chopan & Son River Cliffs', distance: '18 km', type: 'River Valley & Geology', travelTime: '25 min', image: '/images/sandstone_cliff_strata.jpg' },
    { name: 'Vijaygarh Historic Hill Fort', distance: '28 km', type: 'Medieval Hill Fortress', travelTime: '45 min', image: '/images/fossil_boulders.jpg' },
    { name: 'Gotthani Shiv Mandir (Gupta Kashi)', distance: '24 km', type: 'Sacred River Confluence', travelTime: '35 min', image: '/images/kaimur_forest_rocks.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri Airport Varanasi (VNS)', distance: 'Approx. 120 km', time: 'Approx. 3 hours drive via NH-39 and Robertsganj Highway' },
    rail: { station: 'Robertsganj Railway Station (RBGJ) / Chopan (CPU)', distance: '12 km from Robertsganj', time: 'Direct train connectivity to Varanasi, Singrauli, and major North Indian hubs' },
    road: { highway: 'State Highway SH-5A (Robertsganj-Chopan Highway)', distance: 'Directly off SH-5A near Salkhan village', time: 'Easily accessible by private taxi, auto-rickshaw, or state bus from Robertsganj (15–20 mins)' }
  },
  stay: {
    categories: [
      { type: 'Robertsganj City Hotels', range: '₹1,500–₹3,200/night', options: ['Hotel Grand Sonbhadra', 'Hotel Shivam', 'The Son Residency (12 km base)'] },
      { type: 'Budget Lodges & Guesthouses', range: '₹700–₹1,400/night', options: ['Robertsganj Station Road Lodges', 'SH-5A Highway Tourist Motels'] },
      { type: 'Forest / Ecotourism Bungalows', range: '₹800–₹1,500/night', options: ['UP Forest Rest House Robertsganj (Prior permission from DFO)'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Day Tripper', perDay: '₹400–₹750', breakdown: [{ category: 'Shared Auto / Bus from Robertsganj', amount: '₹100–₹200' }, { category: 'Park Entry & Guide Tip', amount: '₹50–₹100' }, { category: 'Baati Chokha & Snacks', amount: '₹150–₹250' }] },
      { tier: 'Comfort Day Out from Varanasi', perDay: '₹2,000–₹3,200', breakdown: [{ category: 'Private Taxi from Varanasi/Robertsganj', amount: '₹1,400–₹2,000' }, { category: 'Park Entry', amount: '₹50' }, { category: 'Restaurant Meals & Drinks', amount: '₹400–₹700' }] },
      { tier: 'Sonbhadra Geoheritage Weekend', perDay: '₹3,500+', breakdown: [{ category: 'Hotel Base in Robertsganj', amount: '₹1,800–₹2,800' }, { category: 'Full Day Chauffeur SUV', amount: '₹1,500–₹2,200' }, { category: 'Dining & Experiences', amount: '₹800+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '08:30 AM', place: 'Drive 12 km south from Robertsganj along SH-5A to Salkhan Fossil Park', duration: '20 min', distance: '12 km' }, { time: '09:00 AM', place: 'Explore central stromatolite rock beds and photograph 1.4-billion-year-old fossil rings', duration: '2 hrs', distance: 'Central Outcrop' }, { time: '11:00 AM', place: 'Walk the perimeter boardwalk and read geological history interpretation panels', duration: '1 hr', distance: 'Boardwalk' }, { time: '12:30 PM', place: 'Enjoy authentic Sonbhadra Baati Chokha and Sattu Sharbat in Robertsganj or Chopan', duration: '1.5 hrs', distance: 'Robertsganj' }, { time: '02:30 PM', place: 'Afternoon excursion to Chopan River Cliffs or Gotthani Sangam Mandir', duration: '2.5 hrs', distance: '18 km' }, { time: '05:30 PM', place: 'Sunset over the Son River before returning to Robertsganj base', duration: '1 hr', distance: 'Chopan' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Comprehensive exploration of Salkhan Fossil Park with macro photography of fossil rings', duration: '3.5 hrs', distance: 'Salkhan' }, { time: '01:30 PM', place: 'Lunch in Robertsganj followed by afternoon visit to historic Vijaygarh Fort', duration: '4 hrs', distance: 'Vijaygarh' }, { time: '06:00 PM', place: 'Return to hotel in Robertsganj for dinner', duration: '1.5 hrs', distance: 'Robertsganj' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Morning excursion to Chopan Son River cliffs and Gotthani Gupta Kashi temple', duration: '4 hrs', distance: 'Chopan' }, { time: '01:00 PM', place: 'Explore ancient rock art shelters of the Vindhyan range', duration: '3 hrs', distance: 'Kaimur Range' }, { time: '05:00 PM', place: 'Return transit to Varanasi Cantt / DDU Junction', duration: '2.5 hrs', distance: 'Varanasi' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Arrival in Robertsganj, check-in, and half-day geoheritage tour of Salkhan Fossil Park', duration: '5 hrs', distance: 'Salkhan' }, { time: '05:00 PM', place: 'Sunset over Kaimur hills and local culinary tour', duration: '2 hrs', distance: 'Robertsganj' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Full day Sonbhadra natural wonder trail: Chopan river cliffs, Gotthani sangam, and Agori Fort', duration: '7 hrs', distance: 'Son Valley' }, { time: '06:00 PM', place: 'Evening leisure in Robertsganj', duration: '2 hrs', distance: 'Hotel' }] },
      { day: 3, schedule: [{ time: '08:30 AM', place: 'Excursion to Mukha Waterfalls and Kaimur Wildlife Sanctuary forest drives', duration: '6 hrs', distance: 'Kaimur' }, { time: '04:00 PM', place: 'Departure transit to Varanasi or Delhi via railway / airport', duration: '2.5 hrs', distance: 'Transit' }] }
    ]
  },
  experiences: [
    { title: '1.4-Billion-Year Stromatolite Discovery Walk', duration: '2 hrs', price: 'Free Entry', category: 'Geoheritage', image: '/images/salkhan_hero_fullhd.jpg' },
    { title: 'Precambrian Fossil Ring Macro Photography', duration: '1.5 hrs', price: 'Free', category: 'Photography', image: '/images/stromatolite_rings.jpg' },
    { title: 'Kaimur Forest Edge Nature Walk', duration: '1 hr', price: 'Free', category: 'Nature', image: '/images/kaimur_forest_rocks.jpg' },
    { title: 'Authentic Sonbhadra Baati Chokha Feast', duration: '1.5 hrs', price: '₹80–₹150', category: 'Culinary', image: '/images/litti_chokha.jpg' }
  ],
  aiPrompts: [
    "What is the age and significance of Salkhan Fossil Park in Sonbhadra?",
    "How were stromatolite fossils formed at Salkhan 1.4 billion years ago?",
    "What is the status of Salkhan Fossil Park on UNESCO's World Heritage Tentative List?",
    "How do I reach Salkhan Fossil Park from Robertsganj and Varanasi?",
    "What are the conservation rules for visiting the fossil park?",
    "सलखन जीवाश्म पार्क सोनभद्र घूमने का सही समय, दूरी और नियम क्या हैं?"
  ],
  reviews: [
    { name: 'Prof. Arvind Pandey', location: 'Varanasi', text: 'To stand before fossils that are 1.4 billion years old is a humbling, transcendental experience. The concentric rings created by ancient cyanobacteria are beautifully preserved. A proud UNESCO Tentative Site!', rating: 5, image: '/images/salkhan_hero_fullhd.jpg', date: 'August 2026' },
    { name: 'Dr. Meenakshi Sanyal', location: 'New Delhi', text: 'One of the greatest geological treasures on planet Earth. Excellent accessibility from Robertsganj along SH-5A. A must-visit for every student, scientist, and curious traveler.', rating: 5, image: '/images/stromatolite_rings.jpg', date: 'September 2026' },
    { name: 'Rajeshwar Singh', location: 'Robertsganj', text: 'Salkhan Fossil Park is our district greatest pride. Clean forest surroundings, peaceful trails, and unmatched historical depth. Pair it with Chopan for an ideal weekend outing.', rating: 5, image: '/images/fossil_boulders.jpg', date: 'October 2025' }
  ],
  sources: {
    official: ['UNESCO World Heritage Centre (whc.unesco.org/en/tentativelists/6842)', 'District Sonbhadra Official Portal (sonbhadra.nic.in/tourist-place/salakhan-fosils-park)', 'Uttar Pradesh Forest Department Eco-Tourism Records'],
    historical: ['Birbal Sahni Institute of Palaeosciences Research Papers', 'Geological Survey of India Memoir by J.B. Auden (1933)'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">1.4 Billion Yrs</p>
              <p className="text-xs text-white/60 mt-1">Mesoproterozoic Era / UNESCO Tentative</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Central Stromatolite Beds' }, { top: '42%', left: '38%', label: 'Visitor Boardwalk' }, { top: '28%', left: '52%', label: 'Kaimur Forest Ridge' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('significance') && `Salkhan Fossil Park contains ~1.4-billion-year-old Mesoproterozoic stromatolite and algae fossils. It was inscribed on UNESCO's World Heritage Tentative List on June 4, 2025, under Natural Criterion (viii).`}
                  {selected?.includes('formed') && `Stromatolites were formed by colonies of photosynthetic cyanobacteria in shallow tidal waters. As sediment was trapped by microbial mats, layers of calcium carbonate precipitated, creating fossilized concentric rings.`}
                  {selected?.includes('UNESCO') && `The park is on India's UNESCO Tentative List, representing outstanding geological and evolutionary earth-history values from the dawn of atmospheric oxygenation.`}
                  {selected?.includes('reach') && `The park is located near Salkhan village on SH-5A, ~12 km south of Robertsganj. It is accessible by auto-rickshaw or taxi in 15–20 minutes from Robertsganj.`}
                  {selected?.includes('rules') && `Visitors must not chip, scratch, paint, hammer, or take away any rock pieces. Wear sturdy footwear, stay on marked trails, and carry all waste back with you.`}
                  {selected?.includes('duri aur') && `सलखन जीवाश्म पार्क रॉबर्ट्सगंज से मात्र 12 किमी दूर स्टेट हाईवे SH-5A पर स्थित है। यह 140 करोड़ वर्ष पुराने जीवाश्मों का अनूठा प्राकृतिक संग्रहालय है। घूमने का सबसे अच्छा समय अक्टूबर से मार्च है।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Strict Fossil Protection Rules', content: 'Never hammer, chip, scratch, collect, or dislodge fossil-bearing stones. Applying chalk, oils, powder, or chemicals to highlight patterns is strictly prohibited and damages irreplaceable specimens.' },
    { title: 'Footwear & Rocky Terrain Safety', content: 'Wear sturdy shoes with non-slip rubber soles. Fossil-bearing rock surfaces can be sharp, uneven, and slippery after monsoon rains.' },
    { title: 'Forest & Wildlife Sanctuary Adjacency', content: 'The park is located on the boundary of Kaimur Wildlife Sanctuary. Respect forest regulations, do not venture off marked pathways, and avoid disturbing local fauna.' },
    { title: 'Best Time & Daylight Visits', content: 'Visit between sunrise and sunset (07:00 AM to 05:00 PM). Morning raking light (08:00 AM to 11:00 AM) brings out the finest structural relief for macro photography.' },
    { title: 'Emergency & District Contacts', content: 'UP Police Emergency: 112 · Robertsganj Police Station: +91-5444-222200 · District Hospital Sonbhadra: +91-5444-222400 · Sonbhadra Forest Division: +91-5444-222300.' },
    { title: 'Water & Supplies Advice', content: 'There are no commercial eateries inside the protected park. Carry ample drinking water, hat/sunscreen, and enjoy meals in nearby Robertsganj (~12 km).' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={salkhan} />
      <QuickFacts facts={salkhan.quickFacts} />
      <WhyVisit destination={salkhan} />
      <DestinationStory destination={salkhan} />
      <HistoryTimeline destination={salkhan} />
      <CultureGrid destination={salkhan} />
      <FoodSection destination={salkhan} />
      <AttractionsGrid destination={salkhan} />
      <HiddenGems destination={salkhan} />
      <ThingsToDo destination={salkhan} />
      <NearbyPlaces destination={salkhan} />
      <HowToReach destination={salkhan} />
      <WhereToStay destination={salkhan} />
      <BestTime destination={salkhan} />
      <BudgetGuide destination={salkhan} />
      <Itineraries destination={salkhan} />
      <LocalExperiences destination={salkhan} />
      <MapSection destination={salkhan} />
      <AskD360 destination={salkhan} />
      <CommunityStories destination={salkhan} />
      <PracticalInfo />
      <SourcesTrust destination={salkhan} />
      <Footer />
    </div>
  )
}
