...
// ─── Raja Vir Singh Palace, Jalaun — Data (Unverified Research Lead) ────────

const jalaun: Destination = {
  id: 'raja-vir-singh-palace-jalaun', slug: 'raja-vir-singh-palace-jalaun', name: 'Raja Vir Singh Palace, Jalaun', localName: '',
  destinationType: 'Historic Palace / Bundela Heritage Lead (Unverified)', country: 'India', state: 'Uttar Pradesh', district: 'Jalaun',
  shortDescription: 'A potential hidden Bundela architectural landmark in Jalaun, linking local heritage with the royal building tradition of Raja Vir Singh Deo — identity and exact location not yet independently verified.',
  tags: ['Bundela Heritage', 'Unverified / Research Lead', 'Bundelkhand', 'Palace Architecture', 'Vir Singh Deo'],
  hero: { image: 'https://commons.wikimedia.org/wiki/Special:FilePath/JAHANGIR MAHAL ORCHHA, TIKAMGARH,MADHYA PRADESH.jpg?width=1600', poster: 'https://commons.wikimedia.org/wiki/Special:FilePath/Palace in Datia, Madhya Pradesh.jpg?width=1600' },
  quickFacts: { bestTime: 'October to March (provisional)', duration: '2-4 hours, once the exact monument and visitor access are confirmed', budget: 'Budget to Moderate (unverified)', destinationType: 'Historic Palace / Bundela Heritage Lead', difficulty: 'Provisional Easy to Moderate — depends on stairs, ruins, uneven ground and access restrictions', distance: 'Unverified — depends on confirmed monument location' },
  discoveryScore: { overall: 6.8, categories: [{ name: 'Popularity Index', score: 2 }, { name: 'Cultural Significance', score: 8 }, { name: 'Historical Weight', score: 8 }, { name: 'Uniqueness / Authenticity', score: 9 }, { name: 'Solo Travel Safety', score: 7 }, { name: 'Accessibility', score: 4 }] },
  editorial: { why: 'If the exact palace is locally confirmed, its strongest value would be its lesser-known character, Bundela architectural identity, and potential connection to the wider Vir Singh Deo / Bundelkhand heritage story.', story: 'The requested Raja Vir Singh Palace is positioned as a classic Bundela-architecture heritage lead within Jalaun\'s historic landscape, a district forming part of Bundelkhand — a region deeply associated with Bundela political history, fortified settlements, palaces and temples.', storyFull: 'This entry is a research lead, not a confirmed monument record. The exact Jalaun monument called "Raja Vir Singh Palace" could not be independently matched to an authoritative indexed source during this research pass — the district\'s official tourism pages document sites such as Rampura Palace and Jagammanpur Fort, but do not establish a monument under this exact name. A documented palace built by Raja Bir Singh Deo does exist, but at Datia, Madhya Pradesh — a seven-storeyed palace described by the Government of Madhya Pradesh\'s district heritage source as a major example of Bundela architecture. That Datia palace is a comparative architectural reference only; its coordinates, history, and photographs must not be treated as describing this Jalaun record. Raja Vir Singh Deo (also Bir Singh Deo) ruled Orchha from 1605 into the 1620s and is associated with a major phase of Bundela architectural production across the region, which is the basis for this entry\'s working hypothesis of a connected Jalaun structure — pending field verification of its precise identity, location and condition.' },
  history: { shortIntro: 'Jalaun sits within Bundelkhand, a region shaped by Bundela political history; this specific palace\'s own documented history remains unconfirmed pending field verification.', timeline: [{ year: 'Historical', event: 'Bundela expansion establishes the Bundelas as an important historical power in the Jalaun region, per Government of Uttar Pradesh history records.', era: 'Bundela' }, { year: '1605-1620s', event: 'Raja Vir Singh Deo (Bir Singh Deo) rules Orchha and presides over a major phase of Bundela architectural production across the wider region.', era: 'Bundela' }, { year: 'Later phases', event: 'Jalaun\'s landscape experiences subsequent Mughal, Maratha, British and post-independence administrative changes.', era: 'Post-Bundela' }] },
  culture: [{ title: 'Bundelkhandi Agrarian Life', description: 'Jalaun belongs to the broader Bundelkhand cultural zone, with predominantly agrarian communities outside urban centres. The exact community profile around the palace itself requires local research.', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ken Rivier Bundelkhand Uttar Pradesh India.jpg?width=1600' }, { title: 'Bundeli Folk Traditions', description: 'Bundeli/Bundelkhandi folk music, oral poetry and seasonal performance traditions provide useful cultural context for the region; any palace-linked crafts or traditions remain to be verified.', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bihar Folk Dance-.jpg?width=1600' }, { title: 'Oral Memory vs. Historical Record', description: 'Local stories concerning royal visits, hidden passages, battles, treasure or royal residences at this site should be treated and recorded as oral tradition unless supported by archival or archaeological evidence.', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ken Rivier Bundelkhand Uttar Pradesh India.jpg?width=1600' }, { title: 'Cultural Etiquette', description: 'Ask permission before entering private land or active religious spaces; dress modestly; avoid touching fragile masonry, murals or inscriptions; follow local photography rules.', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/JAHANGIR MAHAL ORCHHA, TIKAMGARH,MADHYA PRADESH.jpg?width=1600' }, { title: 'Regional Festivals', description: 'Holi, Diwali, Navratri and other regional celebrations are relevant to the wider Bundelkhand area. No palace-specific festival should be invented or assumed without local confirmation.', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Holi Festival Celebrations.jpg?width=1600' }],
  food: [{ name: 'Bundelkhandi Wheat Rotis & Seasonal Vegetables', description: 'Simple regional wheat rotis paired with seasonal vegetables and pulses — a Jalaun/Bundelkhand food layer rather than a palace-specific cuisine, subject to local verification.', category: 'Main', price: 'Pending verification', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Chapati2.JPG?width=1600' }, { name: 'Local Snacks & Sweets', description: 'Regional snacks and sweets available locally in Jalaun; specific named items require field verification.', category: 'Snack / Dessert', price: 'Pending verification', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Indian Snacks (Namkeen).jpg?width=1600' }, { name: 'Tea & Buttermilk', description: 'Simple North Indian/Bundelkhandi beverages commonly available in the local food environment.', category: 'Beverage', price: 'Pending verification', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bihar Village Bazaar.JPG?width=1600' }],
  attractions: [{ id: 'raja-vir-singh-palace-jalaun', name: 'Raja Vir Singh Palace, Jalaun', category: 'Main Landmark / Monument (Unverified)', description: 'The requested primary heritage lead; exact identity, location and visitor access require field verification. Photo shown is the documented Bir Singh Palace at Datia, used here only to illustrate Bundela palace architecture — it is not a photo of the Jalaun structure, whose appearance remains unconfirmed.', duration: '2-4 hrs', distance: 'Pending verification', score: null, image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Palace in Datia, Madhya Pradesh.jpg?width=1600' }, { id: 'jalaun-historic-landscape', name: 'Jalaun Historic Landscape', category: 'Heritage Context', description: 'Bundela-era political geography and surviving historic settlements across the district.', duration: '1-2 hrs', distance: 'District-wide', score: null, image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ken Rivier Bundelkhand Uttar Pradesh India.jpg?width=1600' }, { id: 'kalpi', name: 'Kalpi', category: 'Historic / Religious / Riverfront', description: 'A major historic settlement on the Yamuna and a well-documented part of Jalaun\'s history, including the ruined Kalpi Fort.', duration: 'Half day', distance: 'Within Jalaun district', score: 7.5, image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Piece of fort wall on the north-east scarp with its circular bastion.jpg?width=1600' }, { id: 'jalaun-town-heritage-sites', name: 'Jalaun Town Heritage Sites', category: 'Religious / Local Heritage', description: 'Verified temples, old structures, bazaars and historic buildings to be added after a field inventory. Photo shown is a representative regional town/bazaar scene, not a confirmed Jalaun site.', duration: '1-3 hrs', distance: 'Pending verification', score: null, image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bihar Village Bazaar.JPG?width=1600' }, { id: 'bundelkhand-comparative-monuments', name: 'Bundelkhand Comparative Monuments (Orchha & Datia)', category: 'Architecture — Comparative Reference', description: 'Orchha\'s Jahangir Mahal and Datia\'s Bir Singh Palace are documented reference points for classic Bundela architecture, shown here strictly for comparison — neither is the Jalaun record itself.', duration: 'Full day / extension', distance: 'Extended circuit', score: null, image: 'https://commons.wikimedia.org/wiki/Special:FilePath/JAHANGIR MAHAL ORCHHA, TIKAMGARH,MADHYA PRADESH.jpg?width=1600' }, { id: 'local-bazaar', name: 'Local Bazaar', category: 'Local Market', description: 'Useful for food, crafts and community context once the exact settlement is confirmed. Photo shown is a representative regional village bazaar, not a confirmed Jalaun market.', duration: '1-2 hrs', distance: 'Pending verification', score: null, image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bihar Village Bazaar.JPG?width=1600' }],
  hiddenGems: [],
  thingsToDo: [{ activity: 'Local-history walk led by a resident who knows the palace and surrounding settlement', duration: 'Pending verification', cost: 'Pending verification', difficulty: 'Pending verification', bestTime: 'October to March', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Piece of fort wall on the north-east scarp with its circular bastion.jpg?width=1600' }, { activity: 'Architecture sketching / photography of surviving structural details', duration: 'Pending verification', cost: 'Pending verification', difficulty: 'Pending verification', bestTime: 'Daylight hours', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/JAHANGIR MAHAL ORCHHA, TIKAMGARH,MADHYA PRADESH.jpg?width=1600' }, { activity: 'Oral-history recording with elders or caretakers', duration: 'Pending verification', cost: 'Pending verification', difficulty: 'Pending verification', bestTime: 'October to March', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ken Rivier Bundelkhand Uttar Pradesh India.jpg?width=1600' }],
  nearbyPlaces: [{ name: 'Kalpi', distance: 'Within 50 km', type: 'Historic / Religious / Riverfront', travelTime: 'Pending verification', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Piece of fort wall on the north-east scarp with its circular bastion.jpg?width=1600' }, { name: 'Orchha (Jahangir Mahal)', distance: 'Extended circuit', type: 'Architecture / Heritage — Comparative', travelTime: 'Pending verification', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/JAHANGIR MAHAL ORCHHA, TIKAMGARH,MADHYA PRADESH.jpg?width=1600' }, { name: 'Datia (Bir Singh Palace)', distance: 'Extended circuit', type: 'Architecture / Heritage — Comparative', travelTime: 'Pending verification', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Palace in Datia, Madhya Pradesh.jpg?width=1600' }],
  travel: { air: { airport: 'Gwalior, Kanpur or Lucknow may be relevant regional gateways — final choice pending verified location', distance: null, time: null }, rail: { station: 'Orai/Jalaun-area rail access, to be selected after the exact village/town is confirmed', distance: null, time: null }, road: { highway: 'Jalaun district connects to the Bundelkhand road network; final last-mile route unverified', distance: null, time: null }, fieldVerificationChecklist: ['Record road surface, parking, and walking distance', 'Note stairs and access restrictions', 'Check local signage', 'Check mobile-network reliability'], suggestedCombinations: 'Palace research visit + Kalpi heritage circuit + local food/market experience' },
  stay: { categories: [{ type: 'Budget / Business Hotels', range: 'Unverified', options: ['Budget hotels, business hotels and guesthouse-style stays are more realistic than heritage hotels near Jalaun/Orai', 'Named properties to be added only after current local verification'] }, { type: 'Extended Circuit', range: 'Unverified', options: ['Jhansi/Orchha can serve as a wider Bundelkhand heritage base for a multi-destination itinerary'] }] },
  bestTime: { months: [{ month: 'Jan', status: 'ideal' }, { month: 'Feb', status: 'ideal' }, { month: 'Mar', status: 'good' }, { month: 'Apr', status: 'avoid' }, { month: 'May', status: 'avoid' }, { month: 'Jun', status: 'avoid' }, { month: 'Jul', status: 'avoid' }, { month: 'Aug', status: 'avoid' }, { month: 'Sep', status: 'avoid' }, { month: 'Oct', status: 'ideal' }, { month: 'Nov', status: 'ideal' }, { month: 'Dec', status: 'ideal' }] },
  budget: { tiers: [{ tier: 'Budget / Backpacker', perDay: 'INR 800-1,500 (excluding intercity travel)', breakdown: [] }, { tier: 'Mid-Range', perDay: 'INR 1,500-3,500', breakdown: [{ category: 'Private local transport and meals', amount: 'Included' }] }, { tier: 'Luxury', perDay: 'Not necessary for the monument itself', breakdown: [{ category: 'Premium transport and accommodation', amount: 'Main cost driver, not monument entry' }] }], freeVsPaid: 'Local streets and public viewpoints may be free; monument access and guided services require verification.' },
  itineraries: { '1 Day': [{ day: 1, schedule: [{ time: 'Morning', place: 'Travel to the verified palace location; document the exterior, gateway and architectural details' }, { time: 'Afternoon', place: 'Local heritage walk, food stop and oral-history interview' }, { time: 'Evening', place: 'Return to Jalaun/Orai or continue toward another verified Bundelkhand destination' }] }], '2 Days': [{ day: 1, schedule: [{ time: 'Day 1', place: 'Palace + settlement heritage + local market/food' }] }, { day: 2, schedule: [{ time: 'Day 2', place: 'Kalpi or another verified Jalaun heritage site, followed by archival/local-history work' }] }] },
  experiences: [{ title: 'Local-History Walk', duration: 'Pending verification', price: 'Pending verification', category: 'Heritage', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Piece of fort wall on the north-east scarp with its circular bastion.jpg?width=1600' }, { title: 'Architecture Sketching / Photography Session', duration: 'Pending verification', price: 'Pending verification', category: 'Photography', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/JAHANGIR MAHAL ORCHHA, TIKAMGARH,MADHYA PRADESH.jpg?width=1600' }, { title: 'Oral-History Recording with Elders/Caretakers', duration: 'Pending verification', price: 'Pending verification', category: 'Community', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ken Rivier Bundelkhand Uttar Pradesh India.jpg?width=1600' }, { title: 'Local Food Experience', duration: 'Pending verification', price: 'Pending verification', category: 'Culinary', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Chapati2.JPG?width=1600' }],
  aiPrompts: ['What is the documented history of Raja Vir Singh Deo\'s connection with the Jalaun region?', 'Help me identify Bundela architectural elements visible in this palace photograph.', 'Separate local legends about Raja Vir Singh Palace from historically verified evidence.', 'Plan a 4-hour heritage itinerary around the confirmed palace location in Jalaun.', 'Compare the architecture of this Jalaun palace with documented Bundela monuments at Orchha and Datia.'],
  reviews: [],
  sources: { official: ['Government of Uttar Pradesh — Jalaun District Tourism Portal (Places of Interest pages; documents Rampura Palace, Jagammanpur Fort and other Jalaun attractions, but does not independently establish a monument under the exact name "Raja Vir Singh Palace")', 'Incredible India — Bir Singh Palace page (documents the Bir Singh Palace / Datia Palace in Datia, Madhya Pradesh as a comparative Bundela reference, not evidence of a Jalaun location)', 'Government of Madhya Pradesh — Datia District Heritage Portal (describes Datia\'s seven-storeyed palace built by Raja Bir Singh Deo in the early 17th century)'], historical: ['UNESCO Tentative List — "The Palace-Fortresses of the Bundelas" (comparative architectural context)', 'National Monuments Authority architectural documentation (comparative context only; no monument-specific claims for Jalaun)'], lastVerified: null }
}
// ─── Icons ───────────────────────────────────────────────────────────────────
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Raja Vir Singh Palace (Pending Verification)' }, { top: '42%', left: '38%', label: 'Kalpi' }, { top: '28%', left: '52%', label: 'Jalaun Historic Landscape' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes("Vir Singh Deo's connection") && `Raja Vir Singh Deo (also Bir Singh Deo) ruled Orchha from 1605 into the 1620s and is documented as commissioning dozens of palaces and forts across the Bundela realm, including the well-documented Jahangir Mahal at Orchha and the seven-storeyed Bir Singh Palace at Datia. His specific connection to a structure in present-day Jalaun district has not been independently matched to an authoritative indexed source — that link remains a research hypothesis, not a confirmed fact.`}
                  {selected?.includes('Bundela architectural elements') && `Look for chhatris (domed pavilion-canopies, often on rooftops or over cenotaphs), jharokhas (projecting balcony windows), multi-foil arches blending Rajput and Mughal forms, and courtyard-centred planning. Datia's palace and Orchha's Jahangir Mahal — both genuinely documented — are the reference points to compare against, since this Jalaun record's own architectural details haven't been field-verified yet.`}
                  {selected?.includes('local legends') && `Any story you hear locally about this palace — hidden chambers, buried treasure, a royal visit, a battle — should be treated as oral tradition unless it's backed by an archival record or archaeological evidence. That's not a dismissal of the story; it's simply the honest line between what residents remember and what's been documented, and this record keeps that line visible rather than blurring it.`}
                  {selected?.includes('4-hour heritage itinerary') && `Once the exact site is confirmed: allow roughly 45–60 minutes to document the exterior, gateway and any surviving architectural details, 1–1.5 hours for a slower interior/courtyard walk if access permits, then 1–1.5 hours for a short walk through the surrounding settlement and a food stop. Build in extra time for travel to and from Jalaun/Orai, since the final approach route isn't yet mapped.`}
                  {selected?.includes('Compare the architecture') && `Bundela palace architecture typically pairs Rajput planning — courtyards, defensive massing — with Mughal-influenced domes, arches and painted surfaces, best seen today at Orchha's Jahangir Mahal and Datia's Bir Singh Palace. Whether this Jalaun structure shares those features, and to what degree, is exactly what field documentation would need to establish; nothing here should be assumed to match those confirmed monuments.`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Safety', content: 'Treat this site as potentially fragile or privately controlled until ownership and access are confirmed. Avoid unauthorized guides claiming exclusive access, and do not climb roofs, walls or unstable ruins. Watch for uneven ground, open wells and deteriorating masonry.' },
    { title: 'Local Transport', content: 'Autos, shared vehicles and private cabs are the most practical district-level options; availability at the monument itself is unverified. Jalaun/Orai are provisional bases while the exact site location is confirmed.' },
    { title: 'Photography Rules', content: 'Ask permission before photography inside homes, temples or private compounds. Avoid touching fragile masonry, murals or inscriptions. Photography rules for the palace itself remain unverified.' },
    { title: 'Dress & Etiquette', content: 'Dress modestly, and ask permission before entering private land or active religious spaces. Separate documented history from oral tradition — treat local stories about the palace as oral history unless backed by archival or archaeological evidence.' },
    { title: 'Emergency Information', content: 'Exact nearest police station, medical facility and tourist assistance numbers should be populated after the final palace pin is confirmed. UP Tourist Helpline: 1800-180-1414 is a reliable statewide fallback in the meantime.' },
    { title: 'Travel Tips', content: 'Rural approaches may have inconsistent mobile coverage — carry offline maps and essential contact details. Carry water during hot months. Consider combining a visit with a verified extension to Kalpi, or to Orchha/Datia for confirmed Bundela architecture, rather than relying solely on this unverified record.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={jalaun} />
      <QuickFacts facts={jalaun.quickFacts} />
      <WhyVisit destination={jalaun} />
      <DestinationStory destination={jalaun} />
      <HistoryTimeline destination={jalaun} />
      <CultureGrid destination={jalaun} />
      <FoodSection destination={jalaun} />
      <AttractionsGrid destination={jalaun} />
      <HiddenGems destination={jalaun} />
      <ThingsToDo destination={jalaun} />
      <NearbyPlaces destination={jalaun} />
      <HowToReach destination={jalaun} />
      <WhereToStay destination={jalaun} />
      <BestTime destination={jalaun} />
      <BudgetGuide destination={jalaun} />
      <Itineraries destination={jalaun} />
      <LocalExperiences destination={jalaun} />
      <MapSection destination={jalaun} />
      <AskD360 destination={jalaun} />
      <CommunityStories destination={jalaun} />
      <PracticalInfo />
      <SourcesTrust destination={jalaun} />
      <Footer />
    </div>
  )
}
