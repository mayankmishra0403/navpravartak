...
const baruasagar: Destination = {
  id: 'baruasagar-fort-jhansi',
  slug: 'baruasagar-fort-jhansi-bundelkhand',
  name: 'Barua Sagar Fort',
  localName: 'बरुआ सागर किला',
  destinationType: 'Historical Lake Fort & Pratihara Temple',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Jhansi',
  established: { year: '1744 CE', by: 'Raja Udit Singh of Orchha' },
  shortDescription: 'A picturesque 18th-century Bundela fort towering above an expansive artificial lake, witness to historic Maratha-Bundela battles and home to ancient Pratihara temples.',
  tags: ['LAKE_FORT', 'BUNDELA_ARCHITECTURE', 'PRATIHARA_TEMPLE', 'HERITAGE_LAKE'],
  hero: {
  ...
  quickFacts: {
    ...
    budget: '₹',
    destinationType: 'Lake Fort & Heritage Site',
    difficulty: 'Easy to Moderate',
    distance: '~24 km from Jhansi on NH-39'
  },
  discoveryScore: {
    overall: 8.6,
    categories: [
      { name: 'Uniqueness', score: 8.8 },
      { name: 'Historical Significance', score: 8.7 },
      { name: 'Cultural Value', score: 8.5 },
      { name: 'Crowd Level', score: 9.0 },
      { name: 'Local Experience', score: 8.4 }
    ]
  },
  editorial: {
    why: 'Barua Sagar Fort is an 18th-century Bundela masterpiece built by Raja Udit Singh of Orchha, offering panoramic views over Barua Sagar lake and standing steps away from the 8th-century Jarai ka Math temple.',
    story: 'The site witnessed the famous 1761 Battle of Barua Sagar between Maratha forces and the Bundela-Mughal alliance.',
    storyFull: 'Perched dramatically on a rocky hill overlooking the vast Barua Sagar Lake, Barua Sagar Fort was constructed around 1744 CE by Raja Udit Singh of Orchha. The fort stands as a magnificent example of Bundela military architecture with its massive granite stone walls, elevated watchtowers, and spacious courtyards offering panoramic views of the water reservoir. Nearby stands Jarai ka Math, an exquisite 8th-century Gurjara-Pratihara temple dedicated to Goddess Kali, renowned for its masterfully carved sandstone sculptures.'
  },
  history: {
    shortIntro: '18th-century Bundela lake fort built near an 8th-century Pratihara temple complex.',
    timeline: [
      { year: '8th c. CE', event: 'Jarai ka Math temple constructed during the Gurjara-Pratihara dynasty.', era: 'Pratihara Dynasty' },
      { year: '1744 CE', event: 'Raja Udit Singh of Orchha builds Barua Sagar Fort and lake embankment.', era: 'Bundela Reign' },
      { year: '1761 CE', event: 'Historic Battle of Barua Sagar fought between Maratha armies and Bundela-Mughal alliance.', era: 'Maratha War' },
      { year: 'Present Day', event: 'Protected as a national heritage monument by ASI Jhansi Circle.', era: 'ASI Protected' }
    ]
  },
  culture: [
    { title: 'Jarai ka Math Pratihara Art', description: '8th-century temple featuring detailed granite and sandstone carvings of deities.', image: '/images/jarai_math.jpg' },
    { title: 'Barua Sagar Lake Heritage', description: 'Expansive historic water reservoir created for irrigation and defense by Orchha rulers.', image: '/images/lake_view.jpg' },
    { title: 'Bundelkhand Folk Traditions', description: 'Alha folk ballads, traditional pottery, and vibrant Navratri temple fairs.', image: '/images/bundela_craft.jpg' }
  ],
  food: [
    { name: 'Bundeli Baati Chokha', description: 'Roasted wheat dough balls served with spiced mashed eggplant, tomato, and ghee.', category: 'Regional Cuisine', price: '₹80–₹160', image: '/images/baati_chokha.jpg' },
    { name: 'Jhansi Special Peda', description: 'Rich caramelized milk sweet infused with cardamom and topped with pistachios.', category: 'Dessert', price: '₹60–₹120', image: '/images/jhansi_peda.jpg' }
  ],
  attractions: [
    { id: 'baruasagar-fort-walls', name: 'Barua Sagar Fort Ramparts', category: 'Bundela Fortification', description: '18th-century stone ramparts offering sweeping views across the lake.', duration: '1.5 hrs', distance: 'Barua Sagar', score: 9.0, image: '/images/fort_walls.jpg' },
    { id: 'baruasagar-lake', name: 'Barua Sagar Lake & Embankment', category: 'Scenic Reservoir', description: 'Vast historical water body constructed by Raja Udit Singh of Orchha.', duration: '45 mins', distance: 'Lakefront', score: 8.8, image: '/images/lake_view.jpg' },
    { id: 'jarai-ka-math', name: 'Jarai ka Math Temple', category: 'Pratihara Architecture', description: '8th-century temple with masterfully carved sandstone doorways and statues.', duration: '45 mins', distance: '2 km', score: 9.3, image: '/images/jarai_math.jpg' }
  ],
  hiddenGems: [
    { name: 'Sunset Point at Fort Terraces', why: 'Panoramic sunset view over the wide calm lake waters and surrounding hills.', distance: '0 km', duration: '45 mins', image: '/images/lake_view.jpg' }
  ],
  thingsToDo: [
    { activity: 'Bundela Fort Wall Walk & Lake View Trail', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Late Afternoon', image: '/images/fort_walls.jpg' },
    { activity: 'Jarai ka Math Pratihara Sculpture Tour', duration: '45 mins', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: '/images/jarai_math.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Jhansi Fort & Rani Mahal', distance: '24 km', type: 'Historic Freedom Fort', travelTime: '35 mins', image: '/images/jhansi_fort.jpg' },
    { name: 'Orchha Heritage Town', distance: '15 km', type: 'UNESCO Nominated Site', travelTime: '25 mins', image: '/images/orchha_town.jpg' }
  ],
  travel: {
    air: { airport: 'Gwalior Airport (GWL)', distance: '125 km', time: '2 hrs' },
    rail: { station: 'Virangana Lakshmibai Jhansi Junction / Barwa Sagar Station', distance: '24 km / 2 km', time: '35 mins' },
    road: { highway: 'NH-39 (Jhansi-Khajuraho Highway)', distance: '24 km from Jhansi', time: '35 mins drive' }
  },
  stay: {
    categories: [
      { type: 'Jhansi City Hotels', range: '₹1,500–₹3,500/night', options: ['Jhansi Hotel', 'Nataraj Sarovar Portico Jhansi'] },
      { type: 'Orchha Heritage Stays', range: '₹2,500–₹7,000/night', options: ['Amar Mahal Orchha', 'Orchha Resort'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Day Trip', perDay: '₹700–₹1,400', breakdown: [{ category: 'Shared Transport', amount: '₹200' }, { category: 'Food & Meals', amount: '₹500' }] },
      { tier: 'Comfort Tour', perDay: '₹2,500–₹4,500', breakdown: [{ category: 'Private Car Hire', amount: '₹1,200' }, { category: 'Stay & Dining', amount: '₹1,500' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '9:00 AM', place: 'Drive from Jhansi to Barua Sagar Fort via NH-39', duration: '35 mins', distance: '24 km' }, { time: '9:45 AM', place: 'Explore Barua Sagar Fort Ramparts & Lake Viewpoint', duration: '1.5 hrs', distance: 'Fort' }, { time: '11:30 AM', place: 'Visit 8th-century Jarai ka Math Temple', duration: '45 mins', distance: '2 km' }, { time: '1:00 PM', place: 'Drive to Orchha for Lunch by Betwa River', duration: '30 mins', distance: '15 km' }, { time: '2:30 PM', place: 'Tour Jahangir Mahal & Betwa Chhatris in Orchha', duration: '3 hrs', distance: 'Orchha' }] }]
  },
  experiences: [
    { title: 'Bundela Lake Fort & Pratihara Temple Circuit', duration: '3 hrs', price: 'Free', category: 'Architecture & History', image: '/images/hero.jpg' }
  ],
  aiPrompts: [
    'What is the historical significance of Barua Sagar Fort and the 1761 battle?',
    'What makes Jarai ka Math near Barua Sagar architecturally unique?',
    'How can I combine Barua Sagar, Orchha, and Jhansi in a 1-day trip?'
  ],
  reviews: [
    { name: 'Mahendra Bundela', location: 'Jhansi', text: 'Barua Sagar Fort offers one of the best lake sunset views in Bundelkhand. Jarai ka Math is an absolute hidden architectural jewel!', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format', date: 'Feb 2026' }
  ],
  sources: {
    official: ['ASI Jhansi Circle — Monument Portal', 'UP Tourism Bundelkhand Circuit'],
    historical: ['Imperial Gazetteer of India — Barwa Sagar', 'History of Orchha State'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={baruasagar} />
      <QuickFacts facts={baruasagar.quickFacts} />
      <WhyVisit destination={baruasagar} />
      <DestinationStory destination={baruasagar} />
      <HistoryTimeline destination={baruasagar} />
      <CultureGrid destination={baruasagar} />
      <FoodSection destination={baruasagar} />
      <AttractionsGrid destination={baruasagar} />
      <HiddenGems destination={baruasagar} />
      <ThingsToDo destination={baruasagar} />
      <NearbyPlaces destination={baruasagar} />
      <HowToReach destination={baruasagar} />
      <WhereToStay destination={baruasagar} />
      <BestTime destination={baruasagar} />
      <BudgetGuide destination={baruasagar} />
      <Itineraries destination={baruasagar} />
      <LocalExperiences destination={baruasagar} />
      <MapSection destination={baruasagar} />
      <AskD360 destination={baruasagar} />
      <CommunityStories destination={baruasagar} />
      <PracticalInfo />
      <SourcesTrust destination={baruasagar} />
      <Footer />
    </div>
  )
}
