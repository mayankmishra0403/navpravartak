...
const talbehat: Destination = {
  id: 'talbehat-fort',
  slug: 'talbehat-fort-lalitpur',
  name: 'Talbehat Fort',
  localName: 'तालबेहट किला (ललितपुर)',
  destinationType: 'Historic Bundela Hill Fort & Lakefront Heritage',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Lalitpur',
  shortDescription: "A historic 17th-century Bundela hill fortress rising beside the shimmering Mansarovar Lake, steeped in 1857 freedom struggle valor.",
  tags: ['BUNDELA FORT', 'LAKEFRONT HERITAGE', '1857 FREEDOM MEMORY'],
  hero: {
    image: '/images/talbehat_hero_fullhd.jpg',
    poster: '/images/talbehat_lake_view.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '3–5 Hours',
    budget: '₹',
    destinationType: 'Bundela Hill Fort & Lakefront',
    difficulty: 'Easy–Moderate',
    distance: '~31 km from Lalitpur'
  },
  discoveryScore: {
    overall: 9.2,
    categories: [
      { name: 'Architectural Grandeur', score: 9.4 },
      { name: 'Historical Weight', score: 9.5 },
      { name: 'Lakefront Setting', score: 9.3 },
      { name: 'Crowd Level', score: 9.7 },
      { name: 'Living Heritage', score: 8.8 }
    ]
  },
  editorial: {
    why: "Perched dramatically upon a 100-foot rocky granite outcrop overlooking the vast waters of Mansarovar Lake, Talbehat Fort represents the quintessential marriage of Bundela military engineering and scenic natural topography.",
    story: "Constructed around 1618 by Bharat Shah, the ruler of Bar and Chanderi, the fort later served as the seat of Raja Mardan Singh, who fiercely revolted against British colonial forces during the 1857 First War of Independence alongside Rani Lakshmibai of Jhansi.",
    storyFull: "The massive fort walls naturally contour the rocky hill with six monumental gateways, fortified stone bastions, and royal stepwells (Baoli). Inside the citadel complex stand revered living shrines dedicated to Lord Narsingh, Hanuman, and Angad. Down below, the Mansarovar Lake features gentle boating ghats where visitors can glide past the ancient reflection of Bundela stone ramparts glowing in the evening sunset."
  },
  history: {
    shortIntro: "From a 17th-century Bundela royal stronghold to an 1857 battleground led by Raja Mardan Singh.",
    timeline: [
      { year: '1618 AD', event: 'King Bharat Shah of Bar and Chanderi constructs the massive hill fortress overlooking Mansarovar Lake.', era: 'Bundela Dynasty' },
      { year: '18th Century', event: 'Fortification expanded with six majestic gateways, residential palaces, deep baolis (stepwells), and sacred temple complexes.', era: 'Royal Expansion' },
      { year: '1857 AD', event: 'Raja Mardan Singh of Talbehat rebels against British rule, uniting forces with Rani Lakshmibai of Jhansi to liberate Bundelkhand.', era: '1857 Freedom Uprising' },
      { year: '1858 AD', event: 'British troops under General Hugh Rose assault Talbehat after the siege of Jhansi, dismantling outer battlements.', era: 'Colonial Era' },
      { year: 'Present', event: 'Protected regional heritage site featuring active temples, lake boating, and conservation under UP Tourism.', era: 'Modern Heritage' }
    ]
  },
  culture: [
    { title: '1857 Valour of Raja Mardan Singh', description: 'Talbehat is etched in national memory for Raja Mardan Singh defiance against the British Empire in 1857, celebrated in regional folk ballads (Aalha-Khand style).', image: '/images/talbehat_gate.jpg' },
    { title: 'Living Temple Traditions', description: 'Active worship continues at the historic Narsingh Bhagwan and Hanuman shrines inside the fort, drawing devotees from across Bundelkhand.', image: '/images/talbehat_baoli.jpg' },
    { title: 'Mansarovar Lake & Boat Ghats', description: 'The vast freshwater lake provides a serene waterfront where local communities gather for evening boat rides, festival immersions, and picnics.', image: '/images/talbehat_lake_view.jpg' },
    { title: 'Bundelkhand Basketry & Crafts', description: 'Local rural artisans in Talbehat town maintain traditional bamboo basketry, pottery, and stone-carving traditions passed through generations.', image: '/images/talbehat_ruins.jpg' }
  ],
  food: [
    { name: 'Bundelkhandi Thali & Kadhi', description: 'Rustic spiced besan kadhi with pakodas, served with piping hot rotis, desi ghee, roasted papad, and fresh mint chutney.', category: 'Signature Lunch', price: '₹80–₹120', image: '/images/litti_chokha.jpg' },
    { name: 'Lalitpur Dal Bafla & Chokha', description: 'Boiled and ghee-crisped wheat baflas paired with rich mixed lentil dal, smoky fire-roasted eggplant chokha, and garlic chutney.', category: 'Specialty', price: '₹100–₹160', image: '/images/litti_chokha.jpg' },
    { name: 'Khasta Urad Dal Kachori', description: 'Flaky deep-fried pastry filled with spiced black gram lentils, served with tangy potato-fenugreek curry and sweet tamarind sauce.', category: 'Breakfast', price: '₹25–₹45', image: '/images/kachori.jpg' },
    { name: 'Desi Ghee Jalebi & Kheer', description: 'Crisp golden jalebi coils fried in pure desi ghee paired with thick slow-cooked rice kheer flavored with cardamom and saffron.', category: 'Dessert', price: '₹40–₹70', image: '/images/kheer.jpg' },
    { name: 'Highway Dhaba Samosa Chaat', description: 'Crisp hot samosas crushed under spiced chickpeas, chilled beaten curd, roasted cumin, and sweet-sour chutneys on NH-44.', category: 'Snack', price: '₹30–₹50', image: '/images/samosa_chaat.jpg' }
  ],
  attractions: [
    { id: 'talbehat-citadel', name: 'Talbehat Fort Citadel & Ramparts', category: 'Heritage', description: 'The historic hill fortress perched on granite rocks with expansive views over Mansarovar Lake and surviving royal architecture.', duration: '2–3 hrs', distance: 'Main Hill', score: 9.8, image: '/images/talbehat_hero_fullhd.jpg' },
    { id: 'narsingh-temple', name: 'Ancient Narsingh Bhagwan Temple', category: 'Spiritual', description: 'Revered temple situated within the fort complex, continuously worshipped since the Bundela era with intricate stone pillars.', duration: '45 min', distance: 'Inside Fort', score: 9.4, image: '/images/talbehat_baoli.jpg' },
    { id: 'mansarovar-lake-boating', name: 'Mansarovar Lake & Boating Ghat', category: 'Nature / Leisure', description: 'Picturesque lake at the foot of the fort offering paddle boating, waterfront walking promenades, and sunset viewpoints.', duration: '1–2 hrs', distance: 'Foot of Fort', score: 9.5, image: '/images/talbehat_lake_view.jpg' },
    { id: 'talbehat-fort-gate', name: 'Six Monumental Fort Gateways', category: 'Architecture', description: 'Imposing stone archway gateways illustrating Bundela military architecture with defensive battlements and elephant-spikes.', duration: '45 min', distance: 'Fort Approach', score: 9.2, image: '/images/talbehat_gate.jpg' },
    { id: 'royal-baoli', name: 'Historic Stepwell (Baoli)', category: 'Architecture', description: 'Deep multi-tiered stone stepwell designed for water harvesting and cooling the royal garrison during arid Bundelkhand summers.', duration: '30 min', distance: 'Inner Precinct', score: 9.0, image: '/images/talbehat_baoli.jpg' },
    { id: 'backside-ruins-trail', name: 'Rampart Ruins & Viewpoint Trail', category: 'Adventure', description: 'Scenic walking trail along the northern collapsed ramparts offering 360-degree vistas of the rocky Bundelkhand countryside.', duration: '1 hr', distance: 'North Ridge', score: 8.9, image: '/images/talbehat_backside.jpg' }
  ],
  hiddenGems: [
    { name: 'Mansarovar Hidden Sunset Point', why: 'A secluded rocky promontory behind the fort where the evening sun sets directly behind the water-mirrored fort battlements.', distance: 'West Embankment', duration: '1 hr', image: '/images/talbehat_lake_view.jpg' },
    { name: 'Underground Garrison Vaults', why: 'Stone-vaulted subterranean chambers once used by Raja Mardan Singh soldiers for storing ammunition and provisions during the 1857 uprising.', distance: 'South Bastion', duration: '45 min', image: '/images/talbehat_ruins.jpg' },
    { name: 'Talbehat Rural Pottery Hamlets', why: 'Traditional potter households around the lake crafting terracotta vessels, clay water jugs, and hand-molded earthen lamps.', distance: '1.5 km from fort', duration: '1 hr', image: '/images/talbehat_gate.jpg' }
  ],
  thingsToDo: [
    { activity: 'Mansarovar Lake Paddle Boat Cruise', duration: '1 hr', cost: '₹100–₹200', difficulty: 'Easy', bestTime: '04:00 PM – 06:00 PM', image: '/images/talbehat_lake_view.jpg' },
    { activity: 'Fort Rampart & Gateway Heritage Walk', duration: '2 hrs', cost: 'Free', difficulty: 'Easy–Moderate', bestTime: 'Morning / Late Afternoon', image: '/images/talbehat_gate.jpg' },
    { activity: 'Narsingh & Hanuman Temple Darshan', duration: '45 min', cost: 'Free', difficulty: 'Easy', bestTime: '08:00 AM – 11:00 AM', image: '/images/talbehat_baoli.jpg' },
    { activity: 'Sunset Photography from Hilltop Bastion', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Golden Hour 05:30 PM', image: '/images/talbehat_hero_fullhd.jpg' },
    { activity: 'Authentic Bundelkhandi Kadhi-Roti Lunch', duration: '45 min', cost: '₹80–₹150', difficulty: 'Easy', bestTime: '01:00 PM in Talbehat', image: '/images/litti_chokha.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Lalitpur District Center', distance: '31 km', type: 'District HQ & Railhead', travelTime: '30 min', image: '/images/talbehat_gate.jpg' },
    { name: 'Jhansi Historic Fort & Museum', distance: '48 km', type: '1857 Heritage Capital', travelTime: '50 min', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=500&h=340&fit=crop&auto=format' },
    { name: 'Deogarh Dashavatara Temple & Fort', distance: '65 km', type: 'Gupta Art & Jain Heritage', travelTime: '1.2 hrs', image: '/images/talbehat_ruins.jpg' },
    { name: 'Orchha Royal Palaces & Chhatris', distance: '60 km', type: 'Bundela Capital', travelTime: '1 hr', image: 'https://images.unsplash.com/photo-1600100397608-f010f443b793?w=500&h=340&fit=crop&auto=format' }
  ],
  travel: {
    air: { airport: 'Gwalior Airport (GWL) / Khajuraho (HJR)', distance: '160 km / 185 km', time: 'Gwalior ~3 hrs drive; Bhopal ~4 hrs drive' },
    rail: { station: 'Talbehat Railway Station (TBT) / Lalitpur (LAR) / Jhansi (JHS)', distance: '3 km / 31 km / 48 km', time: 'Talbehat has passenger and express halts; Jhansi Junction is a superfast hub on main Delhi-Mumbai line' },
    road: { highway: 'NH-44 (North-South Corridor 4-lane highway)', distance: 'Directly on 4-lane highway between Jhansi and Lalitpur', time: 'Smooth 45-minute drive from Jhansi or 30-minute drive from Lalitpur' }
  },
  stay: {
    categories: [
      { type: 'Jhansi Heritage & Luxury Hotels', range: '₹2,500–₹6,000/night', options: ['Hotel Bundelkhand Pride Jhansi', 'Hotel Nataraj Sarovar Portico', 'Jhansi Hotel'] },
      { type: 'Lalitpur Business Hotels', range: '₹1,200–₹2,500/night', options: ['Hotel Bundelkhand Lalitpur', 'Hotel Rahi Tourist Bungalow Lalitpur'] },
      { type: 'Talbehat Budget Lodges', range: '₹600–₹1,200/night', options: ['Talbehat Lakeview Rest House', 'Station Road Guest Houses'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Heritage Traveler', perDay: '₹800–₹1,500', breakdown: [{ category: 'Local Train / Bus', amount: '₹150–₹250' }, { category: 'Food & Tea', amount: '₹200–₹350' }, { category: 'Entry & Temples', amount: 'Free' }, { category: 'Boat Ride', amount: '₹100–₹200' }] },
      { tier: 'Day Trip from Jhansi', perDay: '₹2,500–₹4,000', breakdown: [{ category: 'Cab from Jhansi (NH-44)', amount: '₹1,800–₹2,500' }, { category: 'Dhaba Lunch & Snacks', amount: '₹400–₹600' }, { category: 'Lake Activities', amount: '₹200–₹400' }, { category: 'Local Guide', amount: '₹300–₹500' }] },
      { tier: 'Bundelkhand Forts Circuit', perDay: '₹5,000+', breakdown: [{ category: 'Jhansi Hotel Base', amount: '₹2,500–₹4,000' }, { category: 'Private AC Car (Full Day)', amount: '₹2,500–₹3,500' }, { category: 'Fine Dining', amount: '₹800+' }, { category: 'Heritage Experiences', amount: '₹1,000+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '08:30 AM', place: 'Drive down NH-44 from Jhansi/Lalitpur to Talbehat Fort gate', duration: '45 min', distance: 'NH-44' }, { time: '09:30 AM', place: 'Explore main fort citadel, monumental gateways, and royal baoli', duration: '2 hrs', distance: 'Citadel' }, { time: '11:30 AM', place: 'Darshan at ancient Narsingh Bhagwan and Hanuman temple complex', duration: '45 min', distance: 'Inside Fort' }, { time: '12:30 PM', place: 'Traditional Bundelkhandi Dal Bafla lunch at highway restaurant', duration: '1 hr', distance: 'Talbehat Town' }, { time: '02:00 PM', place: 'Afternoon paddle boating and waterfront walk at Mansarovar Lake', duration: '2 hrs', distance: 'Lakeside' }, { time: '04:30 PM', place: 'Sunset photography from hill ramparts before return drive', duration: '1 hr', distance: 'Viewpoint' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Arrival in Talbehat & comprehensive exploration of hill fort architecture', duration: '3 hrs', distance: 'Talbehat Fort' }, { time: '01:00 PM', place: 'Lunch followed by leisurely boat cruise on Mansarovar Lake', duration: '2.5 hrs', distance: 'Mansarovar' }, { time: '04:30 PM', place: 'Drive to Lalitpur hotel & evening walk around local market', duration: '2 hrs', distance: '31 km' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Excursion to Deogarh: 6th-century Gupta Dashavatara Temple and Jain Fort', duration: '4 hrs', distance: 'Deogarh (65 km)' }, { time: '01:30 PM', place: 'Riverside lunch along the Betwa River gorge at Deogarh', duration: '1.5 hrs', distance: 'Betwa Valley' }, { time: '03:30 PM', place: 'Return via Matatila Dam reservoir and gardens', duration: '2.5 hrs', distance: 'Matatila' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Jhansi Heritage Trail: Jhansi Fort, Rani Mahal museum, and 1857 memorial', duration: '4 hrs', distance: 'Jhansi' }, { time: '02:00 PM', place: 'Drive to Talbehat Fort & sunset boat cruise on Mansarovar Lake', duration: '3.5 hrs', distance: 'Talbehat' }] },
      { day: 2, schedule: [{ time: '08:30 AM', place: 'Full-day excursion to Deogarh Gupta Temple and Betwa River rock-cut caves', duration: '5 hrs', distance: 'Deogarh' }, { time: '03:30 PM', place: 'Explore Lalitpur district rural stepwells and ancient shrines', duration: '3 hrs', distance: 'Lalitpur' }] },
      { day: 3, schedule: [{ time: '08:30 AM', place: 'Drive to royal Bundela capital of Orchha (Jahangir Mahal & Ram Raja Temple)', duration: '5 hrs', distance: 'Orchha' }, { time: '03:30 PM', place: 'Departure via Jhansi Junction Vande Bharat or Shatabdi express', duration: '2 hrs', distance: 'Jhansi Station' }] }
    ]
  },
  experiences: [
    { title: 'Mansarovar Lake Waterfront Cruise', duration: '1.5 hrs', price: '₹100–₹200', category: 'Waterfront', image: '/images/talbehat_lake_view.jpg' },
    { title: 'Bundela Hilltop Citadel Heritage Walk', duration: '2 hrs', price: 'Free', category: 'Heritage', image: '/images/talbehat_hero_fullhd.jpg' },
    { title: 'Narsingh Bhagwan Temple Darshan', duration: '45 min', price: 'Free', category: 'Spiritual', image: '/images/talbehat_baoli.jpg' },
    { title: '1857 Raja Mardan Singh Historical Trail', duration: '2 hrs', price: 'Free', category: 'History', image: '/images/talbehat_gate.jpg' }
  ],
  aiPrompts: [
    "What is the historical significance of Talbehat Fort during the 1857 revolt?",
    "How do I reach Talbehat Fort from Jhansi or Lalitpur on NH-44?",
    "What are the boating options and timings at Mansarovar Lake in Talbehat?",
    "Can you suggest a 1-day itinerary combining Jhansi Fort and Talbehat Fort?",
    "Who built Talbehat Fort and what temples are located inside?",
    "Talbehat kile mein ghoomne ke liye best time aur entry rules kya hain?"
  ],
  reviews: [
    { name: 'Raghavendra Bundela', location: 'Jhansi', text: 'Talbehat Fort is an incredible hidden gem right on the 4-lane highway between Jhansi and Lalitpur! The view of Mansarovar Lake from the fort ramparts during sunset is magical.', rating: 5, image: '/images/talbehat_hero_fullhd.jpg', date: 'February 2026' },
    { name: 'Shalini Chauhan', location: 'Gwalior', text: 'The combination of Bundela fort architecture, the active Narsingh temple, and peaceful paddle boating on the lake made this a wonderful family weekend excursion.', rating: 5, image: '/images/talbehat_lake_view.jpg', date: 'January 2026' },
    { name: 'Col. K. P. Singh (Retd.)', location: 'Lucknow', text: 'The 1857 history of Raja Mardan Singh makes this fort sacred ground for Indian patriots. The surviving gateways and stone baolis are majestic examples of Bundela craftsmanship.', rating: 5, image: '/images/talbehat_gate.jpg', date: 'December 2025' }
  ],
  sources: {
    official: ['Lalitpur District Official Administration Portal (lalitpur.nic.in)', 'Uttar Pradesh Tourism Development Corporation (uptourism.gov.in)', 'Archaeological Survey of India Regional Records'],
    historical: ['District Census Handbook: Lalitpur (Village & Town Directory)', 'Historical Survey of Bundela Forts & 1857 Uprising in Central India'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">1618 AD</p>
              <p className="text-xs text-white/60 mt-1">Bundela Dynasty</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Talbehat Fort Citadel' }, { top: '42%', left: '38%', label: 'Mansarovar Lake' }, { top: '28%', left: '52%', label: 'Narsingh Temple' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('1857') && `Raja Mardan Singh of Talbehat was a key leader of the 1857 revolt in Bundelkhand, fighting valiantly alongside Rani Lakshmibai of Jhansi before British forces captured the fort in 1858.`}
                  {selected?.includes('reach') && `Talbehat is located right on 4-lane NH-44 between Jhansi (48 km, 50 mins) and Lalitpur (31 km, 30 mins). It also has its own railway station with frequent passenger and express trains.`}
                  {selected?.includes('boating') && `Mansarovar Lake at the base of the fort offers paddle boats and scenic rowboats (₹100–₹200/person) with a dedicated ghat, jetty, and lakeside restaurant.`}
                  {selected?.includes('itinerary') && `Morning: Explore Jhansi Fort and Rani Mahal. Afternoon: Drive down NH-44 to Talbehat, explore fort citadel, visit Narsingh temple, and enjoy sunset boating on Mansarovar Lake.`}
                  {selected?.includes('built') && `Talbehat Fort was constructed around 1618 AD by King Bharat Shah of Bar and Chanderi. It houses temples dedicated to Lord Narsingh, Hanuman, and Angad, along with multi-tiered stone stepwells.`}
                  {selected?.includes('karein') && `तालबेहट किला झांसी-ललितपुर 4-लेन हाईवे (NH-44) पर स्थित है। घूमने के लिए अक्टूबर से मार्च सबसे अच्छा समय है। प्रवेश निशुल्क है और मानसरोवर झील में नौकायन उपलब्ध है।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Fort & Lake Timings', content: 'Talbehat Fort is open daily from sunrise to sunset (06:00 AM to 06:00 PM). Boating facilities on Mansarovar Lake typically operate from 09:00 AM until sunset.' },
    { title: 'Temple Etiquette', content: 'Remove footwear before stepping onto temple platforms (Narsingh Bhagwan and Hanumanji shrines). Dress modestly in accordance with rural Bundelkhand cultural customs.' },
    { title: 'Safety on Ramparts', content: 'Certain northern and outer sections of the fort are in ruins with unguarded drops. Supervise children closely and avoid climbing unstable stone walls or loose masonry.' },
    { title: 'Accessibility & Terrain', content: 'The fort approach involves climbing ancient stone stairs and uneven rocky paths. Sturdy walking shoes are recommended. Lakefront promenade is relatively flat and easier to navigate.' },
    { title: 'Emergency Contacts', content: 'Talbehat Police Station: 112 / +91-5176-222100 · Lalitpur District Hospital: +91-5176-272200 · UP Tourism Helpline: 1800-180-1414.' },
    { title: 'Connectivity & Highway Access', content: 'Located directly on 4-lane NH-44. Mobile network (Jio, Airtel) is strong throughout the fort and lake area. UPI payments are accepted at highway eateries and boating counters.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={talbehat} />
      <QuickFacts facts={talbehat.quickFacts} />
      <WhyVisit destination={talbehat} />
      <DestinationStory destination={talbehat} />
      <HistoryTimeline destination={talbehat} />
      <CultureGrid destination={talbehat} />
      <FoodSection destination={talbehat} />
      <AttractionsGrid destination={talbehat} />
      <HiddenGems destination={talbehat} />
      <ThingsToDo destination={talbehat} />
      <NearbyPlaces destination={talbehat} />
      <HowToReach destination={talbehat} />
      <WhereToStay destination={talbehat} />
      <BestTime destination={talbehat} />
      <BudgetGuide destination={talbehat} />
      <Itineraries destination={talbehat} />
      <LocalExperiences destination={talbehat} />
      <MapSection destination={talbehat} />
      <AskD360 destination={talbehat} />
      <CommunityStories destination={talbehat} />
      <PracticalInfo />
      <SourcesTrust destination={talbehat} />
      <Footer />
    </div>
  )
}
