...
const vijaygarh: Destination = {
  id: 'vijaygarh-fort-sonbhadra',
  slug: 'vijaygarh-fort-sonbhadra-kaimur',
  name: 'Vijaygarh Fort',
  localName: 'विजयगढ़ दुर्ग',
  destinationType: 'Historical Hill Fort & Prehistoric Cave Art',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Sonbhadra',
  established: { year: '5th c. CE / 1040 CE', by: 'Kol Kings & Maharaja Vijay Pal' },
  shortDescription: 'A crumbling hill-fort lost in the Kaimur jungle, where Gupta feudatories, medieval kings, prehistoric rock art, and Princess Chandrakanta left their trace.',
  tags: ['HILL_FORT', 'PREHISTORIC_CAVE_ART', 'GUPTA_INSCRIPTIONS', 'CHANDRAKANTA'],
  hero: {
  ...
  quickFacts: {
    ...
    budget: '₹',
    destinationType: 'Forest Hill Fort Ruin',
    difficulty: 'Moderate to Strenuous',
    distance: '~25 km from Robertsganj / 100 km Varanasi'
  },
  discoveryScore: {
    overall: 8.9,
    categories: [
  ...
  editorial: {
    why: 'Vijaygarh Fort in Sonbhadra combines Gupta-era stone inscriptions, prehistoric cave art depicting rhino hunts, 11th-century Rang Mahal ruins, and perennial ponds inside Kaimur jungle.',
    story: 'Rebuilt by Maharaja Vijay Pal in 1040 CE and later held by Sher Shah Suri and Raja Chait Singh, the fort inspired Devaki Nandan Khatri\'s famous 1888 fantasy novel Chandrakanta.',
    storyFull: 'Deep in the forested Kaimur hills of Sonbhadra sit the ruins of Vijaygarh Fort. Local tradition credits its earliest structure to the Kol kings of the 5th century, while red sandstone pillars bearing inscriptions naming Vishnuvardhan (a feudatory of Gupta emperor Samudragupta) anchor the site in India\'s classical past. Substantially rebuilt in 1040 CE by Maharaja Vijay Pal, it later passed to Chandela kings, Sher Shah Suri, and Raja Chait Singh of Benares. What remains is a wild archaeological landscape of prehistoric cave paintings, carved temple fragments, twin perennial tanks (Mira Sagar and Ram Sagar), and the ruined Rang Mahal palace.'
  },
  history: {
    shortIntro: 'Continuous occupation from prehistoric rock art era through Gupta, Chandela, Sur, and Benares State times.',
    timeline: [
      { year: 'Prehistoric Era', event: 'Rock shelter cave art painted depicting rhinoceros and elephant hunting scenes.', era: 'Prehistoric' },
      { year: '4th-5th c. CE', event: 'Gupta feudatory Vishnuvardhan installs carved red sandstone inscription pillars.', era: 'Gupta Era' },
      { year: '1040 CE', event: 'Substantially rebuilt by Jadon Rajput Maharaja Vijay Pal, giving the fort its modern name.', era: 'Rajput Era' },
      { year: '1781 CE', event: 'Raja Chait Singh of Benares defends the fort against Warren Hastings and British East India Company.', era: 'Anti-Colonial' },
      { year: '1888 CE', event: 'Devaki Nandan Khatri publishes Chandrakanta, setting its fictional world around Vijaygarh.', era: 'Literary History' }
    ]
  },
  culture: [
    { title: 'Rang Mahal & Chandrakanta Folklore', description: 'Palace ruins identified in local legend as the residence of Princess Chandrakanta.', image: '/images/rang_mahal.jpg' },
    { title: 'Urs of Hazrat Meeran Shah Baba', description: 'Annual April Sufi fair drawing multi-faith devotees to the fort gateway tomb.', image: '/images/sufi_tomb.jpg' },
    { title: 'Sonbhadra Tribal Heritage', description: 'Forest-dwelling Gond, Kol, Kharwar, and Agariya communities around Kaimur hills.', image: '/images/tribal_temple.jpg' }
  ],
  food: [
    { name: 'Vindhya Mahua Ladoos', description: 'Traditional sweet made from harvested mahua flowers, jaggery and roasted seeds.', category: 'Tribal Sweet', price: '₹40–₹80', image: '/images/mahua_laddoo.jpg' },
    { name: 'Rustic Highway Thali', description: 'Dal, roti, seasonal wild greens (chana/bathua saag) served at Robertsganj dhabas.', category: 'Local Thali', price: '₹70–₹130', image: '/images/highway_thali.jpg' }
  ],
  attractions: [
    { id: 'vijaygarh-ramparts', name: 'Fort Ramparts & Main Gateway', category: 'Fort Architecture', description: 'Massive sandstone outer walls and gateway housing the Sufi shrine.', duration: '1.5 hrs', distance: 'Summit', score: 9.2, image: '/images/fort_walls.jpg' },
    { id: 'rang-mahal-vijaygarh', name: 'Rang Mahal Ruins ("Chandrakanta Palace")', category: 'Palace Ruins', description: '11th-century palace wing with rock-cut elephant carvings between twin tanks.', duration: '1 hr', distance: 'Summit', score: 9.4, image: '/images/palace_ruins.jpg' },
    { id: 'cave-art-vijaygarh', name: 'Prehistoric Cave Art Rock Shelters', category: 'Prehistoric Art', description: 'Ancient cave paintings depicting hunting scenes with bows, rhinos and elephants.', duration: '45 mins', distance: 'Near Fort', score: 9.5, image: '/images/cave_art_rooms.jpg' }
  ],
  hiddenGems: [
    { name: 'Dhandhraul Dam', why: 'Serene forest lake offering picturesque views near the fort approach road.', distance: '10 km', duration: '1 hr', image: '/images/dhandhraul_dam.jpg' }
  ],
  thingsToDo: [
    { activity: 'Kaimur Jungle Hill Trek', duration: '2 hrs', cost: 'Free', difficulty: 'Moderate', bestTime: 'Morning', image: '/images/kaimur_view.jpg' },
    { activity: 'Chandrakanta Tilism Trail Exploration', duration: '1.5 hrs', cost: 'Free', difficulty: 'Moderate', bestTime: 'Afternoon', image: '/images/palace_ruins.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Salkhan Fossils Park', distance: '35 km', type: 'Prehistoric Fossils', travelTime: '50 mins', image: '/images/kaimur_view.jpg' },
    { name: 'Rihand Dam', distance: '60 km', type: 'Hydroelectric Reservoir', travelTime: '1.5 hrs', image: '/images/dhandhraul_dam.jpg' },
    { name: 'Robertsganj Town', distance: '25 km', type: 'District HQ', travelTime: '35 mins', image: '/images/fort_walls.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri Airport, Varanasi (VNS)', distance: '100 km', time: '2.5 hrs' },
    rail: { station: 'Robertsganj Railway Station (RBGJ)', distance: '25 km', time: '40 mins' },
    road: { highway: 'SH-5A Varanasi-Robertsganj highway & Churk-Mau Kalan road', distance: '100 km from Varanasi', time: '2.5 hrs drive' }
  },
  stay: {
    categories: [
      { type: 'Robertsganj Hotels', range: '₹1,000–₹2,500/night', options: ['Hotel Son Palace', 'Robertsganj Tourist Guest House'] },
      { type: 'Varanasi City Hotels', range: '₹2,000–₹6,000/night', options: ['Hotel Taj Ganges', 'Gateway Hotel Varanasi'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Backpacker Trekker', perDay: '₹800–₹1,500', breakdown: [{ category: 'Transport', amount: '₹300' }, { category: 'Food & Snacks', amount: '₹500' }] },
      { tier: 'Private Tour', perDay: '₹3,000–₹5,000', breakdown: [{ category: 'Private Car Hire', amount: '₹1,800' }, { category: 'Guide & Meals', amount: '₹1,200' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '7:30 AM', place: 'Drive from Varanasi / Robertsganj to Mau Kalan village', duration: '2 hrs', distance: '90 km' }, { time: '9:30 AM', place: 'Forest hill climb to Vijaygarh Fort Ramparts & Main Gate', duration: '1 hr', distance: 'Trek' }, { time: '10:30 AM', place: 'Explore Rang Mahal, Gupta Inscription Pillars & Prehistoric Cave Art', duration: '2 hrs', distance: 'Fort Summit' }, { time: '1:00 PM', place: 'Relax at Ram Sagar & Mira Sagar Tanks', duration: '45 mins', distance: 'Tanks' }, { time: '3:00 PM', place: 'Descend and proceed to Salkhan Fossils Park', duration: '2 hrs', distance: '35 km' }] }]
  },
  experiences: [
    { title: 'Chandrakanta Fantasy Trail & Kaimur Rock Art Trek', duration: '4 hrs', price: 'Free', category: 'Adventure & History', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=800&h=500&fit=crop&auto=format' }
  ],
  aiPrompts: [
    'How difficult is the hill climb to Vijaygarh Fort, and what should I pack?',
    'What is the real connection between Vijaygarh Fort and the novel Chandrakanta?',
    'Can you plan a 1-day Sonbhadra circuit covering Vijaygarh Fort and Salkhan Fossils Park?'
  ],
  reviews: [
    { name: 'Rajeshwar Singh', location: 'Mirzapur', text: 'An wild, unspoiled hill fort! Finding ancient cave art and Gupta inscriptions deep inside the Kaimur jungle was an unforgettable adventure.', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format', date: 'Jan 2026' }
  ],
  sources: {
    official: ['UP Tourism — Bundelkhand & Vindhya Circuit', 'District Administration of Sonbhadra'],
    historical: ['ASI Survey of Vijaygarh Fort', 'Live History India — Sonbhadra Heritage'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={vijaygarh} />
      <QuickFacts facts={vijaygarh.quickFacts} />
      <WhyVisit destination={vijaygarh} />
      <DestinationStory destination={vijaygarh} />
      <HistoryTimeline destination={vijaygarh} />
      <CultureGrid destination={vijaygarh} />
      <FoodSection destination={vijaygarh} />
      <AttractionsGrid destination={vijaygarh} />
      <HiddenGems destination={vijaygarh} />
      <ThingsToDo destination={vijaygarh} />
      <NearbyPlaces destination={vijaygarh} />
      <HowToReach destination={vijaygarh} />
      <WhereToStay destination={vijaygarh} />
      <BestTime destination={vijaygarh} />
      <BudgetGuide destination={vijaygarh} />
      <Itineraries destination={vijaygarh} />
      <LocalExperiences destination={vijaygarh} />
      <MapSection destination={vijaygarh} />
      <AskD360 destination={vijaygarh} />
      <CommunityStories destination={vijaygarh} />
      <PracticalInfo />
      <SourcesTrust destination={vijaygarh} />
      <Footer />
    </div>
  )
}
