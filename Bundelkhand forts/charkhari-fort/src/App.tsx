...
const charkhariFort: Destination = {
  id: 'charkhari-fort',
  slug: 'charkhari-fort-mahoba-uttar-pradesh',
  name: 'Charkhari Fort',
  localName: 'चरखारी / मङ्गलगढ़ दुर्ग (Kashmir of Bundelkhand)',
  destinationType: 'Heritage Fort Town / Former Princely State Capital',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Mahoba District',
  shortDescription: 'A forgotten Bundela kingdom of six lakes and one hilltop fort, where a princely dynasty\'s palaces still doze in granite silence.',
  tags: ['HERITAGE', 'LAKES', 'BUNDELA HISTORY'],
  hero: {
    image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?auto=format&fit=crop&q=80&w=2000',
    poster: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?auto=format&fit=crop&q=80&w=2000'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '4–6 Hours / 1–2 Days',
    budget: '₹ – ₹₹',
    destinationType: 'Heritage Fort Town',
    difficulty: 'Easy',
    distance: '~80 km from Khajuraho'
  },
  discoveryScore: {
    overall: 6.2,
    categories: [
      { name: 'Uniqueness / Authenticity', score: 8.0 },
      { name: 'Cultural Significance', score: 7.0 },
      { name: 'Historical Weight', score: 6.0 },
      { name: 'Crowd Level', score: 1.0 },
      { name: 'Popularity Index', score: 2.0 }
    ]
  },
  editorial: {
    why: 'Known as the "Kashmir of Bundelkhand," Charkhari offers an untouched princely townscape with six interconnected lakes, an ancient spiked gate with battle legends, and living royal heritage without commercialized crowds.',
    story: 'Founded in 1734 when Jagat Raj, son of Maharaja Chhatrasal, chased a chakhar deer onto Ranjit Hill and laid the foundation for Mangalgarh Fort. In 1765, Maharaja Bijai Bahadur Singh formally established Charkhari State, which remained an independent Bundela kingdom until its accession to India in 1947.',
    storyFull: 'Charkhari blends natural lake scenery with layered royal architecture. Surrounded by six artificial lakes—Vijay Sagar, Malkhan Sagar, Vanshi Sagar, Jai Sagar, Ratan Sagar, and Kothi Tal—the town served as a major regional water management and cultural hub. Today, its heritage spans the hilltop Mangalgarh Fort (Ministry of Defence), the Old Palace (Purana Mahal) with its spiked Deori Darwaza, the colonial Raobagh Palace, and restored boutique stays.'
  },
  history: {
    shortIntro: 'A storied 18th-century Bundela princely state forged through royal succession, British sanads, and 1857 siege lore.',
    timeline: [
      { year: '1731', event: 'Death of Maharaja Chhatrasal; domains partitioned, Jaitpur region given to Raja Jagat Raj.', era: 'Bundela Kingdom' },
      { year: '1734', event: 'Raja Jagat Raj pursues a chakhar deer on Ranjit Hill and establishes Mangalgarh Fort on a Tuesday.', era: 'Fort Foundation' },
      { year: '1765', event: 'Maharaja Bijai Bahadur Singh formally carves out independent Charkhari State from Jaitpur State.', era: 'Princely Era' },
      { year: '1804 & 1811', event: 'British East India Company issues confirmatory sanads recognizing Charkhari sovereignty under paramountcy.', era: 'Colonial Era' },
      { year: '1857', event: 'Tantia Tope besieges Charkhari during the uprising to capture British magistrate Mr. Carne taking refuge.', era: 'Freedom Struggle' },
      { year: 'Aug 1947', event: 'Maharaja Jayendra Singh Ju Deo signs the Instrument of Accession to merge state into India.', era: 'Post-Independence' }
    ]
  },
  culture: [
    {
      title: 'Six Lakes & Hydraulic Tradition',
      description: 'Built following Chandela-era water harvesting traditions, six interlinked lakes encircle the town with stone embankments (pals), ghats, and rock-cut islets.',
      image: 'https://images.unsplash.com/photo-1544834819-a88fe4c70ec0?auto=format&fit=crop&q=80&w=1000'
    },
    {
      title: 'Living Royal Lineage & Mini Vrindavan',
      description: 'Home to active royal descendants residing at Raobagh Palace and a vibrant cluster of historic temples including Maheshwari Mata Temple.',
  ...
  food: [
    {
      ...
      description: 'Baked and steamed wheat dumplings dipped in ghee, served with tangy tadka dal.',
    ...
    {
      name: 'Bara (बरा)',
      description: 'Split black-lentil dumplings soaked in spiced buttermilk, a traditional Bundelkhand delicacy.',
      category: 'Snack / Local',
      price: '₹40–₹80',
      image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&q=80&w=1000'
    },
    {
      name: 'Puri ke Laddoo (पूरी के लड्डू)',
      description: 'Festive sweet made from crushed fried chickpea-flour puris bound with ghee and jaggery.',
      category: 'Sweet',
      price: '₹100–₹200/kg',
      image: 'https://images.unsplash.com/photo-1599488615731-7e5c2823ff28?auto=format&fit=crop&q=80&w=1000'
    },
    {
      name: 'Bundeli Gosht Korma (बुंदेली गोश्त)',
      description: 'Richly spiced regional mutton preparation cooked in robust traditional spices.',
  ...
  attractions: [
    {
      id: 'mangalgarh-fort',
      name: 'Mangalgarh Fort (Charkhari Fort)',
      category: 'Historical / Landmark',
      description: 'The historic 1734 hilltop fort on Ranjit Hill. Under Ministry of Defence control (exterior viewable).',
      duration: '30 mins',
    ...
    {
      id: 'old-palace-purana-mahal',
      name: 'The Old Palace (Purana Mahal)',
      category: 'Historical / Architecture',
      description: 'Town-center royal residence with Diwan-e-Khas and Diwan-e-Aam halls, entered via the spiked Deori Darwaza.',
      duration: '1 hr',
      distance: 'Town Center',
      score: 8.8,
    ...
    {
      id: 'vijay-sagar-lake',
      name: 'Vijay Sagar & Lake Network',
      category: 'Nature / Scenic',
      description: 'One of Charkhari\'s six prominent lakes (Malkhan, Vanshi, Jai, Ratan, Kothi Tal) with scenic embankments.',
      duration: '1–2 hrs',
      distance: 'Town Perimeter',
      score: 8.2,
      image: 'https://images.unsplash.com/photo-1544834819-a88fe4c70ec0?auto=format&fit=crop&q=80&w=1000'
    },
    {
      ...
      description: 'Scenic reservoir 5 km from town, popular for winter birdwatching (migratory ducks) and sunset views.',
      duration: '1.5 hrs',
  ...
  hiddenGems: [
    {
      name: 'Deori Darwaza',
      why: 'Spiked iron entrance gate of the Old Palace featuring war-trophy history from Banda battlefield legends.',
      distance: 'Town Center',
      duration: '15 mins',
      image: 'https://images.unsplash.com/photo-1599707367072-cd6ada2bc375?auto=format&fit=crop&q=80&w=1000'
    },
    {
      name: 'The Old Bazaar Lanes',
      why: 'Atmospheric narrow market streets radiating from ancient town gates, reminiscent of a miniature Chandni Chowk.',
      distance: 'Town Center',
      duration: '45 mins',
  ...
  thingsToDo: [
    { activity: 'Six Lakes Circuit Walk', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning / Evening', image: 'https://images.unsplash.com/photo-1544834819-a88fe4c70ec0?auto=format&fit=crop&q=80&w=1000' },
    { activity: 'Migratory Birdwatching at Arjun Dam', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Winter Mornings', image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&q=80&w=1000' },
    { activity: 'Old Palace Heritage Exploration', duration: '1 hr', cost: 'Free / Local guide', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=1000' }
  ],
  nearbyPlaces: [
    { name: 'Mahoba Town (Chandela Lakes & Temples)', distance: '30 km', type: 'Historical & Archaeological', travelTime: '45 mins', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?auto=format&fit=crop&q=80&w=1000' },
    { name: 'Khajuraho UNESCO Temples', distance: '80 km', type: 'Heritage & Temple Architecture', travelTime: '1.5 hrs', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=1000' },
    { name: 'Jaitpur & Belasagar Lake', distance: '40 km', type: 'Princely Ruins & Scenic Water', travelTime: '50 mins', image: 'https://images.unsplash.com/photo-1544834819-a88fe4c70ec0?auto=format&fit=crop&q=80&w=1000' }
  ],
  travel: {
    air: { airport: 'Khajuraho Airport (HJR)', distance: '80 km', time: '~1.5–2 hrs by taxi' },
    rail: { station: 'Mahoba Junction (MBA) / Charkhari Road (8 km)', distance: '30 km (MBA)', time: 'Direct local bus/auto from Mahoba' },
    road: { highway: 'NH-76 / NH-34 Corridor', distance: '160 km from Jhansi', time: '~3 hrs by car' }
  },
  stay: {
    categories: [
      { type: 'Heritage Palace Hotel', range: '₹3,500–₹7,000/night', options: ['Fort Mangalgarh Palace (Restored boutique fort stay)', 'Raobagh Palace (Royal guest rooms)'] },
      { type: 'Mahoba Town Lodges', range: '₹800–₹2,200/night', options: ['Standard commercial hotels in Mahoba town center (30 km away)'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹800–₹1,500', breakdown: [{ category: 'Stay (Mahoba)', amount: '₹500–₹1,000' }, { category: 'Food', amount: '₹200–₹350' }, { category: 'Local Transit', amount: '₹100–₹150' }] },
      { tier: 'Moderate / Heritage', perDay: '₹2,500–₹5,000', breakdown: [{ category: 'Heritage Stay', amount: '₹2,000–₹3,800' }, { category: 'Food', amount: '₹350–₹700' }, { category: 'Private Cab', amount: '₹500–₹800' }] }
    ]
  },
  itineraries: {
    '1 Day Express': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Old Palace (Purana Mahal) & Deori Darwaza Spiked Gate', duration: '1.5 hrs' }, { time: '11:00 AM', place: 'Vijay Sagar & Ratan Sagar Lake Embankment Walk', duration: '1.5 hrs' }, { time: '01:00 PM', place: 'Traditional Bundeli Dal Bafla Lunch', duration: '1 hr' }, { time: '02:30 PM', place: 'Raobagh Palace & Maheshwari Mata Temple Visit', duration: '1.5 hrs' }, { time: '04:30 PM', place: 'Sunset and Birdwatching at Arjun Dam', duration: '2 hrs' }] }
    ],
    '2 Days Comprehensive': [
      { day: 1, schedule: [{ time: '10:00 AM', place: 'Check-in Fort Mangalgarh Palace & Hill Exploration', duration: '2 hrs' }, { time: '01:00 PM', place: 'Royal Cuisine Lunch at Heritage Palace', duration: '1 hr' }, { time: '02:30 PM', place: 'Purana Mahal, Diwan-e-Khas, and Old Bazaar Walk', duration: '2.5 hrs' }, { time: '05:30 PM', place: 'Sunset across Kothi Tal & Jai Sagar Lakes', duration: '1.5 hrs' }] },
      { day: 2, schedule: [{ time: '07:30 AM', place: 'Morning Birdwatching Circuit at Arjun Dam Reservoir', duration: '2.5 hrs' }, { time: '10:30 AM', place: 'Malkhan Sagar & Vanshi Sagar Lakes Circuit', duration: '1.5 hrs' }, { time: '01:00 PM', place: 'Excursion to Mahoba Chandela Lakes & Temples', duration: '3 hrs' }] }
    ]
  },
  experiences: [
    { title: 'Purana Mahal Guided Heritage Walk', duration: '1.5 hrs', price: 'Free / Local tip', category: 'Heritage Trail', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=1000' },
    { title: 'Arjun Dam Winter Birdwatching & Boating', duration: '2 hrs', price: '₹150–₹300', category: 'Nature & Wildlife', image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&q=80&w=1000' }
  ],
  aiPrompts: [
    "Why is Charkhari known as the 'Kashmir of Bundelkhand'?",
    "Can tourists visit Mangalgarh Fort inside Charkhari?",
    "How to plan a 1-day trip from Khajuraho to Charkhari and Mahoba?",
    "What is the history behind the spiked Deori Darwaza gate?"
  ],
  reviews: [
    { name: 'Vikramaditya Singh', location: 'Gwalior', text: 'Charkhari is an incredible untouched gem. Sitting by Vijay Sagar lake in the evening with Mangalgarh Fort rising above the hills feels like stepping back into the 18th century.', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=1000', date: 'February 2026' }
  ],
  sources: {
    official: ['District Administration Mahoba Portal (mahoba.nic.in)', 'UP Tourism Heritage Directory'],
    historical: ['Charkhari State Gazetteer & Imperial Gazetteer of India'],
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-2xl mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight">A Kingdom Built on Lakes & Granite</h2>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight">Taste of Bundelkhand</h2>
            <p className="text-d360-muted mt-2 text-sm">Traditional regional preparations and sweet specialties.</p>
          </div>
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', 'Historical', 'Nature', 'Wildlife']
    ...
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-10">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight mb-8">Key Landmarks & Lakes</h2>
    ...
    <section className="bg-d360-ink py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-white leading-tight">Secret Corners of Charkhari</h2>
          <p className="text-white/50 mt-2 text-sm">Spiked gates and historic market alleys forgotten by time.</p>
        </div>
            ...
            <div key={gem.name} className="group bg-d360-ink hover:bg-white/5 transition-colors">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-6">
                  <div>
                    <p className="text-white/30 text-[10px] font-mono tracking-widest mb-1">LOCATION</p>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about lakes, fort permissions, history, or local Bundeli cuisine.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('Kashmir') && `Charkhari earned the epithet "Kashmir of Bundelkhand" from British-era chroniclers and local poets due to its surprising landscape of six interconnected lakes surrounding a hill fort in the middle of the parched Bundelkhand plateau.`}
                  {selected?.includes('Mangalgarh Fort') && `The original 1734 hilltop fort of Mangalgarh is under Ministry of Defence control and closed to public access. However, visitors can stay at the restored Fort Mangalgarh Palace or view the fort from the town below.`}
                  {selected?.includes('spiked Deori Darwaza') && `The iron gate at the Old Palace features brass spikes meant to repel war elephants. According to local legend, it was brought as war booty after defeating the ruler of Banda.`}
                  {selected?.includes('Khajuraho') && `Charkhari is just 80 km (~1.5 hours) from Khajuraho via NH-76/NH-34, making it an ideal half-day or 1-day heritage detour combined with Mahoba.`}
                </div>
              </div>
            )}
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={charkhariFort} />
      <QuickFacts facts={charkhariFort.quickFacts} />
      <WhyVisit destination={charkhariFort} />
      <DestinationStory destination={charkhariFort} />
      <HistoryTimeline destination={charkhariFort} />
      <CultureGrid destination={charkhariFort} />
      <FoodSection destination={charkhariFort} />
      <AttractionsGrid destination={charkhariFort} />
      <HiddenGems destination={charkhariFort} />
      <ThingsToDo destination={charkhariFort} />
      <NearbyPlaces destination={charkhariFort} />
      <HowToReach destination={charkhariFort} />
      <WhereToStay destination={charkhariFort} />
      <BestTime destination={charkhariFort} />
      <BudgetGuide destination={charkhariFort} />
      <Itineraries destination={charkhariFort} />
      <LocalExperiences destination={charkhariFort} />
      <AskD360 destination={charkhariFort} />
      <CommunityStories destination={charkhariFort} />
      <SourcesTrust destination={charkhariFort} />
      <Footer />
    </div>
  )
}