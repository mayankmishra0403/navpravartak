...
const ahraura: Destination = {
  id: 'ahraura-mirzapur',
  slug: 'ahraura-minor-rock-edict-mirzapur',
  name: 'Ahraura Edicts',
  localName: 'अहरौरा शिलालेख',
  destinationType: 'Ancient Ashokan Rock Edict & Hill Temple',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Mirzapur',
  established: { year: 'circa 257 BCE', by: 'Emperor Ashoka the Great' },
  shortDescription: "A 2,300-year-old royal confession carved into a Vindhyan hilltop, where Emperor Ashoka records his spiritual conversion and pilgrimage following the Buddha's relic installation.",
  tags: ['ANCIENT_INSCRIPTION', 'ASHOKAN_EDICT', 'BUDDHIST_HERITAGE', 'PILGRIMAGE'],
  hero: {
  ...
  quickFacts: {
    ...
    budget: '₹',
    destinationType: 'Archaeological Rock Inscription',
    difficulty: 'Easy to Moderate',
    distance: '~44 km from Varanasi / 20 km Mirzapur'
  },
  discoveryScore: {
    overall: 9.3,
    categories: [
      { name: 'Uniqueness', score: 9.5 },
      { name: 'Historical Significance', score: 10.0 },
      { name: 'Cultural Value', score: 9.0 },
      { name: 'Crowd Level', score: 9.8 },
      { name: 'Local Experience', score: 8.5 }
    ]
  },
  editorial: {
    why: 'Ahraura is home to Minor Rock Edict I of Emperor Ashoka—one of only 18 in the world—engraved in Brahmi script around 257 BCE. It uniquely records that Ashoka began his pilgrimage immediately after the Buddha\'s relics were enshrined on a stupa platform.',
    story: 'Discovered in 1961 by epigraphist R.G. Pandeya and translated by D.C. Sircar, the Ahraura Edict stands on a hilltop beside the living Bhandari Devi Hindu shrine.',
    storyFull: 'On a modest, temple-topped hill above the small Mirzapur town of Ahraura sits one of the rarest survivals of ancient Indian history: a boulder of dark red sandstone carrying the personal, first-person testimony of Emperor Ashoka the Great, inscribed roughly 2,300 years ago in the Brahmi script. In it, Ashoka admits that he was not especially devoted during his first year as a lay Buddhist (upasaka), and describes drawing closer to the Sangha only afterward. The Ahraura version carries a detail found nowhere else among all eighteen copies: it explicitly states that Ashoka\'s pilgrimage tour began immediately after the installation of the relics of the Buddha on a platform (stupa).'
  },
  history: {
    shortIntro: 'Mauryan imperial inscription carved ~257 BCE, rediscovered in 1961 beside Bhandari Devi temple.',
    timeline: [
      { year: '257 BCE', event: 'Emperor Ashoka commissions Minor Rock Edict I on a red sandstone boulder during his 11th regnal year.', era: 'Mauryan Era' },
      { year: 'Post-Mauryan', event: 'Buddhist monastic almonry (bhandara) recedes; hilltop is absorbed into Bhandari Devi Hindu shrine.', era: 'Medieval Era' },
      { year: '1961 CE', event: 'Inscription is discovered by epigraphist R.G. Pandeya and published by D.C. Sircar.', era: 'Modern Archaeology' },
      { year: 'Present Day', event: 'Protected as an in-situ national archaeological treasure by ASI.', era: 'Protected Monument' }
    ]
  },
  culture: [
    { title: 'Bhandari Devi Hill Shrine', description: 'Hilltop shrine linked to Mahabharata legend and historic Buddhist food almonry (bhandara).', image: '/images/bhandari_temple.jpg' },
    { title: 'Triennial Palanquin Festival', description: 'Unique regional tradition where the goddess idol is carried in palanquin to Shiv Pahar.', image: '/images/palanquin.jpg' },
    { title: 'Mirzapur Craft Traditions', description: 'Wider Mirzapur region celebrated for hand-knotted wool carpets and brassware utensils.', image: '/images/crafts.jpg' }
  ],
  food: [
    { name: 'Eastern UP Dal Sabzi Roti', description: 'Simple, wholesome regional thali meal served with seasonal Vindhya vegetables.', category: 'Local Meal', price: '₹60–₹120', image: '/images/dal_roti.jpg' },
    { name: 'Mirzapur Betel Leaf (Paan)', description: 'Famous regional digestive paan prepared with sweet aromatic spices.', category: 'Specialty', price: '₹15–₹30', image: '/images/paan.jpg' }
  ],
  attractions: [
    { id: 'ahraura-edict', name: 'Ahraura Minor Rock Edict I', category: 'Mauryan Archaeology', description: '3rd-century BCE Brahmi inscription of Emperor Ashoka on a natural red sandstone boulder.', duration: '45 mins', distance: '4 km from town', score: 9.8, image: '/images/edict_rock.jpg' },
    { id: 'bhandari-devi', name: 'Bhandari Devi Temple', category: 'Spiritual Shrine', description: 'Hilltop Hindu temple standing steps away from the Ashokan edict.', duration: '45 mins', distance: 'Hilltop', score: 9.0, image: '/images/bhandari_temple.jpg' },
    { id: 'durga-devi-ahraura', name: 'Durga Devi Temple', category: 'Scenic Shrine', description: 'Southern hill shrine with panoramic views of Ahraura market town.', duration: '40 mins', distance: '2 km', score: 8.5, image: '/images/durga_devi.jpg' }
  ],
  hiddenGems: [
    { name: 'Chunar Fort Ganga Excursion', why: 'Massive historic Ganga fortress linked to Sher Shah Suri and Mughals, 25 km from Ahraura.', distance: '25 km', duration: '2 hrs', image: '/images/chunar_fort.jpg' }
  ],
  thingsToDo: [
    { activity: 'Brahmi Inscription Deciphering & Hill Walk', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: '/images/edict_rock.jpg' },
    { activity: 'Bhandari Devi Sunset View Point', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: 'Sunset', image: '/images/bhandari_temple.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Chunar Fort', distance: '25 km', type: 'Historical Hill Fort', travelTime: '40 mins', image: '/images/chunar_fort.jpg' },
    { name: 'Vindhyachal Shakti Peeth', distance: '35 km', type: 'Pilgrimage Complex', travelTime: '50 mins', image: '/images/vindhyachal.jpg' },
    { name: 'Varanasi Ghats & Sarnath', distance: '44 km', type: 'UNESCO Cultural Hub', travelTime: '1 hr', image: '/images/vns.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri Airport, Varanasi (VNS)', distance: '60 km', time: '1.5 hrs' },
    rail: { station: 'Ahraura Road / Mirzapur Railway Station', distance: '4 km / 20 km', time: '20-30 mins' },
    road: { highway: 'Mirzapur-Vijaypur road & SH-5A Varanasi corridor', distance: '44 km from Varanasi', time: '1 hr drive' }
  },
  stay: {
    categories: [
      { type: 'Mirzapur City Stays', range: '₹1,200–₹2,800/night', options: ['Hotel Janhavi International', 'Mirzapur Tourist Lodge'] },
      { type: 'Varanasi Heritage Hotels', range: '₹2,500–₹7,000/night', options: ['BrijRama Palace', 'Ganga View Stays'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Day Trip', perDay: '₹600–₹1,200', breakdown: [{ category: 'Local Transport', amount: '₹250' }, { category: 'Food & Tea', amount: '₹350' }] },
      { tier: 'Comfort Tour', perDay: '₹2,500–₹4,000', breakdown: [{ category: 'Private Taxi', amount: '₹1,500' }, { category: 'Stay & Meals', amount: '₹1,500' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Drive from Varanasi / Mirzapur to Ahraura', duration: '1 hr', distance: '44 km' }, { time: '9:30 AM', place: 'Ascend Bhandari Devi Hill & Inspect Ashokan Minor Rock Edict I', duration: '1.5 hrs', distance: 'Hilltop' }, { time: '11:30 AM', place: 'Visit Durga Devi Temple & Ahraura Bazaar', duration: '1 hr', distance: '2 km' }, { time: '1:00 PM', place: 'Lunch at Mirzapur / Chunar Dhabas', duration: '1 hr', distance: '20 km' }, { time: '2:30 PM', place: 'Explore Chunar Fort above the Ganga', duration: '2.5 hrs', distance: '25 km' }] }]
  },
  experiences: [
    { title: 'Mauryan Epigraphy & Ancient Brahmi Inscription Walk', duration: '2 hrs', price: 'Free', category: 'Heritage', image: '/images/edict_rock.jpg' }
  ],
  aiPrompts: [
    "What exactly does Ashoka's Minor Rock Edict I at Ahraura say?",
    'Why is the Ahraura version of this Ashokan edict unique among all 18 copies?',
    'How do I reach Ahraura Edict from Varanasi or Mirzapur?'
  ],
  reviews: [
    { name: 'Dr. Anandvardhan Sharma', location: 'Varanasi', text: 'Standing next to an inscription carved 2,300 years ago by Emperor Ashoka himself on a quiet Vindhyan hill is a profound spiritual and historical experience.', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format', date: 'Feb 2026' }
  ],
  sources: {
    official: ['ASI Sarnath Circle — Protected Monuments', 'District Administration of Mirzapur'],
    historical: ['D.C. Sircar Translation of Ahraura Minor Rock Edict I', 'Epigraphia Indica Vol XXXVI'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={ahraura} />
      <QuickFacts facts={ahraura.quickFacts} />
      <WhyVisit destination={ahraura} />
      <DestinationStory destination={ahraura} />
      <HistoryTimeline destination={ahraura} />
      <CultureGrid destination={ahraura} />
      <FoodSection destination={ahraura} />
      <AttractionsGrid destination={ahraura} />
      <HiddenGems destination={ahraura} />
      <ThingsToDo destination={ahraura} />
      <NearbyPlaces destination={ahraura} />
      <HowToReach destination={ahraura} />
      <WhereToStay destination={ahraura} />
      <BestTime destination={ahraura} />
      <BudgetGuide destination={ahraura} />
      <Itineraries destination={ahraura} />
      <LocalExperiences destination={ahraura} />
      <MapSection destination={ahraura} />
      <AskD360 destination={ahraura} />
      <CommunityStories destination={ahraura} />
      <PracticalInfo />
      <SourcesTrust destination={ahraura} />
      <Footer />
    </div>
  )
}
