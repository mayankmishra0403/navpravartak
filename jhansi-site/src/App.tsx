...
const jhansi: Destination = {
  id: 'jhansi', slug: 'jhansi-uttar-pradesh', name: 'Jhansi', localName: 'झाँसी',
  destinationType: 'Gateway to Bundelkhand & Historic Fort City', country: 'India', state: 'Uttar Pradesh', district: 'Jhansi',
  established: { year: '1613 CE', by: 'Raja Bir Singh Deo (Bundela Ruler)' },
  shortDescription: 'The invincible gateway to Bundelkhand, immortalized by the supreme valor of Rani Lakshmibai during the First War of Independence in 1857.',
  tags: ['HERITAGE', 'HISTORICAL', 'RANI_LAKSHMIBAI', 'FORTRESS'],
  hero: {
  ...
  quickFacts: {
    ...
    destinationType: 'Historic Fort & Heritage City', difficulty: 'Easy', distance: '~300 km from Lucknow / 100 km Gwalior'
  },
  discoveryScore: {
    overall: 9.3,
    categories: [
      { name: 'Uniqueness', score: 9.4 },
      { name: 'Historical Significance', score: 9.8 },
  ...
  editorial: {
    why: 'Jhansi is the beating heart of Indian independence history. Dominated by the majestic 17th-century Jhansi Fort atop Bangira Hill and Rani Mahal, it stands as an eternal tribute to Rani Lakshmibai\'s heroism.',
    story: 'Built in 1613 CE by Orchha ruler Raja Bir Singh Deo, Jhansi grew into a powerful Maratha kingdom state before becoming the legendary center of resistance during the 1857 Rebellion.',
    storyFull: 'Perched atop Bangira Hill, Jhansi Fort\'s 20-foot-thick granite walls witnessed fierce battles in 1858 when Rani Lakshmibai fought British forces led by General Hugh Rose. The Rani\'s daring leap on horseback with her son strapped to her back remains one of India\'s most iconic historical moments. Nearby Rani Mahal displays exquisite Maratha frescoes, while medieval Orchha (25 km away) adds majestic palaces and Betwa river chhatris to the circuit.'
  },
  history: {
    shortIntro: 'Capital of Bundela and Maratha rulers, immortalized by Rani Lakshmibai during the 1857 Independence Movement.',
    timeline: [
      { year: '1613 CE', event: 'Orchha ruler Raja Bir Singh Deo constructs Jhansi Fort atop Bangira Hill', era: 'Bundela Foundation' },
      { year: '1734 CE', event: 'Peshwa Baji Rao receives Jhansi region from Maharaja Chhatrasal, starting Maratha rule', era: 'Maratha Dynasty' },
      { year: '1857 CE', event: 'Rani Lakshmibai leads heroic resistance against British siege during 1857 War of Independence', era: '1857 Rebellion' },
      { year: 'Modern Era', event: 'Jhansi develops into Bundelkhand\'s premier commercial, railway, and cultural hub', era: 'Modern Era' }
    ]
  },
  culture: [
    { title: 'Jhansi Fort & Bangira Hill Ramparts', description: 'Massive 15-acre hill fortress featuring Shiva Temple, ancient cannons, execution tower, and sound & light show.', image: '/images/jhansi_fort.jpg' },
    { title: 'Rani Mahal Maratha Frescoes', description: '18th-century palace of Rani Lakshmibai showcasing intricate Maratha wall paintings, royal court halls, and weapons museum.', image: '/images/sangam.jpg' },
    { title: 'Medieval Orchha Palaces (25 km)', description: 'Stunning 16th-century capital of Orchha Kingdom featuring Jahangir Mahal, Ram Raja Temple, and Betwa cenotaphs.', image: '/images/kalpavriksha.jpg' },
    { title: 'Bundeli Freedom Heritage & Cuisine', description: 'Rich martial traditions, Alha-Udal folklore ballads, and delicious regional dishes like Baati Chokha and Bhutte ka Kees.', image: '/images/baati_chokha.jpg' }
  ],
  food: [
    { name: 'Bundeli Baati Chokha', description: 'Sattu-stuffed wheat balls roasted over live charcoal coals, served with ghee, mashed eggplant chokha, and garlic chutney.', category: 'Main Course', price: '₹90–₹170', image: '/images/baati_chokha.jpg' },
    { name: 'Crispy Kachori Sabzi', description: 'Classic Jhansi breakfast featuring golden dal-stuffed kachoris served with spicy aloo gravy and fried green chilies.', category: 'Breakfast', price: '₹40–₹80', image: '/images/maheri.jpg' },
    { name: 'Savory Bhutte Ka Kees', description: 'Grated fresh sweet corn cooked with milk, mustard seeds, green chilies, and aromatic Bundeli spices.', category: 'Snack', price: '₹50–₹90', image: '/images/bhutte_kees.jpg' },
    { name: 'Rich Kulfi Falooda', description: 'Dense, creamy cardamom kulfi served over silky vermicelli falooda noodles and fragrant rose syrup.', category: 'Dessert', price: '₹60–₹100', image: '/images/hamirpur_peda.jpg' }
  ],
  attractions: [
    { id: 'jhansi-fort', name: 'Jhansi Fort (झाँसी का किला)', category: 'Heritage', description: 'Imposing 17th-century hill fort built by Raja Bir Singh Deo, featuring 20-ft walls, Shiv temple, and 1857 war memorial.', duration: '2.5 hrs', distance: 'City center', score: 9.8, image: '/images/jhansi_fort.jpg' },
    { id: 'rani-mahal', name: 'Rani Mahal (रानी महल)', category: 'History', description: 'Exquisite 18th-century Maratha palace of Rani Lakshmibai, housing colorful ceiling murals and archaeological artifacts.', duration: '1.5 hrs', distance: '1 km from Fort', score: 9.4, image: '/images/kalpavriksha.jpg' },
    { id: 'orchha-town', name: 'Orchha Medieval Town (25 km)', category: 'Heritage', description: 'Frozen-in-time medieval capital featuring Jahangir Mahal, Ram Raja Temple, and 14 royal Betwa chhatris.', duration: '4 hrs', distance: '25 km from Jhansi', score: 9.7, image: '/images/kalpavriksha.jpg' },
    { id: 'government-museum', name: 'Government Museum Jhansi', category: 'Culture', description: 'One of UP\'s oldest museums, displaying Chandela stone sculptures, 1857 weapons, and Bundeli miniature art.', duration: '1.5 hrs', distance: 'Sadar Bazaar', score: 9.0, image: '/images/brahmadev.jpg' }
  ],
  hiddenGems: [
    { name: 'St. Jude\'s Shrine', why: 'Famous 19th-century Catholic pilgrimage site with Gothic stained glass windows and serene gardens.', distance: 'Civil Lines', duration: '1 hr', image: '/images/sangam.jpg' },
    { name: 'Parichha Dam & Reservoir', why: 'Scenic dam on Betwa River surrounded by rocky hills, ideal for birdwatching, boating, and sunset views.', distance: '25 km from Jhansi', duration: '2 hrs', image: '/images/parichha_dam.jpg' }
  ],
  thingsToDo: [
    { activity: 'Jhansi Fort Sound & Light Show', duration: '1 hr', cost: '₹100', difficulty: 'Easy', bestTime: 'Evening (7:00 PM)', image: '/images/jhansi_fort.jpg' },
    { activity: 'Orchha Jahangir Mahal & Betwa Chhatris Tour', duration: '4 hrs', cost: '₹200', difficulty: 'Easy', bestTime: 'Morning', image: '/images/kalpavriksha.jpg' },
    { activity: 'Rani Mahal & Government Museum Heritage Walk', duration: '2.5 hrs', cost: '₹50', difficulty: 'Easy', bestTime: 'Afternoon', image: '/images/sangam.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Orchha Medieval Heritage Town', distance: '25 km', type: 'UNESCO Nominated Capital', travelTime: '30 mins', image: '/images/kalpavriksha.jpg' },
    { name: 'Gwalior Fort & Palaces', distance: '100 km', type: 'Royal Heritage City', travelTime: '1.8 hrs', image: '/images/hero.jpg' },
    { name: 'Datia Pitambara Peeth Temple', distance: '30 km', type: 'Shakti Peeth Temple', travelTime: '40 mins', image: '/images/sangam.jpg' },
    { name: 'Khajuraho UNESCO Temples', distance: '170 km', type: 'World Heritage Site', travelTime: '3.5 hrs', image: '/images/sangam.jpg' }
  ],
  travel: {
    air: { airport: 'Gwalior Airport (GWL) / Rajmata Vijaya Raje Scindia Airport', distance: '100 km away', time: '1.8 hrs drive via NH44 highway' },
    rail: { station: 'Virangana Lakshmibai Jhansi Junction (VGLJ)', distance: '2 km from city center', time: 'Major railway junction on North-South corridor' },
    road: { highway: 'Connected via NH44 (North-South Corridor) and NH27 to Gwalior, Kanpur, and Delhi', distance: '100 km Gwalior / 300 km Lucknow', time: 'Direct highway access' }
  },
  stay: {
    categories: [
      { type: 'Heritage & Luxury Hotels', range: '₹3,500 – ₹8,000 / night', options: ['Orchha Palace Hotel & Convention Centre', 'Jhansi Heritage Resorts'] },
      { type: 'Mid-Range Hotels', range: '₹1,800 – ₹3,500 / night', options: ['Jhansi Station Road Hotels', 'Sadar Bazaar Guest Houses'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Backpacker', perDay: '₹1,200 / day', breakdown: [{ category: 'Fort & Museum Entry', amount: '₹150' }, { category: 'Local Auto-Rickshaw', amount: '₹350' }, { category: 'Dhaba Meals & Kachori', amount: '₹700' }] },
      { tier: 'Mid-Range Traveler', perDay: '₹3,500 / day', breakdown: [{ category: 'Private Car Rental', amount: '₹1,800' }, { category: 'Hotel Stay', amount: '₹1,000' }, { category: 'Food & Sound Show', amount: '₹700' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:30 AM', place: 'Breakfast — Kachori Sabzi at Sadar Bazaar', duration: '45 min', distance: 'Sadar Bazaar' }, { time: '9:30 AM', place: 'Jhansi Fort Guided Tour & Ramparts', duration: '2.5 hrs', distance: 'Bangira Hill' }, { time: '12:30 PM', place: 'Rani Mahal Maratha Murals & Government Museum', duration: '2 hrs', distance: '1 km' }, { time: '3:00 PM', place: 'Drive to Orchha — Jahangir Mahal & Betwa Chhatris', duration: '3.5 hrs', distance: '25 km' }, { time: '7:00 PM', place: 'Jhansi Fort Evening Sound & Light Show', duration: '1 hr', distance: 'Jhansi' }] }],
    '2 Days': [{ day: 1, schedule: [{ time: '9:00 AM', place: 'Jhansi Fort & Shiv Temple Exploration', duration: '3 hrs', distance: 'Jhansi' }, { time: '1:00 PM', place: 'Lunch — Baati Chokha at Heritage Restaurant', duration: '1 hr', distance: 'Civil Lines' }, { time: '2:30 PM', place: 'Rani Mahal & Government Museum Tour', duration: '2.5 hrs', distance: 'City center' }, { time: '5:30 PM', place: "St. Jude's Shrine & Sadar Bazaar Shopping", duration: '2 hrs', distance: 'Civil Lines' }] }, { day: 2, schedule: [{ time: '8:30 AM', place: 'Excursion to Orchha — Jahangir Mahal, Raj Mahal & Ram Raja Temple', duration: '4 hrs', distance: '25 km' }, { time: '2:00 PM', place: 'Parichha Dam Betwa Reservoir Sunset Boating', duration: '3 hrs', distance: '25 km' }] }]
  },
  experiences: [
    { title: 'Jhansi Fort & Rani Lakshmibai 1857 Freedom Trail', duration: '4 hrs', price: '₹400', category: 'Heritage', image: '/images/jhansi_fort.jpg' }
  ],
  aiPrompts: [
    'What is the history of Jhansi Fort during the 1857 Indian Rebellion?',
    'What are the main places to visit in Orchha near Jhansi?',
    'Where can I get authentic Bundeli Baati Chokha in Jhansi?'
  ],
  reviews: [
    { name: 'Vikramaditya Singh', location: 'Gwalior', text: 'Jhansi Fort and Rani Mahal give chills! The story of Rani Lakshmibai comes alive on every rampart.', rating: 5, image: '/images/sangam.jpg', date: 'Jan 2026' }
  ],
  sources: {
    official: ['UP Tourism — Bundelkhand Circuit', 'District Administration of Jhansi'],
    historical: ['ASI Survey of Jhansi Fort', 'Historical Records of 1857 Rebellion'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={jhansi} />
      <QuickFacts facts={jhansi.quickFacts} />
      <WhyVisit destination={jhansi} />
      <DestinationStory destination={jhansi} />
      <HistoryTimeline destination={jhansi} />
      <CultureGrid destination={jhansi} />
      <FoodSection destination={jhansi} />
      <AttractionsGrid destination={jhansi} />
      <HiddenGems destination={jhansi} />
      <ThingsToDo destination={jhansi} />
      <NearbyPlaces destination={jhansi} />
      <HowToReach destination={jhansi} />
      <WhereToStay destination={jhansi} />
      <BestTime destination={jhansi} />
      <BudgetGuide destination={jhansi} />
      <Itineraries destination={jhansi} />
      <LocalExperiences destination={jhansi} />
      <MapSection destination={jhansi} />
      <AskD360 destination={jhansi} />
      <CommunityStories destination={jhansi} />
      <PracticalInfo />
      <SourcesTrust destination={jhansi} />
      <Footer />
    </div>
  )
}
