...
const kaimoor: Destination = {
  id: 'kaimoor-wls', slug: 'kaimoor-wildlife-sanctuary-uttar-pradesh', name: 'Kaimoor Wildlife Sanctuary', localName: 'कैमूर वन्यजीव अभ्यारण्य',
  destinationType: 'Nature & Wildlife Reserve, Historical Cave Art Site', country: 'India', state: 'Uttar Pradesh', district: 'Mirzapur & Sonbhadra',
  established: { year: '1982 CE', by: 'Forest Department of Uttar Pradesh' },
  shortDescription: 'Spanning over 500 square kilometers along the scenic Kaimur hills, a pristine blend of rich biodiversity, 4,000-year-old Lakhania rock paintings, and roaring waterfalls.',
  tags: ['WILDLIFE', 'PREHISTORIC_ART', 'WATERFALLS', 'UNDERRATED_GEM'],
  hero: {
    image: '/assets/kaimur_plateau_landscape.png',
    poster: '/assets/kaimur_plateau_landscape.png'
  },
  quickFacts: {
    bestTime: 'Oct – Mar', duration: '1 to 2 days', budget: '₹1,500 - ₹3,000/day',
    destinationType: 'Nature & Wildlife Reserve', difficulty: 'Moderate', distance: '~100 km from Varanasi / 3 km Robertsganj'
  },
  discoveryScore: {
    overall: 8.1,
    categories: [
      { name: 'Uniqueness', score: 8.0 },
      { name: 'Historical Significance', score: 9.0 },
      { name: 'Cultural Value', score: 8.0 },
      { name: 'Crowd Level', score: 4.0 },
      { name: 'Local Experience', score: 8.5 }
    ]
  },
  editorial: {
    why: 'Spanning over 500 square kilometers along the scenic Kaimur hills, the Kaimoor Wildlife Sanctuary is a pristine blend of rich biodiversity, ancient history, and dramatic natural topography.',
    story: 'Located strategically on the border of Uttar Pradesh and Bihar, it serves as a sprawling haven for wildlife including leopards, blackbucks, chinkaras, and over 70 bird species.',
    storyFull: 'Beyond its fauna, the sanctuary reveals deep archaeological secrets—most notably the 4,000-year-old Lakhania rock paintings that depict the daily lives, hunts, and rituals of prehistoric civilizations. Characterized by a mosaic of tropical dry deciduous forests, swampy marshes, and striking waterfalls like Karkat and Telhar, the sanctuary is an off-the-beaten-path destination that appeals equally to nature lovers and history buffs.'
  },
  history: {
    shortIntro: 'Established officially in 1982 to protect Kaimur Range biodiversity, preserving 4,000-year-old prehistoric terracotta cave paintings.',
    timeline: [
      { year: '2000 BCE', event: 'Lakhania rock shelters painted in natural terracotta depicting hunting scenes, cattle grazing, bee-keeping, and warfare', era: 'Prehistoric Era' },
      { year: '1540 CE', event: 'Region historically linked to Sher Shah Suri; nearby Vijaygarh Fort fortified along the trade and army routes', era: 'Suri Dynasty Era' },
      { year: '1982 CE', event: 'Officially declared Kaimoor Wildlife Sanctuary by Government of UP covering over 500 sq km', era: 'Sanctuary Foundation' },
      { year: 'Modern Era', event: 'Kaimur Recovery Project initiated by Wildlife Trust of India for blackbuck protection and habitat recovery', era: 'Conservation Age' }
    ]
  },
  culture: [
    { title: '4,000-Year-Old Lakhania Rock Art', description: 'Prehistoric cave shelters housing natural terracotta rock art depicting ancient hunting scenes, cattle grazing, and bee-keeping.', image: '/assets/lakhania_rock_paintings.png' },
    { title: 'Indigenous Tribal Heritage', description: 'Tribal villages preserving traditional floor art designs similar to 4,000-year-old cave motifs during local festivals.', image: '/assets/lakhania_rock_paintings.png' },
    { title: 'Kaimur Wildlife & Blackbuck Haven', description: 'Sprawling dry deciduous sanctuary harboring blackbucks, chinkara, nilgai, and elusive leopards of the Vindhyan range.', image: '/assets/blackbuck.png' },
    { title: 'Echo Valley & Forest Shrines', description: 'Acoustic natural bowl creating distinct echo reverberations and small forest shrines dedicated to local deities.', image: '/assets/kaimur_plateau_landscape.png' }
  ],
  food: [
    { name: 'Litti Chokha', description: 'Staple UP-Bihari border cuisine: roasted wheat balls stuffed with sattu, served with mashed eggplant and potatoes.', category: 'Signature Dish', price: '₹80–₹150', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=500&h=360&fit=crop&auto=format' },
    { name: 'Dal Pitha', description: 'Steamed rice flour dumplings filled with spiced chana dal mixture, steamed fresh for breakfast.', category: 'Snack / Meal', price: '₹40–₹80', image: 'https://images.unsplash.com/photo-1552912470-ee2e96439539?w=500&h=360&fit=crop&auto=format' },
    { name: 'North Indian Thali', description: 'Rustic highway dhaba thali featuring seasonal forest vegetables, dal tadka, fresh tandoori rotis, and steamed rice.', category: 'Main Course', price: '₹100–₹180', image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=500&h=360&fit=crop&auto=format' },
    { name: 'Mahua Delicacies & Wild Jamun', description: 'Mahua-based local delicacies and seasonal forest fruits like Jamun collected by local tribal harvesters.', category: 'Specialty / Dessert', price: '₹30–₹70', image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=360&fit=crop&auto=format' }
  ],
  attractions: [
    { id: 'lakhania-dari', name: 'Lakhania Dari & Caves', category: 'Heritage', description: 'Rock shelters housing 4,000-year-old terracotta paintings alongside a seasonal waterfall.', duration: '2-3 hours', distance: 'Inside Sanctuary', score: 9.5, image: '/assets/lakhania_rock_paintings.png' },
    { id: 'telhar-waterfall', name: 'Telhar Waterfall', category: 'Nature', description: 'A spectacular waterfall plunging deep into a valley, best viewed post-monsoon.', duration: '1-2 hours', distance: 'Sanctuary Core', score: 9.2, image: '/assets/kaimur_plateau_landscape.png' },
    { id: 'echo-valley', name: 'Echo Valley', category: 'Hidden Gems', description: 'A natural topographical bowl where acoustic phenomena create distinct echoes.', duration: '1 hour', distance: 'Sanctuary Trail', score: 8.7, image: '/assets/kaimur_plateau_landscape.png' },
    { id: 'anupam-lake', name: 'Anupam Lake', category: 'Nature', description: 'A serene lake attracting numerous migratory birds during the winter months.', duration: '1 hour', distance: 'Core Forest', score: 8.5, image: '/assets/blackbuck.png' },
    { id: 'karkat-waterfall', name: 'Karkat Waterfall', category: 'Nature', description: 'Another scenic waterfall located within the sanctuary valley region.', duration: '1-2 hours', distance: 'Kaimur Range', score: 8.8, image: '/assets/kaimur_plateau_landscape.png' }
  ],
  hiddenGems: [
    { name: 'Echo Valley', why: 'Natural topographical bowl with unique acoustic echo reverberations.', distance: 'Inside Sanctuary', duration: '1 hour', image: '/assets/kaimur_plateau_landscape.png' },
    { name: 'Vijaygarh Fort Ruins', why: 'Ruined medieval hill fort in Sonbhadra known for cave paintings.', distance: '25 km from sanctuary', duration: '2 hours', image: '/assets/kaimur_plateau_landscape.png' },
    { name: 'Churk Forest Rest House', why: 'Quiet forest rest house location managed by UP Forest Department.', distance: '10 km from Robertsganj', duration: '1 hour', image: '/assets/blackbuck.png' }
  ],
  thingsToDo: [
    { activity: 'Lakhania Rock Art Hikes', duration: '3 hours', cost: '₹30 Entry Fee', difficulty: 'Moderate', bestTime: 'Morning (8:00 AM)', image: '/assets/lakhania_rock_paintings.png' },
    { activity: 'Wildlife Safari Drive', duration: '3 hours', cost: '₹1,000–₹1,500 (Jeep)', difficulty: 'Easy', bestTime: '7:00 AM / 4:00 PM', image: '/assets/blackbuck.png' },
    { activity: 'Telhar Waterfall Nature Trail', duration: '2 hours', cost: 'Free', difficulty: 'Moderate', bestTime: 'Post-Monsoon Afternoon', image: '/assets/kaimur_plateau_landscape.png' },
    { activity: 'Echo Valley Acoustic Tour', duration: '1 hour', cost: 'Free', difficulty: 'Easy', bestTime: 'Anytime', image: '/assets/kaimur_plateau_landscape.png' },
    { activity: 'Anupam Lake Birdwatching', duration: '1.5 hours', cost: 'Free', difficulty: 'Easy', bestTime: 'Early Morning', image: '/assets/blackbuck.png' }
  ],
  nearbyPlaces: [
    { name: 'Robertsganj', distance: '5 km', type: 'Nearest town, basic transit hub', travelTime: '15 mins', image: '/assets/kaimur_plateau_landscape.png' },
    { name: 'Churk', distance: '10 km', type: 'Forest Rest House location', travelTime: '20 mins', image: '/assets/blackbuck.png' },
    { name: 'Vijaygarh Fort', distance: '25 km', type: 'Historical ruined fort in Sonbhadra', travelTime: '45 mins', image: '/assets/lakhania_rock_paintings.png' },
    { name: 'Wyndham Falls & Chunar Fort', distance: '50 km', type: 'Historic fort on banks of Ganges & waterfall', travelTime: '1.2 hrs', image: '/assets/kaimur_plateau_landscape.png' },
    { name: 'Varanasi', distance: '100 km', type: 'Major cultural hub & airport', travelTime: '2.5 hrs', image: '/assets/kaimur_plateau_landscape.png' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri International Airport, Babatpur, Varanasi', distance: '100-110 km away', time: '2.5 - 3 hrs drive via NH35' },
    rail: { station: 'Robertsganj Railway Station / Mirzapur Railway Station', distance: '3 km from sanctuary edge / 100 km Mirzapur', time: '10 mins drive from Robertsganj' },
    road: { highway: 'Accessible via road from Mirzapur (100 km) and Varanasi via NH35', distance: '100 km Mirzapur / 110 km Varanasi', time: '2.5 hrs by private taxi/car' }
  },
  stay: {
    categories: [
      { type: 'Forest Rest Houses', range: '₹100 to ₹300 / night', options: ['Harrah Forest Rest House', 'Mahuaria Forest Rest House', 'Churk Forest Rest House'] },
      { type: 'Mid-range Hotels', range: '₹1,200 to ₹2,500 / night', options: ['Basic business hotels in Robertsganj', 'Guest houses in Mirzapur'] },
      { type: 'Luxury Options', range: '₹4,000+ / night', options: ['Require staying in Varanasi (100 km away)'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget', perDay: '₹1,000', breakdown: [{ category: 'ENTRY FEE', amount: '₹30' }, { category: 'LOCAL TRANSIT', amount: '₹370' }, { category: 'DHABA FOOD', amount: '₹600' }] },
      { tier: 'Mid-Range', perDay: '₹3,000', breakdown: [{ category: 'TAXI RENTAL', amount: '₹1,500' }, { category: 'FOREST GUEST HOUSE', amount: '₹300' }, { category: 'GUIDE FEES', amount: '₹500' }, { category: 'FOOD & OTHER', amount: '₹700' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '7:00 AM', place: 'Arrive at Kaimoor WLS, hire local guide/jeep & explore core forest area', duration: '3 hrs', distance: 'Core Forest' }, { time: '12:00 PM', place: 'Hike to Lakhania Dari to view 4,000-year-old rock paintings & packed lunch', duration: '2.5 hrs', distance: 'Lakhania Dari' }, { time: '3:30 PM', place: 'Visit Echo Valley and Anupam Lake for birdwatching before exiting sanctuary', duration: '2 hrs', distance: 'Sanctuary Viewpoints' }] }],
    '2 Days': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Morning Wildlife Safari & Lakhania Prehistoric Rock Art', duration: '4 hrs', distance: 'Kaimoor Forest' }, { time: '1:00 PM', place: 'Lunch at Robertsganj Dhaba', duration: '1 hr', distance: 'Robertsganj' }, { time: '3:00 PM', place: 'Telhar Waterfall & Echo Valley Nature Trail', duration: '3 hrs', distance: 'Kaimur Hills' }] }, { day: 2, schedule: [{ time: '8:30 AM', place: 'Drive to Vijaygarh Fort (Ruined hill fort & cave art)', duration: '45 min', distance: '25 km' }, { time: '9:30 AM', place: 'Vijaygarh Fort Exploration & Ancient Inscriptions', duration: '3 hrs', distance: 'Sonbhadra' }, { time: '2:00 PM', place: 'Excursion to Wyndham Falls & Sunset at Chunar Fort', duration: '3 hrs', distance: '50 km' }] }]
  },
  experiences: [
    { title: 'Guided Heritage Walk to Lakhania Caves', duration: '3 hours', price: '₹350', category: 'Guided Walk', image: '/assets/lakhania_rock_paintings.png' },
    { title: 'Kaimur Wildlife & Blackbuck Safari', duration: '3 hours', price: '₹1,500', category: 'Wildlife Safari', image: '/assets/blackbuck.png' },
    { title: 'Telhar & Karkat Waterfall Nature Tour', duration: '4 hours', price: '₹500', category: 'Nature Trail', image: '/assets/kaimur_plateau_landscape.png' },
    { title: 'Vijaygarh Fort Excursion', duration: '4 hours', price: '₹800', category: 'Fort Tour', image: '/assets/kaimur_plateau_landscape.png' }
  ],
  aiPrompts: [
    'What exactly do the 4,000-year-old Lakhania cave paintings depict?',
    'How do I book a Forest Rest House in Churk or Harrah?',
    'What is the best way to reach Kaimoor Wildlife Sanctuary from Varanasi?',
    'Are there any specific vehicle restrictions for entering the Kaimoor Sanctuary?',
    'What rare or endangered wildlife species can I spot in Kaimoor?'
  ],
  reviews: [
    { name: 'Rahul Verma', location: 'Mirzapur', text: 'Lakhania cave paintings are a hidden wonder! Seeing 4,000-year-old terracotta art in real life was unforgettable.', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format', date: 'Mar 2026' },
    { name: 'Ananya Singh', location: 'Varanasi', text: 'Telhar waterfall and spotting blackbucks in Kaimoor forest made for a perfect offbeat weekend trip.', rating: 5, image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&auto=format', date: 'Jan 2026' }
  ],
  sources: {
    official: ['Forest Department of Uttar Pradesh', 'UP Tourism — Sonbhadra & Mirzapur Circuits'],
    historical: ['ASI Prehistoric Rock Art Survey of Sonbhadra', 'Wildlife Trust of India — Kaimur Recovery Project'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={kaimoor} />
      <QuickFacts facts={kaimoor.quickFacts} />
      <WhyVisit destination={kaimoor} />
      <DestinationStory destination={kaimoor} />
      <HistoryTimeline destination={kaimoor} />
      <CultureGrid destination={kaimoor} />
      <FoodSection destination={kaimoor} />
      <AttractionsGrid destination={kaimoor} />
      <HiddenGems destination={kaimoor} />
      <ThingsToDo destination={kaimoor} />
      <NearbyPlaces destination={kaimoor} />
      <HowToReach destination={kaimoor} />
      <WhereToStay destination={kaimoor} />
      <BestTime destination={kaimoor} />
      <BudgetGuide destination={kaimoor} />
      <Itineraries destination={kaimoor} />
      <LocalExperiences destination={kaimoor} />
      <MapSection destination={kaimoor} />
      <AskD360 destination={kaimoor} />
      <CommunityStories destination={kaimoor} />
      <PracticalInfo />
      <SourcesTrust destination={kaimoor} />
      <Footer />
    </div>
  )
}
