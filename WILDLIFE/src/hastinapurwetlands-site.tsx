...
// ─── Hastinapur Wetlands Data ─────────────────────────────────────────────────

const hastinapurWetlands: Destination = {
  id: 'hastinapur-wetlands',
  slug: 'hastinapur-wetlands-uttar-pradesh',
  name: 'Hastinapur Wetlands',
  localName: 'हस्तिनापुर वेटलैंड / बिजनौर गंगा बैराज',
  destinationType: 'Protected Wetland / Sanctuary',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Bijnor & Meerut',
  shortDescription: 'A dramatic riverine wetland sanctuary where endangered Gangetic river dolphins breach alongside wintering migratory birds beneath epic Mahabharata skies.',
  tags: ['RIVERINE', 'WILDLIFE', 'HERITAGE'],
  hero: {
  ...
  quickFacts: {
    ...
    duration: '1–2 Days',
    budget: '₹',
    destinationType: 'Wetland / Sanctuary',
  ...
  discoveryScore: {
    overall: 8.4,
    categories: [
      { name: 'Uniqueness / Authenticity', score: 9.5 },
      { name: 'Historical Weight', score: 8.0 },
      { name: 'Cultural Significance', score: 8.0 },
      { name: 'Crowd Level', score: 2.5 },
      { name: 'Popularity Index', score: 2.5 }
    ]
  },
  editorial: {
    why: 'One of the few places in India where visitors can witness endangered Gangetic river dolphins in their natural riverine habitat combined with massive winter migratory bird congregations, entirely free of commercialized tourism pressures.',
    story: 'Centered around the massive Bijnor Barrage on the holy Ganga River, this vast matrix of braided channels, sandy river islands (khaddar), shallow oxbow lakes, and reed-choked marshes forms an indispensable corridor for aquatic and terrestrial biodiversity.',
    storyFull: 'Recognized formally as part of the Hastinapur Wildlife Sanctuary, this wetland tract transitions seamlessly from fast-flowing Himalayan sub-montane river waters into slow, nutrient-rich Gangetic plains. Steeped in deep epic lore associated with the Kaurava capital of Hastinapur just downriver, the Bijnor wetland sector blends wild natural isolation with a heavy undercurrent of ancient myth, making it an extraordinary frontier for wildlife researchers, eco-travelers, and cultural historians.'
  },
  history: {
    shortIntro: 'An ancient riverine landscape linked to the imperial capital of the Kuru dynasty and modern Gangetic canal conservation.',
    timeline: [
      { year: 'Vedic / Epic Era', event: 'The wider Hastinapur region served as the grand imperial capital of the Kuru dynasty on the ancient banks of the Ganga.', era: 'Mahabharata Era' },
      { year: '1860s–1950s', event: 'Development of upper Ganga canal systems and subsequent construction of modern barrages altered the wetland hydrology.', era: 'Colonial / Engineering Era' },
      { year: '1986', event: 'Establishment of the Hastinapur Wildlife Sanctuary by the UP government to protect swamp deer, marsh crocodiles, and Gangetic river dolphins.', era: 'Conservation Era' }
    ]
  },
  culture: [
    {
      title: 'Riverine Ethos & Boatmen Culture',
      description: 'The lifestyle along the wetland fringe is closely tied to agricultural crop cycles and riverine fishing regulations, maintained by traditional boatmen (Mallah/Nishad community).',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      title: 'Mahabharata & Ganga Devotion',
      description: 'Deeply anchored in Kuru Kingdom geography, the river segment is intensely sacred with seasonal river fairs like Ganga Snan Melas during Kartik Purnima and rituals on Ganga Dussehra.',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    }
  ],
  food: [
    {
      name: 'Bedmi Poori with Aloo Sabzi (बेड़मी पूड़ी और आलू सब्ज़ी)',
      description: 'Crispy spiced urad dal-stuffed pooris served with a tangy, thin potato curry.',
      category: 'Breakfast / Snack',
      price: '₹40–₹80',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      name: 'Fresh Ganne ka Ras (ताज़ा गन्ने का रस)',
      description: 'Freshly extracted sugarcane juice, sourced directly from one of UP’s top sugarcane belts.',
      category: 'Beverage',
      price: '₹15–₹30',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      name: 'Artisanal Gur (देसी गुड़)',
      description: 'Freshly prepared sugarcane jaggery from open-air crushing units in the winter season.',
      category: 'Sweet / Specialty',
      price: '₹50–₹100/kg',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      name: 'Desi Khana & Tandoori Roti (देसी खाना)',
      description: 'Wholesome lentil preparations, seasonal vegetable curries in mustard oil, and bajra/wheat rotis.',
      category: 'Main Course',
      price: '₹80–₹150',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      name: 'Hot Jalebi & Rabri (जलेबी - रबड़ी)',
      description: 'Crispy fried sweet spirals served warm with condensed milk from Bijnor City main bazaar.',
      category: 'Sweet',
      price: '₹50–₹120',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      name: 'Spiced Chhaas (मसाला छाछ)',
      description: 'Locally churned buttermilk flavored with roasted cumin and black salt.',
      category: 'Beverage',
      price: '₹20–₹40',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    }
  ...
  attractions: [
    {
      id: 'bijnor-barrage-viewpoint',
      name: 'Bijnor Ganga Barrage Viewpoint',
      category: 'Nature / Scenic Spot',
      description: 'The premier vantage point for observing winter migratory birds, expansive river water sheets, and Gangetic dolphin surfacing activities.',
      duration: '2–3 hrs',
      distance: '8 km from Bijnor city center',
      score: 9.2,
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      id: 'hastinapur-sanctuary-fringes',
      name: 'Hastinapur Sanctuary Wetland Fringes (Khaddar)',
      category: 'Nature / Wildlife',
      description: 'Braided river channels, oxbow ponds, and tall grasslands offering premier wildlife tracking and birdwatching.',
      duration: '3–4 hrs',
      distance: '10 km from Bijnor barrage',
      score: 9.0,
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      id: 'vidur-kutir',
      name: 'Vidur Kutir',
      category: 'Historical / Spiritual Site',
      description: 'An ancient hermitage site on the banks of the Ganga where Mahatma Vidur from the Mahabharata reportedly lived and counseled the Pandavas.',
      duration: '2 hrs',
    ...
    {
      id: 'hastinapur-ancient-mound',
      name: 'Hastinapur Archaeological Mound & Temple Complex',
      category: 'Historical / Religious Site',
      description: 'The historical site of ancient Hastinapur featuring excavation mounds and significant Jain temples.',
      duration: '3 hrs',
      distance: '35 km from barrage',
      score: 8.5,
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    }
  ],
  hiddenGems: [
    {
      name: 'Dharanagar Lake (Wetland Pocket)',
      why: 'A secluded secondary wetland pocket near Bijnor frequented by lesser-known migratory waders, raptors, and solitary boatmen.',
      distance: '15 km from Bijnor Barrage',
      duration: '1–2 hrs',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    }
  ],
  thingsToDo: [
    { activity: 'Gangetic Dolphin Spotting', duration: '2–3 hrs', cost: 'Free / Boat fee', difficulty: 'Easy', bestTime: 'Early Morning / Dawn', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Migratory Birdwatching along Bunds', duration: '3 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Traditional Wooden Skiff River Ride', duration: '1.5 hrs', cost: '₹400–₹1,000', difficulty: 'Moderate', bestTime: 'Sunset', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  nearbyPlaces: [
    { name: 'Vidur Kutir Ashram', distance: '10 km', type: 'Spiritual & Historical', travelTime: '20 mins', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { name: 'Mandawar Historic Town', distance: '25 km', type: 'Heritage & Architectural Ruins', travelTime: '45 mins', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { name: 'Hastinapur Town (Meerut Side)', distance: '40 km', type: 'Archaeological Mound & Temples', travelTime: '1 hr', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { name: 'Shukartal', distance: '50 km', type: 'Sacred Banyan & Ganga Ghats', travelTime: '1.2 hrs', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  travel: {
    air: { airport: 'Indira Gandhi International (DEL) / Jolly Grant (DED)', distance: '150 km (DEL) / 110 km (DED)', time: '~3–4 hrs by taxi' },
    rail: { station: 'Bijnor Railway Station (BJO) / Najibabad (NBD)', distance: '8 km (BJO) / 30 km (NBD)', time: 'Direct local auto/taxi to barrage' },
    road: { highway: 'NH-34 / State Highways via Delhi & Meerut', distance: '150 km from Delhi', time: '~3.5–4 hrs by car' }
  },
  stay: {
    categories: [
      { type: 'Town Hotels & Lodges', range: '₹1,200–₹3,000/night', options: ['Hotel Presidency (Bijnor)', 'Grand Plaza (Bijnor)', 'Local Commercial Inns'] },
      { type: 'Forest Rest Houses', range: '₹800–₹1,500/night', options: ['UP Forest Department Guest Houses (Subject to prior permissions)'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹1,200–₹2,000', breakdown: [{ category: 'Stay', amount: '₹700–₹1,200' }, { category: 'Food', amount: '₹350–₹500' }, { category: 'Boat / Transit', amount: '₹150–₹300' }] },
      { tier: 'Comfort / Mid-Range', perDay: '₹2,500–₹4,500', breakdown: [{ category: 'Stay', amount: '₹1,500–₹2,500' }, { category: 'Food', amount: '₹500–₹800' }, { category: 'Private Cab & Boat', amount: '₹500–₹1,200' }] }
    ]
  },
  itineraries: {
    '1 Day': [
      { day: 1, schedule: [{ time: '06:30 AM', place: 'Bijnor Ganga Barrage Dawn Birdwatching & Dolphin Spotting', duration: '4 hrs' }, { time: '11:30 AM', place: 'Vidur Kutir Ashram Visit', duration: '2.5 hrs' }, { time: '02:00 PM', place: 'Traditional Rural Lunch in Bijnor', duration: '1 hr' }, { time: '03:30 PM', place: 'Bijnor Civil Lines Handloom & Jaggery Market', duration: '2 hrs' }] }
    ],
    '2 Days': [
      { day: 1, schedule: [{ time: '06:30 AM', place: 'Bijnor Barrage Floodplain Exploration & Wildlife Tracking', duration: '4 hrs' }, { time: '01:00 PM', place: 'Desi Khana Lunch & Gur Tasting', duration: '1.5 hrs' }, { time: '03:30 PM', place: 'Sunset Photography of Raptors & Waterfowl near Barrage', duration: '2 hrs' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Cross over to Hastinapur Archaeological Sites & Vidur Kutir', duration: '3.5 hrs' }, { time: '01:00 PM', place: 'Ancient Excavation Mounds & Jain Temple Complex', duration: '2.5 hrs' }, { time: '04:30 PM', place: 'Evening Tea by the Riverbanks before departure', duration: '1 hr' }] }
    ]
  },
  experiences: [
    { title: 'Dolphin & Avian Tracking Walk', duration: '3 hrs', price: 'Free / Self-guided', category: 'Wildlife Trail', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { title: 'Cottage Gur-Making (Jaggery) Tour', duration: '1.5 hrs', price: '₹100–₹300', category: 'Culture', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  aiPrompts: [
    "Best winter months to spot Gangetic river dolphins at Bijnor Barrage?",
    "How to hire a local boatman for birdwatching at Hastinapur wetlands?",
    "Outline a 2-day historical and ecological itinerary for Bijnor Wetlands.",
    "Where to sample authentic local jaggery in Bijnor city?"
  ],
  reviews: [
    { name: 'Dr. Anita Sharma', location: 'Delhi', text: 'An incredibly raw and pristine ecosystem. Standing on the barrage gates at dawn and watching Gangetic dolphins breach while bar-headed geese flew overhead was unforgettable.', rating: 5, image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000', date: 'December 2025' }
  ],
  sources: {
    official: ['UP Forest Department Wildlife Sanctuary Notifications (upforest.gov.in)', 'District Administration Bijnor Portal (bijnor.nic.in)'],
    historical: ['Wildlife Institute of India (WII) Gangetic Dolphin Basin Reports'],
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', 'Nature', 'Wildlife', 'Historical', 'Spiritual']
    ...
    <section className="bg-d360-ink py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-white leading-tight">Beyond the Main Barrage</h2>
          <p className="text-white/50 mt-2 text-sm">Secluded pockets most visitors miss.</p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about wildlife, Gangetic dolphins, birdwatching, history, or local jaggery tasting.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('dolphins') && `The best time to spot Gangetic river dolphins at the Bijnor Barrage is during the winter months (November to February) in the early morning hours when river waters are clear.`}
                  {selected?.includes('boatman') && `Local wooden boats can be arranged directly with local boatmen (Mallah/Nishad community) at the riverbanks near the barrage. Standard rates range between ₹400–₹1,000 per boat.`}
                  {selected?.includes('jaggery') && `Authentic fresh jaggery (Gur) can be sampled directly from open-air crushing units in the rural surrounding fields or at the Bijnor Civil Lines Handloom & Jaggery Market.`}
                  {selected?.includes('2-day') && `Day 1 focus: Dawn dolphin and birdwatching around Bijnor Barrage, followed by lunch and local handloom exploration. Day 2 focus: Cross over to Vidur Kutir and the ancient Mahabharata archaeological mounds and Jain temples of Hastinapur.`}
                </div>
              </div>
            )}
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={hastinapurWetlands} />
      <QuickFacts facts={hastinapurWetlands.quickFacts} />
      <WhyVisit destination={hastinapurWetlands} />
      <DestinationStory destination={hastinapurWetlands} />
      <HistoryTimeline destination={hastinapurWetlands} />
      <CultureGrid destination={hastinapurWetlands} />
      <FoodSection destination={hastinapurWetlands} />
      <AttractionsGrid destination={hastinapurWetlands} />
      <HiddenGems destination={hastinapurWetlands} />
      <ThingsToDo destination={hastinapurWetlands} />
      <NearbyPlaces destination={hastinapurWetlands} />
      <HowToReach destination={hastinapurWetlands} />
      <WhereToStay destination={hastinapurWetlands} />
      <BestTime destination={hastinapurWetlands} />
      <BudgetGuide destination={hastinapurWetlands} />
      <Itineraries destination={hastinapurWetlands} />
      <LocalExperiences destination={hastinapurWetlands} />
      <AskD360 destination={hastinapurWetlands} />
      <CommunityStories destination={hastinapurWetlands} />
      <SourcesTrust destination={hastinapurWetlands} />
      <Footer />
    </div>
  )
}