...
// ─── Mokaam Waterfall Data ──────────────────────────────────────────────────

const mokaamWaterfall: Destination = {
  id: 'mokaam-waterfall', slug: 'mokaam-waterfall', name: 'Mokaam Waterfall', localName: 'मुकाम जलप्रपात',
  destinationType: 'Natural Waterfall / Eco-Tourism', country: 'India', state: 'Uttar Pradesh', district: 'Chandauli',
  shortDescription: 'The raw, hidden plunge of Purvanchal where ancient Vindhyan sandstone cuts through untouched jungle wilderness — a seasonal cascade in the Chandraprabha Wildlife Sanctuary belt, wild and largely unvisited.',
  tags: ['Hidden Waterfall', 'Eco-Tourism', 'Vindhyan Sandstone', 'Off the Beaten Track', 'Forest Trekking', 'Kaimur Range'],
  hero: { image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=1600&h=900&fit=crop&auto=format', poster: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=1600&h=900&fit=crop&auto=format' },
  quickFacts: { bestTime: 'July to November', duration: '3–5 Hours', budget: '₹300 – ₹800/day', destinationType: 'Natural Waterfall / Eco-Tourism', difficulty: 'Moderate — unpaved trails, uneven sandstone steps, slippery boulders', distance: '~75–95 km from Varanasi' },
  discoveryScore: { overall: 5.1, categories: [{ name: 'Popularity Index', score: 2.5 }, { name: 'Cultural Significance', score: 4.0 }, { name: 'Historical Weight', score: 5.0 }, { name: 'Uniqueness / Authenticity', score: 9.0 }, { name: 'Accessibility', score: 2.0 }] },
  editorial: { why: 'Zero commercial noise, pristine natural sandstone canyon topography, and an authentic off-grid trek experience within the Vindhyan forest belt — without the crowds of Rajdari or Lakhaniya Dari.', story: 'Mokaam Waterfall is one of the best-kept secrets of the Chandauli district in eastern Uttar Pradesh. Tucked deep within dry deciduous forest corridors of the Vindhya Range, it\'s a seasonal stream-fed cascade that plunges over stepped sandstone cliffs into a secluded, rocky canyon basin — predominantly wild and untouched by major development.', storyFull: 'Mokaam Waterfall is one of the best-kept secrets of the Chandauli district in eastern Uttar Pradesh. Tucked away deep within the dry deciduous forest corridors of the Vindhya Range, Mokaam is a seasonal stream-fed cascade that dramatically plunges over stepped sandstone cliffs into a secluded, rocky canyon basin. Unlike its heavily commercialized regional neighbors — Devdari and Rajdari — Mokaam remains predominantly wild, untouched by major urban development, and wrapped in the quiet stillness of the Kaimur ecosystem. The landscape surrounding Mokaam is defined by rugged red sandstone bluffs, dense Sal, Teak and Mahua canopy, and carved stream channels formed over millennia by monsoon runoff. The waterfall springs to life during and immediately after the South-West monsoon, transforming from a quiet trickle into a roaring white curtain that feeds into downstream tributaries of the Karamnasa River system. Visiting Mokaam offers a glimpse into the raw, unpolished wilderness of the Kaimur-Vindhyan belt. It serves as a vital hydrological sanctuary for resident wildlife and migratory birds, while offering intrepid travelers an off-the-beaten-track haven for eco-trekking, nature photography and rustic wilderness immersion.' },
  history: { shortIntro: 'Mokaam\'s geology dates to the Proterozoic Vindhyan Supergroup, and its surrounding forests were once part of the royal hunting reserves of the Kashi Naresh — today it survives as an unmanaged, wild forest tract.', timeline: [{ year: 'Proterozoic Era', event: 'Geological formation of the Vindhyan Supergroup; seasonal rain rivers begin cutting through horizontal beds of quartzitic red sandstone and siltstone.', era: 'Geological' }, { year: '18th–19th century', event: 'The surrounding forests of Chandauli/Chakia are preserved as royal hunting reserves (Shikargarh) of the Kashi Naresh (Maharaja of Banaras) for game preservation and water catchment.', era: 'Pre-colonial' }, { year: 'Present day', event: 'Mokaam remains in a wild and unmanaged state under Uttar Pradesh Forest Department jurisdiction, with minimal physical infrastructure.', era: 'Modern' }] },
  culture: [{ title: 'Forest-Dwelling Communities', description: 'Local Kol, Baiga and Gond tribal communities live alongside rural agrarian villagers of Chandauli, sustained by subsistence agriculture and forest produce — Mahua flowers, Tendu leaves, honey and herbs.', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=800&fit=crop&auto=format' }, { title: 'Kajari Teej & Monsoon Fairs', description: 'Celebrated locally in rural Chandauli with regional Kajari folk music, marking the arrival of the monsoon that also feeds the waterfall itself.', image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=1200&h=800&fit=crop&auto=format' }, { title: 'Reverence for Van Devi', description: 'Locals customarily pay respects to the Forest Goddess (Van Devi) and village deities (Gram Devtas) at small stone shrines before entering deeper forest patches.', image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=1200&h=800&fit=crop&auto=format' }],
  food: [{ name: 'Baati Chokha', description: 'Sandstone/wood-charcoal roasted wheat balls stuffed with sattu (roasted gram flour), served with mashed spiced aubergine and potato — the region\'s signature dish.', category: 'Main Course', price: '₹100–300', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=800&h=600&fit=crop&auto=format' }, { name: 'Dehati Jaggery Tea (Gur Ki Chai)', description: 'Brewed over open fires with local ginger and unrefined jaggery — the standard warm-up after a forest trek.', category: 'Beverage', price: '₹10–30', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=800&h=600&fit=crop&auto=format' }, { name: 'Desi Sattu Paratha & Chutney', description: 'A staple high-energy food used by locals hiking through the forest, eaten with a tangy regional chutney.', category: 'Street Food', price: '₹40–80', image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=800&h=600&fit=crop&auto=format' }, { name: 'Mahua Delicacies', description: 'Seasonal Mahua flower preparations — sweet dishes or traditional fermented preparations during the local harvest season.', category: 'Seasonal', price: 'Varies', image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=800&h=600&fit=crop&auto=format' }, { name: 'Sawan Kheer / Pua', description: 'Sweet fried fritters cooked during monsoon festivals, a common treat in the Chakia/Naugarh markets during Sawan.', category: 'Dessert', price: '₹30–60', image: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=800&h=600&fit=crop&auto=format' }],
  attractions: [{ id: 'mokaam-main-cascade', name: 'Mokaam Waterfall Main Cascade & Pool', category: 'Nature / Scenic Spots', description: 'The primary cliff drop where monsoon runoff cascades down sandstone terraces into a deep forest pool.', duration: '2–3 hrs', distance: 'Central plunge basin', score: 8.8, image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=1200&h=800&fit=crop&auto=format' }, { id: 'chandraprabha-wildlife-sanctuary', name: 'Chandraprabha Wildlife Sanctuary', category: 'Nature / Wildlife', description: 'The surrounding protected sanctuary, home to leopards, chinkara, blackbucks and over 150 species of birds.', duration: '3–4 hrs', distance: 'Surrounding belt', score: 8.0, image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=800&fit=crop&auto=format' }, { id: 'rajdari-devdari-waterfalls', name: 'Rajdari & Devdari Waterfalls', category: 'Main Landmarks / Nature', description: 'The twin landmark waterfalls of Chandauli, featuring structured viewing galleries and developed picnic grounds — far more visited than Mokaam.', duration: '2–3 hrs', distance: '~25 km', score: 7.5, image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=1200&h=800&fit=crop&auto=format' }, { id: 'naugarh-fort', name: 'Naugarh Fort (Naugarh Durg)', category: 'Hidden Gems / Historical', description: 'A historic hilltop fortification offering sweeping views of the Vindhyan forest cover and reservoir structures.', duration: '1–2 hrs', distance: '~15 km', score: 6.8, image: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=1200&h=800&fit=crop&auto=format' }, { id: 'chakia-local-market', name: 'Chakia Local Market', category: 'Local Markets / Bazaars', description: 'A rustic sub-divisional market hub ideal for sampling fresh local snacks, street tea and regional agricultural produce.', duration: '1 hr', distance: '~20 km', score: 6.0, image: 'https://images.unsplash.com/photo-1533900298318-6b8da08a523e?w=1200&h=800&fit=crop&auto=format' }],
  hiddenGems: [{ name: 'Aurwatand Rock Paintings', why: 'Ancient prehistoric rock art sites tucked inside the Vindhyan forest pockets, rarely visited even by those who make it to Rajdari-Devdari.', distance: '~25 km', duration: '1–2 hrs', image: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=1200&h=800&fit=crop&auto=format' }, { name: 'Naugarh Dam / Reservoir', why: 'A scenic water storage body framed by hills, ideal for peaceful sunset views with almost no other visitors.', distance: '~10 km', duration: '45 min', image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=1200&h=800&fit=crop&auto=format' }],
  thingsToDo: [{ activity: 'Guided jungle walk to the plunge basin', duration: '2–3 hrs', cost: '₹100–300 (local guide)', difficulty: 'Moderate', bestTime: 'Morning, July–November', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=800&fit=crop&auto=format' }, { activity: 'Cautious swim in the plunge pool', duration: '1 hr', cost: 'Free', difficulty: 'Moderate to hard', bestTime: 'Post-monsoon, avoid peak currents', image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=1200&h=800&fit=crop&auto=format' }, { activity: 'Country cooking demonstration with local villagers', duration: '1–2 hrs', cost: 'Varies, arrange locally', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=1200&h=800&fit=crop&auto=format' }, { activity: 'Day trip combining Rajdari, Devdari and Mokaam', duration: 'Full day', cost: '₹2,500–4,000 (private cab from Varanasi)', difficulty: 'Moderate', bestTime: 'Early morning start', image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=1200&h=800&fit=crop&auto=format' }],
  nearbyPlaces: [{ name: 'Naugarh Dam / Reservoir', distance: '10 km', type: 'Reservoir / Scenic Viewpoint', travelTime: '20–25 min', image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=1200&h=800&fit=crop&auto=format' }, { name: 'Rajdari & Devdari Waterfalls', distance: '25 km', type: 'Waterfalls', travelTime: '40–50 min', image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=1200&h=800&fit=crop&auto=format' }, { name: 'Aurwatand Rock Paintings', distance: '25 km', type: 'Prehistoric Rock Art', travelTime: '40–50 min', image: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=1200&h=800&fit=crop&auto=format' }, { name: 'Chandraprabha Dam', distance: '50 km', type: 'Dam / Reservoir', travelTime: '1–1.5 hrs', image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=1200&h=800&fit=crop&auto=format' }, { name: 'Latif Shah Tomb & Dam', distance: '50 km', type: 'Historic Sufi Shrine', travelTime: '1–1.5 hrs', image: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=1200&h=800&fit=crop&auto=format' }],
  travel: { air: { airport: 'Lal Bahadur Shastri International Airport, Varanasi (VNS)', distance: '~85–95 km', time: '~2–2.5 hrs by road' }, rail: { station: 'Pt. Deen Dayal Upadhyaya Junction / Mughalsarai (DDU) — closer; Varanasi Junction (BSB) also well connected', distance: 'DDU ~55–65 km; BSB ~75–80 km', time: '~1.5–2 hrs by road from either station' }, road: { highway: 'Varanasi–Chakia Highway / AH1 / NH19, turning towards Chakia and the Chakia–Naugarh Road', distance: '~75–95 km from Varanasi', time: 'Final 2–3 km is unpaved forest track — high-clearance vehicle or two-wheeler recommended' } },
  stay: { categories: [{ type: 'Budget / Forest Rest House', range: 'Nominal (prior booking required)', options: ['UP Forest Department Guest Houses in Chakia / Rajdari (official booking required)', 'Basic rustic guesthouses around Chakia town'] }, { type: 'Mid-Range', range: 'Limited locally', options: ['Eco-resorts and homestays are highly limited near Mokaam itself'] }, { type: 'Luxury (base in Varanasi)', range: '₹6,000+/night', options: ['Heritage and full-amenity hotels in Varanasi City, 75 km away', 'Hotels in Mughalsarai as a closer alternative base'] }] },
  bestTime: { months: [{ month: 'Jan', status: 'good' }, { month: 'Feb', status: 'good' }, { month: 'Mar', status: 'avoid' }, { month: 'Apr', status: 'avoid' }, { month: 'May', status: 'avoid' }, { month: 'Jun', status: 'avoid' }, { month: 'Jul', status: 'good' }, { month: 'Aug', status: 'good' }, { month: 'Sep', status: 'good' }, { month: 'Oct', status: 'ideal' }, { month: 'Nov', status: 'ideal' }, { month: 'Dec', status: 'good' }] },
  budget: { tiers: [{ tier: 'Budget (Day-Tripper)', perDay: '₹300–₹800', breakdown: [{ category: 'Forest entry fee', amount: 'Free – ₹50' }, { category: 'Parking / local guide tip', amount: '₹100–300' }, { category: 'Food & water', amount: '₹150–400' }] }, { tier: 'Mid-Range (Private Cab)', perDay: '₹3,000–₹5,000', breakdown: [{ category: 'Round-trip cab hire from Varanasi', amount: '₹2,500–4,000' }, { category: 'Food & water', amount: '₹300–500' }, { category: 'Guide + parking', amount: '₹200–500' }] }, { tier: 'Comfort (Varanasi-Based)', perDay: '₹6,000+', breakdown: [{ category: 'Varanasi hotel stay', amount: '₹4,000+' }, { category: 'Chauffeured day-trip car', amount: '₹2,500–4,000' }, { category: 'Food & guide', amount: '₹500–800' }] }] },
  itineraries: { '1 Day': [{ day: 1, schedule: [{ time: '6:30 AM', place: 'Depart early from Varanasi / DDU Junction in a private cab or SUV', duration: '2 hrs', distance: 'Varanasi to Chakia' }, { time: '8:30 AM', place: 'Quick stop at Chakia for hot Baati Chokha or Sattu Parathas with Dehati Tea', duration: '30 min', distance: 'Chakia town' }, { time: '10:00 AM', place: 'Arrive at the trailhead for Mokaam Waterfall; begin the forest trek', duration: '1 hr', distance: 'Trailhead' }, { time: '10:30 AM – 1:30 PM', place: 'Explore the Mokaam Waterfall basin, take photos, swim with caution, quiet picnic (pack in, pack out)', duration: '3 hrs', distance: 'Plunge basin' }, { time: '2:00 PM', place: 'Drive to the nearby Rajdari/Devdari complex for panoramic gorge views', duration: '1.5 hrs', distance: '~25 km' }, { time: '4:30 PM', place: 'Evening tea near Naugarh Reservoir, watching the sunset over the Kaimur range', duration: '1 hr', distance: 'Naugarh Reservoir' }, { time: '7:30 PM', place: 'Return to Varanasi', duration: '2 hrs', distance: 'Return leg' }] }] },
  experiences: [{ title: 'Guided Jungle Walk with Local Youth', duration: '2–3 hrs', price: '₹100–300', category: 'Eco-Trekking', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=800&fit=crop&auto=format' }, { title: 'Country Cooking Demonstration (Open-Woodfire)', duration: '1–2 hrs', price: 'Arrange locally', category: 'Cultural Immersion', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=1200&h=800&fit=crop&auto=format' }, { title: 'Full-Day Waterfall Circuit (Mokaam + Rajdari + Devdari)', duration: 'Full day', price: '₹2,500–4,000 (transport)', category: 'Nature', image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=1200&h=800&fit=crop&auto=format' }],
  aiPrompts: ['Is Mokaam Waterfall safe to visit with family during the peak monsoon season?', 'How do I reach Mokaam Waterfall from Varanasi without a personal car?', 'What are the key differences in crowd level and scenery between Mokaam, Rajdari, and Devdari waterfalls?', 'What hidden rock art or ancient historical sites are located near Mokaam Waterfall in Chandauli?', 'Can I set up an overnight camp at Mokaam Waterfall, and what are the forest regulations?'],
  reviews: [{ name: 'Traveler Review', location: 'Varanasi, India', text: 'Placeholder — add real visitor reviews here once available. Mokaam is remote enough that first-hand accounts are rare; treat any review as anecdotal until verified.', rating: 4.5, image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=80&h=80&fit=crop&auto=format', date: '2026' }],
  sources: { official: ['Uttar Pradesh Forest Department', 'Chandauli District Administration — chandauli.nic.in'], historical: ['Regional oral history — Kashi Naresh Shikargarh records', 'Vindhyan Supergroup geological surveys'], lastVerified: 'September 2026' }
}
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Main Cascade & Pool' }, { top: '42%', left: '38%', label: 'Chandraprabha Sanctuary' }, { top: '28%', left: '52%', label: 'Naugarh Fort' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('peak monsoon season') && `Peak monsoon (July–September) means the waterfall is at its most dramatic, but trails get slippery and the ravine can flash-flood — not ideal with young children. If you're bringing family, October–November gives you strong water flow with much safer, more manageable trekking conditions.`}
                  {selected?.includes('without a personal car') && `It's genuinely difficult without a private vehicle. Public buses only run as far as Chakia or Naugarh town; from there you'd need a shared auto-rickshaw to Naugarh and then a two-wheeler or walk for the final unpaved stretch. A hired cab from Varanasi is by far the most practical option.`}
                  {selected?.includes('crowd level and scenery') && `Mokaam is almost empty even on weekends — genuinely wild, with no infrastructure. Rajdari and Devdari, just 25 km away, have viewing galleries, picnic grounds and noticeably more footfall. If you want solitude, Mokaam; if you want convenience and amenities, Rajdari-Devdari.`}
                  {selected?.includes('rock art') && `The Aurwatand Rock Paintings, about 25 km from Mokaam, feature prehistoric cave art on the walls beneath a 200-ft waterfall on the Karmanasa River. It's being developed as an eco-tourism site but still sees very few visitors.`}
                  {selected?.includes('overnight camp') && `There's no official camping infrastructure at Mokaam itself, and it falls under Uttar Pradesh Forest Department jurisdiction, so any overnight stay would need prior permission from the forest office. The nearest sanctioned accommodation is the UP Forest Department guest houses in Chakia or Rajdari, which also require advance booking.`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Safety', content: 'Moderate risk. Avoid trekking after 5:00 PM due to lack of light and the presence of wild fauna (wild boars, sloths, and rare leopard sightings). Solo travelers should not stay past sunset — the area is remote with no network coverage.' },
    { title: 'Local Transport', content: 'Private vehicles or hired cabs are strongly recommended. Public buses run only as far as Chakia or Naugarh town, and shared auto-rickshaws cover Chakia to Naugarh, but the last-mile stretch to Mokaam needs a private two-wheeler, car, or a walk.' },
    { title: 'Flash Flood Warning', content: 'During heavy monsoon downpours, water flow in the ravine can rise rapidly. If the water turns muddy or rises unexpectedly, exit the riverbed immediately — this is the single most important safety rule at Mokaam.' },
    { title: 'No Connectivity, No ATMs', content: 'Cellular signal (Jio/Airtel) drops significantly once inside the forest ravine, and there are no ATMs nearby. Carry adequate physical cash from Chakia or Varanasi before heading in.' },
    { title: 'Emergency Information', content: 'Police Control Room: 112 · Naugarh Police Station (via district police directory) · Nearest Primary Health Centre: Naugarh / Chakia Community Health Centre (CHC).' },
    { title: 'Travel Tips', content: 'Take all plastic trash back with you — there\'s no waste infrastructure here. Dress comfortably for dense brush, avoid alcohol and loud music near the water (it disturbs wildlife and local sensibilities), and don\'t attempt deep-water swimming in unmonitored pools during peak monsoon currents.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={mokaamWaterfall} />
      <QuickFacts facts={mokaamWaterfall.quickFacts} />
      <WhyVisit destination={mokaamWaterfall} />
      <DestinationStory destination={mokaamWaterfall} />
      <HistoryTimeline destination={mokaamWaterfall} />
      <CultureGrid destination={mokaamWaterfall} />
      <FoodSection destination={mokaamWaterfall} />
      <AttractionsGrid destination={mokaamWaterfall} />
      <HiddenGems destination={mokaamWaterfall} />
      <ThingsToDo destination={mokaamWaterfall} />
      <NearbyPlaces destination={mokaamWaterfall} />
      <HowToReach destination={mokaamWaterfall} />
      <WhereToStay destination={mokaamWaterfall} />
      <BestTime destination={mokaamWaterfall} />
      <BudgetGuide destination={mokaamWaterfall} />
      <Itineraries destination={mokaamWaterfall} />
      <LocalExperiences destination={mokaamWaterfall} />
      <MapSection destination={mokaamWaterfall} />
      <AskD360 destination={mokaamWaterfall} />
      <CommunityStories destination={mokaamWaterfall} />
      <PracticalInfo />
      <SourcesTrust destination={mokaamWaterfall} />
      <Footer />
    </div>
  )
}
