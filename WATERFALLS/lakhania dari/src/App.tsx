...
const lakhania: Destination = {
  id: 'lakhania-dari-mirzapur',
  slug: 'lakhania-dari-mirzapur',
  name: 'Lakhania Dari',
  localName: 'लखनिया दरी जलप्रपात एवं शैलचित्र (मिर्ज़ापुर)',
  destinationType: 'Hidden Gorge Waterfall & Prehistoric Rock-Art Landscape',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Mirzapur',
  shortDescription: "A hidden Vindhyan gorge where monsoon torrents plunge over massive sandstone escarpments, combined with a scenic rocky stream trek into prehistoric painted rock-shelter country.",
  tags: ['HIDDEN GORGE WATERFALL', 'PREHISTORIC ROCK ART', 'VINDHYAN STREAM TREK', 'AHRAURA RESERVOIR CIRCUIT'],
  hero: {
    image: '/images/lakhania_hero_fullhd.jpg',
    poster: '/images/gorge_cascade.jpg'
  },
  quickFacts: {
    bestTime: 'Jul – Feb (Peak Flow: Jul – Sep)',
    duration: 'Half Day / 3–5 Hrs (with trek)',
    budget: '₹ (Low–Moderate)',
    destinationType: 'Hidden Gorge & Rock Art',
    difficulty: 'Moderate Trek (2–3 km rocky path)',
    distance: '~54 km from Varanasi / ~45 km from Mirzapur'
  },
  discoveryScore: {
    overall: 9.3,
    categories: [
      { name: 'Gorge Landscape & Plunge Waterfall', score: 9.7 },
      { name: 'Prehistoric Rock Art Heritage', score: 9.5 },
      { name: 'Rocky Stream Trek Experience', score: 9.2 },
      { name: 'Monsoon Wilderness Ambiance', score: 9.4 },
      { name: 'Proximity to Chunar & Varanasi', score: 8.8 }
    ]
  },
  editorial: {
    why: "Tucked away near Latifpur and Ahraura in the northern Vindhyan hills, Lakhaniya Dari is a breathtaking seasonal gorge waterfall that combines dramatic natural cascade scenery with ancient human archaeology—preserving one of Mirzapur's most significant prehistoric rock-art panels.",
    story: "Unlike roadside waterfalls, Lakhaniya Dari rewards adventurous visitors with an experiential 2–3 km natural trek across exposed sandstone riverbeds, flowing stream channels, and deciduous woodlands before revealing a roaring plunge waterfall framed by sheer rocky escarpments.",
    storyFull: "The gorge's significance extends deep into antiquity. Archaeological research by scholars including Prof. Ajay Pratap documents a major painted rock shelter at Likhaniya Dari with over fifty individual prehistoric and early historic images—depicting hunting scenes, animals, and geometric motifs created in natural ochre pigments thousands of years ago."
  },
  history: {
    shortIntro: "From prehistoric rock-art shelters to colonial archaeological surveys and modern eco-trekking adventures.",
    timeline: [
      { year: 'Prehistoric Era', event: 'Early human hunter-gatherers use natural sandstone shelters for habitation, painting over 50 dynamic figures of wildlife and hunting rituals.', era: 'Rock Art Creation' },
      { year: '19th–20th Century', event: 'Archaeologists and antiquarians document Likhaniya Dari as a premier painted rock-art station within the northern Vindhyan archaeological landscape.', era: 'Archaeological Discovery' },
      { year: 'Late 20th Century', event: 'Development of Ahraura Dam and surrounding reservoir catchment channels fed by the natural seasonal drainage of Lakhaniya gorge.', era: 'Water & Forest Management' },
      { year: 'Present', event: 'Recognized as Eastern Uttar Pradesh most thrilling monsoon trek, combining high-flow waterfalls with irreplaceable archaeological heritage.', era: 'Modern Eco-Tourism' }
    ]
  },
  culture: [
    { title: 'Vindhyan Rock Art Heritage', description: 'Ancient painted panels depicting hunting scenes, deer, elephants, and symbolic motifs preserving thousands of years of human cultural memory.', image: '/images/likhaniya_rock_art.png' },
    { title: 'Purvanchali Monsoon Trekking Tradition', description: 'Generations of nature lovers from Varanasi, Chunar, and Mirzapur embarking on adventurous riverbed treks during the rainy season.', image: '/images/gorge_stream_trek.jpg' },
    { title: 'Chunar & Ahraura Craft Connections', description: 'Deep synergy with the traditional red-clay pottery, sandstone carving, and handloom weaving traditions of the Chunar-Ahraura belt.', image: '/images/kachori.jpg' },
    { title: 'Leave-No-Trace Conservation Ethic', description: 'A shared responsibility among travelers to protect fragile ancient paintings and keep pristine forest streams free of plastic waste.', image: '/images/chandraprabha_forest.jpg' }
  ],
  food: [
    { name: 'Mirzapur Baati Chokha with Pure Desi Ghee', description: 'Charcoal-baked whole wheat batis dipped in pure desi ghee, served with smoky roasted brinjal-tomato mash and spicy yellow dal.', category: 'Signature Trek Meal', price: '₹60–₹110/plate', image: '/images/litti_chokha.jpg' },
    { name: 'Crisp Urad Dal Kachori & Hing Aloo', description: 'Flaky golden kachoris stuffed with spiced black gram lentils, accompanied by zesty asafetida-flavored potato curry.', category: 'Breakfast Staple', price: '₹30–₹50', image: '/images/kachori.jpg' },
    { name: 'Ahraura Samosa & Matar Chaat', description: 'Hot potato samosas crushed over spiced chickpea curry, sweetened tamarind chutney, and fresh mint-coriander sauce.', category: 'Snack', price: '₹25–₹45', image: '/images/samosa_chaat.jpg' },
    { name: 'Chilled Spiced Sattu Sharbat', description: 'Nutritious roasted gram flour drink spiked with roasted cumin, rock salt, and fresh lemon—perfect replenishment after a rocky trek.', category: 'Beverage', price: '₹20–₹35', image: '/images/sattu_drink.jpg' },
    { name: 'Traditional Mirzapur Peda & Rice Kheer', description: 'Caramelized condensed milk fudge and slow-simmered cardamom-scented rice kheer garnished with roasted almonds.', category: 'Dessert', price: '₹35–₹65', image: '/images/kheer.jpg' }
  ],
  attractions: [
    { id: 'lakhania-waterfall-main', name: 'Lakhaniya Dari Main Waterfall', category: 'Nature / Scenic', description: 'Dramatic seasonal waterfall plunging from a high rocky escarpment into a deep natural plunge pool surrounded by sheer cliffs.', duration: '2 hrs', distance: 'Trail End', score: 9.8, image: '/images/lakhania_hero_fullhd.jpg' },
    { id: 'likhaniya-rock-art-shelter', name: 'Likhaniya Dari Prehistoric Rock Art', category: 'Archaeology', description: 'Protected sandstone rock shelter preserving over 50 ancient painted figures of hunters, animals, and multi-period motifs.', duration: '1 hr', distance: 'Along Gorge', score: 9.6, image: '/images/likhaniya_rock_art.png' },
    { id: 'gorge-riverbed-trek', name: '2–3 km Rocky Riverbed Gorge Trek', category: 'Adventure / Trek', description: 'Scenic wilderness trail navigating massive sandstone boulders, stream crossings, and lush green deciduous forest canopy.', duration: '2 hrs', distance: 'Trail Corridor', score: 9.4, image: '/images/gorge_stream_trek.jpg' },
    { id: 'ahraura-dam-reservoir', name: 'Ahraura Dam & Reservoir Catchment', category: 'Waterbody', description: 'Expansive reservoir downstream of the gorge, framed by Vindhyan hill ridges and tranquil water vistas.', duration: '1 hr', distance: '6 km North', score: 9.1, image: '/images/ahraura_dam.jpg' },
    { id: 'chunar-historic-fort', name: 'Chunar Historic Fort Corridor', category: 'Heritage Fort', description: 'Massive medieval fortress overlooking the River Ganges with legends of King Vikramaditya and Mughal history.', duration: '2.5 hrs', distance: '25 km North', score: 9.5, image: '/images/devdari_gorge.jpg' },
    { id: 'tanda-wyndham-circuit', name: 'Tanda & Wyndham Waterfalls Circuit', category: 'Waterfall Circuit', description: 'Combine Lakhaniya with sister waterfalls of Mirzapur for a comprehensive multi-cascade monsoon experience.', duration: '3 hrs', distance: '35–45 km West', score: 9.2, image: '/images/chandraprabha_forest.jpg' }
  ],
  hiddenGems: [
    { name: 'Upper Gorge Secluded Plunge Pool', why: 'Quiet natural rock basin upstream of the main cascade surrounded by towering sandstone walls and emerald water.', distance: '300m above falls', duration: '45 min', image: '/images/gorge_cascade.jpg' },
    { name: 'Ochre Animal Painting Panels', why: 'Tucked beneath an overhanging rock ledge, a remarkably well-preserved group of painted horned animals and hunters.', distance: 'Main Rock Shelter', duration: '30 min', image: '/images/likhaniya_rock_art.png' },
    { name: 'Latifpur Village Hilltop Overlook', why: 'Elevated rural vantage point providing a panoramic view of the entire Vindhyan gorge slicing into the plains.', distance: '1.5 km from trailhead', duration: '30 min', image: '/images/chandraprabha_forest.jpg' }
  ],
  thingsToDo: [
    { activity: 'Rocky Riverbed Gorge Trekking', duration: '2.5 hrs', cost: 'Free / Local Guide (Optional)', difficulty: 'Moderate', bestTime: '07:30 AM – 11:30 AM (Jul–Oct)', image: '/images/gorge_stream_trek.jpg' },
    { activity: 'Prehistoric Rock Art Exploration & Photography', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning / Diffused Daylight', image: '/images/likhaniya_rock_art.png' },
    { activity: 'Monsoon Waterfall Plunge Pool Viewing', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '10:00 AM – 01:00 PM', image: '/images/lakhania_hero_fullhd.jpg' },
    { activity: 'Traditional Ahraura Baati Chokha Feast', duration: '1 hr', cost: '₹70–₹130', difficulty: 'Easy', bestTime: '01:30 PM – 03:00 PM', image: '/images/litti_chokha.jpg' },
    { activity: 'Combined Chunar Fort & Ganges Sunset Drive', duration: '3 hrs', cost: '₹200–₹500', difficulty: 'Easy', bestTime: 'Afternoon / Golden Hour', image: '/images/devdari_gorge.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Ahraura Town & Reservoir', distance: '8 km', type: 'Local Hub & Lake', travelTime: '15 min', image: '/images/ahraura_dam.jpg' },
    { name: 'Chunar Junction & Historic Fort', distance: '25 km', type: 'Heritage Fort & Railhead', travelTime: '40 min', image: '/images/devdari_gorge.jpg' },
    { name: 'Varanasi City (Cantt / Ghats)', distance: '54 km', type: 'Spiritual Capital', travelTime: '1.5 hrs', image: '/images/kachori.jpg' },
    { name: 'Mirzapur City & Tanda Fall', distance: '45 km', type: 'District Center & Waterfalls', travelTime: '1.2 hrs', image: '/images/chandraprabha_forest.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri International Airport Varanasi (VNS)', distance: 'Approx. 75 km', time: 'Approx. 2 hours drive via Varanasi Ring Road and Ahraura Highway' },
    rail: { station: 'Chunar Junction (CAR) / Varanasi Cantt (BSB)', distance: '25 km / 54 km from waterfall', time: 'Chunar and Varanasi are premier railheads with nationwide superfast train connectivity' },
    road: { highway: 'Mirzapur–Ahraura Road / Varanasi-Ahraura Highway', distance: '54 km from Varanasi via Chunar-Ahraura route to Latifpur', time: 'Easily accessible by private taxi, hired cab, or personal SUV from Varanasi (~1.5 hrs)' }
  },
  stay: {
    categories: [
      { type: 'Varanasi Heritage & City Hotels', range: '₹2,000–₹6,500/night', options: ['Taj Ganges Varanasi', 'Radisson Hotel Varanasi', 'BrijRama Palace (54 km base)'] },
      { type: 'Mirzapur & Chunar Hotels', range: '₹1,200–₹2,800/night', options: ['Hotel The Galaxy Mirzapur', 'Chunar Ganga Tourist Lodge'] },
      { type: 'Budget Guesthouses & Homestays', range: '₹700–₹1,400/night', options: ['Ahraura Market Guesthouses', 'Highway Tourist Motels'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Trekker Day Trip', perDay: '₹500–₹950', breakdown: [{ category: 'Shared Transit / Bus from Varanasi', amount: '₹150–₹250' }, { category: 'Packed Food & Baati Chokha', amount: '₹200–₹350' }, { category: 'Guide / Incidentals', amount: '₹150–₹350' }] },
      { tier: 'Private Cab Day Out from Varanasi', perDay: '₹2,200–₹3,800', breakdown: [{ category: 'Private Sedan / SUV from Varanasi', amount: '₹1,600–₹2,500' }, { category: 'Dhaba Lunch & Snacks', amount: '₹400–₹800' }, { category: 'Local Guide & Entry', amount: '₹200+' }] },
      { tier: 'Mirzapur & Chunar Heritage Weekend', perDay: '₹3,500+', breakdown: [{ category: 'Hotel Base in Varanasi/Mirzapur', amount: '₹2,000–₹3,200' }, { category: 'Chauffeur Cab Full Day', amount: '₹1,500–₹2,200' }, { category: 'Dining & Experiences', amount: '₹800+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '06:30 AM', place: 'Depart Varanasi/Chunar early via Ahraura road to Latifpur trailhead', duration: '1.5 hrs', distance: '54 km' }, { time: '08:00 AM', place: 'Begin 2–3 km scenic rocky stream trek navigating boulders and river pools', duration: '1.5 hrs', distance: 'Gorge Trail' }, { time: '09:30 AM', place: 'Reach Lakhaniya Dari main cascade and photograph roaring waterfall and gorge', duration: '2 hrs', distance: 'Main Waterfall' }, { time: '11:30 AM', place: 'Visit Likhaniya Dari prehistoric painted rock shelter and observe ancient ochre art', duration: '1 hr', distance: 'Rock Shelter' }, { time: '01:00 PM', place: 'Return trek to trailhead and enjoy hot Baati Chokha lunch at Ahraura', duration: '1.5 hrs', distance: 'Ahraura' }, { time: '03:00 PM', place: 'Afternoon visit to historic Chunar Fort overlooking the Ganges', duration: '2 hrs', distance: 'Chunar' }, { time: '06:00 PM', place: 'Return to Varanasi before nightfall', duration: '1.5 hrs', distance: 'Varanasi' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '07:30 AM', place: 'Full-day wilderness and archaeological excursion to Lakhaniya Dari and Ahraura Dam', duration: '6 hrs', distance: 'Lakhaniya' }, { time: '02:30 PM', place: 'Explore historic Chunar Fort and sunset along the river Ganga', duration: '3 hrs', distance: 'Chunar' }, { time: '06:30 PM', place: 'Check-in to hotel in Varanasi or Mirzapur for dinner', duration: '1.5 hrs', distance: 'Hotel' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Mirzapur multi-waterfall circuit: Tanda Fall, Tanda Dam, and Wyndham Fall', duration: '5 hrs', distance: 'Mirzapur Waterfalls' }, { time: '02:00 PM', place: 'Darshan at Maa Vindhyavasini Temple in Vindhyachal', duration: '2.5 hrs', distance: 'Vindhyachal' }, { time: '05:30 PM', place: 'Return transit via Varanasi / Mirzapur railway station', duration: '1.5 hrs', distance: 'Transit' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '08:00 AM', place: 'Arrival in Varanasi & morning trek to Lakhaniya Dari gorge waterfall and rock art', duration: '6 hrs', distance: 'Lakhaniya' }, { time: '04:00 PM', place: 'Chunar stone craft workshop tour and evening Ganga aarti in Varanasi', duration: '3 hrs', distance: 'Varanasi' }] },
      { day: 2, schedule: [{ time: '08:30 AM', place: 'Borderland cascades: Rajdari & Devdari Waterfalls in Chandraprabha Sanctuary', duration: '6 hrs', distance: 'Chandauli' }, { time: '04:00 PM', place: 'Explore ancient Naugarh Fort and return to Varanasi hotel', duration: '2.5 hrs', distance: 'Hotel' }] },
      { day: 3, schedule: [{ time: '08:00 AM', place: 'Mirzapur nature & spiritual circuit: Tanda Fall and Vindhyachal Shaktipeeth', duration: '5 hrs', distance: 'Mirzapur' }, { time: '03:30 PM', place: 'Departure transit via Lal Bahadur Shastri Airport Varanasi', duration: '2 hrs', distance: 'Transit' }] }
    ]
  },
  experiences: [
    { title: 'Wilderness Riverbed Gorge Trek', duration: '2.5 hrs', price: 'Free Entry', category: 'Adventure', image: '/images/gorge_stream_trek.jpg' },
    { title: 'Prehistoric Rock Art Heritage Observation', duration: '1 hr', price: 'Free', category: 'Archaeology', image: '/images/likhaniya_rock_art.png' },
    { title: 'Monsoon Escarpment Waterfall Spectacle', duration: '1.5 hrs', price: 'Free', category: 'Nature', image: '/images/lakhania_hero_fullhd.jpg' },
    { title: 'Purvanchali Desi Ghee Baati Chokha Meal', duration: '1 hr', price: '₹80–₹150', category: 'Culinary', image: '/images/litti_chokha.jpg' }
  ],
  aiPrompts: [
    "What is the safest trekking route to Lakhaniya Dari during the monsoon?",
    "How old are the prehistoric rock paintings at Likhaniya Dari in Mirzapur?",
    "How can I plan a 1-day trip to Lakhaniya Dari from Varanasi?",
    "What shoes and precautions are needed for the 2–3 km rocky riverbed trek?",
    "Which nearby attractions like Chunar Fort can be combined with Lakhaniya Dari?",
    "लखनिया दरी जलप्रपात और शैलचित्र घूमने का सही समय, रास्ता और सावधानियां क्या हैं?"
  ],
  reviews: [
    { name: 'Adarsh Pandey', location: 'Varanasi', text: 'Lakhaniya Dari is by far the most thrilling waterfall trek near Varanasi! Walking across the rocky riverbed to reach the roaring gorge waterfall is pure adventure. Make sure to wear high-grip shoes.', rating: 5, image: '/images/lakhania_hero_fullhd.jpg', date: 'August 2026' },
    { name: 'Dr. Archana Verma', location: 'Prayagraj', text: 'The combination of natural waterfall scenery and ancient rock paintings in the rock shelter is extraordinary. Please respect the heritage and never scratch or touch the painted rock faces.', rating: 5, image: '/images/likhaniya_rock_art.png', date: 'September 2026' },
    { name: 'Vikramaditya Rai', location: 'Chunar', text: 'Our favorite weekend getaway! We started early from Varanasi, completed the trek by noon, and enjoyed delicious baati chokha on our way to Chunar Fort. An absolute 10/10 day trip.', rating: 5, image: '/images/gorge_stream_trek.jpg', date: 'October 2025' }
  ],
  sources: {
    official: ['Mirzapur Tourism Official Directory (mirzapurtourism.com/destinations/lakhaniya-dari)', 'Uttar Pradesh Tourism & Ecotourism Board (upecotourism.in)', 'Archaeological Survey & Research Publications by Prof. Ajay Pratap'],
    historical: ['Antiquity & Peer-Reviewed Papers on Vindhyan Rock Art Shelters', 'Mirzapur District Gazetteer'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">Prehistoric Era</p>
              <p className="text-xs text-white/60 mt-1">Ancient Rock Art & Gorge</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Lakhaniya Dari Main Waterfall' }, { top: '42%', left: '38%', label: 'Likhaniya Painted Rock Shelter' }, { top: '28%', left: '52%', label: 'Rocky Riverbed Trek Route' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('safest way') && `Wear high-traction shoes, trek in a group or with a local guide, stay on stable boulders away from deep pools, carry water, and complete the return before 04:00 PM.`}
                  {selected?.includes('half-day') && `Depart Varanasi by 06:30 AM (54 km), reach Latifpur by 08:00 AM. Trek to the waterfall, explore rock art shelters, return to Ahraura for lunch by 01:00 PM, and return to Varanasi by afternoon.`}
                  {selected?.includes('rock paintings') && `The shelter contains over 50 prehistoric and historic figures painted in natural ochre, showing hunting scenes and fauna. Never touch, wet, or deface these ancient archaeological surfaces.`}
                  {selected?.includes('nearby waterfalls') && `You can combine Lakhaniya Dari with Chunar Fort on Day 1, and explore Tanda Fall, Tanda Dam, and Wyndham Fall in Mirzapur on Day 2.`}
                  {selected?.includes('children and') && `The 2–3 km trek over uneven riverbed boulders can be strenuous for elderly visitors and small children. Active families can enjoy safe viewing areas with careful supervision.`}
                  {selected?.includes('sahii rasta') && `लखनिया दरी वाराणसी से लगभग 54 किमी दूर चुनार-अहरौरा मार्ग पर स्थित है। 2-3 किमी का पथरीला नदी मार्ग पार करके जलप्रपात तक पहुंचा जाता है। घूमने का सबसे उत्तम समय जुलाई से फरवरी है।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Slippery Boulders & Flash Flood Warning', content: 'Monsoon rocks along the 2–3 km riverbed trek are extremely slippery. Flash floods can occur in narrow drainage channels after heavy rain; avoid water channels if water turns muddy or rises.' },
    { title: 'Prehistoric Rock Art Protection', content: 'Never touch, wet, chalk, scratch, or climb on painted rock shelter surfaces. These ochre paintings are fragile national archaeological treasures.' },
    { title: 'Footwear & Trekking Gear', content: 'Wear sturdy sports shoes or hiking sandals with high-traction rubber soles. Carry an extra dry pair of socks, waterproof pouch for electronics, and trekking stick.' },
    { title: 'Group Travel & Daylight Rule', content: 'Always visit in groups or with a local guide during the monsoon. Start early and begin the return trek by 03:30 PM to reach the trailhead well before sunset.' },
    { title: 'Emergency & District Contacts', content: 'UP Police Emergency: 112 · Ahraura Police Station: +91-5443-252200 · Mirzapur Police Control: +91-5442-252200 · District Hospital Mirzapur: +91-5442-252400.' },
    { title: 'Food & Drinking Water Advice', content: 'There are no permanent food facilities inside the gorge. Carry at least 2 liters of drinking water per person, energy snacks, and pack out all plastic waste.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={lakhania} />
      <QuickFacts facts={lakhania.quickFacts} />
      <WhyVisit destination={lakhania} />
      <DestinationStory destination={lakhania} />
      <HistoryTimeline destination={lakhania} />
      <CultureGrid destination={lakhania} />
      <FoodSection destination={lakhania} />
      <AttractionsGrid destination={lakhania} />
      <HiddenGems destination={lakhania} />
      <ThingsToDo destination={lakhania} />
      <NearbyPlaces destination={lakhania} />
      <HowToReach destination={lakhania} />
      <WhereToStay destination={lakhania} />
      <BestTime destination={lakhania} />
      <BudgetGuide destination={lakhania} />
      <Itineraries destination={lakhania} />
      <LocalExperiences destination={lakhania} />
      <MapSection destination={lakhania} />
      <AskD360 destination={lakhania} />
      <CommunityStories destination={lakhania} />
      <PracticalInfo />
      <SourcesTrust destination={lakhania} />
      <Footer />
    </div>
  )
}
