...
const tanda: Destination = {
  id: 'tanda-fall-mirzapur',
  slug: 'tanda-fall-mirzapur',
  name: 'Tanda Fall',
  localName: 'टांडा जलप्रपात (मिर्ज़ापुर)',
  destinationType: 'Rocky Forest Cascade & Reservoir Landscape',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Mirzapur',
  shortDescription: "Tranquil Vindhyan rock cascade framed by forested slopes and the scenic Tanda Dam reservoir—Mirzapur's premier monsoon nature retreat and family picnic escape.",
  tags: ['VINDHYAN CASCADE', 'TANDA DAM RESERVOIR', 'MONSOON NATURE RETREAT', 'MIRZAPUR CIRCUIT'],
  hero: {
    image: '/images/tanda_hero_fullhd.jpg',
    poster: '/images/tanda_dam_reservoir.jpg'
  },
  quickFacts: {
    bestTime: 'Jul – Feb (Peak: Jul – Oct)',
    duration: 'Half Day / 3–4 Hrs',
    budget: '₹ (Low Cost)',
    destinationType: 'Rocky Cascade & Forest Dam',
    difficulty: 'Easy–Moderate',
    distance: '~14 km from Mirzapur / Pahari Road'
  },
  discoveryScore: {
    overall: 9.2,
    categories: [
      { name: 'Monsoon Cascade Spectacle', score: 9.6 },
      { name: 'Dam Reservoir & Water Views', score: 9.4 },
      { name: 'Vindhyan Rocky Formations', score: 9.1 },
      { name: 'Peaceful Picnic Atmosphere', score: 9.3 },
      { name: 'Circuit Connectivity (Vindhyachal)', score: 9.0 }
    ]
  },
  editorial: {
    why: "Nestled in the serene Vindhya foothills just 14 km from Mirzapur city, Tanda Fall offers a refreshing nature escape where seasonal mountain streams cascade over dark sandstone rock shelves directly opposite the placid waters of the Tanda Dam reservoir.",
    story: "Celebrated by the Mirzapur district administration as a destination of pristine natural tranquility, Tanda Fall comes alive during the monsoon when rushing waters turn milky white, filling rocky plunge pools and invigorating the surrounding dry deciduous forest.",
    storyFull: "For generations, families and nature lovers across Mirzapur, Prayagraj, and Varanasi have gathered here for weekend picnics and leisurely walks along the reservoir bund, pairing the waterfall visit with the sacred shrines of Vindhyachal and nearby sister cascades like Wyndham Fall."
  },
  history: {
    shortIntro: "From natural Vindhyan rock streams to a vital regional water reservoir and cherished eco-tourism destination.",
    timeline: [
      { year: 'Ancient Era', event: 'Natural geological sculpting of sandstone shelves and rocky plunge pools across millions of years in the Vindhya range.', era: 'Geological Formation' },
      { year: '20th Century', event: 'Construction of Tanda Dam across the seasonal stream to conserve rainwater and support regional irrigation and groundwater recharge.', era: 'Dam & Reservoir Creation' },
      { year: '1980s–2000s', event: 'Emergence as Mirzapur foremost monsoon weekend picnic spot, renowned for tranquil landscapes and cool breezes.', era: 'Picnic Tradition' },
      { year: 'Present', event: 'Integrated into the Vindhyachal-Mirzapur tourism circuit, attracting nature enthusiasts, photographers, and pilgrims year-round.', era: 'Modern Eco-Tourism' }
    ]
  },
  culture: [
    { title: 'Vindhyan Monsoon Picnic Culture', description: 'Centuries-old local tradition of families preparing fresh bati-chokha and seasonal snacks by shaded forest streams after rainy showers.', image: '/images/litti_chokha.jpg' },
    { title: 'Mirzapur Craft & Stone Heritage', description: 'Connection to the historic sandstone quarries, brass craft workshops, and handmade carpet weaving legacies of Mirzapur.', image: '/images/sandstone_cliff_strata.jpg' },
    { title: 'Vindhyachal Shaktipeeth Circuit', description: 'Deep cultural synergy with Maa Vindhyavasini Temple and Ashtabhuja shrine located just 15 km away in Vindhyachal.', image: '/images/chandraprabha_forest.jpg' },
    { title: 'Reservoir & Watershed Harmony', description: 'Appreciation of how Tanda Dam sustains local agriculture while providing a serene open-water recreational landscape.', image: '/images/tanda_dam_reservoir.jpg' }
  ],
  food: [
    { name: 'Mirzapur Baati Chokha with Pure Desi Ghee', description: 'Wood-fired wheat batis drenched in fragrant desi ghee, served with spicy roasted brinjal-tomato chokha and yellow toor dal.', category: 'Signature Picnic Meal', price: '₹60–₹110/plate', image: '/images/litti_chokha.jpg' },
    { name: 'Crisp Urad Dal Kachori & Hing Aloo', description: 'Flaky golden kachoris stuffed with spiced black gram, served alongside piping hot asafetida-flavored potato curry.', category: 'Breakfast Staple', price: '₹30–₹50', image: '/images/kachori.jpg' },
    { name: 'Desi Samosa & Matar Chaat', description: 'Crushed potato samosas topped with warm white peas curry, sweet tamarind chutney, and fresh mint-coriander sauce.', category: 'Snack', price: '₹25–₹45', image: '/images/samosa_chaat.jpg' },
    { name: 'Chilled Spiced Sattu Sharbat', description: 'Nutritious roasted gram flour beverage blended with black salt, roasted cumin, and fresh lemon juice for energy on hot days.', category: 'Beverage', price: '₹20–₹35', image: '/images/sattu_drink.jpg' },
    { name: 'Traditional Mirzapur Peda & Rice Kheer', description: 'Slow-cooked condensed milk fudge and creamy cardamom-flavored rice pudding garnished with roasted cashews.', category: 'Dessert', price: '₹35–₹65', image: '/images/kheer.jpg' }
  ],
  attractions: [
    { id: 'tanda-fall-main', name: 'Tanda Waterfall Main Cascade', category: 'Nature / Scenic', description: 'Milky white seasonal cascade rushing over weathered sandstone shelves into rocky natural pools during monsoon months.', duration: '2 hrs', distance: 'Main Site', score: 9.7, image: '/images/tanda_hero_fullhd.jpg' },
    { id: 'tanda-dam-reservoir', name: 'Tanda Dam Reservoir Lake', category: 'Waterbody', description: 'Expansive water storage reservoir directly facing the waterfall, framed by green hills and offering tranquil water views.', duration: '1.5 hrs', distance: 'Adjacent to Falls', score: 9.5, image: '/images/tanda_dam_reservoir.jpg' },
    { id: 'rocky-stream-channels', name: 'Vindhyan Rocky Stream Channels', category: 'Geology & Streams', description: 'Natural sandstone channels, rock pools, and cascading rapids providing picturesque landscape photography.', duration: '1 hr', distance: 'Upper Stream', score: 9.2, image: '/images/rocky_cascade.jpg' },
    { id: 'forested-picnic-groves', name: 'Forested Hillside Picnic Groves', category: 'Recreation', description: 'Shaded groves under ancient Mahua, Sal, and Banyan trees offering ideal family picnic lawns and resting spots.', duration: '1.5 hrs', distance: 'Lake Perimeter', score: 9.3, image: '/images/chandraprabha_forest.jpg' },
    { id: 'wyndham-waterfall-circuit', name: 'Wyndham Fall Regional Circuit', category: 'Waterfall Circuit', description: 'Another renowned sister waterfall in Mirzapur (~15 km), famous for rocky rapids and forest viewpoints.', duration: '2 hrs', distance: '15 km West', score: 9.1, image: '/images/rajdari_monsoon_stream.jpg' },
    { id: 'vindhyachal-shaktipeeth', name: 'Maa Vindhyavasini Temple Corridor', category: 'Pilgrimage Heritage', description: 'Ancient sacred Shaktipeeth shrine and Ganga river ghats situated just 15 km northwest in Vindhyachal.', duration: '2 hrs', distance: '15 km Northwest', score: 9.4, image: '/images/kachori.jpg' }
  ],
  hiddenGems: [
    { name: 'Reservoir Spillway Sunrise Bank', why: 'Quiet eastern bank of Tanda Dam offering serene dawn reflections and mist rising over calm water.', distance: '500m along Dam Bund', duration: '45 min', image: '/images/tanda_dam_reservoir.jpg' },
    { name: 'Pagar Forest Stream Trail', why: 'Unpaved nature walking trail along the stream gorge through untouched dry deciduous woodland.', distance: '1 km Upstream', duration: '1 hr', image: '/images/chandraprabha_forest.jpg' },
    { name: 'Upper Sandstone Ledge Lookout', why: 'Natural elevated rock perch offering a sweeping view of both the active cascade and the reservoir behind it.', distance: 'Upper Ridge', duration: '30 min', image: '/images/tanda_hero_fullhd.jpg' }
  ],
  thingsToDo: [
    { activity: 'Monsoon Waterfall & Rock Photography', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '08:30 AM – 11:30 AM (Jul–Oct)', image: '/images/tanda_hero_fullhd.jpg' },
    { activity: 'Tanda Dam Bund Stroll & Water Views', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: 'Late Afternoon / Sunset', image: '/images/tanda_dam_reservoir.jpg' },
    { activity: 'Traditional Forest Baati Chokha Picnic', duration: '1.5 hrs', cost: '₹70–₹130', difficulty: 'Easy', bestTime: '01:00 PM – 02:30 PM', image: '/images/litti_chokha.jpg' },
    { activity: 'Combined Vindhyachal Temple Darshan', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning / Evening', image: '/images/kachori.jpg' },
    { activity: 'Wyndham Fall & Mirzapur City Exploration', duration: '3 hrs', cost: '₹200–₹400', difficulty: 'Easy', bestTime: 'Afternoon Circuit', image: '/images/rajdari_monsoon_stream.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Mirzapur City & Railway Station', distance: '14 km', type: 'District Headquarters', travelTime: '30 min', image: '/images/kachori.jpg' },
    { name: 'Maa Vindhyavasini Temple (Vindhyachal)', distance: '15 km', type: 'Major Shaktipeeth', travelTime: '35 min', image: '/images/chandraprabha_forest.jpg' },
    { name: 'Wyndham Fall', distance: '15 km', type: 'Scenic Waterfall', travelTime: '30 min', image: '/images/rajdari_monsoon_stream.jpg' },
    { name: 'Chunar Historic Fort', distance: '45 km', type: 'Ganges Hill Fortress', travelTime: '1 hr', image: '/images/sandstone_cliff_strata.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri International Airport Varanasi (VNS)', distance: 'Approx. 88 km', time: 'Approx. 2.5 hours drive via NH-19 and Mirzapur Road' },
    rail: { station: 'Mirzapur Railway Station (MZP) / Vindhyachal (BDL)', distance: '14 km / 18 km from waterfall', time: 'Major mainline junction on Delhi-Howrah route with superfast train connectivity' },
    road: { highway: 'Mirzapur–Pahari Road', distance: '14 km south of Mirzapur city on paved district road', time: 'Easily accessible by private taxi, personal car, or hired auto-rickshaw in 30–40 minutes' }
  },
  stay: {
    categories: [
      { type: 'Mirzapur City Comfort Hotels', range: '₹1,600–₹3,500/night', options: ['Hotel The Galaxy Mirzapur', 'Hotel Konark Heritage', 'The Retreat Mirzapur (14 km base)'] },
      { type: 'Vindhyachal Pilgrim Lodges', range: '₹800–₹1,800/night', options: ['UP Tourism Rahi Yatri Niwas Vindhyachal', 'Temple Trust Dharamshalas'] },
      { type: 'Budget Guesthouses & Homestays', range: '₹600–₹1,200/night', options: ['Station Road Lodges Mirzapur', 'Pahari Road Highway Guesthouses'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Day Tripper', perDay: '₹400–₹750', breakdown: [{ category: 'Shared Auto / Bus from Mirzapur', amount: '₹100–₹200' }, { category: 'Packed Food & Snacks', amount: '₹150–₹250' }, { category: 'Tea & Refreshments', amount: '₹100–₹150' }] },
      { tier: 'Family Day Out from Varanasi', perDay: '₹1,800–₹3,000', breakdown: [{ category: 'Private Taxi from Varanasi (~80 km)', amount: '₹1,400–₹2,000' }, { category: 'Family Dhaba Lunch & Sweets', amount: '₹400–₹700' }, { category: 'Parking & Offerings', amount: '₹100+' }] },
      { tier: 'Mirzapur Waterfall & Temple Weekend', perDay: '₹3,200+', breakdown: [{ category: 'Hotel Base in Mirzapur', amount: '₹1,600–₹2,600' }, { category: 'Chauffeur Cab Full Day', amount: '₹1,200–₹1,800' }, { category: 'Dining & Experiences', amount: '₹600+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '08:00 AM', place: 'Depart Mirzapur city along Mirzapur-Pahari road toward Tanda Fall', duration: '35 min', distance: '14 km' }, { time: '08:45 AM', place: 'Explore Tanda Waterfall cascade and photograph rocky plunge pools', duration: '2 hrs', distance: 'Main Waterfall' }, { time: '10:45 AM', place: 'Walk along the Tanda Dam reservoir bund enjoying cool breezes and lake views', duration: '1 hr', distance: 'Tanda Dam' }, { time: '12:00 PM', place: 'Enjoy hot Baati Chokha or packed picnic lunch under shaded trees', duration: '1 hr', distance: 'Picnic Lawn' }, { time: '01:30 PM', place: 'Short drive to neighboring Wyndham Fall or Vindhyachal Maa Vindhyavasini Temple', duration: '2.5 hrs', distance: '15 km' }, { time: '04:30 PM', place: 'Return to Mirzapur city for famous local peda and evening tea', duration: '1 hr', distance: 'Mirzapur City' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Morning arrival in Mirzapur, check-in, and transfer to Tanda Fall & Tanda Dam', duration: '4 hrs', distance: 'Tanda' }, { time: '02:00 PM', place: 'Lunch followed by visit to Wyndham Fall and Sirsi Dam scenic overflow', duration: '3.5 hrs', distance: 'Waterfall Circuit' }, { time: '06:00 PM', place: 'Evening leisure in Mirzapur city with carpet weaving market tour', duration: '2 hrs', distance: 'Mirzapur' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Sacred Vindhyachal pilgrimage: Maa Vindhyavasini, Kali Khoh, and Ashtabhuja Temple', duration: '4 hrs', distance: 'Vindhyachal' }, { time: '01:00 PM', place: 'Excursion to historic Chunar Fort overlooking the holy River Ganges', duration: '3 hrs', distance: 'Chunar' }, { time: '05:00 PM', place: 'Return transit via Mirzapur or Varanasi Cantt railway station', duration: '1.5 hrs', distance: 'Transit' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Varanasi to Mirzapur: Tanda Fall, Tanda Dam, and traditional picnic lunch', duration: '6 hrs', distance: 'Mirzapur' }, { time: '05:30 PM', place: 'Sunset along the Ganga ghats in Mirzapur and hotel check-in', duration: '2 hrs', distance: 'Mirzapur' }] },
      { day: 2, schedule: [{ time: '08:30 AM', place: 'Full-day Vindhyan nature trail: Wyndham Fall, Meja Dam, and Lal Bhairav shrine', duration: '7 hrs', distance: 'Vindhyan Hills' }, { time: '05:30 PM', place: 'Evening dining with authentic Purvanchali cuisine', duration: '2 hrs', distance: 'Hotel' }] },
      { day: 3, schedule: [{ time: '08:00 AM', place: 'Vindhyachal spiritual darshan and excursion to Chunar Fort stone monuments', duration: '5 hrs', distance: 'Chunar' }, { time: '03:30 PM', place: 'Return transit to Varanasi Airport / Railway station', duration: '2 hrs', distance: 'Transit' }] }
    ]
  },
  experiences: [
    { title: 'Monsoon Waterfall & Plunge Pool Walk', duration: '2 hrs', price: 'Free Entry', category: 'Nature', image: '/images/tanda_hero_fullhd.jpg' },
    { title: 'Tanda Dam Lakeview Contemplation', duration: '1 hr', price: 'Free', category: 'Scenic', image: '/images/tanda_dam_reservoir.jpg' },
    { title: 'Vindhyachal Pilgrim Nature Circuit', duration: '3 hrs', price: 'Free', category: 'Heritage', image: '/images/chandraprabha_forest.jpg' },
    { title: 'Purvanchali Desi Ghee Baati Chokha Picnic', duration: '1.5 hrs', price: '₹80–₹150', category: 'Culinary', image: '/images/litti_chokha.jpg' }
  ],
  aiPrompts: [
    "What is the best time to visit Tanda Fall in Mirzapur?",
    "How far is Tanda Fall from Mirzapur railway station and Vindhyachal?",
    "What safety precautions are needed around slippery rocks in monsoon?",
    "Can I combine Tanda Fall, Wyndham Fall, and Vindhyavasini Temple in one day?",
    "What food options and facilities are available near Tanda Dam?",
    "टांडा जलप्रपात मिर्ज़ापुर जाने का सही रास्ता, समय और जरूरी सावधानियां क्या हैं?"
  ],
  reviews: [
    { name: 'Praveen Upadhyay', location: 'Mirzapur', text: 'Tanda Fall is our favorite monsoon escape. When the rain falls, the cascade turns milky white and the view of Tanda Dam right in front is breathtaking. Perfect for family picnics!', rating: 5, image: '/images/tanda_hero_fullhd.jpg', date: 'August 2026' },
    { name: 'Dr. Shalini Singh', location: 'Varanasi', text: 'Only a 2-hour drive from Varanasi. We visited Maa Vindhyavasini Temple in the morning and spent a peaceful afternoon at Tanda Fall. Cool breeze from the reservoir is so refreshing.', rating: 5, image: '/images/tanda_dam_reservoir.jpg', date: 'September 2026' },
    { name: 'Anurag Gupta', location: 'Prayagraj', text: 'Great rocky terrain and clean water during July to October. Make sure to wear shoes with good grip and carry your own drinking water and snacks.', rating: 5, image: '/images/rocky_cascade.jpg', date: 'October 2025' }
  ],
  sources: {
    official: ['Mirzapur District Administration (mirzapur.nic.in/tourist-place/tanda-fall)', 'Uttar Pradesh Tourism Official Directory', 'Ministry of Tourism Regional Scenic Compendium'],
    historical: ['Mirzapur District Gazetteer', 'Irrigation Department Records of Tanda Dam Reservoir'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">Monsoon Peak</p>
              <p className="text-xs text-white/60 mt-1">Vindhyan Rock Cascade & Dam</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Tanda Waterfall Main Cascade' }, { top: '42%', left: '38%', label: 'Tanda Dam Reservoir' }, { top: '28%', left: '52%', label: 'Vindhya Forest Picnic Grounds' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('best time') && `The best time to visit is during the monsoon and post-monsoon (July to February). The waterfall is at its peak flow between July and October when water turns milky white.`}
                  {selected?.includes('How far') && `Tanda Fall is located ~14 km south of Mirzapur railway station along the Mirzapur–Pahari road (30–40 mins) and ~15 km from Maa Vindhyavasini Temple in Vindhyachal.`}
                  {selected?.includes('precautions') && `Always wear shoes with strong grip, avoid wet algae-covered rocks, never enter deep reservoir waters, and depart before dark.`}
                  {selected?.includes('combine') && `Yes! A popular 1-day itinerary includes morning darshan at Vindhyachal, afternoon picnic at Tanda Fall & Tanda Dam, and a stop at Wyndham Fall before returning.`}
                  {selected?.includes('facilities') && `On-site food is limited to small seasonal tea and snack stalls. It is best to carry drinking water and packed snacks, or dine in Mirzapur city.`}
                  {selected?.includes('sahii rasta') && `टांडा जलप्रपात मिर्ज़ापुर रेलवे स्टेशन से लगभग 14 किमी की दूरी पर मिर्ज़ापुर-पहाड़ी मार्ग पर स्थित है। बरसात के मौसम (जुलाई से अक्टूबर) में पानी का प्रवाह सबसे मनमोहक होता है। चट्टानें फिसलने वाली होती हैं, इसलिए मजबूत पकड़ वाले जूते पहनें।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Slippery Rocks & Flow Caution', content: 'The Mirzapur district administration specifically warns that rocks become extremely slippery during the monsoon. Never step onto wet mossy ledges or active waterfall stream channels.' },
    { title: 'Tanda Dam Reservoir Safety', content: 'Tanda Dam is a deep water body directly opposite the falls. Stay away from restricted dam infrastructure, steep embankments, and deep water.' },
    { title: 'Footwear & Monsoon Gear', content: 'Wear sturdy sports shoes or hiking sandals with high-grip rubber soles. Avoid smooth leather shoes or slick flip-flops.' },
    { title: 'Limited On-Site Catering', content: 'Catering facilities at the falls are very limited. Carry ample drinking water, light snacks, and a garbage bag to pack out all waste.' },
    { title: 'Emergency & District Contacts', content: 'UP Police Emergency: 112 · Mirzapur Police Control: +91-5442-252200 · District Hospital Mirzapur: +91-5442-252400 · UP Tourism Helpline: 1800-180-1414.' },
    { title: 'Daylight Visits & Mobile Reach', content: 'Finish your waterfall and dam visit well before sunset. Mobile network connectivity may fluctuate in deeper forested hill pockets.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={tanda} />
      <QuickFacts facts={tanda.quickFacts} />
      <WhyVisit destination={tanda} />
      <DestinationStory destination={tanda} />
      <HistoryTimeline destination={tanda} />
      <CultureGrid destination={tanda} />
      <FoodSection destination={tanda} />
      <AttractionsGrid destination={tanda} />
      <HiddenGems destination={tanda} />
      <ThingsToDo destination={tanda} />
      <NearbyPlaces destination={tanda} />
      <HowToReach destination={tanda} />
      <WhereToStay destination={tanda} />
      <BestTime destination={tanda} />
      <BudgetGuide destination={tanda} />
      <Itineraries destination={tanda} />
      <LocalExperiences destination={tanda} />
      <MapSection destination={tanda} />
      <AskD360 destination={tanda} />
      <CommunityStories destination={tanda} />
      <PracticalInfo />
      <SourcesTrust destination={tanda} />
      <Footer />
    </div>
  )
}
