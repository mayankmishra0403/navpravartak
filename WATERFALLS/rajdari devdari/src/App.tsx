...
// ─── Rajdari & Devdari Waterfalls Data ───────────────────────────────────────

const rajdariDevdari: Destination = {
  id: 'rajdari-devdari-waterfalls',
  slug: 'rajdari-devdari-waterfalls-chandauli',
  name: 'Rajdari & Devdari Waterfalls',
  localName: 'राजदरी एवं देवदरी जलप्रपात (चंदौली)',
  destinationType: 'Tiered Stepped Cascade & Forest Gorge Waterfalls',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Chandauli',
  shortDescription: "A spectacular paired monsoon cascade framed by rocky forest, where stepped sandstone terraces and deep river gorges define Chandauli's premier wilderness escape.",
  tags: ['STEPPED WATERFALL', 'CHANDRAPRABHA SANCTUARY', 'PAIRED MONSOON CASCADE'],
  hero: {
    image: '/images/rajdari_hero_fullhd.jpg',
    poster: '/images/devdari_waterfall.jpg'
  },
  quickFacts: {
    bestTime: 'Jul – Feb',
    duration: 'Full Day Outing',
    budget: '₹',
    destinationType: 'Paired Forest Waterfalls',
    difficulty: 'Easy–Moderate',
    distance: '~65 km from Varanasi / DDU'
  },
  discoveryScore: {
    overall: 9.4,
    categories: [
      { name: 'Hydrological Beauty', score: 9.8 },
      { name: 'Sanctuary Biodiversity', score: 9.4 },
      { name: 'Stepped Rock Formations', score: 9.6 },
      { name: 'Crowd Level', score: 9.3 },
      { name: 'Picnic & Nature Value', score: 9.1 }
    ]
  },
  editorial: {
    why: "Nestled deep within the forested hills of the Chandraprabha Wildlife Sanctuary, the paired cascades of Rajdari and Devdari present one of Eastern Uttar Pradesh most enchanting natural spectacles, where the Chandraprabha River carves its way through ancient Vindhyan sandstone terraces.",
    story: "Set inside a protected wildlife sanctuary notified in 1957—originally chosen as a pioneering conservation habitat for Asiatic lions—Rajdari cascades down multiple natural giant stone steps, while its sister waterfall Devdari plunges dramatically into a sheer canyon just 500 meters downstream.",
    storyFull: "During the monsoon and winter seasons, the forest comes alive with lush emerald canopies, mist-veiled viewpoints, and the roar of cascading streams. Families, photographers, and nature lovers travel from Varanasi, Prayagraj, and Bihar to spend unhurried days amidst cool river spray, sprawling picnic lawns, and canopy watchtowers overlooking the wild Vindhyan plateau."
  },
  history: {
    shortIntro: "From the royal hunting forests of the Kashi Kingdom to a 1957 wildlife sanctuary and eco-tourism haven.",
    timeline: [
      { year: 'Ancient Era', event: 'Natural geological formation of tiered sandstone terraces through millions of years of Chandraprabha River fluvial erosion.', era: 'Geological Origin' },
      { year: 'Medieval Era', event: 'Dense forests of Chakia and Naugarh served as royal hunting preserves and strategic hill forts for Kashi Naresh rulers.', era: 'Kashi Kingdom' },
      { year: '1957 AD', event: 'Notified as the Chandraprabha Wildlife Sanctuary covering nearly 9,600 hectares, serving as an early translocation site for Asiatic lions.', era: 'Sanctuary Notification' },
      { year: '1980s', event: 'Development of designated forest rest houses, landscaped picnic lawns, and stepped safety viewpoints by the UP Forest Department.', era: 'Eco-Tourism Setup' },
      { year: 'Present', event: 'Chandauli foremost natural tourism hub featuring twin cascades, wildlife watchtowers, and pristine Vindhyan hill circuits.', era: 'Modern Destination' }
    ]
  },
  culture: [
    { title: 'Chandraprabha Wildlife Heritage', description: 'The sanctuary shelters diverse fauna including leopards, chital, sambar, wild boars, and over 150 species of resident and migratory woodland birds.', image: '/images/chandraprabha_forest.jpg' },
    { title: 'Purvanchali Picnic Tradition', description: 'For generations, families across Varanasi and eastern UP have celebrated winter Sundays by preparing fresh bati-chokha on open campfires near forest streams.', image: '/images/rajdari_monsoon_stream.jpg' },
    { title: 'Naugarh Hill Fortress Lore', description: 'Surrounding hills preserve ancient legends of Naugarh Fort and royal secret tunnels connecting the Vindhyan forest retreats to Varanasi.', image: '/images/devdari_gorge.jpg' },
    { title: 'Vindhyan Stone & Woodcraft', description: 'Local artisans in Chakia and Chandauli maintain traditional sandstone masonry, red clay pottery, and bamboo forest crafts.', image: '/images/rajdari_stepped_cascade.jpg' }
  ],
  food: [
    { name: 'Authentic Dal-Bati & Chokha', description: 'Hard wheat flour batis roasted over cow-dung or charcoal fire, dipped in pure desi ghee, served with spiced toor dal and fire-roasted brinjal-tomato chokha.', category: 'Signature Picnic Meal', price: '₹70–₹120/plate', image: '/images/litti_chokha.jpg' },
    { name: 'Chandauli Khasta Urad Kachori', description: 'Extra-crispy flaky pastries stuffed with spiced black gram lentils, accompanied by tangy potato-curry and fresh mint-coriander chutney.', category: 'Breakfast', price: '₹25–₹45', image: '/images/kachori.jpg' },
    { name: 'Spiced Sattu Sharbat', description: 'Chilled roasted gram flour drink flavored with black salt, roasted cumin, chopped onions, and lemon—the perfect summer refreshment.', category: 'Beverage', price: '₹20–₹35', image: '/images/sattu_drink.jpg' },
    { name: 'Desi Samosa Chaat & Mattha', description: 'Hot potato samosas crushed over spiced chickpea curry, sweetened curd, and tamarind chutney, paired with fresh country buttermilk.', category: 'Snack', price: '₹30–₹50', image: '/images/samosa_chaat.jpg' },
    { name: 'Traditional Thekua & Kheer', description: 'Crisp deep-fried wheat and jaggery cookies served with thick slow-cooked rice kheer garnished with cardamom and dry fruits.', category: 'Dessert', price: '₹35–₹60', image: '/images/kheer.jpg' }
  ],
  attractions: [
    { id: 'rajdari-stepped-waterfall', name: 'Rajdari Stepped Waterfall', category: 'Nature / Scenic', description: 'The grand multi-tiered stepped waterfall cascading over wide natural sandstone shelves, surrounded by landscaped lawns and walking tracks.', duration: '2–3 hrs', distance: 'Main Complex', score: 9.9, image: '/images/rajdari_hero_fullhd.jpg' },
    { id: 'devdari-canyon-waterfall', name: 'Devdari Gorge & Plunge Fall', category: 'Nature', description: 'Spectacular deep gorge waterfall located 700 meters downstream from Rajdari, plunging directly into a rocky canyon pool.', duration: '1.5–2 hrs', distance: '700m Downstream', score: 9.7, image: '/images/devdari_waterfall.jpg' },
    { id: 'chandraprabha-sanctuary-trails', name: 'Chandraprabha Wildlife Sanctuary Trails', category: 'Wildlife', description: '9,600-hectare protected Vindhyan forest reserve offering wildlife trails, deer sightings, and rich avian biodiversity.', duration: '2 hrs', distance: 'Sanctuary Environs', score: 9.3, image: '/images/chandraprabha_forest.jpg' },
    { id: 'chandraprabha-dam-reservoir', name: 'Chandraprabha Dam & Reservoir', category: 'Nature / Scenic', description: 'Scenic irrigation reservoir nestled among forest hills, providing serene water views and tranquil sunset viewpoints.', duration: '1 hr', distance: '5 km from falls', score: 9.1, image: '/images/rajdari_monsoon_stream.jpg' },
    { id: 'canopy-watchtower-point', name: 'Forest Canopy Watchtower', category: 'Nature', description: 'Elevated wooden and steel watchtower offering 360-degree panoramic views over the Vindhyan forest canopy and river gorge.', duration: '45 min', distance: 'Upper Ridge', score: 9.2, image: '/images/devdari_gorge.jpg' },
    { id: 'naugarh-fort-heritage', name: 'Naugarh Historic Hill Fort', category: 'Heritage', description: 'Medieval hilltop fortification built amidst dense forests, commanding ancient trade routes and panoramic valley views.', duration: '2 hrs', distance: '22 km from falls', score: 9.0, image: '/images/rajdari_stepped_cascade.jpg' }
  ],
  hiddenGems: [
    { name: 'Latif Shah Dam & Historical Tomb', why: 'A historic Mughal-era stone dam across the Karmanasa River near Chakia, featuring the ancient revered tomb of Sufi saint Latif Shah.', distance: '18 km from Rajdari', duration: '1.5 hrs', image: '/images/devdari_gorge.jpg' },
    { name: 'Sirsi Dam & Waterfalls', why: 'A secluded reservoir and overflow waterfall in the neighboring forest range, offering total peace away from weekend picnic crowds.', distance: '32 km from sanctuary', duration: '2 hrs', image: '/images/rajdari_monsoon_stream.jpg' },
    { name: 'Chakia Ancient Sandstone Stepwells', why: 'Historic stone stepwells and baolis built during the Kashi kingdom era for royal travelers navigating forest corridors.', distance: '15 km in Chakia', duration: '1 hr', image: '/images/rajdari_stepped_cascade.jpg' }
  ],
  thingsToDo: [
    { activity: 'Stepped Waterfall Viewpoint & Photography', duration: '2 hrs', cost: '₹50 (Sanctuary Entry)', difficulty: 'Easy', bestTime: '08:30 AM – 11:30 AM, Jul–Feb', image: '/images/rajdari_hero_fullhd.jpg' },
    { activity: 'Devdari Canyon Gorge Nature Hike', duration: '1.5 hrs', cost: 'Included', difficulty: 'Moderate', bestTime: 'Morning / Late Afternoon', image: '/images/devdari_waterfall.jpg' },
    { activity: 'Traditional Forest Picnic & Dal-Bati Feast', duration: '2 hrs', cost: '₹80–₹150', difficulty: 'Easy', bestTime: '01:00 PM – 03:00 PM', image: '/images/litti_chokha.jpg' },
    { activity: 'Canopy Watchtower Birdwatching', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: 'Golden Hour (04:00 PM)', image: '/images/chandraprabha_forest.jpg' },
    { activity: 'Chandraprabha Dam Sunset Drive', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: '05:00 PM – 06:00 PM', image: '/images/rajdari_monsoon_stream.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Chakia Market Town', distance: '15 km', type: 'Local Hub & Transit', travelTime: '25 min', image: '/images/rajdari_stepped_cascade.jpg' },
    { name: 'Pt Deen Dayal Upadhyaya Junction (DDU)', distance: '50 km', type: 'Major Railway Terminal', travelTime: '1.2 hrs', image: '/images/devdari_gorge.jpg' },
    { name: 'Varanasi Heritage City & Ghats', distance: '65 km', type: 'Spiritual & Tourism Hub', travelTime: '1.5 hrs', image: 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=500&h=340&fit=crop&auto=format' },
    { name: 'Naugarh Fort & Forests', distance: '22 km', type: 'Hill Fortress', travelTime: '35 min', image: '/images/chandraprabha_forest.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri Airport Varanasi (VNS)', distance: '85 km from falls', time: 'Approx. 2 hours drive via NH-19 and Chakia State Highway' },
    rail: { station: 'Pt. Deen Dayal Upadhyay Junction (DDU) / Varanasi Cantt (BSB)', distance: '50 km / 65 km', time: 'DDU is one of India busiest mainline railway junctions with superfast train connectivity nationwide' },
    road: { highway: 'State Highway via Chandauli / Chakia / Naugarh', distance: 'Scenic paved road climbing the Vindhyan foothills', time: 'Taxis, private cars, and tourist buses easily available from Varanasi and DDU (~1.5 hrs)' }
  },
  stay: {
    categories: [
      { type: 'Varanasi Heritage & Luxury Hotels', range: '₹2,500–₹8,000/night', options: ['Taj Ganges Varanasi', 'BrijRama Palace', 'Radisson Hotel Varanasi (65 km base)'] },
      { type: 'Chandauli & DDU Guesthouses', range: '₹1,000–₹2,200/night', options: ['Hotel Grand DDU', 'Chandauli Highway Tourist Lodge'] },
      { type: 'Forest Rest Houses', range: '₹800–₹1,500/night', options: ['UP Forest Rest House Chandraprabha (Booking via Forest Dept)', 'Chakia Inspection Bungalow'] }
    ]
  },
  bestTime: {
    months: [
      { month: 'Jan', status: 'ideal' }, { month: 'Feb', status: 'ideal' }, { month: 'Mar', status: 'good' },
      { month: 'Apr', status: 'avoid' }, { month: 'May', status: 'avoid' }, { month: 'Jun', status: 'good' },
      { month: 'Jul', status: 'ideal' }, { month: 'Aug', status: 'ideal' }, { month: 'Sep', status: 'ideal' },
      { month: 'Oct', status: 'ideal' }, { month: 'Nov', status: 'ideal' }, { month: 'Dec', status: 'ideal' }
    ]
  },
  budget: {
    tiers: [
      { tier: 'Budget Day Tripper', perDay: '₹600–₹1,200', breakdown: [{ category: 'Shared Transit / Bus', amount: '₹150–₹250' }, { category: 'Picnic Food & Snacks', amount: '₹200–₹350' }, { category: 'Sanctuary Entry', amount: '₹50' }, { category: 'Tea & Refreshments', amount: '₹100–₹200' }] },
      { tier: 'Family Day Out from Varanasi', perDay: '₹2,200–₹3,800', breakdown: [{ category: 'Private Cab from Varanasi/DDU', amount: '₹1,600–₹2,400' }, { category: 'Dhaba Lunch & Snacks', amount: '₹400–₹600' }, { category: 'Vehicle & Person Entry', amount: '₹100–₹200' }, { category: 'Activities & Guide', amount: '₹300+' }] },
      { tier: 'Chandraprabha & Kaimur Safari', perDay: '₹4,500+', breakdown: [{ category: 'Hotel Base in Varanasi', amount: '₹2,500–₹4,000' }, { category: 'Full Day Chauffeur SUV', amount: '₹2,200–₹3,000' }, { category: 'Gourmet Picnic & Guide', amount: '₹1,000+' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '08:00 AM', place: 'Drive from Varanasi/DDU through scenic Chakia countryside into sanctuary gates', duration: '1.5 hrs', distance: '65 km' }, { time: '09:30 AM', place: 'Explore Rajdari Stepped Waterfall, photograph cascade across rock shelves, and walk lawns', duration: '2 hrs', distance: 'Rajdari Complex' }, { time: '11:30 AM', place: 'Walk 700m to Devdari Waterfall canyon and observe deep plunge gorge', duration: '1.5 hrs', distance: 'Devdari Gorge' }, { time: '01:00 PM', place: 'Enjoy authentic Dal-Bati Chokha picnic lunch beneath shaded forest trees', duration: '1.5 hrs', distance: 'Picnic Lawns' }, { time: '02:30 PM', place: 'Climb Canopy Watchtower for panoramic views and drive to Chandraprabha Dam', duration: '1.5 hrs', distance: '5 km' }, { time: '04:30 PM', place: 'Return drive toward Varanasi with a brief stop at historic Latif Shah Dam', duration: '1.5 hrs', distance: 'Chakia Road' }] }],
    '2 Days': [
      { day: 1, schedule: [{ time: '08:30 AM', place: 'Full-day nature exploration of Rajdari & Devdari Waterfalls and Chandraprabha Sanctuary', duration: '5 hrs', distance: 'Sanctuary' }, { time: '02:30 PM', place: 'Afternoon visit to Chandraprabha Dam reservoir and Naugarh hill fortress', duration: '3 hrs', distance: 'Naugarh' }, { time: '05:30 PM', place: 'Return to hotel in Varanasi or DDU for evening dinner', duration: '2 hrs', distance: 'Varanasi' }] },
      { day: 2, schedule: [{ time: '08:00 AM', place: 'Morning drive to neighboring Karkatgarh Waterfall and crocodile sanctuary on the border', duration: '4 hrs', distance: 'Karkatgarh (45 km)' }, { time: '01:00 PM', place: 'Lunch followed by visit to ancient 108 AD Maa Mundeshwari Temple', duration: '3 hrs', distance: 'Mundeshwari' }, { time: '05:00 PM', place: 'Return to Varanasi for evening Ganga Aarti at Dashashwamedh Ghat', duration: '2 hrs', distance: 'Ghats' }] }
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: '09:00 AM', place: 'Arrival in Varanasi & full-day heritage excursion to Rajdari & Devdari Waterfalls', duration: '6 hrs', distance: 'Chandauli' }, { time: '05:00 PM', place: 'Sunset over Vindhyan foothills and return to Varanasi hotel', duration: '2 hrs', distance: 'Varanasi' }] },
      { day: 2, schedule: [{ time: '08:30 AM', place: 'Borderland waterfall trail: Karkatgarh Waterfall & Telhar Kund in Kaimur range', duration: '6 hrs', distance: 'Kaimur' }, { time: '04:00 PM', place: 'Explore historic Naugarh Fort and prehistoric rock art shelters', duration: '3 hrs', distance: 'Naugarh' }] },
      { day: 3, schedule: [{ time: '08:00 AM', place: 'Varanasi spiritual circuit: Kashi Vishwanath Corridor, Sarnath, and riverboat cruise', duration: '5 hrs', distance: 'Varanasi' }, { time: '04:00 PM', place: 'Departure via Lal Bahadur Shastri Airport or DDU Junction', duration: '2 hrs', distance: 'Transit' }] }
    ]
  },
  experiences: [
    { title: 'Stepped Waterfall Panoramic Walk', duration: '2 hrs', price: '₹50 Entry', category: 'Nature', image: '/images/rajdari_hero_fullhd.jpg' },
    { title: 'Devdari Gorge & Canyon Exploration', duration: '1.5 hrs', price: 'Included', category: 'Adventure', image: '/images/devdari_waterfall.jpg' },
    { title: 'Chandraprabha Wildlife Sanctuary Trail', duration: '2 hrs', price: 'Included', category: 'Wildlife', image: '/images/chandraprabha_forest.jpg' },
    { title: 'Purvanchali Forest Dal-Bati Picnic', duration: '2 hrs', price: '₹80–₹150', category: 'Culinary', image: '/images/rajdari_monsoon_stream.jpg' }
  ],
  aiPrompts: [
    "What is the difference between Rajdari and Devdari waterfalls in Chandauli?",
    "What is the best time of year to visit Chandraprabha Wildlife Sanctuary?",
    "How can I plan a 1-day picnic trip from Varanasi to Rajdari Devdari?",
    "What wildlife species can be spotted inside Chandraprabha Sanctuary?",
    "What are the road directions from Varanasi or DDU Junction to Rajdari falls?",
    "Rajdari Devdari waterfall ghoomne ke liye best season aur entry rules kya hain?"
  ],
  reviews: [
    { name: 'Saurabh Rai', location: 'Varanasi', text: 'Rajdari is hands down the most beautiful stepped waterfall in Uttar Pradesh! The giant stone terraces look like a natural water staircase during monsoons. Great picnic lawns for families.', rating: 5, image: '/images/rajdari_hero_fullhd.jpg', date: 'August 2026' },
    { name: 'Pooja Kashyap', location: 'Prayagraj', text: 'Walking between Rajdari and Devdari through the green forest trail was pure bliss. Devdari has a dramatic deep gorge that photographers will fall in love with.', rating: 5, image: '/images/devdari_waterfall.jpg', date: 'September 2026' },
    { name: 'Dr. Manish Tripathi', location: 'Mughalsarai', text: 'Our favorite family weekend getaway from DDU and Varanasi. Fresh air, dense Vindhyan forest, roaring waterfalls, and preparing hot bati-chokha by the stream is unmatched.', rating: 5, image: '/images/rajdari_stepped_cascade.jpg', date: 'October 2025' }
  ],
  sources: {
    official: ['Chandauli District Official Portal (chandauli.nic.in)', 'Uttar Pradesh Forest Department / Eco-Tourism Board', 'Ministry of Tourism Wildlife Compendium'],
    historical: ['Gazetteer of Varanasi & Chandauli District', 'Botanical Survey of India Chandraprabha Sanctuary Records'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">1957 AD</p>
              <p className="text-xs text-white/60 mt-1">Wildlife Sanctuary</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Rajdari Stepped Fall' }, { top: '42%', left: '38%', label: 'Devdari Gorge Fall' }, { top: '28%', left: '52%', label: 'Chandraprabha Dam' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('difference') && `Rajdari is a wide, multi-tiered stepped waterfall cascading over natural rock shelves, while Devdari (700m downstream) is a dramatic plunge waterfall falling into a sheer canyon gorge.`}
                  {selected?.includes('time of year') && `The best time to visit is from July to February. Monsoon months (July–September) offer roaring full-force cascades, while post-monsoon winter (October–February) offers clear skies and ideal picnic weather.`}
                  {selected?.includes('picnic trip') && `Depart Varanasi/DDU by 08:00 AM, reach Rajdari by 09:30 AM. Spend 3–4 hours exploring both waterfalls and the canopy watchtower, enjoy a forest picnic lunch, and return via Chandraprabha Dam by evening.`}
                  {selected?.includes('wildlife') && `Chandraprabha Sanctuary is home to leopards, spotted deer (chital), sambar, wild boars, Indian gazelles, nilgai, and over 150 species of birds including hornbills and eagles.`}
                  {selected?.includes('directions') && `From Varanasi/DDU (~65 km), take the road via Mughal Sarai to Chakia town, then follow the paved forest road climbing the Vindhyan hills straight to the sanctuary entrance gate.`}
                  {selected?.includes('season aur') && `राजदरी-देवदरी घूमने का सबसे अच्छा समय जुलाई से फरवरी है। वाराणसी से दूरी लगभग 65 किमी है। वन विभाग के चेकपोस्ट पर मामूली प्रवेश शुल्क लगता है और शाम 5:30 बजे से पहले बाहर आना होता है।`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Waterfall & Slippery Rock Safety', content: 'Never climb over safety barriers or step onto wet mossy rock ledges near the waterfall crest. Rocks are extremely slippery during the monsoon and strong currents can sweep feet unexpectedly.' },
    { title: 'Sanctuary Entry & Timings', content: 'Chandraprabha Wildlife Sanctuary is open daily from sunrise to sunset (06:00 AM to 05:30 PM). Modest nominal entry fees apply per person and per vehicle at the forest entry checkpost.' },
    { title: 'Picnic & Waste Etiquette', content: 'Carry all plastic wrappers, bottles, and food containers back out with you. Chandraprabha is an eco-sensitive wildlife habitat; littering and open alcohol consumption are strictly prohibited.' },
    { title: 'Footwear & Monsoon Gear', content: 'Wear sturdy sports shoes or hiking sandals with high-traction rubber soles. Carry an umbrella or lightweight raincoat during the July–September monsoon season.' },
    { title: 'Emergency Contacts', content: 'Chandauli Police Control Room: 112 / +91-5412-262200 · Chakia Police Station: +91-5412-222100 · District Hospital Chandauli: +91-5412-262300 · Chandraprabha Forest Office: +91-5412-262500.' },
    { title: 'Cash & Food Advice', content: 'Mobile network is intermittent within deep forest pockets. Carry cash for entry tickets, parking, and local canteen snacks. Stalls serve hot tea, Maggi, and snacks at the main gate.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={rajdariDevdari} />
      <QuickFacts facts={rajdariDevdari.quickFacts} />
      <WhyVisit destination={rajdariDevdari} />
      <DestinationStory destination={rajdariDevdari} />
      <HistoryTimeline destination={rajdariDevdari} />
      <CultureGrid destination={rajdariDevdari} />
      <FoodSection destination={rajdariDevdari} />
      <AttractionsGrid destination={rajdariDevdari} />
      <HiddenGems destination={rajdariDevdari} />
      <ThingsToDo destination={rajdariDevdari} />
      <NearbyPlaces destination={rajdariDevdari} />
      <HowToReach destination={rajdariDevdari} />
      <WhereToStay destination={rajdariDevdari} />
      <BestTime destination={rajdariDevdari} />
      <BudgetGuide destination={rajdariDevdari} />
      <Itineraries destination={rajdariDevdari} />
      <LocalExperiences destination={rajdariDevdari} />
      <MapSection destination={rajdariDevdari} />
      <AskD360 destination={rajdariDevdari} />
      <CommunityStories destination={rajdariDevdari} />
      <PracticalInfo />
      <SourcesTrust destination={rajdariDevdari} />
      <Footer />
    </div>
  )
}
