...
const wyndham: Destination = {
  id: 'wyndham-waterfall-mirzapur',
  slug: 'wyndham-waterfall-mirzapur',
  name: 'Wyndham Falls',
  localName: 'विन्ढम वॉटरफॉल',
  destinationType: 'Natural Waterfall & Woodland Cascade',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Mirzapur',
  established: { year: 'British Era Naming', by: 'Collector Wyndham (Ancient Vindhyan Rock Formation)' },
  shortDescription: 'A scenic woodland cascade where monsoon water cuts through exposed Vindhyan rock formations, featuring documented prehistoric rock-art shelters downstream.',
  tags: ['NATURAL_WATERFALL', 'MONSOON_GETAWAY', 'VINDHYAN_ROCKS', 'PREHISTORIC_ROCK_ART', 'SCENIC_BEAUTY'],
  hero: {
    image: '/images/hero.jpg',
    poster: '/images/poster.jpg'
  },
  quickFacts: {
    bestTime: 'Jul – Sep (Monsoon) / Oct – Feb',
    duration: 'Half Day (3 – 4 Hours)',
    budget: '₹',
    destinationType: 'Natural Waterfall & Scenic Gorge',
    difficulty: 'Easy to Moderate',
    distance: '~14 km from Mirzapur / 75 km Varanasi'
  },
  discoveryScore: {
    overall: 8.7,
    categories: [
      { name: 'Uniqueness', score: 8.8 },
      { name: 'Natural Beauty', score: 9.4 },
      { name: 'Cultural & Archaeological Value', score: 8.5 },
      { name: 'Crowd Level', score: 6.0 },
      { name: 'Local Experience', score: 8.6 }
    ]
  },
  editorial: {
    why: 'Wyndham Falls is a captivating seasonal cascade nestled in the Vindhyan hill range of Mirzapur. Surrounded by dense woodland, exposed sedimentary strata, and prehistoric painted rock shelters, it offers an unspoiled nature escape.',
    story: 'Named during the British era after Collector Wyndham, this natural cascade cuts through ancient sandstone. Downstream archaeological surveys have revealed painted rock shelters (WYN 1 and WYN 2), testifying to millennia of human connection to this verdant valley.',
    storyFull: 'Located just 14 km from Mirzapur along the Windom Fall Road, Wyndham Falls transforms into a roaring natural cascade during the monsoon season as rainwater drains through stepped Vindhyan sandstone shelves into a picturesque forest gorge. Beyond its recreational charm, the destination holds significant archaeological depth: researchers have documented rock art sites downstream featuring ancient ochre paintings. The combination of gushing seasonal cascades, shaded forest paths, and deep geological heritage makes it one of Eastern UP\'s most scenic gems.'
  },
  history: {
    shortIntro: 'Ancient Vindhyan riverine landscape with prehistoric painted shelters, popularized as a scenic hill retreat during the British colonial period.',
    timeline: [
      { year: 'Prehistoric Era', event: 'Ancient humans inhabit downstream rock shelters (WYN 1 & WYN 2), creating mineral rock paintings', era: 'Stone Age' },
      { year: 'British Colonial Era', event: 'District Collector Wyndham popularizes the waterfall as a scenic woodland retreat and picnic spot', era: 'Colonial Period' },
      { year: 'Modern Archaeology', event: 'Epigraphists and archaeologists document downstream painted rock shelters as part of Vindhyan rock art heritage', era: 'Archaeological Survey' },
      { year: 'Present Day', event: 'Ecotourism destination attracting nature enthusiasts, photographers, and monsoon travelers', era: 'Ecotourism' }
    ]
  },
  culture: [
    { title: 'Vindhyan Woodland & Riverine Ecology', description: 'Dense deciduous forest canopy and rocky stream beds supporting native bird species, butterflies, and seasonal flora.', image: '/images/woodland.jpg' },
    { title: 'Downstream Prehistoric Rock Art (WYN 1 & 2)', description: 'Protected sandstone shelters downstream containing fragile ochre pictographs created by early human settlements.', image: '/images/rock_art.jpg' },
    { title: 'Monsoon Picnic & Retreat Culture', description: 'Longstanding regional tradition of families and travelers escaping to the cool cascade viewpoints during rains.', image: '/images/cascade.jpg' },
    { title: 'Mirzapur Brassware & Carpet Heritage', description: 'Nearby Mirzapur town is world-renowned for hand-woven carpets, brass utensils, and vibrant local bazaars.', image: '/images/crafts.jpg' }
  ],
  food: [
    { name: 'Crispy Samosa & Kachori Sabzi', description: 'Piping hot spiced potato samosas and lentil kachoris served with tangy aloo rassa curry at approach eateries.', category: 'Snacks / Breakfast', price: '₹30–₹60', image: '/images/kachori.jpg' },
    { name: 'Traditional Dal Bati & Poori Sabzi', description: 'Hearty fried puris with spiced seasonal vegetable curries and roasted wheat bati served in local highway dhabas.', category: 'Main Course', price: '₹80–₹150', image: '/images/poori_sabzi.jpg' },
    { name: 'Fresh Masala Chai & Buttermilk (Chaas)', description: 'Clay-cup ginger tea and spiced cooling buttermilk, perfect refreshments after a waterfall hike.', category: 'Beverage', price: '₹15–₹40', image: '/images/chai.jpg' },
    { name: 'Mirzapur Khurchan & Peda', description: 'Rich caramelized condensed milk sweet delicacy prepared fresh across Mirzapur\'s traditional sweet shops.', category: 'Dessert', price: '₹50–₹100', image: '/images/peda.jpg' }
  ],
  attractions: [
    { id: 'wyndham-main-cascade', name: 'Wyndham Main Waterfall & Pool', category: 'Waterfall', description: 'The principal stepped waterfall cascading over layered Vindhyan sandstone into a scenic rocky pool.', duration: '1.5 – 2 hrs', distance: 'Site center', score: 9.6, image: '/images/hero.jpg' },
    { id: 'watercourse-rock-corridor', name: 'Watercourse & Rock Strata Corridor', category: 'Geology & Nature', description: 'Natural walking trail alongside the stream revealing exposed sedimentary rock beds and seasonal rivulets.', duration: '1 hr', distance: 'Stream side', score: 8.9, image: '/images/rock_corridor.jpg' },
    { id: 'forest-viewpoint-trail', name: 'Woodland Viewpoint & Ridge Walk', category: 'Scenic Lookout', description: 'Elevated vantage points offering sweeping views across the lush green Mirzapur forest canopy and hill slopes.', duration: '45 mins', distance: 'Approach ridge', score: 8.7, image: '/images/woodland.jpg' },
    { id: 'wyn-rock-shelters', name: 'Downstream Painted Rock Shelters', category: 'Archaeology', description: 'Prehistoric rock art site located ~800m downstream, preserving delicate ancient paintings on sandstone overhangs.', duration: '1 hr (Specialist visit)', distance: '800 m downstream', score: 9.1, image: '/images/rock_art.jpg' }
  ],
  hiddenGems: [
    { name: 'Upper Stream Rock Pools', why: 'Quiet natural water basins upstream surrounded by wild ferns and rocky outcrops, away from main picnic crowds.', distance: '300 m upstream', duration: '45 mins', image: '/images/stream_pools.jpg' },
    { name: 'Lower Gorge Forest Glade', why: 'Tranquil shaded woodland clearing below the falls ideal for birdwatching and landscape photography.', distance: '500 m downstream', duration: '1 hr', image: '/images/gorge.jpg' }
  ],
  thingsToDo: [
    { activity: 'Monsoon Waterfall Photography & Viewpoint Walk', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning (8:00 AM)', image: '/images/hero.jpg' },
    { activity: 'Vindhyan Rock Strata & Nature Trail Exploration', duration: '1.5 hrs', cost: 'Free', difficulty: 'Moderate', bestTime: 'Late Afternoon', image: '/images/rock_corridor.jpg' },
    { activity: 'Local Mirzapur Culinary & Chai Tasting Excursion', duration: '1 hr', cost: '₹100', difficulty: 'Easy', bestTime: 'Post-visit', image: '/images/kachori.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Vindhyachal Shaktipeeth Temple', distance: '22 km', type: 'Sacred Pilgrimage', travelTime: '35 mins', image: '/images/vindhyachal.jpg' },
    { name: 'Chunar Hill Fort & Ganga View', distance: '38 km', type: 'Historic Fortress', travelTime: '55 mins', image: '/images/chunar_fort.jpg' },
    { name: 'Sirsi Dam & Waterfalls', distance: '28 km', type: 'Scenic Reservoir', travelTime: '45 mins', image: '/images/sirsi.jpg' },
    { name: 'Varanasi Ghats & Cultural Hub', distance: '75 km', type: 'Historic Holy City', travelTime: '1.8 hrs', image: '/images/varanasi.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri International Airport, Varanasi (VNS)', distance: '85 km away', time: '2 hrs drive via NH19 and SH5' },
    rail: { station: 'Mirzapur Railway Station (MZP) / Vindhyachal (BDL)', distance: '14 km from waterfall', time: '25 mins drive by taxi or auto' },
    road: { highway: 'Approached via Windom Fall Road / Gortutwa-Barkachhakalan road from Mirzapur city', distance: '14 km Mirzapur / 75 km Varanasi', time: '30 mins from Mirzapur city center' }
  },
  stay: {
    categories: [
      { type: 'Mirzapur City & Heritage Hotels', range: '₹1,500 – ₹3,500 / night', options: ['Hotel Janhavi International', 'The Galaxy Hotel Mirzapur', 'Mirzapur Club Stays'] },
      { type: 'Varanasi Riverside & Luxury Resorts', range: '₹3,000 – ₹8,000 / night', options: ['Taj Ganges Varanasi', 'BrijRama Palace', 'Ganga View Boutique Hotels'] }
    ]
  },
  bestTime: {
    months: [
      { month: 'Jan', status: 'good' }, { month: 'Feb', status: 'good' }, { month: 'Mar', status: 'avoid' },
      ...
      { month: 'Oct', status: 'ideal' }, { month: 'Nov', status: 'good' },  { month: 'Dec', status: 'good' }
    ]
  },
  budget: {
    tiers: [
      { tier: 'Day Tripper / Backpacker', perDay: '₹600 / day', breakdown: [{ category: 'Shared Taxi / Auto', amount: '₹250' }, { category: 'Local Food & Chai', amount: '₹250' }, { category: 'Incidentals & Water', amount: '₹100' }] },
      { tier: 'Private Tour / Family', perDay: '₹2,200 / day', breakdown: [{ category: 'Private AC Cab Rental', amount: '₹1,400' }, { category: 'Family Meals & Snacks', amount: '₹600' }, { category: 'Guide / Entry Fees', amount: '₹200' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Drive from Mirzapur / Varanasi towards Wyndham Falls', duration: '45 mins', distance: '14 km' }, { time: '9:00 AM', place: 'Wyndham Main Cascade & viewpoint photography', duration: '2 hrs', distance: 'Main falls' }, { time: '11:30 AM', place: 'Rock strata walk & downstream scenic trail', duration: '1.5 hrs', distance: 'Stream trail' }, { time: '1:30 PM', place: 'Traditional Lunch & Chai near Mirzapur highway', duration: '1 hr', distance: 'Highway eatery' }, { time: '3:00 PM', place: 'Excursion to Vindhyachal Shaktipeeth or Chunar Fort', duration: '2.5 hrs', distance: '22 km' }, { time: '6:00 PM', place: 'Sunset return towards Mirzapur / Varanasi', duration: '1 hr', distance: 'Return' }] }]
  },
  experiences: [
    { title: 'Monsoon Waterfall & Vindhyan Forest Discovery Tour', duration: '4 hrs', price: '₹400', category: 'Nature & Adventure', image: '/images/hero.jpg' }
  ],
  aiPrompts: [
    'What is the best time to visit Wyndham Falls in Mirzapur for maximum water flow?',
    'How to reach Wyndham Falls from Varanasi and Mirzapur railway station?',
    'What are the nearby attractions to combine with Wyndham Falls on a day trip?'
  ],
  reviews: [
    { name: 'Siddharth Pandey', location: 'Varanasi', text: 'Wyndham Falls in July and August is breathtaking! The green woodland and cascade over red rocks make it the best weekend getaway.', rating: 5, image: '/images/hero.jpg', date: 'August 2026' }
  ],
  sources: {
    official: ['Mirzapur District Administration, Govt of Uttar Pradesh', 'UP Ecotourism & Forest Department'],
    historical: ['Archaeological Survey of Vindhyan Rock Art (WYN 1 & 2)', 'Gazetteer of Mirzapur District'],
  ...
  return (
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="absolute left-[160px] top-0 bottom-0 w-px bg-d360-border hidden md:block" />
          <div className="flex flex-col gap-0">
            {shown.map((entry, i) => (
              <div key={i} className="flex gap-8 md:gap-0 group">
                <div className="hidden md:flex items-start pt-5 w-[160px] shrink-0 justify-end pr-6 text-right">
                  <span className="font-mono text-sm font-medium text-d360-primary leading-tight">{entry.year}</span>
                </div>
                <div className="hidden md:flex items-start pt-6 shrink-0 relative">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={wyndham} />
      <QuickFacts facts={wyndham.quickFacts} />
      <WhyVisit destination={wyndham} />
      <DestinationStory destination={wyndham} />
      <HistoryTimeline destination={wyndham} />
      <CultureGrid destination={wyndham} />
      <FoodSection destination={wyndham} />
      <AttractionsGrid destination={wyndham} />
      <HiddenGems destination={wyndham} />
      <ThingsToDo destination={wyndham} />
      <NearbyPlaces destination={wyndham} />
      <HowToReach destination={wyndham} />
      <WhereToStay destination={wyndham} />
      <BestTime destination={wyndham} />
      <BudgetGuide destination={wyndham} />
      <Itineraries destination={wyndham} />
      <LocalExperiences destination={wyndham} />
      <MapSection destination={wyndham} />
      <AskD360 destination={wyndham} />
      <CommunityStories destination={wyndham} />
      <PracticalInfo />
      <SourcesTrust destination={wyndham} />
      <Footer />
    </div>
  )
}
