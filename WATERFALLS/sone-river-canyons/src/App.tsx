...
const sone: Destination = {
  id: 'sone-river-canyons',
  slug: 'sone-river-canyons-sonbhadra',
  name: 'Sone River Canyons',
  localName: 'सोन नदी घाटी एवं कैनियन',
  destinationType: 'Rocky River Canyons & Kaimur Escarpment',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Sonbhadra',
  established: { year: 'Ancient Geological Formation', by: 'Kaimur Group Sandstones & Vindhyan Basin' },
  shortDescription: 'Dramatic sandstone cliffs, rugged canyon gorges, and panoramic viewpoints carved by the ancient Son River along the steep Kaimur escarpment.',
  tags: ['CANYON_VIEWS', 'SON_RIVER_VALLEY', 'KAIMUR_ESCARPMENT', 'GEOHERITAGE', 'ECO_TOURISM'],
  hero: {
    image: '/images/hero.jpg',
    poster: '/images/poster.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar (Panoramic Views) / Jul – Sep (Monsoon)',
    duration: '1 Full Day',
    budget: '₹₹',
    destinationType: 'Sandstone Escarpment & River Valley',
    difficulty: 'Easy to Moderate (Viewpoint exploration)',
    distance: '~6 km from Robertsganj / 90 km Varanasi'
  },
  discoveryScore: {
    overall: 9.2,
    categories: [
      { name: 'Uniqueness', score: 9.6 },
      { name: 'Geological Significance', score: 9.8 },
      { name: 'Scenic Beauty', score: 9.3 },
      { name: 'Crowd Level', score: 4.5 },
      { name: 'Local Experience', score: 8.9 }
    ]
  },
  editorial: {
    why: 'The Sone River Canyon landscape is Uttar Pradesh\'s grandest geological spectacle—a dramatic expanse of 2-meter-thick Kaimur sandstone cliffs, forested scarps, and the sweeping silver corridor of the Son River.',
    story: 'Carved over hundreds of millions of years by the ancient Son River through the Vindhyan basin, this canyon terrain features the famed Son Eco Point at Markundi, Veer Lorik folklore stones, and prehistoric rock art.',
    storyFull: 'Stretching across central Sonbhadra district south of the Kaimur Range, the Son River valley presents a majestic canyon-like topography characterized by stepped sandstone escarpments, deep river gorges, and sheer drop-offs. Scientific surveys by IGNCA have documented thick-bedded Kaimur Group sandstones exhibiting ancient ripple marks and shallow-marine sedimentary bedding. From vantage points like Markundi Son Eco Point (along SH5A) and Son View Point, visitors can witness uninterrupted panoramic vistas of the meandering river valley framed by mist-clad peaks and tribal woodlands.'
  },
  history: {
    shortIntro: 'Ancient river basin with Proterozoic sandstone geology, rock-shelter heritage, and legendary Bundeli-Bhojpuri folklore.',
    timeline: [
      { year: 'Proterozoic Era', event: 'Marine sedimentation forms thick-bedded Upper Vindhyan Kaimur sandstone strata and scarps', era: 'Geological Genesis' },
      { year: 'Mesolithic Era', event: 'Early human hunters inhabit Kaimur rock shelters, leaving geometric ochre cave paintings across the valley', era: 'Prehistoric Period' },
      { year: 'Medieval Folklore', event: 'The legendary Veer Lorik-Manjari folklore takes root at the split rock landmark near Markundi', era: 'Folklore Era' },
      { year: 'Present Day', event: 'Son Eco Point and Robertsganj circuit developed as prominent geoheritage and nature destinations', era: 'Eco-Tourism' }
    ]
  },
  culture: [
    { title: 'Markundi Hill & Son Eco Point Panorama', description: 'Scenic high-altitude cliff vantage points on SH5A offering breathtaking 180-degree vistas across the Son River basin.', image: '/images/son_valley.jpg' },
    { title: 'Veer Lorik Stone & Folk Ballads', description: 'Historic split monolith celebrated in regional Bhojpuri-Bundeli lore as proof of legendary hero Veer Lorik\'s strength.', image: '/images/veer_lorik.jpg' },
    { title: 'Vindhyan Rock Art & Tribal Lore', description: 'Sandstone caverns and shelters preserving ancient ochre rock paintings created by indigenous forest communities.', image: '/images/rock_art.jpg' },
    { title: 'Gotthani Sangam (Gupta Kashi)', description: 'Sacred river confluence near Chopan where Renu, Sone, and Vijul rivers meet beneath ancient Shiva shrines.', image: '/images/sangam.jpg' }
  ],
  food: [
    { name: 'Authentic Bundeli Dal Bafla & Chokha', description: 'Crispy ghee-dipped wheat dough balls served with spicy mixed lentil dal, roasted baingan bharta, and garlic chutney.', category: 'Main Course', price: '₹90–₹160', image: '/images/dal_bafla.jpg' },
    { name: 'Tribal Mahua Sweets & Laddoo', description: 'Fragrant sweet laddoos prepared from wild sun-dried mahua flowers, jaggery, and crushed dry nuts.', category: 'Dessert / Sweet', price: '₹40–₹90', image: '/images/mahua_sweet.jpg' },
    { name: 'Spicy Samosa & Matar Chaat', description: 'Crunchy golden pastry triangles filled with spiced potatoes, smothered in tangy white pea matar gravy.', category: 'Snack', price: '₹30–₹60', image: '/images/samosa.jpg' },
    { name: 'Robertsganj Highway Thali', description: 'Complete wholesome North Indian vegetarian meal with paneer, dal fry, fresh rotis, rice, and seasonal greens.', category: 'Meal', price: '₹120–₹220', image: '/images/thali.jpg' }
  ],
  attractions: [
    { id: 'son-eco-point', name: 'Markundi Son Eco Point & Lookout', category: 'Canyon Viewpoint', description: 'The premier elevated viewing terrace on SH5A overlooking the vast Son River valley and Kaimur sandstone scarps.', duration: '1.5 – 2 hrs', distance: '6 km from Robertsganj', score: 9.8, image: '/images/hero.jpg' },
    { id: 'veer-lorik-stone', name: 'Veer Lorik Stone Landmark', category: 'Heritage & Legend', description: 'Famed split rock formation near Markundi steeped in regional romantic folklore and local folk songs.', duration: '45 mins', distance: '5 km from Robertsganj', score: 9.0, image: '/images/veer_lorik.jpg' },
    { id: 'son-riverfront-chopan', name: 'Chopan Son River Corridor', category: 'River Landscape', description: 'Picturesque riverside stretch at Chopan town offering boating, angling, and peaceful sunset panoramas.', duration: '2 hrs', distance: '25 km south', score: 8.9, image: '/images/son_valley.jpg' },
    { id: 'salkhan-fossil-park', name: 'Salkhan Geoheritage Fossil Park', category: 'Geoheritage', description: 'World-renowned 1.4-billion-year-old stromatolite fossil beds situated just a short drive from Robertsganj.', duration: '1.5 hrs', distance: '15 km from Robertsganj', score: 9.5, image: '/images/fossil_park.jpg' }
  ],
  hiddenGems: [
    { name: 'Gotthani Gupta Kashi Sangam', why: 'Tranquil sacred river confluence of Sone, Renu, and Vijul rivers featuring peaceful ghats and an ancient Shiva temple.', distance: '6 km west of Chopan', duration: '1.5 hrs', image: '/images/sangam.jpg' },
    { name: 'Markundi Ridge Sunset Deck', why: 'Secluded rocky ledge away from highway traffic with mesmerizing evening light over the canyon escarpments.', distance: 'Markundi Ghat', duration: '1 hr', image: '/images/sunset.jpg' }
  ],
  thingsToDo: [
    { activity: 'Son Valley Canyon Photography & Sunrise Viewing', duration: '2.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Sunrise (6:00 AM)', image: '/images/hero.jpg' },
    { activity: 'Markundi & Veer Lorik Cultural Heritage Trail', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: '/images/veer_lorik.jpg' },
    { activity: 'Salkhan Fossil Park Geoheritage Excursion', duration: '2 hrs', cost: '₹20', difficulty: 'Easy', bestTime: 'Late Afternoon', image: '/images/fossil_park.jpg' }
  ],
  nearbyPlaces: [
    { name: 'Vijaygarh Hill Fort', distance: '30 km', type: 'Ancient Hill Fortress', travelTime: '50 mins', image: '/images/vijaygarh.jpg' },
    { name: 'Salkhan Stromatolite Fossil Park', distance: '15 km', type: 'Geoheritage Site', travelTime: '20 mins', image: '/images/fossil_park.jpg' },
    { name: 'Naugarh Wildlife Sanctuary & Dam', distance: '45 km', type: 'Forest & Wildlife', travelTime: '1 hr', image: '/images/naugarh.jpg' },
    { name: 'Varanasi Heritage & Airport', distance: '90 km', type: 'Cultural Capital', travelTime: '2.2 hrs', image: '/images/varanasi.jpg' }
  ],
  travel: {
    air: { airport: 'Lal Bahadur Shastri International Airport, Varanasi (VNS)', distance: '110 km away', time: '2.5 hrs drive via SH5A and NH19' },
    rail: { station: 'Robertsganj Railway Station (RBGJ) / Chopan (CPU)', distance: '6 km / 25 km', time: '15 mins drive from Robertsganj station' },
    road: { highway: 'State Highway SH5A connects Robertsganj and Markundi with Varanasi, Mirzapur, and Renukoot', distance: '6 km Robertsganj / 90 km Varanasi', time: 'Well-paved highway connectivity' }
  },
  stay: {
    categories: [
      { type: 'Robertsganj Town Hotels & Lodges', range: '₹1,200 – ₹2,800 / night', options: ['Hotel Son View Robertsganj', 'The Grand Radhey Hotel', 'U.P. Tourism Rahi Tourist Bungalow'] },
      { type: 'Chopan Riverfront Guest Houses', range: '₹1,000 – ₹2,200 / night', options: ['Chopan PWD Inspection Bungalow', 'Railway Guest Houses'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Solo Explorer', perDay: '₹800 / day', breakdown: [{ category: 'Local Bus / Auto', amount: '₹200' }, { category: 'Dhaba Meals & Chai', amount: '₹400' }, { category: 'Fossil Park / Sights', amount: '₹200' }] },
      { tier: 'Private Tour / Family', perDay: '₹2,600 / day', breakdown: [{ category: 'Private Taxi / Cab', amount: '₹1,600' }, { category: 'Hotel & Dining', amount: '₹800' }, { category: 'Guidance & Entry', amount: '₹200' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '7:30 AM', place: 'Morning drive to Markundi Son Eco Point on SH5A', duration: '45 mins', distance: '6 km' }, { time: '8:30 AM', place: 'Panoramic canyon photography & Kaimur scarp viewing', duration: '2 hrs', distance: 'Son Eco Point' }, { time: '11:00 AM', place: 'Visit Veer Lorik Stone & explore local folklore legends', duration: '1 hr', distance: '3 km' }, { time: '12:30 PM', place: 'Authentic Bundeli Lunch at Robertsganj', duration: '1 hr', distance: 'Robertsganj' }, { time: '2:00 PM', place: 'Excursion to Salkhan Fossil Park (Stromatolite beds)', duration: '2.5 hrs', distance: '15 km' }, { time: '5:00 PM', place: 'Sunset river view at Chopan Son Riverbank', duration: '1.5 hrs', distance: 'Chopan' }] }]
  },
  experiences: [
    { title: 'Son Valley Canyon & Kaimur Geoheritage Safari', duration: '5 hrs', price: '₹500', category: 'Geotourism & Scenic', image: '/images/hero.jpg' }
  ],
  aiPrompts: [
    'What makes the Sone River Canyons in Sonbhadra geologically unique?',
    'Where is Son Eco Point located in Markundi and what are the viewing hours?',
    'How to plan a one-day circuit covering Sone River Canyon, Veer Lorik Stone, and Salkhan Fossil Park?'
  ],
  reviews: [
    { name: 'Anurag Srivastava', location: 'Prayagraj', text: 'The view of the Son River valley from Markundi Eco Point is mesmerizing! The scale of the sandstone cliffs feels like a mini Grand Canyon.', rating: 5, image: '/images/hero.jpg', date: 'January 2026' }
  ],
  sources: {
    official: ['District Administration of Sonbhadra, Government of UP', 'IGNCA Field Documentation of Sonbhadra Rock Art & Geology'],
    historical: ['Upper Son Valley Geological Survey Reports', 'Gazetteer of Mirzapur-Sonbhadra Region'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={sone} />
      <QuickFacts facts={sone.quickFacts} />
      <WhyVisit destination={sone} />
      <DestinationStory destination={sone} />
      <HistoryTimeline destination={sone} />
      <CultureGrid destination={sone} />
      <FoodSection destination={sone} />
      <AttractionsGrid destination={sone} />
      <HiddenGems destination={sone} />
      <ThingsToDo destination={sone} />
      <NearbyPlaces destination={sone} />
      <HowToReach destination={sone} />
      <WhereToStay destination={sone} />
      <BestTime destination={sone} />
      <BudgetGuide destination={sone} />
      <Itineraries destination={sone} />
      <LocalExperiences destination={sone} />
      <MapSection destination={sone} />
      <AskD360 destination={sone} />
      <CommunityStories destination={sone} />
      <PracticalInfo />
      <SourcesTrust destination={sone} />
      <Footer />
    </div>
  )
}
