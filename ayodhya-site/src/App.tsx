...
export const ayodhya: Destination = {
  id: 'ayodhya',
  slug: 'ayodhya-uttar-pradesh',
  name: 'Ayodhya',
  localName: 'अयोध्या',
  destinationType: 'Spiritual & Sacred Pilgrimage',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Ayodhya',
  shortDescription: 'The sacred birthplace of Lord Rama, an ancient holy city of immense religious and historical significance resting along the banks of the Saryu River.',
  tags: ['PILGRIMAGE', 'RAMA JANMABHOOMI', 'HERITAGE'],
  hero: {
    image: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000',
    poster: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹₹',
    destinationType: 'Religious & Pilgrimage Center',
    difficulty: 'Easy',
  ...
  discoveryScore: {
    overall: 9.8,
    categories: [
      { name: 'Spiritual Significance', score: 10.0 },
      { name: 'Historical Heritage', score: 9.9 },
      { name: 'Local Culinary', score: 9.2 },
      { name: 'Ghat Experience', score: 9.5 },
      { name: 'Accessibility', score: 9.3 }
    ]
  },
  editorial: {
    why: 'Ayodhya is revered across the globe as the birthplace of Lord Rama and one of the seven most sacred cities (Saptapuri) in Hinduism.',
    story: 'From ancient links to the Ramayana epic to centuries of spiritual heritage along the sacred Saryu River, Ayodhya stands as the vibrant cultural heart of Purvanchal.',
    storyFull: 'Today, Ayodhya combines its timeless spiritual core with grand modern developments, inviting millions of pilgrims to witness magnificent temples, vibrant ghats, and traditional sweets.'
  },
  history: {
    shortIntro: 'The legendary capital of the Ikshvaku dynasty and the sacred realm of Lord Rama.',
    timeline: [
      { year: 'Ancient Era', event: 'Founded according to scripture by Manu; served as capital for the Ikshvaku dynasty and birthplace of Lord Rama', era: 'Vedic Era' },
      { year: '5th Century BCE', event: 'Prominent center during the Buddhist and Jain eras; birth city of multiple Jain Tirthankaras', era: 'Ancient Era' },
      { year: 'Medieval Era', event: 'Continued spiritual importance with the construction of historical temples like Kanak Bhavan and Hanuman Garhi', era: 'Medieval Era' },
      { year: 'Contemporary', event: 'Consecration of the grand Ram Mandir and transformed into a premier worldwide spiritual destination', era: 'Modern Era' }
    ]
  },
  culture: [
    {
      title: 'Ram Janmabhoomi Heritage',
      description: 'The monumental core of Ayodhya celebrated as the legendary birthplace of Lord Rama.',
      image: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000'
    },
    {
      title: 'Saryu River Ghats',
      description: 'Sacred riverbanks hosting daily evening aartis, spiritual baths, and lit lamps across Ram Ki Paidi.',
      image: 'https://drive.google.com/thumbnail?id=1ppOB9B_H2n8eU9WM7yUIofowBb9IzPhG&sz=w2000'
    },
    {
      title: 'Traditional Temple Craft',
      description: 'Centuries-old stone carving, classical temple architecture, and religious artwork heritage.',
      image: 'https://drive.google.com/thumbnail?id=15HQDD35xiswxt-5MOM9ociFCVyfX4aKr&sz=w2000'
    },
    {
      title: 'Satvik Culinary Legacy',
      description: 'Pure vegetarian prasad and traditional confectionery including Ram Laddus and Ayodhya Pedas.',
      image: 'https://drive.google.com/thumbnail?id=1Wfb4xvd6qGvPWtfMNkDNKxsedbJVe14S&sz=w2000'
    }
  ],
  food: [
    {
      name: 'Ram Laddu (राम लड्डू)',
      description: 'Special laddus offered as prasad',
      category: 'Prasad / Sweet',
      price: '₹50–₹150',
      image: 'https://drive.google.com/thumbnail?id=1Wfb4xvd6qGvPWtfMNkDNKxsedbJVe14S&sz=w2000'
    },
    {
      name: 'Ayodhya Peda (अयोध्या पेड़ा)',
      description: 'Traditional milk-based sweet',
      category: 'Sweet / Specialty',
      price: '₹100–₹250',
      image: 'https://drive.google.com/thumbnail?id=1lhv_eZuSD5cGYq2FTxRAgTxmSrv0AN-I&sz=w2000'
    },
    {
      name: 'Satvik Thaali (सात्विक थाली)',
      description: 'Pure vegetarian traditional meal',
      category: 'Main Course',
      price: '₹120–₹250',
      image: 'https://drive.google.com/thumbnail?id=1bGBIhTkcXJ-wzwKk9MqEO0OeD9veo3VX&sz=w2000'
    },
    {
      name: 'Malpua (मालपुआ)',
      ...
      category: 'Dessert',
      price: '₹60–₹120',
      image: 'https://drive.google.com/thumbnail?id=1-bazNn63GcAqYKjAmIBmK19b4iQmzq5C&sz=w2000'
    }
  ],
  attractions: [
    {
    ...
    },
    {
      ...
      score: 9.7,
      image: 'https://drive.google.com/thumbnail?id=1bpMIc88IsI4XHwY2Q7v7f-aIPNkd2d3l&sz=w2000'
    },
    {
      id: 'kanak-bhavan',
      name: 'Kanak Bhavan',
    ...
    },
    {
      ...
      distance: '1 km from Ram Mandir',
      score: 9.3,
      image: 'https://drive.google.com/thumbnail?id=1dMRc9wuKAYbJ-mdiEKf3TaZpoXET1oWY&sz=w2000'
    },
    {
      id: 'sita-ki-rasoi',
      name: 'Sita Ki Rasoi',
      ...
      duration: '45 min',
      distance: 'Near Ram Janmabhoomi',
      score: 9.1,
      image: 'https://drive.google.com/thumbnail?id=1-ASen83VA5hr1iICu_5HucbUi7JMVpLl&sz=w2000'
    }
  ],
  hiddenGems: [
    {
      name: 'Guptar Ghat',
      why: 'Where Lord Rama took Jal Samadhi along the serene banks of the Saryu River.',
    ...
    {
      name: 'Jain Mandir',
      why: 'Beautiful ancient Jain temple commemorating the birthplace of five Jain Tirthankaras.',
      distance: '2 km from centre',
      duration: '1 hr',
      image: 'https://drive.google.com/thumbnail?id=1p2NHiXcz0qZYjZSP0Wi4Q_vvSmUs2q2o&sz=w2000'
    }
  ],
  thingsToDo: [
    { activity: 'Darshan at Ram Mandir & Hanuman Garhi', duration: '3 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000' },
    { activity: 'Attend Evening Saryu Aarti at Ram Ki Paidi', duration: '1.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Evening', image: 'https://drive.google.com/thumbnail?id=1ppOB9B_H2n8eU9WM7yUIofowBb9IzPhG&sz=w2000' },
    { activity: 'Taste Traditional Ayodhya Peda & Ram Laddu', duration: '1 hr', cost: '₹100–₹200', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://drive.google.com/thumbnail?id=1Wfb4xvd6qGvPWtfMNkDNKxsedbJVe14S&sz=w2000' }
  ],
  nearbyPlaces: [
    { name: 'Nandigram (Bharat Kund)', distance: '20 km', type: 'Spiritual Heritage', travelTime: '35 min', image: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000' },
    { name: 'Lucknow', distance: '135 km', type: 'Capital City & Awadhi Heritage', travelTime: '2.5 hrs', image: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000' }
  ],
  travel: {
    air: { airport: 'Maharishi Valmiki International Airport (AYJ)', distance: '12 km', time: '20 mins to town' },
    rail: { station: 'Ayodhya Dham Junction (AY) / Ayodhya Cantt (AYC)', distance: 'City centre', time: 'Direct Vande Bharat & Express connectivity' },
    road: { highway: 'Lucknow–Gorakhpur Highway (NH-27)', distance: '135 km from Lucknow', time: '2.5 hrs via highway' }
  },
  stay: {
    categories: [
      { type: 'Pilgrimage Hotels', range: '₹1,200–₹4,000/night', options: ['Hotels catering to pilgrims', 'Dharamshalas', 'City Guesthouses'] },
      { type: 'Heritage / Luxury', range: '₹4,500–₹10,000/night', options: ['Luxury Riverfront Resorts', 'Heritage Hotels'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Explorer', perDay: '₹800–₹1,500', breakdown: [{ category: 'Stay', amount: '₹500–₹900' }, { category: 'Food', amount: '₹200–₹400' }, { category: 'Transport', amount: '₹100–₹200' }] },
      { tier: 'Comfort', perDay: '₹2,500–₹5,000', breakdown: [{ category: 'Stay', amount: '₹1,800–₹3,500' }, { category: 'Food', amount: '₹500–₹1,000' }, { category: 'Transport', amount: '₹200–₹500' }] }
    ]
  },
  itineraries: {
    '1 Day': [
      {
        day: 1,
        schedule: [
          { time: '7:00 AM', place: 'Morning Darshan at Hanuman Garhi', duration: '1.5 hrs', distance: 'Centre' },
          { time: '9:00 AM', place: 'Grand Darshan at Ram Mandir', duration: '2.5 hrs', distance: 'Centre' },
          { time: '12:00 PM', place: 'Visit Kanak Bhavan & Dashrath Mahal', duration: '1.5 hrs', distance: '1 km' },
          { time: '1:30 PM', place: 'Traditional Satvik Thaali Lunch', duration: '1 hr', distance: 'Town' },
          { time: '3:00 PM', place: 'Explore Sita Ki Rasoi & local markets', duration: '1.5 hrs', distance: 'Centre' },
          { time: '5:00 PM', place: 'Visit Guptar Ghat & Saryu Riverfront', duration: '1.5 hrs', distance: '8 km' },
          { time: '6:30 PM', place: 'Evening Saryu Aarti at Ram Ki Paidi', duration: '1 hr', distance: 'Ram Ki Paidi' }
        ]
      }
    ]
  },
  experiences: [
    { title: 'Ram Janmabhoomi Spiritual Guided Tour', duration: '3 hrs', price: 'Free', category: 'Pilgrimage Walk', image: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000' },
    { title: 'Saryu River Evening Aarti Experience', duration: '1.5 hrs', price: 'Free', category: 'Spiritual', image: 'https://drive.google.com/thumbnail?id=1ppOB9B_H2n8eU9WM7yUIofowBb9IzPhG&sz=w2000' },
    { title: 'Ayodhya Satvik Food & Sweet Trail', duration: '1.5 hrs', price: '₹150–₹350', category: 'Culinary', image: 'https://drive.google.com/thumbnail?id=1Wfb4xvd6qGvPWtfMNkDNKxsedbJVe14S&sz=w2000' }
  ],
  aiPrompts: [
    'What are the best timings to visit Ram Mandir and Hanuman Garhi?',
    'How to experience the Saryu Aarti at Ram Ki Paidi?',
    'Where to try authentic Ayodhya Peda and Ram Laddu?',
    'How to reach Ayodhya via Maharishi Valmiki International Airport?'
  ],
  reviews: [
    { name: 'Amit Verma', location: 'Delhi', text: 'Visiting Ram Mandir and witnessing the evening Saryu Aarti at Ram Ki Paidi was a deeply spiritual experience. The city infrastructure is phenomenal.', rating: 5, image: 'https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000', date: 'January 2026' },
    { name: 'Priya Mishra', location: 'Lucknow', text: 'Kanak Bhavan and Hanuman Garhi have such peaceful vibration. Do not miss tasting the fresh Ram Laddus and Pedas near the temple complex!', rating: 5, image: 'https://drive.google.com/thumbnail?id=15HQDD35xiswxt-5MOM9ociFCVyfX4aKr&sz=w2000', date: 'February 2026' }
  ],
  sources: {
    official: ['Uttar Pradesh Tourism (uptourism.gov.in)', 'Ayodhya District Administration (ayodhya.nic.in)'],
    historical: ['Ramayana Scriptures', 'Gazetteer of Ayodhya'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              <p className="font-mono text-xs text-white/50 mb-1">SACRED REALM</p>
              <p className="font-display text-xl font-medium">Saptapuri</p>
              <p className="text-xs text-white/60 mt-1">One of the Seven Holy Cities of India</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex gap-5 overflow-x-auto scrollbar-hide pb-2 -mx-6 px-6 md:mx-0 md:px-0 md:grid md:grid-cols-2 lg:grid-cols-4">
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', 'Sacred Temple', 'Ghats & Riverfront', 'Historical Place']
...
function NearbyPlaces({ destination }: { destination: Destination }) {
  const filters = ['25 km', '150 km', 'All']
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          <img src="https://drive.google.com/thumbnail?id=10B2hBK-Ow422yFhuqYnKBLy67M9alxCH&sz=w2000" alt={`Map of ${destination.name}`} className="w-full h-full object-cover opacity-40" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about temple timings, spiritual heritage, hidden gems, or traditional food trails.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('Ram Mandir') && `Ram Mandir and Hanuman Garhi are best visited in early morning hours to avoid long queues. Hanuman Garhi is traditionally visited first.`}
                  {selected?.includes('Saryu Aarti') && `The Saryu Aarti takes place every evening at Ram Ki Paidi around sunset. Arrive 30 minutes early to secure a good viewing spot along the ghats.`}
                  {selected?.includes('Peda') && `Traditional sweets like Ayodhya Peda and Ram Laddu can be found at famous sweet shops surrounding Hanuman Garhi and the central temple precinct.`}
                  {selected?.includes('Airport') && `Maharishi Valmiki International Airport (AYJ) is located approximately 12 km from the main temple area, with taxis and shuttles widely available.`}
                  {!selected?.includes('Ram Mandir') && !selected?.includes('Saryu Aarti') && !selected?.includes('Peda') && !selected?.includes('Airport') && `${destination.name} offers incredible cultural richness: explore ${destination.attractions[0]?.name}, enjoy local ${destination.food[0]?.name}, and discover the historical heritage of ${destination.district}.`}
                </div>
              </div>
            )}
...
function PracticalInfo({ destination }: { destination: Destination }) {
  ...
  const items = [
    { title: 'Safety & Etiquette', content: `${destination.name} is a sacred pilgrimage hub. Dress modestly when visiting temple premises, remove footwear before entering holy areas, and remain mindful in large crowd gatherings.` },
    { title: 'Local Transport', content: `E-rickshaws, shared autos, and tourist cabs operate frequently between Maharishi Valmiki Airport, Ayodhya Dham Junction, Ram Janmabhoomi, and Guptar Ghat.` },
    { title: 'Temple Visit Rules', content: `Mobile phones, leather items, and bags may be subject to security screening or restricted inside central temple zones like Ram Mandir.` },
...
export default function App() {
  const destination: Destination = ayodhya
