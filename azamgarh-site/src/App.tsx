...
const azamgarh: Destination = {
  id: 'azamgarh',
  slug: 'azamgarh-uttar-pradesh',
  name: 'Azamgarh',
  localName: 'आजमगढ़',
  destinationType: 'Craft & Cultural Hub',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Azamgarh',
  shortDescription: 'Historic town noted for black clay pottery, saree markets, and rich cultural heritage.',
  tags: ['PURVANCHAL', 'HERITAGE', 'CRAFT & CULTURAL'],
  hero: {
    image: 'https://drive.google.com/thumbnail?id=1_NNR_rj8a-1Qx8KHj8FAWAlQJ7UMhCZ3&sz=w2000',
    poster: 'https://drive.google.com/thumbnail?id=1_NNR_rj8a-1Qx8KHj8FAWAlQJ7UMhCZ3&sz=w2000'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹',
    destinationType: 'Cultural & Craft Center',
    difficulty: 'Easy',
  ...
  discoveryScore: {
    ...
    categories: [
      ...
      { name: 'Historical Significance', score: 8.6 },
  ...
  editorial: {
    why: 'Azamgarh is a cultural treasure in Purvanchal, famous globally for its distinctive Nizamabad black clay pottery, traditional Mubarakpur saree weaving, and deep mythological roots along the Tamsa river.',
    story: 'Founded in the 17th century by Vikramajit’s son Azam Khan, Azamgarh grew into a resilient stronghold of heritage, trade, literature, and indigenous artisan traditions.',
    storyFull: 'From ancient ashrams associated with revered sages like Durvasa and Dattatreya along the tranquil Tamsa River to the intricate handloom heritage of Mubarakpur and GI-tagged black clay pottery of Nizamabad, Azamgarh reflects the artistic spirit and timeless legacy of eastern Uttar Pradesh.'
  },
  history: {
    shortIntro: 'An ancient land of mythological ashrams evolving into a medieval center of art and trade.',
    timeline: [
      { year: 'Ancient Era', event: 'Sages Durvasa and Dattatreya established hermitages along the banks of the sacred Tamsa River.', era: 'Mythological / Ancient' },
      { year: '1665 AD', event: 'Azam Khan, son of Vikramajit, founded the city of Azamgarh.', era: 'Mughal Era' },
      { year: '19th–20th Century', event: 'Evolved into a major weaving and pottery industrial center of Purvanchal.', era: 'Modern Era' }
    ]
  },
  culture: [
    {
      title: 'Nizamabad Pottery Tradition',
      description: 'Famous for unique GI-tagged black clay pottery decorated with silver foil etching.',
      image: 'https://drive.google.com/thumbnail?id=1ojLtt7M3zKCk3oGBeiPcUw6_EnmJIEHv&sz=w2000'
    },
    {
      title: 'Mubarakpur Weaving Legacy',
      description: 'A historic textile hub known for intricate silk and zari saree weaving crafts.',
      image: 'https://drive.google.com/thumbnail?id=1mHH-xW_q1IyVtK69_ruTNP4lGFvrhiOc&sz=w2000'
    }
  ],
  food: [
    {
      name: 'Launglata (लौंग्लता)',
      description: 'Flaky pastry stuffed with khoya and sealed with a clove, soaked in sugar syrup.',
      category: 'Sweet',
      price: '₹20–₹40',
      image: 'https://drive.google.com/thumbnail?id=1zI5V7l3lT3QfAFGzxCpXVAhNy6lM9HTV&sz=w2000'
    },
    {
      name: 'Amla Laddu (आंवला लड्डू)',
      description: 'Vitamin-rich sweet spheres made from fresh gooseberries.',
      category: 'Sweet',
      price: '₹200–₹350/kg',
      image: 'https://drive.google.com/thumbnail?id=15zwUbAe0t9UlchhQqpoHBu2s_STzHoMN&sz=w2000'
    },
    {
      name: 'Chawal ke Farre (चावल के फर्रे)',
      description: 'Steamed rice flour dumplings stuffed with lightly spiced lentils.',
      category: 'Snack',
      price: '₹40–₹80',
      image: 'https://drive.google.com/thumbnail?id=1sQjoclf5tzLAq4cdzGjFX6jZUeFEJ2Wa&sz=w2000'
    },
    {
      name: 'Chole Samosa (छोले समोसा)',
      description: 'Crispy samosa served crushed and topped with spicy chickpea curry.',
      category: 'Street Food',
      price: '₹30–₹60',
      image: 'https://drive.google.com/thumbnail?id=1xajcIyVH8xjXo5SMNdcBCSwsidc0DeQU&sz=w2000'
    },
    {
      name: 'Arbi Patta Rolls (अरबी पत्ता रोल्स)',
      description: 'Steamed and fried colocasia leaf rolls stuffed with spiced gram flour.',
      category: 'Snack',
      price: '₹40–₹70',
      image: 'https://drive.google.com/thumbnail?id=1qURAUGltG_VXr6she6njy52DD4Pqd0h5&sz=w2000'
    },
    {
      name: 'Chatpati Chaat (चटपटी चाट)',
      description: 'Tangy and spicy Purvanchal street chaat topped with chutney and sev.',
      category: 'Street Food',
      price: '₹30–₹60',
      image: 'https://drive.google.com/thumbnail?id=1si6FUacfjhGZD2su1lj34O-B--VPKC-m&sz=w2000'
    },
    {
      name: 'Kalika Mutton (कालिका मटन)',
      description: 'Richly spiced slow-cooked local mutton curry.',
      category: 'Main Course',
      price: '₹200–₹350',
      image: 'https://drive.google.com/thumbnail?id=1obWCrxKBG50nonMQtte0mSEfZYlr-Zc9&sz=w2000'
    },
    {
      name: 'Chicken Biryani (चिकन बिरयानी)',
      description: 'Aromatic layered rice cooked with herbs, chicken, and local spices.',
      category: 'Main Course',
      price: '₹120–₹220',
      image: 'https://drive.google.com/thumbnail?id=1ZyHc-ilEX3S7tIB3OGthRDKyQIla-iI1&sz=w2000'
    }
  ],
  attractions: [
    {
      ...
      name: 'Govind Sahab',
      category: 'Pilgrimage',
      description: 'Prominent local temple complex and cultural fair ground.',
      duration: '1–2 hrs',
      distance: '30 km from city center',
      score: 8.8,
      image: 'https://drive.google.com/thumbnail?id=1QcI2DqJho6NeBY1OXU9bBKJqKmbCNnjK&sz=w2000'
    },
    {
      id: 'daulat-ibrahim-khan-tomb',
      name: 'Daulat Ibrahim Khan Tomb',
      category: 'Historical',
      description: 'Historical tomb showing elegant Mughal architectural influences.',
      duration: '1 hr',
      distance: '10 km from city center',
      score: 8.2,
      image: 'https://drive.google.com/thumbnail?id=1E-aZMlImACk2g4Y28-wJZFnICeYyJUmV&sz=w2000'
    },
    {
      id: 'mehnagar-fort',
      name: 'Mehnagar Fort',
      category: 'Historical',
      description: 'Ancient fort ruins surrounded by scenic views and rural countryside.',
      duration: '2 hrs',
      distance: '36 km from city center',
      score: 8.5,
      image: 'https://drive.google.com/thumbnail?id=1_NNR_rj8a-1Qx8KHj8FAWAlQJ7UMhCZ3&sz=w2000'
    },
    {
      id: 'durvasa-rishi-ashram',
      name: 'Durvasa Rishi Ashram',
      category: 'Pilgrimage',
      description: 'Mythological hermitage site situated at the confluence of rivers.',
      duration: '1–2 hrs',
      distance: '25 km from city center',
      score: 8.7,
      image: 'https://drive.google.com/thumbnail?id=1Zi7VN54Bfdi-QNs6d03aYhJWMO7zgp4t&sz=w2000'
    },
    {
      id: 'dattatreya-ashram',
      name: 'Dattatreya Ashram',
      category: 'Pilgrimage',
      description: 'Spiritual retreat near the river offering serene surroundings.',
      duration: '1 hr',
      distance: '20 km from city center',
      score: 8.3,
      image: 'https://drive.google.com/thumbnail?id=1Ie5VVG8gpbmRgmNNupXtwUmrfpAyig8m&sz=w2000'
    },
    {
      id: 'tamsa-river',
      name: 'Tamsa River',
      category: 'Nature',
      description: 'Peaceful riverside landscapes deeply tied to ancient lore.',
      duration: '1–2 hrs',
      distance: 'City outskirts',
      score: 8.4,
      image: 'https://drive.google.com/thumbnail?id=1n0_0ctI5awV9kIYWXpt6BfFPQheqQAZT&sz=w2000'
    }
  ],
  hiddenGems: [
    {
      name: 'Nizamabad Black Clay Pottery',
      why: 'Unique craft village tradition generating shiny black pottery with silver etching.',
      distance: '20 km from Azamgarh',
      duration: '2 hrs',
      image: 'https://drive.google.com/thumbnail?id=1ojLtt7M3zKCk3oGBeiPcUw6_EnmJIEHv&sz=w2000'
    },
    {
      name: 'Mubarakpur Saree Market',
      why: 'Traditional handloom weaving cluster famed for exquisite silk sarees.',
      distance: '13 km from Azamgarh',
      duration: '2 hrs',
      image: 'https://drive.google.com/thumbnail?id=1mHH-xW_q1IyVtK69_ruTNP4lGFvrhiOc&sz=w2000'
    }
  ],
  thingsToDo: [
    { activity: 'Black Clay Pottery Workshop in Nizamabad', duration: '2 hrs', cost: 'Free / Nominal', difficulty: 'Easy', bestTime: 'Morning', image: 'https://drive.google.com/thumbnail?id=1ojLtt7M3zKCk3oGBeiPcUw6_EnmJIEHv&sz=w2000' },
    { activity: 'Mubarakpur Saree Market Trail', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://drive.google.com/thumbnail?id=1mHH-xW_q1IyVtK69_ruTNP4lGFvrhiOc&sz=w2000' },
    { activity: 'Tamsa Riverside Walk & Ashram Tour', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Sunset', image: 'https://drive.google.com/thumbnail?id=1n0_0ctI5awV9kIYWXpt6BfFPQheqQAZT&sz=w2000' }
  ],
  nearbyPlaces: [
    { name: 'Varanasi', distance: '100 km', type: 'Pilgrimage & Heritage', travelTime: '2.5 hrs', image: 'https://drive.google.com/thumbnail?id=1_NNR_rj8a-1Qx8KHj8FAWAlQJ7UMhCZ3&sz=w2000' },
    { name: 'Ayodhya', distance: '140 km', type: 'Spiritual Center', travelTime: '3 hrs', image: 'https://drive.google.com/thumbnail?id=1_NNR_rj8a-1Qx8KHj8FAWAlQJ7UMhCZ3&sz=w2000' }
  ],
  travel: {
    air: { airport: 'Varanasi Lal Bahadur Shastri Airport (VNS)', distance: '90 km', time: '~2 hrs by taxi' },
    rail: { station: 'Azamgarh Railway Station (AMH)', distance: 'City Centre', time: 'Well connected to Delhi, Mumbai, and Lucknow' },
    road: { highway: 'Purvanchal Expressway / NH-28', distance: '270 km from Lucknow', time: '~4 hrs by car via expressway' }
  },
  stay: {
    categories: [
      { type: 'Guest House & Lodges', range: '₹800–₹1,800/night', options: ['Local Lodges', 'Budget Highway Stays'] },
      { type: 'Mid-Range Hotels', range: '₹2,000–₹3,800/night', options: ['City Center Hotels', 'Comfort Accommodations'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹700–₹1,400', breakdown: [{ category: 'Stay', amount: '₹400–₹800' }, { category: 'Food', amount: '₹200–₹400' }, { category: 'Transport', amount: '₹100–₹200' }] },
      { tier: 'Comfort', perDay: '₹1,800–₹3,500', breakdown: [{ category: 'Stay', amount: '₹1,200–₹2,200' }, { category: 'Food', amount: '₹400–₹800' }, { category: 'Transport', amount: '₹200–₹500' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Chole Samosa & Launglata Breakfast', duration: '45 min' }, { time: '9:30 AM', place: 'Nizamabad Pottery Craft Village', duration: '2.5 hrs' }, { time: '1:00 PM', place: 'Local Purvanchal Lunch', duration: '1 hr' }, { time: '2:30 PM', place: 'Mubarakpur Saree Weaving Market', duration: '2.5 hrs' }, { time: '5:30 PM', place: 'Durvasa Rishi Ashram & Tamsa River', duration: '1.5 hrs' }] }]
  },
  experiences: [
    { title: 'Black Clay Pottery Crafting', duration: '2 hrs', price: '₹200–₹400', category: 'Craft Trail', image: 'https://drive.google.com/thumbnail?id=1ojLtt7M3zKCk3oGBeiPcUw6_EnmJIEHv&sz=w2000' },
    { title: 'Mubarakpur Handloom Silk Trail', duration: '2.5 hrs', price: '₹300–₹600', category: 'Culture', image: 'https://drive.google.com/thumbnail?id=1mHH-xW_q1IyVtK69_ruTNP4lGFvrhiOc&sz=w2000' }
  ],
  aiPrompts: ["What is Azamgarh famous for?", "Where to buy authentic Nizamabad pottery?", "Must-try dishes in Azamgarh?", "Plan a 1 day craft itinerary in Azamgarh"],
  reviews: [
    { name: 'Siddharth Rai', location: 'Varanasi', text: 'Azamgarh blew me away with its Nizamabad pottery work! The Mubarakpur saree market is also incredible for handloom enthusiasts.', rating: 5, image: 'https://drive.google.com/thumbnail?id=1_NNR_rj8a-1Qx8KHj8FAWAlQJ7UMhCZ3&sz=w2000', date: 'January 2026' }
  ],
  sources: {
    official: ['Uttar Pradesh Tourism (uptourism.gov.in)', 'Azamgarh District Portal (azamgarh.nic.in)'],
    historical: ['Gazetteer of Azamgarh District'],
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <p className="text-d360-muted mt-2 text-sm">Don't leave without trying these delicacies.</p>
          </div>
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', 'Pilgrimage', 'Historical', 'Nature']
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about black clay pottery, local delicacies, history, or travel plans.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('dishes') && `Must-try foods in Azamgarh include Launglata (khoya-filled flaky sweet), Chawal ke Farre, Amla Laddu, Chole Samosa, Arbi Patta Rolls, and Kalika Mutton Curry.`}
                  {selected?.includes('famous') && `Azamgarh is famous for its GI-tagged Nizamabad Black Clay Pottery, handloom Mubarakpur silk saree weaving, rich literary history, and spiritual sites like Durvasa Rishi Ashram.`}
                  {selected?.includes('pottery') && `Authentic Nizamabad Black Clay Pottery can be bought directly from artisan workshops in Nizamabad village, located about 20 km from Azamgarh city center.`}
                  {selected?.includes('craft itinerary') && `For a 1-day craft itinerary: start in Nizamabad watching artisan black clay pottery making, enjoy Launglata and local street food, spend the afternoon in Mubarakpur touring saree weaving markets, and end your evening at Durvasa Rishi Ashram near the Tamsa River.`}
                </div>
              </div>
            )}
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={azamgarh} />
      <QuickFacts facts={azamgarh.quickFacts} />
      <WhyVisit destination={azamgarh} />
      <DestinationStory destination={azamgarh} />
      <HistoryTimeline destination={azamgarh} />
      <CultureGrid destination={azamgarh} />
      <FoodSection destination={azamgarh} />
      <AttractionsGrid destination={azamgarh} />
      <HiddenGems destination={azamgarh} />
      <ThingsToDo destination={azamgarh} />
      <NearbyPlaces destination={azamgarh} />
      <HowToReach destination={azamgarh} />
      <WhereToStay destination={azamgarh} />
      <BestTime destination={azamgarh} />
      <BudgetGuide destination={azamgarh} />
      <Itineraries destination={azamgarh} />
      <LocalExperiences destination={azamgarh} />
      <AskD360 destination={azamgarh} />
      <CommunityStories destination={azamgarh} />
      <SourcesTrust destination={azamgarh} />
      <Footer />
    </div>
  )
}